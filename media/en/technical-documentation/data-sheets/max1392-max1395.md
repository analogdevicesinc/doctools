...
|--------------|----------------|---------------|-----------------|------------|
| MAX1392 ETB+ | -40°C to +85°C | 10 TDFN-EP*   | 1-CH DIFF       | AOY        |
| MAX1395 ETB+ | -40°C to +85°C | 10 TDFN-EP*   | 2-CH S/E        | APB        |
...
| Differential Nonlinearity            | DNL                             | No missing code overtemperature                      | No missing code overtemperature                      |                                 |                                 | ±0.5                            | LSB                             |
| Offset Error                         |                                 |                                                      |                                                      |                                 | 0.25                            | ±0.5                            | LSB                             |
| Gain Error                           |                                 | Offset nulled                                        | Offset nulled                                        |                                 | 0.25                            | ±0.5                            | LSB                             |
...
| Channel-to-Channel Offset Matching   |                                 | MAX1395 only                                         | MAX1395 only                                         |                                 | ±0.1                            |                                 | LSB                             |
| Channel-to-Channel Gain Matching     |                                 | MAX1395 only                                         | MAX1395 only                                         |                                 | ±0.1                            |                                 | LSB                             |
| Input Common-Mode Rejection          | CMR                             | V CM = 0 to V DD , MAX1392 only                      | V CM = 0 to V DD , MAX1392 only                      |                                 | ±0.1                            |                                 | mV/V                            |
...
| Signal-to-Noise Plus Distortion      | SINAD                           | V REF = V DD = 1.6 to 3.6V                           | V REF = V DD = 1.6 to 3.6V                           | 61                              |                                 |                                 | dB                              |
| Signal-to-Noise Ratio                | SNR                             | V REF = V DD = 1.6 to 3.6V                           | V REF = V DD = 1.6 to 3.6V                           | 61                              |                                 |                                 | dB                              |
| Total Harmonic Distortion            | THD                             |                                                      |                                                      |                                 | -83                             | -73                             | dBc                             |
| Spurious-Free Dynamic Range          | SFDR                            |                                                      |                                                      |                                 | -84                             | -74                             | dBc                             |
| Intermodulation Distortion           | IMD                             | f IN1 = 83kHz at -6.5dBFS, f IN2 = 87kHz at -6.5dBFS | f IN1 = 83kHz at -6.5dBFS, f IN2 = 87kHz at -6.5dBFS |                                 | -75                             |                                 | dB                              |
| Channel-to-Channel Crosstalk         |                                 | MAX1395 only                                         | MAX1395 only                                         |                                 | -70                             |                                 | dB                              |
| Full-Power Bandwidth                 |                                 | -3dB point                                           | -3dB point                                           |                                 | 4                               |                                 | MHz                             |
| Full-Linear Bandwidth                |                                 |                                                      | MAX1392                                              |                                 | 200                             |                                 | kHz                             |
|                                      |                                 | SINAD > 59dB                                         | MAX1395                                              |                                 | 150                             |                                 |                                 |
...
| Conversion Time                                      | t CONV                                               | 11 clock cycles                                                                | 2.2                                                  |                                                      |                                                      | µs                                                   |
...
| Input Voltage Range                                  | V IN                                                 | Unipolar                                                                       | 0                                                    |                                                      | V REF                                                | V                                                    |
|                                                      |                                                      | Bipolar, MAX1392 only (AIN+ - AIN-)                                            | -V REF /2                                            |                                                      | +V REF /2                                            |                                                      |
| Common-Mode Input Voltage Range                      | V CM                                                 | Bipolar, MAX1392 only [(AIN+) + (AIN-)] / 2                                    | 0                                                    |                                                      | V DD                                                 | V                                                    |
...
| Input Capacitance                                    | CIN                                                  | CS , OE CH1 /CH2, UNI/ BIP                                                     |                                                      | 1 12.5                                               |                                                      | pF                                                   |
...
| POWER SUPPLY                     |          |                                       |                                       |       |       |         |
| Positive Supply Voltage          | V DD     |                                       |                                       |       | 3.6   | V       |
| Positive Supply Current (Note 4) | I DD     | f SAMPLE = 100ksps                    | V DD = 1.6V                           | 150   | 170   | µA      |
| Positive Supply Current (Note 4) | I DD     | f SAMPLE = 100ksps                    | V DD = 3V                             | 200   | 225   | µA      |
| Positive Supply Current (Note 4) | I DD     | f SAMPLE = 357ksps                    | V DD = 1.6V                           | 520   | 600   | µA      |
| Positive Supply Current (Note 4) | I DD     | f SAMPLE = 357ksps                    | V DD = 3V                             | 710   | 800   | µA      |
...
| Power-Supply Rejection (Note 7)  | PSR      | V DD = 1.5V to 3.6V, full-scale input | V DD = 1.5V to 3.6V, full-scale input | ±150  | ±1000 | µV/V    |
...
|-----------------------------------------|----------|-------|-------|-------|---------|
| SCLK Clock Period                       | t CP     |   200 |       | 10000 | ns      |
...
| 1       | 1       | V DD     | Positive Supply Voltage. Connect V DD to a 1.5V to 3.6V power supply. Bypass V DD to GND with a 0.1µF capacitor as close to the device as possible.                                                                                                                      |
...
| 10      | 10      | SCLK     | Serial-Clock Input. SCLK drives the conversion process and clocks data out. Acquisition ends on the 3rd falling edge after the CS falling edge. The LSB is clocked out on the SCLK 13th falling edge and the device enters AutoShutdown mode (see Figures 8, 9, and 10). |
...
t ACQ ≥ 7.4 x (RSOURCE + RIN) x CIN + tPU where:
...
The ADC automatically powers down on the SCLK falling edge that clocks out the LSB. This is the falling edge after the 13th SCLK. DOUT goes low when the LSB has been clocked into the master (µC) on the 16th rising SCLK edge.

Alternatively, drive OE high to force the MAX1392/ MAX1395 into power-down. Whenever OE goes high, the ADC powers down and disables DOUT regardless of CS ,  SCLK, or the state of the ADC. DOUT enters a high-impedance state after tDOD.
...
- 5th-order intermodulation products: 3 x fIN1 - 2 x fIN2, 3 x fIN2 - 2 x fIN1, 3 x fIN1 + 2 x f IN2, 3 x fIN2 + 2 x fIN1
...
|-------------------|-----------------|---------------------------------------------------------------------------------------------------------------------------------------------|-----------------|
|                 2 | 11/06           | Removed the future status from the MAX1392 part number in the Ordering Information table.                                                   | 1               |
|                 2 | 11/06           | In the Electrical Characteristics table, changed the Input Leakage Current parameter from ± 1µA (max) to ± 1.5µA (max).                     | 3               |
|                 3 | 10/09           | Removed the military grade packages from the General Description section, Ordering Information table, and Absolute Maximum Ratings section. | 1, 2            |
