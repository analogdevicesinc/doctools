...
- ♦ Superior Dynamic Performance 73dBc SFDR at fOUT = 20MHz UMTS ACLR = 63dB at fOUT = 30.7MHz
...
| Continuous Power Dissipation (T A = +70°C) 48-Pin TQFP-EP (derate 36.2mW/°C above                 | +70°C)....2.899W                                  |
...
| Resolution                                               |                     |                                                                |                                                                | 10                  |                     |                     | Bits                |
| Integral Nonlinearity                                    | INL                 | R L = 0                                                        | R L = 0                                                        | -1.25               | ±0.5                | +1.25               | LSB                 |
...
| Gain Error (See Gain Error                               | GE                  | Internal reference (Note 1)                                    | Internal reference (Note 1)                                    | -10                 | ±1.6                | +11                 | %                   |
| Parameter Definitions Section)                           | GE                  | External reference                                             | External reference                                             | -8                  | ±1.2                | +8                  | %                   |
...
| Spurious-Free Dynamic Range to Input Update Rate Nyquist | SFDR                | f DAC = 165Msps                                                | f OUT = 5MHz, T A ≥ +25°C                                      | 68                  | 76                  |                     | dBc                 |
| Spurious-Free Dynamic Range to Input Update Rate Nyquist | SFDR                | f DAC = 165Msps                                                | f OUT = 20MHz                                                  | 73                  | 73                  | 73                  | dBc                 |
| Spurious-Free Dynamic Range to Input Update Rate Nyquist | SFDR                | f DAC = 165Msps                                                | f OUT = 50MHz                                                  | 66                  | 66                  | 66                  | dBc                 |
| Spurious-Free Dynamic Range to Input Update Rate Nyquist | SFDR                | f DAC = 165Msps                                                | f OUT = 70MHz                                                  | 65                  | 65                  | 65                  | dBc                 |
| Spurious-Free Dynamic Range to Input Update Rate Nyquist | SFDR                | f DAC = 300Msps, 2x interpolation                              | f OUT = 5MHz                                                   | 76                  | 76                  | 76                  | dBc                 |
| Spurious-Free Dynamic Range to Input Update Rate Nyquist | SFDR                | f DAC = 300Msps, 2x interpolation                              | f OUT = 40MHz                                                  | 73                  | 73                  | 73                  | dBc                 |
| Spurious-Free Dynamic Range to Input Update Rate Nyquist | SFDR                | f DAC = 300Msps, 2x interpolation                              | f OUT = 60MHz                                                  | 72                  | 72                  | 72                  | dBc                 |
...
| Spurious-Free Dynamic Range Within a Window              | SFDR                | f DAC = 165Msps, f OUT = 5MHz, span = 4MHz                     | f DAC = 165Msps, f OUT = 5MHz, span = 4MHz                     | 76.5                | 85                  | 85                  | dBc                 |
...
| PARAMETER                               | SYMBOL                                  | CONDITIONS                       |   MIN | TYP   |   MAX | UNITS             |
|-----------------------------------------|-----------------------------------------|----------------------------------|-------|-------|-------|-------------------|
| Total Harmonic Distortion to Nyquist    | THD                                     | f DAC = 165Msps, f OUT = 5MHz    |       | -72   |       | dBc               |
| Noise Spectral Density                  | n D                                     | f DAC = 165Msps, f OUT = 5MHz    |       | -143  |       | dBm/Hz            |
...
| REFERENCE                               |                                         |                                  |       |       |       |                   |
| Reference Output Voltage                | V REF0                                  | REN = AGND                       |  1.14 | 1.24  |  1.34 | V                 |
| Output-Voltage Temperature Drift        | TCV REF                                 |                                  |       | ±50   |       | ppm/ ° C          |
| Reference Output Drive Capability       |                                         |                                  |       | 50    |       | µA                |
| Reference Input Voltage Range           |                                         | REN = AV DD                      |  0.10 |       |  1.32 | V                 |
...
| Passband Width                          | f OUT /                                 | -0.005dB                         |       | 0.398 |       | MHz/ MHz          |
| Passband Width                          | f OUT /                                 | -0.01dB                          |       | 0.402 |       | MHz/ MHz          |
| Passband Width                          | 0.5f DAC                                | -0.1dB                           |       | 0.419 |       | MHz/ MHz          |
| Passband Width                          | f OUT /                                 | -3dB                             |       | 0.478 |       | MHz/ MHz          |
...
| Passband Width                                         | f OUT / 0.5f DAC                                       | -0.005dB                                               | -0.005dB                                               | 0.200                                                  | 0.200                                                  | 0.200                                                  | MHz/ MHz                                               |
|                                                        |                                                        | -0.01dB                                                | -0.01dB                                                | 0.201                                                  | 0.201                                                  | 0.201                                                  | MHz/ MHz                                               |
|                                                        |                                                        | -0.1dB                                                 | -0.1dB                                                 | 0.210                                                  | 0.210                                                  | 0.210                                                  | MHz/ MHz                                               |
|                                                        |                                                        | -3dB                                                   | -3dB                                                   | 0.239                                                  | 0.239                                                  | 0.239                                                  | MHz/ MHz                                               |
|                                                        |                                                        | 0.302f DAC / 2 to 1.698f DAC / 2                       | 0.302f DAC / 2 to 1.698f DAC / 2                       | 74                                                     | 74                                                     | 74                                                     | dB                                                     |
| Stopband Rejection                                     |                                                        | 0.300f DAC / 2 to 1.700f DAC / 2                       | 0.300f DAC / 2 to 1.700f DAC / 2                       | 63                                                     | 63                                                     | 63                                                     | dB                                                     |
...
| LOGIC INPUTS (IDE, CW , REN , DA9-DA0, DB9-DB0, PLLEN) | LOGIC INPUTS (IDE, CW , REN , DA9-DA0, DB9-DB0, PLLEN) | LOGIC INPUTS (IDE, CW , REN , DA9-DA0, DB9-DB0, PLLEN) | LOGIC INPUTS (IDE, CW , REN , DA9-DA0, DB9-DB0, PLLEN) | LOGIC INPUTS (IDE, CW , REN , DA9-DA0, DB9-DB0, PLLEN) | LOGIC INPUTS (IDE, CW , REN , DA9-DA0, DB9-DB0, PLLEN) | LOGIC INPUTS (IDE, CW , REN , DA9-DA0, DB9-DB0, PLLEN) | LOGIC INPUTS (IDE, CW , REN , DA9-DA0, DB9-DB0, PLLEN) |
| Digital Input-Voltage High                             | V                                                      | IH                                                     | IH                                                     | 2                                                      | 2                                                      | 2                                                      | V                                                      |
...
| Digital Input Capacitance                              |                                                        | CIN                                                    | CIN                                                    | 3                                                      | 3                                                      | 3                                                      | pF                                                     |
...
| Input Data Rate                                        | f DATA                                                 | 2x interpolation                                       | PLL disabled PLL enabled                               | 75                                                     |                                                        | 150 150                                                | Msps                                                   |
| Input Data Rate                                        | f DATA                                                 |                                                        | PLL disabled                                           |                                                        |                                                        | 75                                                     | Msps                                                   |
| Input Data Rate                                        | f DATA                                                 | 4x interpolation                                       | PLL enabled                                            | 37.5                                                   |                                                        | 75                                                     | Msps                                                   |
|                                                        |                                                        | No interpolation, PLL enabled                          | No interpolation, PLL enabled                          |                                                        |                                                        | 165                                                    |                                                        |
| Clock Frequency at CLK Input                           | f CLK                                                  | 2x interpolation, PLL enabled                          | 2x interpolation, PLL enabled                          | 75                                                     |                                                        | 150                                                    | MHz                                                    |
|                                                        |                                                        |                                                        |                                                        | 37.5 75                                                | 37.5 75                                                | 37.5 75                                                |                                                        |
...
| Data-to-CLK Rise Setup Time (Note 3)                     | t DCSR             | PLL disabled                     | 1.5                |                    |                    | ns                 |
| Data-to-CLK Rise Setup Time (Note 3)                     | t DCSR             | PLL enabled                      | 2.2                |                    |                    | ns                 |
| Data-to-CLK Rise Hold Time (Note 3)                      | t DCHR             | PLL disabled                     | 0.4                |                    |                    | ns                 |
| Data-to-CLK Rise Hold Time (Note 3)                      | t DCHR             | PLL enabled                      | 1.4                |                    |                    | ns                 |
| Data-to-CLK Fall Setup Time (Note 3)                     | t DCSF             | PLL disabled                     | 1.8                |                    |                    | ns                 |
| Data-to-CLK Fall Setup Time (Note 3)                     | t DCSF             | PLL enabled                      | 2.4                |                    |                    | ns                 |
| Data-to-CLK Fall Hold Time (Note 3)                      | t DCHF             | PLL disabled                     | 1.2                |                    |                    | ns                 |
| Data-to-CLK Fall Hold Time (Note 3)                      | t DCHF             | PLL enabled                      | 1.3                |                    |                    | ns                 |
...
| Clock Frequency at CLKXP/CLKXN Input                     | f CLKDIFF          | Differential clock, PLL disabled |                    |                    | 300                | MHz                |
| CLKXP/CLKXN Differential Clock Input to CLK Output Delay | t CXD              | PLL disabled                     |                    | 4.6                |                    | ns                 |
...
|----------------------------------|-----------|-------------------------------------------------------|-------------------------------------------------------|-------|-------|-------|---------|
| Digital Supply Current (Note     |           |                                                       | No interpolation                                      |    34 |       |       | mA      |
|                                  |           |                                                       | 2x interpolation                                      |    75 |       |       | mA      |
|                                  |           |                                                       | 4x interpolation                                      |    72 |       |       | mA      |
|                                  | I DVDD    |                                                       | No interpolation                                      |    54 |    61 |       | mA      |
|                                  |           |                                                       | 2x interpolation                                      |   146 |       |       | mA      |
|                                  |           |                                                       | 4x interpolation                                      |   140 |       |       | mA      |
|                                  |           |                                                       | 2x interpolation                                      |   172 |   186 |       | mA      |
|                                  |           |                                                       | 4x interpolation                                      |   165 |   178 |       | mA      |
| PLL Power-Supply Voltage         | PV DD     |                                                       |                                                       |   2.7 |   3.3 |       | V       |
| PLL Supply Current (Note 4)      | I PVDD    | f DAC = 60Msps                                        | f DAC = 60Msps                                        |    17 |       |       | mA      |
| PLL Supply Current (Note 4)      | I PVDD    | f DAC = 165Msps                                       | f DAC = 165Msps                                       |    46 |    52 |       | mA      |
| PLL Supply Current (Note 4)      | I PVDD    | f DAC = 200Msps, 2x interpolation or 4x interpolation | f DAC = 200Msps, 2x interpolation or 4x interpolation |    55 |    61 |       | mA      |
| Standby Current                  | I STANDBY | (Note 5)                                              | (Note 5)                                              |   4.4 |   4.8 |       | mA      |
| Power-Down Current               | I PD      | (Note 5)                                              | (Note 5)                                              |     1 |       |       | µA      |
| Total Power Dissipation (Note 4) | P TOT     |                                                       | No interpolation                                      |   324 |       |   486 | mW      |
| Total Power Dissipation (Note 4) | P TOT     |                                                       | 2x interpolation                                      |   487 |       |   486 | mW      |
| Total Power Dissipation (Note 4) | P TOT     |                                                       | 4x interpolation                                      |   498 |       |   486 | mW      |
|                                  |           |                                                       | No interpolation                                      |   438 |       |   486 | mW      |
|                                  |           |                                                       | 2x interpolation                                      |   735 |       |   486 | mW      |
|                                  |           |                                                       | 4x interpolation                                      |   721 |       |   486 | mW      |
|                                  |           |                                                       | 2x interpolation                                      |   816 |       |   486 | mW      |
|                                  |           |                                                       | 4x interpolation                                      |   795 |       |   486 | mW      |
...
FFT PLOT FOR DAC UPDATE NYQUIST WINDOW (2x INTERPOLATION, f DAC  = 200MHz, fOUT = 10MHz, AOUT = 0dBFS)

<!-- image -->

<!-- image -->

FFT PLOT FOR DAC UPDATE NYQUIST WINDOW (4x INTERPOLATION, f DAC  = 200MHz, fOUT = 10MHz, AOUT = 0dBFS)
...
8-TONE MTPR PLOT FOR NYQUIST WINDOW (4x INTERPOLATION, fDAC = 286.4MHz, fCENTER = 20MHz, INPUT TONES SPACING ~ 300kHz, AOUT = -18dBFS)
...
8-TONE MTPR PLOT (4x INTERPOLATION, f DAC  = 286.4MHz, fCENTER = 29.9572MHz)
...
FFT PLOT FOR PLL DISABLED AND PLL ENABLED (f OUT  = 10MHz, 2x INTERPOLATION)
...
| 7, 18, 48 | DV DD     | Digital Power Supply. See Power Supplies, Bypassing, Decoupling, and Layout section.                                                                                          |
...
| 32     | PV DD  | PLL Power Supply. See Power Supplies, Bypassing, Decoupling, and Layout section.                                                                                                                                                                                                 |
| 33     | PGND   | PLL Ground                                                                                                                                                                                                                                                                       |
...
An 8-bit control word routed through channel A's data port programs the gain matching, interpolator configuration, and operational mode of the MAX5858A. The control word is latched on the falling edge of CW .  Table 1 describes the control word format and function.
...
At  power-up, the MAX5858A is configured in no-interpolation mode with a gain adjustment setting of 0dB and a fully operational converter. In shutdown, the MAX5858A consumes only 1µA of supply current, and in standby the current consumption is 4.4mA. Wake-up time from standby mode to normal operation is 0.7µs.
...
|---------|--------|--------|------------------------------------------------|-------------------------------|------------------|-----------------|------------------------------|
|       1 |      0 |      0 | N/A (connect CLXP low and CLXN high)           | 0 to 165 (input)              | f CLK            | 1x              | 82                           |
|       1 |      0 |      1 | N/A (connect CLXP low and CLXN high)           | 75 to 150 (input)             | 2 x f CLK        | 2x              | 63                           |
|       1 |      1 |      1 | N/A (connect CLXP low and CLXN high)           | 37 to 75 (input)              | 4 x f CLK        | 4x              | 31                           |
...
The MAX5858A includes three separate power-supply inputs: analog (AVDD), digital (DVDD), and clock (PVDD). Use a single linear regulator power source to branch out to three separate power-supply lines (AVDD, DVDD, PVDD) and returns (AGND, DGND, PGND). Filter each power-supply line to the respective return line using LC filters comprising ferrite beads and 10µF capacitors. Filter  each supply input locally with 0.1µF ceramic capacitors to the respective return lines.
