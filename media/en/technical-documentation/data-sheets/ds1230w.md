...
The DS1230W executes a write cycle whenever the  WE  and  CE  signals are active (low) after address inputs are stable. The later-occurring falling edge of  CE  or  WE  will determine the start of the write cycle.
...
Each DS1230W device is shipped from Maxim with its lithium energy source disconnected, guaranteeing full energy capacity. When VCC is first applied at a level greater than 3.0 volts, the lithium energy source is enabled for battery back-up operation.
...
| PARAMETER                       | SYMBOL      | DS1230W-100   | DS1230W-100   | UNITS   | NOTES   |
|---------------------------------|-------------|---------------|---------------|---------|---------|
|                                 |             | MIN           | MAX           |         |         |
...
9. Each DS1230W has a built-in switch that disconnects the lithium source until VCC is first applied by the user. The expected tDR is defined as accumulative time in the absence of VCC starting from the time power is first applied by the user.
...
|-----------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------|
| 121907          | Added the Ordering Information table; removed the DIP module package drawing and dimension table                                                                                                                                                                                                                                                                                       | 8               |
