...
|------------|-----------------|----------------|
| MAX6971AUG | -40°C to +125°C | 24 TSSOP       |
| MAX6971ANG | -40°C to +125°C | 24 Narrow PDIP |
...
Point-of-Order Signs Traffic Signs Gaming Features Architectural Lighting
...
|---------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| V+ ............................................................................-0.3V to +6V | V+ ............................................................................-0.3V to +6V |
| OUT_ .....................................................................-0.3V to +40V     | OUT_ .....................................................................-0.3V to +40V     |
| DIN, CLK, LE, OE , SET                                                                      | ................................-0.3V to (V+ + 0.3V)                                        |
| DOUT Current ..................................................................±10mA        | DOUT Current ..................................................................±10mA        |
...
| Output Current OUT_                                                                  | I OUT       | V+ = 3V to 5.5V, V OUT = 0.8V to 2.5V, R SET = 360 Ω         | 37        |    50 | 61       | mA      |
...
| LE Rising to OUT_ Falling Delay    | t LRF      | (Note 3)                           |       |       |   300 | ns      |
...
| OE Falling to OUT_ Falling Delay   | t OE L     | (Note 3)                           |       |       |   320 | ns      |
...
Note 3: A 65 Ω pullup resistor connected from OUT\_  to 5.5V.
...
| LE Rising to OUT_ Rising Delay     | t LRR      | (Note 3)                 |       |       |   120 | ns      |
| LE Rising to OUT_ Falling Delay    | t LRF      | (Note 3)                 |       |       |   310 | ns      |
| CLK Rising to OUT_ Rising Delay    | t CRR      | (Note 3)                 |       |       |   120 | ns      |
| CLK Rising to OUT_ Falling Delay   | t CRF      | (Note 3)                 |       |       |   330 | ns      |
| OE Rising to OUT_ Rising Delay     | t OE H     | (Note 3)                 |       |       |   120 | ns      |
| OE Falling to OUT_ Falling Delay   | t OE L     | (Note 3)                 |       |       |   330 | ns      |
| LED Output OUT_ Turn-On Fall Time  | t f        | 80% to 20% (Note 3)      |       |       |   120 | ns      |
...
| 5-20  | OUT0-OUT15 | LED Driver Outputs. OUT0 to OUT15 are open-drain, constant-current-sinking outputs rated to 36V.                                                                                                                            |
...
LE is the latch load input of the MAX6971 that transfers data from the MAX6971 16-bit shift register to its 16-bit latch  when LE is high (transparent latch), and latches the data on the falling edge of LE (Figure 2).
...
DOUT is the serial-data output, which shifts data out from the MAX6971's 16-bit shift register on the rising edge of CLK. Data at DIN is propagated through the shift register and appears at DOUT 16 clock cycles later.
...
| PART    |   NUMBER OF OUTPUTS |   MAX OUTPUT VOLTAGE (V) |   MAX OUTPUT CURRENT (mA) | LED FAULT DETECTION   | WATCHDOG   |
|---------|---------------------|--------------------------|---------------------------|-----------------------|------------|
| MAX6968 |                   8 |                      5.5 |                        55 | -                     | -          |
| MAX6977 |                   8 |                      5.5 |                        55 | Yes                   | -          |
| MAX6978 |                   8 |                      5.5 |                        55 | Yes                   | Yes        |
| MAX6970 |                   8 |                       36 |                        55 | -                     | -          |
| MAX6981 |                   8 |                       36 |                        55 | Yes                   | -          |
| MAX6980 |                   8 |                       36 |                        55 | Yes                   | Yes        |
| MAX6969 |                  16 |                      5.5 |                        55 | -                     | -          |
| MAX6979 |                  16 |                      5.5 |                        55 | Yes                   | Yes        |
| MAX6971 |                  16 |                       36 |                        55 | -                     | -          |
| MAX6983 |                  16 |                       36 |                        55 | Yes                   | Yes        |
