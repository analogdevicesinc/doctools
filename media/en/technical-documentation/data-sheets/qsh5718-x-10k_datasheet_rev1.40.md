<!-- lastmod 2023-09-25 -->
## QSH5718-x-10k Hardware Manual

Hardware Version V1.00 | Document Revision V1.40 • 24.04.2023

QSH5718-x-10k is a NEMA23 (57mm) 2-phase stepper motor including a small size optical incremental encoder kit. It comes with a resolution of 625 lines (40.000 counts). Trinamic's Stepper motors are quality motors for universal use. They feature a long life due to ball bearings and no wearing out parts.
...
|                 |                                                                                                            | and Mechanical . . . . . . . . . . . . . Torque-Speed . . . . . . .                                                                       | 4 5   |
|                 | 2.2                                                                                                        | Diagrams . . . . . . . . . . . . . . . 2.2.1                                                                                              |       |
|                 |                                                                                                            | QSH5718-51-28-101-10k . . . . . . . . . . . . . . . . . QSH5718-76-28-189-10k                                                             | 5     |
|                 | 2.2.2                                                                                                      | . . . . . . . . . . . . . . . . .                                                                                                         | 6     |
...
| QSH5718-51-28-101-10k   | QSH5718-51-28-101-10000-AT   | Motor + Encoder Module, NEMA23 2- phase stepper motor (2.8A / 1.01Nm) with incremental encoder kit, resolution of 625lpr (40.000cpr), ABN, TTL   | 57x57x73.6   |
|-------------------------|------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------|--------------|
| QSH5718-76-28-189-10k   | QSH5718-76-28-189-10000-AT   | Motor + Encoder Module, NEMA23 2- phase stepper motor (2.8A / 1.89Nm) with incremental encoder kit, resolution of 625lpr (40.000cpr), ABN, TTL   | 57x57x98.6   |
...
- NEMA23 mounting con/uniFB01guration, Flange max. 56.5mm x 56.5mm
...
| Rated Voltage                       | V      | 2.3   | 3.2   |
|-------------------------------------|--------|-------|-------|
| Rated Phase Current                 | A      | 2.8   | 2.8   |
| Phase Resistance at 20°C            | Ω      | 0.83  | 1.13  |
| Phase Inductance (typ.)             | mH     | 2.2   | 3.6   |
| Holding Torque                      | Nm     | 1.01  | 1.89  |
| Detent Torque                       | Nm     | 0.035 | 0.066 |
| Rotor Inertia                       | g cm 2 | 275   | 480   |
| Weight (Mass)                       | Kg     | 0.65  | 1.00  |
| Insulation Class                    |        | B     | B     |
| Insulation Resistance               | Ω      | 100M  | 100M  |
| Dialectic Strength (for one minute) | VAC    | 500   | 500   |
| Connection Wires                    |        | 4     | 4     |
| Max applicable Voltage              | V      | 75    | 75    |
| Step Angle                          | °      | 1.8   | 1.8   |
| Step angle Accuracy (max.)          | %      | 5     | 5     |
| Flange Size (max.)                  | mm     | 56.5  | 56.5  |
| Motor Length (max.)                 | mm     | 51    | 67    |
| Axis Diameter                       | mm     | 6.35  | 6.35  |
| Axis Length (typ.)                  | mm     | 20.0  | 20.0  |
| Axis D-cut (0.5mm depth)            | mm     | 15.0  | 15.0  |

QSH5718-76-28-189-10k
...
|---------------------------------------|---------|-----------|-----------|
| Maximum Radial Force (20mm off front) | N       | 75        | 75        |
| Maximum Axial Force                   | N       | 15        | 15        |
| Ambient Temperature                   | °C      | -20...+50 | -20...+50 |
| Temp Rise (rated current, 2phase on)  | °C max. | 80        | 80        |
| Winding Thermal Time Constant         | min     | 22        | 30        |
| Surface Thermal Time Constant         | min     | 30        | 39        |
...
## 2.2.1 QSH5718-51-28-101-10k

Testing conditions: Driver Supply 30V, 2.8A RMS Coil Current, Half Step Operation.

<!-- image -->

Figure 1: QSH5718-51-28-101-10k velocity vs. torque characteristic

<!-- image -->

0.02

## 2.2.2 QSH5718-76-28-189-10k

Testing conditions: Driver Supply 30V, 2.8A RMS Coil Current, Half Step Operation.

Figure 2: QSH5718-76-28-189-10k velocity vs. torque characteristics
...
| QSH5718-51-28-101-10k   | 51mm   |
|-------------------------|--------|
| QSH5718-76-28-189-10k   | 76mm   |
...
|----|------------------------------------------------------------------------------------|
|  2 | QSH5718-76-28-189-10k velocity vs. torque characteristics . . . . . . . . . 6      |
|  3 | Lead wire con/uniFB01guration . . . . . . . . 8 Connection and circuit diagram for |
|  4 | the line driver outputs . . . . . . . . . 9                                        |

1

QSH5718-51-28-101-10k velocity
...
|     |                                                                                         |     | 13 . . . . . . . . .                                                                     |    |
|-----|-----------------------------------------------------------------------------------------|-----|------------------------------------------------------------------------------------------|----|
| 2   | Electrical and Mechanical Characteris- tics Motor . . . . . . . . . . . . . . . . . . . | 5   | Motor current settings 15                                                                | 12 |
| 3 4 | Electrical Characteristics Encoder Mechanical Speci/uniFB01cations . . . . . . . . . .  | 6   | Driver supply voltage considerations 17 full-                                            | 13 |
|     | . .                                                                                     | 7 7 | Comparing microstepping and stepping . . . . . . . . . . . . . . . . . . . . . . . . . . | 15 |
| 5 7 | Environmental Speci/uniFB01cations Connector and signals of                             | 7   | 18 Hardware Revision . .                                                                 | 20 |
| 9   | motor Connector and signals of the                                                      | 8   | 19 . . . . . . . . . .                                                                   | 20 |
|     | . . . encoder                                                                           |     | Document Revision .                                                                      |    |
...
|    1.2 | 11.08.2020   | SK   | Lpr parameter updated. Motor cable length information added. Thermal time constant added. |
|    1.3 | 16.04.2021   | SK   | Order codes updated.                                                                      |
|    1.4 | 24.04.2023   | SK   | Typos and layout corrected.                                                               |
