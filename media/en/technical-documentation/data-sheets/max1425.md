...
- ♦ Signal-to-Noise Ratio 61dB (at fIN = 2MHz) 59.3dB (at fIN = 10MHz)
...
| DGND to AGND................................................................. | ±0.3V                                                  |
| REFP, REFIN, REFN, CMLN, CMLP,                                                | REFP, REFIN, REFN, CMLN, CMLP,                         |
| CML, INP, INN                                                                 | ....................(V AGND - 0.3V) to (V AVDD + 0.3V) |
...
(VAVDD = VCMLP = +5V, VDVDD = +3.3V, VCMLN = VAGND = VDGND = 0V, internal reference, digital output load = 35pF, fCLK = 20MHz (50% duty cycle), TA = TMIN to TMAX, unless otherwise noted. Typical values are at TA = +25°C.)
...
|                                                  | GE                                    | External reference (REFIN) (Note 2)                        | -5                                    | ±2                                    | 5                                     | %FSR                                  |
|                                                  | GE                                    | External reference (REFP, CML, REFN) (Note 3)              | -5                                    | ±3                                    | 5                                     | %FSR                                  |
| Power-Supply Rejection Ratio                     | PSRR                                  | (Note 4)                                                   | -5                                    | ±2                                    | 5                                     | mV/V                                  |
| DYNAMIC PERFORMANCE (A IN = -1.0dBFS)            | DYNAMIC PERFORMANCE (A IN = -1.0dBFS) | DYNAMIC PERFORMANCE (A IN = -1.0dBFS)                      | DYNAMIC PERFORMANCE (A IN = -1.0dBFS) | DYNAMIC PERFORMANCE (A IN = -1.0dBFS) | DYNAMIC PERFORMANCE (A IN = -1.0dBFS) | DYNAMIC PERFORMANCE (A IN = -1.0dBFS) |
| Signal-to-Noise Ratio                            | SNR                                   | f = 2MHz                                                   | 60                                    | 61                                    |                                       | dB                                    |
|                                                  | SNR                                   | f = 10MHz                                                  | 56                                    | 59                                    |                                       | dB                                    |
| Spurious-Free Dynamic Range                      | SFDR                                  | f = 2MHz                                                   | 70                                    | 72                                    |                                       | dB                                    |
|                                                  | SFDR                                  | f = 10MHz                                                  | 64                                    | 69                                    |                                       | dB                                    |
| Total Harmonic Distortion (first five harmonics) | THD                                   | f = 2MHz                                                   |                                       | -70                                   | -67                                   | dB                                    |
| Total Harmonic Distortion (first five harmonics) | THD                                   | f = 10MHz                                                  |                                       | -69                                   | -64                                   | dB                                    |
| Signal-to-Noise and Distortion                   | SINAD                                 | f = 2MHz                                                   | 59                                    | 61                                    |                                       | dB                                    |
| Signal-to-Noise and Distortion                   | SINAD                                 | f = 10MHz                                                  | 55                                    | 59                                    |                                       | dB                                    |
| Effective Number of Bits                         | ENOB                                  | f = 2MHz                                                   | 9.3                                   | 9.7                                   |                                       | Bits                                  |
| Effective Number of Bits                         | ENOB                                  | f = 10MHz                                                  | 8.8                                   | 9.5                                   |                                       | Bits                                  |
...
| Positive Reference                                            | V REFP                                                        | (Note 1)                                                      |                                                               | 3.25                                                          |                                                               | V                                                             |
| Common-Mode Reference Voltage                                 | V CML                                                         | (Note 1)                                                      |                                                               | 2.25                                                          |                                                               | V                                                             |
| Negative Reference                                            | V REFN                                                        | (Note 1)                                                      |                                                               | 1.25                                                          |                                                               | V                                                             |
| Differential Reference                                        |                                                               | V REFP - V REFN , T A = +25°C                                 | 1.8                                                           | 2                                                             | 2.2                                                           | V                                                             |
...
|-----------------------------------------------------------|------------------------------|--------------------------------|-------------------------|--------------|--------|---------|---------|
| POWER SUPPLY                                              |                              |                                |                         |              |        |         |         |
| Analog Supply Voltage                                     | V AVDD                       |                                |                         | 4.75         | 5.00   | 5.25    | V       |
| Digital Supply Voltage                                    | V DVDD                       |                                |                         | 2.7          | 3.3    | 5.5     | V       |
| Analog Supply Current                                     | I AVDD                       |                                |                         |              | 31     | 38      | mA      |
| Analog Supply Current with Internal Reference in Shutdown |                              | REFIN = AGND                   |                         |              | 26     | 35      | mA      |
| Analog Shutdown Current                                   |                              | OE /PD = DV DD                 |                         |              | 0.6    | 1       | mA      |
| Digital Supply Current                                    | I DVDD                       | V DVDD = 3.3V                  |                         |              | 5.3    | 9       | mA      |
| Digital Shutdown Current                                  |                              | OE /PD = DV DD V DVDD = 5.0V   |                         |              | 90 8.5 | 150 14  | µA      |
| Power Dissipation                                         | PD                           |                                |                         |              | 172    | 220     | mW      |
| DIGITAL INPUTS (CLK, OE /PD)                              | DIGITAL INPUTS (CLK, OE /PD) |                                |                         |              |        |         |         |
|                                                           |                              | V DVDD > 4.75V                 |                         | 2.4          |        |         |         |
| Input Logic High                                          | V IH                         | V DVDD < 4.75V                 |                         | 0.7 · V DVDD |        |         | V       |
| Input Logic Low                                           |                              | V DVDD > 4.75V                 |                         |              |        | 0.8     |         |
| Input Current Leakage                                     |                              | V = 5.25V                      | I CLK                   | -10          |        | 10      | µA      |
|                                                           |                              | DVDD                           | I OE /PD                | -20          |        | 20      | µA      |
| Input Capacitance                                         |                              |                                |                         |              | 10     |         | pF      |
| DIGITAL OUTPUTS (D0-D9)                                   | DIGITAL OUTPUTS (D0-D9)      | DIGITAL OUTPUTS (D0-D9)        | DIGITAL OUTPUTS (D0-D9) |              |        |         |         |
| Output Logic High                                         | VOH                          | I OH = -200µA, V DVDD = 2.7V   |                         | V DVDD - 0.5 |        | V DV DD | V       |
| Output Logic Low                                          | VOL                          | I OL = 200µA, V DVDD = 2.7V    |                         |              |        | 0.5     | V       |
| Three-State Leakage                                       |                              | V DVDD = 5.25V, OE /PD = DV DD |                         | -10          |        | 10      | µA      |
| Three-State Capacitance                                   |                              | OE /PD = DV DD                 |                         |              | 10     |         | pF      |
...
| Clock High                                                | t CH                         | Figure 4                       |                         | 20           | 25     | 30      | ns      |
| Clock Low                                                 | t CL                         | Figure 4                       |                         | 20           | 25     | 30      | ns      |
...
(VAVDD = VCMLP = +5V, VDVDD = +3.3V, VCMLN = VAGND = 0V, internal reference, digital output load = 35pF, fCLK = 20Msps (50% duty cycle), for dynamic performance 0dB is full scale, TA = +25°C, unless otherwise noted.)
...
| 5      | REFN   | Negative Reference Output. Bypass to AGND with a 0.1µF capacitor. REFN can accept an external voltage when the internal reference is disabled (REFN = AGND).                                                             |
...
The MAX1425 has an internal +2.5V reference used to generate three reference levels: +3.25V, +2.25V, and +1.25V corresponding to VREFP, VCML, and VREFN. These reference voltages enable a ±2V input range. Bypass all reference voltages with a 0.1µF capacitor.
...
|                 1 | 7/11            | Updated Ordering Information , Absolute Maximum Ratings , Electrical Characteristics and Package Information | 1, 2, 4, 15     |
