...
The  MAX98500  is  available  in  a  small,  0.5mm  pitch 16-bump WLP package (2.1mm x 2.1mm). It is specified over the extended -40 N C to +85 N C temperature range.
...
Active Speaker Accessories Features

- S Boosted Class D Output
- S Integrated Automatic Level Control
- S Output Power 2.2W into 8 I , 10% THD+N 1.7W into 8 I , 1% THD+N
...
|--------------|--------------------|---------------|
| MAX98500EWE+ | -40 N C to +85 N C | 16 WLP        |
...
| SDBST , SDSPK to AGND......................................                                                          | -0.3V to V BAT    |
...
|---------------------------------------|-----------------|----------------------------------------------------|----------------------------------------------------|-----------------|-----------------|-----------------|-----------------|
| Power-Supply Rejection Ratio (Note 3) | PSRR            | T A = +25 N C, V BAT = 2.5V to 5.5V                | T A = +25 N C, V BAT = 2.5V to 5.5V                |                 | 95              |                 | dB              |
| Quiescent Current                     | I VBAT          | T A = +25 N C, SDSPK = SDBST = V BAT               | T A = +25 N C, SDSPK = SDBST = V BAT               |                 | 3.05            |                 | mA              |
| Quiescent Current                     | I VBAT          | T A = +25 N C, V SDSPK = 0V, SDBST = V BAT         | T A = +25 N C, V SDSPK = 0V, SDBST = V BAT         |                 | 0.09            | 0.15            | mA              |
| Quiescent Current                     | I PVDD          | T A = +25 N C, PVDD = 5.55V, SDSPK = SDBST = V BAT | T A = +25 N C, PVDD = 5.55V, SDSPK = SDBST = V BAT |                 | 1.7             | 2.7             | mA              |
| Combined Efficiency                   | E               | P OUT = 1.7W, f = 1kHz, Z SPK = 8 I + 68 F H       | P OUT = 1.7W, f = 1kHz, Z SPK = 8 I + 68 F H       |                 | 87              |                 | %               |
| Shutdown Current                      | I SHDN          | V SDSPK = V SDBST = 0V, T A = +25 N C              | V SDSPK = V SDBST = 0V, T A = +25 N C              |                 | 0.04            | 1.5             | F A             |
| Turn-On Time                          | tON             | Time from power-on to full operation               | Time from power-on to full operation               |                 | 10              | 12              | ms              |
...
| Undervoltage Lockout                  | UVLO            | V BAT falling                                      | V BAT falling                                      | 2.1             | 2.2             | 2.3             | V               |
| Boost Converter Output Voltage        | V VCCOUT        | I LOAD = 0mA                                       | I LOAD = 0mA                                       | 5.45            | 5.5             | 5.65            | V               |
| Output Current Limit                  | IMAX            | V BAT R = 3.6V                                     | V BAT R = 3.6V                                     | 1.5             |                 |                 | A               |
| Input Current Limit                   | I LIMIT         | Startup, VCCOUT = 0V                               | Startup, VCCOUT = 0V                               |                 | 0.3             | 0.5             | A               |
| nMOS Current Limit                    | I LX,MAX        |                                                    |                                                    |                 | 3.3             |                 | A               |
| pMOS Turn-Off Current Limit           |                 |                                                    |                                                    |                 | 10              |                 | mA              |
| Switching Frequency                   | f S             |                                                    |                                                    | 1.8             | 2.0             | 2.2             | MHz             |
| Efficiency                            | E               | 0.1A P I OUT P 0.75A                               | 0.1A P I OUT P 0.75A                               |                 | 93              |                 | %               |
| Startup Short-Circuit Time            |                 | Converter latch off                                | Converter latch off                                |                 | 50              |                 | ms              |
| Thermal Shutdown                      |                 |                                                    |                                                    |                 | 165             |                 | N C             |
| LX Leakage Current                    |                 | VLX = 0V or 5.5V,                                  | T A = +25 N C                                      | -1.0            | +0.1            | +1.0            | F A             |
| LX Leakage Current                    |                 | VCCOUT = 5.5V                                      | -40 N C P T A P +85 N C                            |                 | 0.1             |                 |                 |
...
|--------------------------------------|----------|------------------------------------------------------------------------|------------------------------------------------------------------------|-------|-------|-------|---------|
| SPEAKER AMPLIFIER                    |          |                                                                        |                                                                        |       |       |       |         |
| Output Offset Voltage                | VOS      | T A = +25 N C                                                          | T A = +25 N C                                                          |       |     1 |     3 | mV      |
| Click-and-Pop Level                  | KCP      | Peak voltage, T A = +25 N C, A-weighted, 32 Into shutdown              | Peak voltage, T A = +25 N C, A-weighted, 32 Into shutdown              |       |   -56 |       | dBV     |
|                                      | KCP      | samples per second, Z SPK = 8 I + 68 F H, (Notes 3, 4) Out of shutdown | samples per second, Z SPK = 8 I + 68 F H, (Notes 3, 4) Out of shutdown |       |   -56 |       | dBV     |
| Output Power (Note 5)                | P OUT    | THD+N P 1%                                                             | THD+N P 1%                                                             |       |   1.7 |       | W       |
|                                      | P OUT    |                                                                        | THD+N P 10%                                                            |       |   2.2 |       | W       |
| Total Harmonic Distortion Plus Noise | THD+N    | = 1kHz, P OUT = 850mW, T A = +25 N C, Z SPK = 8 I + 68 F H             | = 1kHz, P OUT = 850mW, T A = +25 N C, Z SPK = 8 I + 68 F H             |       |  0.05 |       | %       |
| Output Switching Frequency           |          |                                                                        |                                                                        |       |   300 |       | kHz     |
| Gain                                 | AV       | GAIN = AGND                                                            | GAIN = AGND                                                            |   5.5 |     6 |   6.5 |         |
|                                      | AV       | GAIN = unconnected                                                     | GAIN = unconnected                                                     |    15 |  15.5 |    16 | dB      |
|                                      | AV       | GAIN = VBAT                                                            | GAIN = VBAT                                                            |  19.5 |    20 |  20.5 |         |
| Output Current Limit                 |          |                                                                        |                                                                        |       |     2 |       | A       |
| Efficiency                           | E        | POUT = 1.7W, f = 1kHz, Z SPK = 8 I + 68 F H                            | POUT = 1.7W, f = 1kHz, Z SPK = 8 I + 68 F H                            |       |    92 |       | %       |
| Output Noise                         | E        | A-weighted                                                             | A-weighted                                                             |       |    43 |       | F VRMS  |
| Input Resistance                     | RIN      |                                                                        | AV = 6dB (GAIN = AGND)                                                 |    36 |    54 |    72 | k I     |
| Input Resistance                     | RIN      | SDBST = SDSPK = AV = 15.5dB (GAIN =                                    | SDBST = SDSPK = AV = 15.5dB (GAIN =                                    |    12 |    18 |    26 | k I     |
| Input Resistance                     | RIN      |                                                                        | AV = 20dB (GAIN = V BAT                                                |   6.5 |    11 |    16 | k I     |
| Input Resistance                     | RIN      | V SDBST = V SDSPK = 0V All gain settings                               | V SDBST = V SDSPK = 0V All gain settings                               |       |   110 |       | k I     |
| Common-Mode Rejection Ratio          | CMRR     | f = 1kHz                                                               | f = 1kHz                                                               |       |    60 |       | dB      |
| Bias                                 | VBIAS    | Voltage                                                                | Voltage                                                                |   1.3 |   1.4 |   1.5 | V       |
| ALC                                  |          |                                                                        |                                                                        |       |       |       |         |
| Attack Time                          |          |                                                                        |                                                                        |       |    20 |       | F s/dB  |
| Release Time                         |          |                                                                        |                                                                        |       |   1.6 |       | s/dB    |
| Maximum                              |          | Attenuation                                                            | Attenuation                                                            |       |     8 |       | dB      |
...
| PARAMETER                        | SYMBOL                           | CONDITIONS                       | CONDITIONS                       | MIN                              | TYP                              | MAX                              | UNITS                            |
|----------------------------------|----------------------------------|----------------------------------|----------------------------------|----------------------------------|----------------------------------|----------------------------------|----------------------------------|
| Knee Resistor                    | RKNEE                            |                                  | V KNEE = 3.25V                   |                                  | 43.2                             |                                  | k I                              |
| Knee Resistor                    |                                  |                                  | V KNEE = 3.35V                   |                                  | 37.4                             |                                  | k I                              |
| Knee Resistor                    |                                  |                                  | V KNEE = 3.45V                   |                                  | 32.4                             |                                  | k I                              |
| Knee Resistor                    |                                  |                                  | V KNEE = 3.55V                   |                                  | 27.4                             |                                  | k I                              |
| Knee Resistor                    |                                  |                                  | V KNEE = 3.65V                   |                                  | 23.2                             |                                  | k I                              |
| Knee Resistor                    |                                  |                                  | V KNEE = 3.75V                   |                                  | 18.7                             |                                  | k I                              |
| Knee Resistor                    |                                  |                                  | V KNEE = 3.85V                   |                                  | 15.0                             |                                  | k I                              |
...
| Input Leakage Current            | I IN                             | T A = +25 N C                    | T A = +25 N C                    | -1.0                             |                                  | +1.0                             | F A                              |
...
The MAX98500 filterless Class D amplifier offers much higher  efficiency  than  Class  AB  amplifiers.  The  high efficiency of a Class D amplifier is due to the switching operation of the output stage transistors. Any power loss associated with the Class D output stage is mostly due to the I 2 R loss of the MOSFET on-resistance and quiescent current overhead.
...
An output capacitor, CVCCOUT, is required to keep the output voltage ripple small and to ensure regulation loop stability.  The  output  capacitor  must  have  low  impedance  at  the  switching  frequency.  Ceramic  capacitors are highly recommended due to their small size and low ESR. Ceramic capacitors with X5R or X7R temperature characteristics generally perform well. The recommended nominal capacitance for the MAX98500 is 22 F F (0805 case size or larger). Ensure the minimum capacitance at 5.5V is 6.8 F F.
