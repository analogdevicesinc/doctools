<!-- lastmod 2022-10-10 -->
## MAX38640A µDFN Evaluation Kit

## General Description

The  MAX38640A  evaluation  kit  (EV  kit)  evaluates  the MAX38640A,  an  ultra-low  quiescent  current  step-down DC-DC  converter  in  the  µDFN  package.  The  EV  kit operates over an input rangeof 1.8V to 5.5V, and provides resistor-configurable  output  voltages  from  1.0V  to  3.3V. The EV kit delivers up to 175mA of current depending on the input voltage to the output voltage ratio.

The EV kit comes with the MAX38640AELT+ installed.

## Features

- Evaluates the MAX38640A IC in a 6-pin µDFN
...
| FILE                         | DECRIPTION              |
|------------------------------|-------------------------|
| MAX38640A µDFN EV BOM        | EV Kit Bill of Material |
| MAX38640A µDFN EV PCB Layout | EV Kit Layout           |
| MAX38640A µDFN EV Schematic  | EV Kit Schematic        |

<!-- image -->

Evaluates: MAX38640 A in µDFN

## Quick Start

## Required Equipment

- MAX38640A µDFN EV kit
...
The MAX38640A EV kit evaluates the MAX38640A, an ultra-low  quiescent  current  step-down  DC-DC  converter in the µDFN package. The EV kit operates over an input range of 1.8V to 5.5V, and provides resistor-configurable output voltages from 1.0V to 3.3V. The EV kit delivers up to 175mA of current depending on the input voltage to the output voltage ratio.

The EV kit comes with the MAX38640AELT+ installed.

## EN

The MAX38640A µDFN EV kit provides a jumper JU1 to enable or disable the MAX38640A. Refer to Table 1 for jumper JU1 settings.
...
Note: Indicate that you are using the MAX38640A when con- tacting these component suppliers.

## Evaluates: MAX38640 A in µDFN

## Output Voltage Selection

The MAX38640A µDFN EV kit provides a jumper JU2 to select the MAX38640A output voltage. Refer to Table 2 for jumper JU2 settings.

## Spare Inductor

The MAX38640A µDFN EV kit provides a spare inductor on  the  PCB's  bottom  side.  This  spare  inductor  can  be used to reconfigure the EV kit with a lower inductor DC resistance.
...
| PART              | TYPE   |
|-------------------|--------|
| MAX38640AEVK#uDFN | EV Kit |

# Denotes RoHS

## MAX38640A µDFN EV Kit Bill of Materials

|   ITEM | REF_DES   | DNI/DNP   |   QTY | MFG PART #                                     | MANUFACTURER                           | VALUE         | DESCRIPTION                                                                                                                                      |
|--------|-----------|-----------|-------|------------------------------------------------|----------------------------------------|---------------|--------------------------------------------------------------------------------------------------------------------------------------------------|
|      1 | C1        | -         |     1 | C1608X5R1A106K080AC                            | TDK                                    | 10µF          | CAPACITOR; SMT (0603); CERAMIC CHIP; 10µF; 10V; TOL = 10%; MODEL = ; TG = -55°C TO +85°C; TC = X5R                                               |
|      2 | C2        | -         |     1 | CL10A226KQ8NRN                                 | SAMSUNG                                | 22µF          | CAP; SMT (0603); 22µF; 10%; 6.3V; X5R; CERAMIC CHIP                                                                                              |
|      3 | C5        | -         |     1 | 25SVPF100M                                     | PANASONIC                              | 100µF         | CAP; SMT (CASE_E7); 100UF; 20%; 25V; ALUMINUM-ORGANIC                                                                                            |
...
|      7 | L1        | -         |     1 | 1285AS-H-2R2M                                  | TOKO                                   | 2.2µH         | INDUCTOR; SMT (2016); METAL ALLOY CHIP; 2.2UH; TOL = ±20%; 1.4A                                                                                  |
|      8 | L1A       | -         |     1 | 74479276222                                    | WURTH ELECTRONICS INC.                 | 2.2µH         | INDUCTOR; SMT (0806); MOLDED CHIP; 2.2µH; 30%; 1.40A                                                                                             |
...
|     17 | U1        | -         |     1 | MAX38640AELT+                                  | MAXIM                                  | MAX38640AELT+ | EVKIT PART - IC; TINY 300NANO-AMP NANOPOWER BUCK CONVERTER; PACKAGE OUTLINE: 21-0164; PACKAGE CODE: L622+1C; PACKAGE LAND PATTERN: 90-0004; DFN6 |
|     18 | PCB       | -         |     1 | MAX38640AUDFN                                  | MAXIM                                  | PCB           | PCB:MAX38640AUDFN                                                                                                                                |
...
## MAX38640A µDFN EV Kit Schematic

<!-- image -->

## MAX38640A µDFN EV Kit PCB Layout Diagrams

<!-- image -->

MAX38640A µDFN EV Kit-Top Silkscreen

<!-- image -->

MAX38640A µDFN EV Kit-Top

MAX38640A µDFN EV Kit-Bottom

<!-- image -->

MAX38640A µDFN EV Kit-Bottom Silkscreen
