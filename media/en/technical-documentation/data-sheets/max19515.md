...
The MAX19515 is available in a small 7mm x 7mm 48pin thin QFN package and is specified over the -40°C to +85°C extended temperature range.
...
- ♦ Excellent Dynamic Performance 60.1dBFS SNR at 70MHz 82dBc SFDR at 70MHz
...
(VAVDD = VOVDD = 1.8V, internal reference, differential clock, VCLK = 1.5VP-P, fCLK = 65MHz, AIN = -0.5dBFS, data output termination = 50 Ω , TA = -40°C to +85°C, unless otherwise noted. Typical values are at TA = +25°C.) (Note 1)
...
| Input Current                          | I IN                                   | Switched capacitance input current, each input                 | 35              | 35              |                 | µA              |
...
| Minimum Clock Frequency                | f CLK                                  |                                                                | 30              | 30              | 30              | MHz             |
...
| Small-Signal Noise Floor                               | SSNF                | f IN = 70MHz, < -35dBFS       |                     | -60.4               |                     | dBFS                |
|                                                        |                     | f IN = 3MHz                   |                     | 60.2                |                     | dBFS                |
| Signal-to-Noise Ratio                                  | SNR                 | f IN = 70MHz                  | 59.3                | 60.1                |                     | dBFS                |
| Signal-to-Noise Ratio                                  |                     | f IN = 175MHz                 |                     | 59.8                |                     | dBFS                |
| Signal-to-Noise Plus Distortion Ratio                  | SINAD               | f IN = 3MHz                   |                     | 59.7                |                     | dB                  |
|                                                        |                     | f IN = 70MHz                  | 58.8                | 59.6                |                     | dB                  |
|                                                        |                     | f IN = 175MHz                 |                     | 59.3                |                     | dB                  |
| Spurious-Free Dynamic Range (2nd and 3rd Harmonic)     |                     | f IN = 3MHz                   |                     | 85                  |                     | dBc                 |
|                                                        | SFDR1               | f IN = 70MHz                  | 73                  | 84                  |                     | dBc                 |
|                                                        |                     | f IN = 175MHz                 |                     | 81                  |                     | dBc                 |
| Spurious-Free Dynamic Range (4th and Higher Harmonics) | SFDR2               | f IN = 3MHz                   |                     | 82                  |                     | dBc                 |
| Spurious-Free Dynamic Range (4th and Higher Harmonics) |                     | f IN = 70MHz                  | 74.4                | 82                  |                     | dBc                 |
| Spurious-Free Dynamic Range (4th and Higher Harmonics) |                     | f IN = 175MHz                 |                     | 82                  |                     | dBc                 |
| Second Harmonic                                        |                     | f IN = 3MHz                   |                     | -86                 |                     | dBc                 |
| Second Harmonic                                        | HD2                 | f IN = 70MHz                  |                     | -86                 | -73                 | dBc                 |
| Second Harmonic                                        |                     | f IN = 175MHz                 |                     | -82                 |                     | dBc                 |
...
| Total Harmonic Distortion                              | THD                 | f IN = 70MHz f IN = 175MHz    |                     | -79 -77             | -71.8               | dBc                 |
...
| Aperture Delay                                         | t                   |                               | 850                 |                     |                     | MHz ps              |
|                                                        | AD                  |                               |                     | 0.3                 |                     | ps RMS              |
| Aperture Jitter                                        | t AJ                | ±10% beyond full scale        |                     | 1                   |                     | Cycles              |
...
|                                                             |                                                             | f INA or f INB = 175MHz at -1dBFS                           |                                                             | 85                                                          |                                                             | dBc                                                         |
...
| DIGITAL INPUTS (SHDN, CS )                                                                  | DIGITAL INPUTS (SHDN, CS )                                                                  | DIGITAL INPUTS (SHDN, CS )                                                                  | DIGITAL INPUTS (SHDN, CS )                                                                  | DIGITAL INPUTS (SHDN, CS )                                                                  | DIGITAL INPUTS (SHDN, CS )                                                                  | DIGITAL INPUTS (SHDN, CS )                                                                  |
| Allowable Logic Swing                                                                       |                                                                                             |                                                                                             | 0                                                                                           | - V AVDD                                                                                    |                                                                                             | V                                                                                           |
...
| Input Pulldown Current                                                                      |                                                                                             | V SCLK /V SDIN /V CS = 0V, V AVDD = 1.8V                                                    | -65                                                                                         | -50                                                                                         | -35                                                                                         | µA                                                                                          |
|                                                                                             |                                                                                             | V SCLK /V SDIN /V CS = 0V, V AVDD = 3.3V                                                    | -105                                                                                        | -90                                                                                         | -75                                                                                         |                                                                                             |
...
|                                                                                             | I LEAK                                                                                      | V OVDD applied                                                                              |                                                                                             |                                                                                             | +0.5                                                                                        |                                                                                             |
| Three-State Leakage Current                                                                 |                                                                                             | GND applied                                                                                 | -0.5                                                                                        |                                                                                             |                                                                                             | µA                                                                                          |
...
| Clock Pulse-Width High                                                                         | t CH                                                                                           |                                                                                                | 7.69                                                                                           | 7.69                                                                                           |                                                                                                | ns                                                                                             |
| Clock Pulse-Width Low                                                                          | t CL                                                                                           |                                                                                                |                                                                                                | 7.69                                                                                           |                                                                                                | ns                                                                                             |
| Clock Duty Cycle                                                                               | t CH /t CLK                                                                                    |                                                                                                |                                                                                                | 30to 70                                                                                        |                                                                                                | %                                                                                              |
| Data Delay After Rising Edge of CLK+                                                           | t DD                                                                                           | CL = 10pF, V OVDD = 1.8V (Note 2) CL = 10pF, V OVDD = 3.3V                                     | 3.4                                                                                            | 5.3 4.1                                                                                        | 7.1                                                                                            | ns                                                                                             |
| Data to DCLK Setup Time                                                                        | t SETUP                                                                                        | CL = 10pF, V OVDD = 1.8V (Note 2)                                                              | 12.8                                                                                           | 13.4                                                                                           |                                                                                                | ns                                                                                             |
| Data to DCLK Hold Time                                                                         | t HOLD                                                                                         | CL = 10pF, V OVDD = 1.8V (Note 2)                                                              | 1.4                                                                                            | 2.0                                                                                            |                                                                                                | ns                                                                                             |
| TIMING CHARACTERISTICS-MULTIPLEXED BUS PARALLEL MODE (Figure 10) (Default Timing, see Table 5) | TIMING CHARACTERISTICS-MULTIPLEXED BUS PARALLEL MODE (Figure 10) (Default Timing, see Table 5) | TIMING CHARACTERISTICS-MULTIPLEXED BUS PARALLEL MODE (Figure 10) (Default Timing, see Table 5) | TIMING CHARACTERISTICS-MULTIPLEXED BUS PARALLEL MODE (Figure 10) (Default Timing, see Table 5) | TIMING CHARACTERISTICS-MULTIPLEXED BUS PARALLEL MODE (Figure 10) (Default Timing, see Table 5) | TIMING CHARACTERISTICS-MULTIPLEXED BUS PARALLEL MODE (Figure 10) (Default Timing, see Table 5) | TIMING CHARACTERISTICS-MULTIPLEXED BUS PARALLEL MODE (Figure 10) (Default Timing, see Table 5) |
| Clock Pulse-Width High                                                                         | t CH                                                                                           |                                                                                                |                                                                                                | 7.69                                                                                           |                                                                                                | ns                                                                                             |
| Clock Pulse-Width Low                                                                          | t CL                                                                                           |                                                                                                |                                                                                                | 7.69                                                                                           |                                                                                                | ns                                                                                             |
| Clock Duty Cycle                                                                               | t CH /t CLK                                                                                    |                                                                                                |                                                                                                | 30to 70                                                                                        |                                                                                                | %                                                                                              |
| Data Delay After Rising Edge of                                                                | t DD                                                                                           | CL = 10pF, V OVDD = 1.8V (Note 2)                                                              | 3.3                                                                                            | 5.2                                                                                            | 7.0                                                                                            | ns                                                                                             |
| CLK+                                                                                           | t DD                                                                                           | CL = 10pF, V OVDD = 3.3V                                                                       |                                                                                                | 4.0                                                                                            |                                                                                                |                                                                                                |
| Data to DCLK Setup Time                                                                        | t SETUP                                                                                        | CL = 10pF, V OVDD = 1.8V (Note 2)                                                              | 5.0                                                                                            | 5.9                                                                                            |                                                                                                | ns                                                                                             |
| Data to DCLK Hold Time                                                                         | t HOLD                                                                                         | CL = 10pF, V OVDD = 1.8V (Note 2)                                                              | 1.2                                                                                            | 1.8                                                                                            |                                                                                                | ns                                                                                             |
| DCLK Duty Cycle                                                                                | t DCH /t CLK                                                                                   | CL = 10pF, V OVDD = 1.8V (Note 2)                                                              | 44                                                                                             | 50                                                                                             | 56                                                                                             | %                                                                                              |
| MUX Data Duty Cycle                                                                            | t CHA /t CLK                                                                                   | CL = 10pF, V OVDD = 1.8V (Note 2)                                                              | 44                                                                                             | 50                                                                                             | 56                                                                                             | %                                                                                              |
...
| Hold-Off Time for Invalid Clock Edge                                                           | t SDH                                                                                          | Edge mode (Note 2)                                                                             | 0.5                                                                                            |                                                                                                |                                                                                                | ns                                                                                             |
...
| Analog Supply Current         | I AVDD             | Dual channel                                              | 47                 | 55                 | mA                 |                    |
| Analog Supply Current         | I AVDD             | Single channel active                                     | 28                 |                    | mA                 |                    |
| Analog Supply Current         |                    | Standby mode                                              | 8.5                | 12                 | mA                 |                    |
| Analog Supply Current         |                    | Power-down mode                                           | 0.65               | 0.9                | mA                 |                    |
| Analog Supply Current         |                    | Power-down mode, V AVDD = 3.3V                            | 1.6                |                    | mA                 |                    |
| Analog Power Dissipation      | P DA               | Dual channel                                              | 85                 | 99                 | mW                 |                    |
| Analog Power Dissipation      | P DA               | Dual channel, V AVDD = 3.3V                               | 155                |                    | mW                 |                    |
| Analog Power Dissipation      | P DA               | Single channel active                                     | 50                 |                    | mW                 |                    |
| Analog Power Dissipation      | P DA               | Standby mode                                              | 15                 | 22                 | mW                 |                    |
| Analog Power Dissipation      | P DA               | Power-down mode                                           | 1.2                | 1.6                | mW                 |                    |
| Analog Power Dissipation      | P DA               | Power-down mode, V AVDD = 3.3V                            | 2.9                |                    | mW                 |                    |
| Digital Output Supply Current | I OVDD             | Dual-channel mode, CL = 10pF                              | 13                 |                    | mA                 |                    |
...
(VAVDD = VOVDD = 1.8V, internal reference, differential clock, VCLK = 1.5VP-P, fCLK = 65MHz, AIN = -0.5dBFS, data output termination = 50 Ω , TA = +25°C, unless otherwise noted.)
...
The MAX19515 uses a 10-stage, fully differential, pipelined architecture (Figure 1) that allows for highspeed conversion while minimizing power consumption.  Samples taken at the inputs move progressively through the pipeline stages every half clock cycle. From input to output the total latency is 9 clock cycles. Each pipeline converter stage converts its input voltage to a digital output code. At every stage, except the last, the error between the input voltage and the digital output code is multiplied and passed on to the next pipeline stage. Digital error correction compensates for ADC comparator offsets in each pipeline stage and ensures no missing codes. Figure 2 shows the MAX19515 functional diagram.
...
The SHDN input (pin 7) toggles between any two power-management states. The Power Management register defines each power-management state. In the default state, SHDN = 1 shuts down the MAX19515 and SHDN = 0 returns to full power.
...
The MAX19515 offers a clock-divider option. Enable clock division either by setting DIV0 and DIV1 through the  serial  interface;  see  the  Clock  Divide/Data
...
The MAX19515's wide common-mode voltage range (0.4V to 1.4V) allows DC-coupled signals. Ensure that the common-mode voltage remains between 0.4V and 1.4V.
