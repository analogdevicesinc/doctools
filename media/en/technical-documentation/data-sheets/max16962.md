...
## 4A, 2.MHz, Synchronous Step-Down

## General Description

The  MAX16962  is  a  high-efficiency,  synchronous  stepdown converter that operates with a 2.7V to 5.5V input voltage range and provides a 0.8V to 3.6V output voltage range. The wide input/output voltage range and the ability to provide up to 4A to load current make this device ideal  for  on-board  point-of-load  and  post-regulation applications. The MAX16962 achieves -3.7%/+2.6% output error over load, line, and temperature ranges.
...
The  MAX16962  is  available  in  thermally  enhanced 16-pin TSSOP-EP and 4mm x 4mm, 16-pin TQFN-EP packages, and is specified for operation over the  -40 N C  to  +125 N C  automotive  temperature  range.

Ordering Information appears at end of data sheet.

## MAX16962 DC-DC Converter
...
- S 4mm x 4mm, 16-Pin Thin QFN and 16-Pin TSSOP Packages
...
| Supply Current                        | IPV                                   | No load, VPWM = 0V                               |    12 |    26 |    45 | F A     |
| Shutdown Supply Current               | ISHDN                                 | VEN = 0V, TA = +25 ° C                           |       |     1 |     5 | F A     |
...
| SYNCHRONOUS STEP-DOWN DC-DC CONVERTER | SYNCHRONOUS STEP-DOWN DC-DC CONVERTER | SYNCHRONOUS STEP-DOWN DC-DC CONVERTER            |       |       |       |         |
| FB Regulation Voltage                 | VOUTS                                 |                                                  |       |   800 |       | mV      |
| Feedback Set-Point Accuracy           | VOUTS                                 | ILOAD = 4A                                       |  -3.7 |     0 |  +2.6 | %       |
| Feedback Set-Point Accuracy           | VOUTS                                 | ILOAD = 0A                                       |  -1.9 |       |  +2.6 | %       |
| pMOS On-Resistance                    | RDSON_P                               | VPV1 = 5V, ILX_ = 0.4A, LX1 in parallel with LX2 |       |    34 |    55 | m I     |
| nMOS On-Resistance                    | RDSON_N                               | VPV1 = 5V, ILX_ = 0.8A, LX1 in parallel with LX2 |       |    25 |    45 | m I     |
...
|--------------------------------------------|-------------------------------------|---------------------------------------------|-------------------------------------|-------------------------------------|-------------------------------------|-------------------------------------|
| PARAMETER                                  | SYMBOL                              | CONDITIONS                                  | MIN                                 | TYP                                 | MAX                                 | UNITS                               |
| Maximum Output Current                     | IOUT                                | (VOUT + 0.5V P VPV1 P 5.5V) (Note 3)        | 4.4                                 |                                     |                                     | A                                   |
|                                            | IB_OUTS                             | Fixed output voltage variants               | 1                                   | 2                                   | 5                                   | F A                                 |
| OUTS Bias Current                          |                                     | Adjustable output version                   | -1                                  |                                     | +1                                  |                                     |
| LX_ Leakage Current                        | ILX_LEAK                            | VPV_ = 5V, LX_ = PGND_ or PV_, TA = +25 ° C | -1                                  |                                     | +1                                  | F A                                 |
| Minimum On-Time                            | tON_MIN                             |                                             |                                     | 60                                  |                                     | ns                                  |
| LX Discharge Resistance                    | RLX                                 | VEN = 0V, through the OUTS pin              | 15                                  | 24                                  | 55                                  | I                                   |
...
| Output High Leakage Current                |                                     | TA = +25 ° C                                |                                     |                                     | 0.2                                 | F A                                 |
|                                            |                                     | ISINK = 3mA                                 |                                     |                                     | 0.4                                 | V                                   |
| PG Output Low Voltage                      |                                     | VPV = 1.2V, ISINK = 100 F A                 |                                     |                                     | 0.4                                 |                                     |
| ENABLE INPUTS (EN)                         |                                     |                                             |                                     |                                     |                                     |                                     |
| Input Voltage High                         | VINH                                | Input rising                                | 2.4                                 |                                     |                                     | V                                   |
| Input Voltage Low                          | VINL                                | Input falling                               |                                     |                                     | 0.5                                 | V                                   |
| Input Hysteresis                           |                                     |                                             |                                     | 0.85                                |                                     | V                                   |
| Input Current                              |                                     | VEN = high                                  | 0.1                                 | 1.0                                 | 2                                   | F A                                 |
| Pulldown Resistor                          |                                     | VEN = low                                   | 50                                  | 100                                 | 200                                 | k I                                 |
...
## 4A, 2.MHz, Synchronous Step-Down DC-DC Converter
...
| Output Voltage High             | VOH                             | VPV = 5V, ISOURCE = 3mA         |   4.2 |       |       | V       |
...
## 4A, 2.2MHz, Synchronous Step-Down 4A, 2.2MHz, Synchronous Step-Down

## MAX16962 DC-DC Converter MAX16962 DC-DC Converter
...
The  MAX16962  is  a  high-efficiency,  synchronous  stepdown converter that operates with a 2.7V to 5.5V input voltage range and provides a 0.8V to 3.6V output voltage range. The MAX16962 delivers up to 4A of load current and achieves -3.7%/+2.6% output error over load, line, and temperature ranges.

The PWM input forces the MAX16962 into either a fixedfrequency,  2.2MHz  PWM  mode  or  a  low-power  pulse frequency  modulation  mode  (SKIP).  Optional  spreadspectrum frequency modulation minimizes radiated electromagnetic  emissions  due  to  the  switching  frequency. The  factory  programmable  synchronization  I/O  (SYNC) enables system synchronization.
...
The MAX16962 features an open-drain power-good output that asserts when the output voltage drops 8% below or  rises  10%  above  the  regulated  voltage.  PG  remains asserted for a fixed 16ms timeout period after the output rises  up  to  its  regulated  voltage.  Connect  PG  to  OUTS with a 20k I resistor.
...
The  MAX16962  featuring  spread-spectrum  (SS)  operation  varies  the  internal  operating  frequency  up by SS  =  6%  relative  to  the  internally  generated  operating frequency of 2.2MHz (typ). This function does not apply to  externally  applied  oscillation  frequency.  The  internal oscillator  is  frequency  modulated  with  a  6%  frequency deviation. See the Selector Guide for available options.
...
| V IN - V OUT (V)   |   5.0 to 3.3 |   5.0 to 2.5 |   5.0 to 1.5 |   3.3 to 0.8 |
|--------------------|--------------|--------------|--------------|--------------|
...
Three  key  inductor  parameters  must  be  specified  for operation  with  the  MAX16962:  inductance  value  (L), inductor  saturation  current  (I SAT ),  and  DC  resistance (R DCR ).  Use  the  following  formulas  to  determine  the minimum inductor value:
...
where  f CO ,  the  target  crossover  frequency,  is  210kHz, GEAMP, the error-amplifier voltage gain, is 31.7V/V, and RCS is 139m Ω .
...
- 6)  OUTS are sensitive to noise for devices with external feedback option. The resistive network, R1, R2, and C1 must be placed close to OUTS and far away from the LX\_ node and high switching current paths. The ground node of R2 must be close to GND.
...
|-------------|------------------|-----------------|------------------|-------------------|---------------|
| MAX16962    | RAUE             | A/V+            | Ext. Adj.        | Disabled          | In            |
| MAX16962    | SAUE             | A/V+            | Ext. Adj.        | Enabled           | In            |
| MAX16962    | RATE             | A/V+            | Ext. Adj.        | Disabled          | In            |
| MAX16962    | SATE             | A/V+            | Ext. Adj.        | Enabled           | In            |
...
|------------------|-----------------|-------------------------------|---------------|
| MAX16962_ATE_/V+ | -40°C to +125°C |                             4 | 16 TQFN-EP*   |
| MAX16962_AUE_/V+ | -40°C to +125°C |                             4 | 16 TSSOP-EP*  |

Note: '\_' is a package suffix placeholder for either 'R' or 'S,' as shown the Selector Guide. The second '\_' is in the option suffix. /V denotes an automotive qualified part.
...
|                 2 | 5/14            | Added FB regulation voltage specifications and updated V PV condition in Electrical Characteristics table; corrected equations and updated Table 2 in the Inductor Selection and Output Capacitor sections; updated Ordering Information | 2, 3, 9 - 11    |
