...
- ♦ Excellent Dynamic Performance 58.5dB SNR at fIN = 20MHz 72dB SFDR at fIN = 20MHz
- ♦ SNR Flat within 1dB for fIN = 20MHz to 100MHz
- ♦ Low Power 125mA (Normal Operation) 2.8mA (Sleep Mode) 1µA (Shutdown Mode)
...
(VDD = 3.3V, OVDD = 2.5V; 0.1µF and 1.0µF capacitors from REFP, REFN, and COM to GND; REFOUT connected to REFIN through a 10k Ω resistor, VIN = 2VP-P (differential with respect to COM), CL = 10pF at digital outputs (Note 1), fCLK = 105.263MHz, TA = TMIN to TMAX, unless otherwise noted. Typical values are at TA = +25°C.) (Note 2)

| PARAMETER                                                 | SYMBOL   | CONDITIONS                                  |   MIN | TYP            | MAX   | UNITS        |
|-----------------------------------------------------------|----------|---------------------------------------------|-------|----------------|-------|--------------|
| DC ACCURACY                                               |          |                                             |       |                |       |              |
| Resolution                                                |          |                                             |    10 |                |       | Bits         |
| Integral Nonlinearity                                     | INL      | f IN = 7.47MHz                              |       | ± 0.75         | ± 2.5 | LSB          |
| Differential Nonlinearity                                 | DNL      | f IN = 7.47MHz, no missing codes guaranteed |  -1.0 | ± 0.4          | +1.5  | LSB          |
| Offset Error                                              |          |                                             |  -1.8 |                | +1.8  | %FS          |
| Gain Error                                                |          |                                             |       | 0              | ± 2   | %FS          |
| ANALOG INPUT                                              |          |                                             |       |                |       |              |
...
| Signal-to-Noise Ratio (Note 3)                            | SNR      | f INA or B = 7.47MHz, T A = +25 ° C         |       | 59             |       | dB           |
| Signal-to-Noise Ratio (Note 3)                            | SNR      | f INA or B = 20MHz, T A = +25 ° C           |    55 | 58.5           |       | dB           |
| Signal-to-Noise Ratio (Note 3)                            | SNR      | f INA or B = 50.078MHz                      |       | 58             |       | dB           |
| Signal-to-Noise and Distortion (Note 3)                   |          | f INA or B = 7.47MHz, T A = +25 ° C         |       | 58.2           |       | dB           |
| Signal-to-Noise and Distortion (Note 3)                   | SINAD    | f INA or B = 20MHz, T A = +25 ° C           |  54.7 | 58.1           |       | dB           |
| Signal-to-Noise and Distortion (Note 3)                   |          | f INA or B = 50.078MHz                      |       | 57.6           |       | dB           |
| Spurious-Free Dynamic Range (Note 3)                      |          | f INA or B = 7.47MHz, T A = +25 ° C         |       | 72             |       | dBc          |
| Spurious-Free Dynamic Range (Note 3)                      | SFDR     | f INA or B = 20MHz, T A = +25 ° C           |    60 | 72             |       | dBc          |
| Spurious-Free Dynamic Range (Note 3)                      |          | f INA or B = 50.078MHz                      |       | 70             |       | dBc          |
| Total Harmonic Distortion (First Four Harmonics) (Note 3) |          | f INA or B = 7.47MHz, T A = +25 ° C         |       | -71            |       |              |
| Total Harmonic Distortion (First Four Harmonics) (Note 3) | THD      | f INA or B = 20MHz, T A = +25 ° C           |       | -70            | -59   | dBc          |
| Total Harmonic Distortion (First Four Harmonics) (Note 3) |          | f INA or B = 50.078MHz                      |       | -69            |       | dBc          |
...
| PARAMETER                                      | SYMBOL                                         | CONDITIONS                                                                     | MIN TYP                                        | MAX                                            | UNITS                                          |                                                |
|------------------------------------------------|------------------------------------------------|--------------------------------------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|
| Third-Harmonic Distortion                      | HD3                                            | f INA or B = 7.47MHz                                                           | -75                                            |                                                | dBc                                            |                                                |
| (Note 3)                                       | HD3                                            | f INA or B = 20MHz f INA or B = 50.078MHz                                      | -75 -73                                        |                                                | dBc                                            |                                                |
| Intermodulation Distortion                     | IMD                                            | f INA or B = 38.055MHz at -6.5dBFS f INA or B = 42.926MHz at -6.5dBFS (Note 4) | -74                                            |                                                | dBc                                            |                                                |
...
| Positive Reference Output Voltage              | V REFP                                         |                                                                                | 2.162                                          |                                                | V                                              |                                                |
| Negative Reference Output Voltage              | V REFN                                         |                                                                                | 1.138                                          |                                                | V                                              |                                                |
...
| Input Leakage                                                                                     | I IH                                                                                              | V IH = OV DD or V DD (CLK)                                                                        |                                                                                                   |                                                                                                   | ± 5                                                                                               | µA                                                                                                |
|                                                                                                   | I IL                                                                                              | V IL = 0                                                                                          |                                                                                                   |                                                                                                   | ± 5                                                                                               |                                                                                                   |
| Input Capacitance                                                                                 | CIN                                                                                               |                                                                                                   |                                                                                                   | 5                                                                                                 |                                                                                                   | pF                                                                                                |
...
| Analog Supply Current                                                                             | I VDD                                                                                             | Operating, f INA or B = 20MHz at -0.5dBFS                                                         |                                                                                                   | 125                                                                                               | 156                                                                                               | mA                                                                                                |
|                                                                                                   | I VDD                                                                                             | Sleep mode                                                                                        |                                                                                                   | 2.8                                                                                               |                                                                                                   |                                                                                                   |
|                                                                                                   | I VDD                                                                                             | Shutdown, clock idle, PD = OE = OV DD                                                             |                                                                                                   | 1                                                                                                 | 15                                                                                                | µA                                                                                                |
...
| PARAMETER                     | SYMBOL                      | CONDITIONS                                            | MIN                         | TYP                         | MAX                         | UNITS                       |
|-------------------------------|-----------------------------|-------------------------------------------------------|-----------------------------|-----------------------------|-----------------------------|-----------------------------|
| Output Supply Current         | I OVDD                      | Operating, CL = 15pF , f INA or B = 20MHz at -0.5dBFS |                             | 15                          |                             | mA                          |
| Output Supply Current         | I OVDD                      | Sleep mode                                            |                             | 100                         |                             | µA                          |
| Output Supply Current         | I OVDD                      | Shutdown, clock idle, PD = OE = OV DD                 |                             | 2                           | 10                          | µA                          |
| Power Dissipation             | PDISS                       | Operating, f INA or B = 20MHz at -0.5dBFS             |                             | 413                         | 511                         | mW                          |
| Power Dissipation             | PDISS                       | Sleep mode                                            |                             | 9.2                         |                             | µW                          |
| Power Dissipation             | PDISS                       | Shutdown, clock idle, PD = OE = OV DD                 |                             | 3                           | 50                          | µW                          |
...
| CLK Pulse-Width High          | t CH                        | Figure 3, clock period: 9.5ns                         |                             | 4.75 ± 1.5                  |                             | ns                          |
| CLK Pulse-Width Low           | t CL                        | Figure 3, clock period: 9.5ns                         |                             | 4.75 ± 1.5                  |                             | ns                          |
| Wake-Up Time (Note 6)         | t WAKE                      | Wakeup from sleep mode Wakeup from shutdown           |                             | 0.18 1.5                    |                             | µs                          |
...
(VDD = 3.3V, OVDD = 2.5V, internal reference, differential input at -0.5dBFS, fCLK = 105.0006MHz, CL ≈ 10pF. TA = +25°C, unless otherwise noted.)
...
| 2, 6, 11, 14, 15 | V DD   | Analog Supply Voltage. Bypass each supply pin to GND with a 0.1µF capacitor. The analog supply accepts a 2.7V to 3.6V input range. |
...
| 32, 33 | OV DD  | Output Driver Supply Voltage. Bypass each supply pin to OGND with a 0.1µF capacitor. The output driver supply accepts a 1.7V to 3.6V input range. |
...
| 46     | REFIN  | Reference Input. V REFIN = 2 ✕ (V REFP - V REFN ). Bypass to GND with a > 1nF capacitor.                                                          |
...
The full-scale range of the MAX1180 is determined by  the  internally  generated  voltage  difference between REFP (VDD / 2 + VREFIN / 4) and REFN (VDD / 2 VREFIN / 4).The full-scale range for both on-chip
...
ADCs is adjustable through the REFIN pin, which is provided for this purpose.

REFOUT, REFP, COM (VDD / 2), and REFN are internally buffered low-impedance outputs.

The MAX1180 provides three modes of reference operation:

- Internal reference mode
- Buffered external reference mode
- Unbuffered external reference mode

In the internal reference mode, connect the internal reference output REFOUT to REFIN through a resistor (e.g., 10k Ω ) or resistor divider, if an application requires
...
a reduced full-scale range. For stability and noise filtering purposes, bypass REFIN with a &gt; 10nF capacitor to GND. In internal reference mode, REFOUT, COM, REFP, and REFN become low-impedance outputs.
...
The MAX1180 clock input operates with a voltage threshold set to VDD / 2. Clock inputs with a duty cycle other than 50%, must meet the specifications for high and low periods as stated in the Electrical Characteristics.
...
The MAX1180 offers two power-save modes, sleep and full  power-down mode. In sleep mode (SLEEP = 1), only the reference bias circuit is active (both ADCs are disabled) and current consumption is reduced to 2.8mA.
