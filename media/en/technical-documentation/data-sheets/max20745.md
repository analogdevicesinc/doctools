...
| V REF Tolerance                                 |            | Referred to V SENSE pins (Notes 5, 8) | 0.6484V V REF                  | -1.0      |           | +1.0      | %       |
| V REF Tolerance                                 |            | Referred to V SENSE pins (Notes 5, 8) | 0.8984V V REF                  | -1.0      |           | +1.0      | %       |
| V REF Tolerance                                 |            | Referred to V SENSE pins (Notes 5, 8) | 1V V REF                       | -1.0      |           | +1.0      | %       |
| FEEDBACK LOOP                                   |            |                                       |                                |           |           |           |         |
| Integrator Recovery Time Constant               | t REC      |                                       |                                | 20        | 20        | 20        | µs      |
| Gain (see the Control Loop section for details) | R GAIN     |                                       |                                | 0.9       | 0.9       | 0.9       | mV/A    |
| Gain (see the Control Loop section for details) | R GAIN     | Selected by R_SEL3 (Note 5, 7)        | Selected by R_SEL3 (Note 5, 7) | 1.8       | 1.8       | 1.8       | mV/A    |
| Gain Accuracy                                   | R GAIN     | (Notes 5, 8, 9)                       | (Notes 5, 8, 9)                | 3.6 -20   | 3.6 -20   | +20       | %       |
| SWITCHING FREQUENCY                             | R GAIN     |                                       |                                |           |           |           | mV/A    |
| Switching Frequency                             | f SW       |                                       |                                | 400 500   | 400 500   | 400 500   | kHz     |
| Switching Frequency                             | f SW       | Selected by C_SEL2 and C_SEL3         | Selected by C_SEL2 and C_SEL3  | 600       | 600       | 600       | kHz     |
| Switching Frequency                             | f SW       | (see Tables 5, 6) (Note 7)            | (see Tables 5, 6) (Note 7)     | 700       | 700       | 700       | kHz     |
| Switching Frequency                             | f SW       |                                       |                                | 800       | 800       | 800       | kHz     |
| Switching Frequency                             | f SW       |                                       |                                | 900       | 900       | 900       | kHz     |
| Switching Frequency Accuracy                    | f SW       | (Notes 5, 8, 9)                       | (Notes 5, 8, 9)                | -20       |           | +20       | %       |
| INPUT PROTECTION                                |            |                                       |                                |           |           |           |         |
| Rising V DDH UVLO Threshold                     | V DDH_UVLO | (Note 5)                              | (Note 5)                       | 4.25 4.47 | 4.25 4.47 | 4.25 4.47 | V       |
...
|                                                            | OCP                              | Selected by R_SEL3 (Notes 5, 7, 8, 9) | Setting 1                           | 11.8                             | 16.6                             | 21.3                             | A                                |
|                                                            | OCP                              | Selected by R_SEL3 (Notes 5, 7, 8, 9) | Setting 2                           | 15.1                             | 20.1                             | 25.0                             | A                                |
|                                                            | OCP                              | Selected by R_SEL3 (Notes 5, 7, 8, 9) | Setting 3                           | 18.1                             | 23.6                             | 29.1                             | A                                |
| Hysteresis of Positive OCP                                 |                                  |                                       |                                     |                                  | 20                               |                                  | %                                |
|                                                            |                                  | Selected by R_SEL3                    | Setting 0                           |                                  | -19                              |                                  | A                                |
| Negative OCP Inception                                     |                                  | Selected by R_SEL3                    | Setting 1                           |                                  | -23                              |                                  | A                                |
| Threshold (Inductor Valley Current)                        |                                  | Selected by R_SEL3                    | Setting 2                           |                                  | -26                              |                                  | A                                |
|                                                            |                                  | Selected by R_SEL3                    | Setting 3                           |                                  | -30                              |                                  | A                                |
...
|                                                            | OTP                              | Selectable by PGM2 pin using R_SEL2   | Selectable by PGM2 pin using R_SEL2 | 140                              | 150                              | 160                              |                                  |
| Hysteresis                                                 | OTP                              | (Notes 7, 8, 9)                       | (Notes 7, 8, 9)                     |                                  | 10                               |                                  | °C                               |
...
| OE Max Voltage                                             | OE                               |                                       |                                     |                                  |                                  | 3.6                              | V                                |
| Rising Threshold                                           | OE                               |                                       |                                     | 0.83                             | 0.9                              | 0.97                             |                                  |
| Hysteresis                                                 | OE                               | Measured at OE pin (Note 5)           | Measured at OE pin (Note 5)         |                                  | 0.2                              |                                  | V                                |
...
| Soft-Start Ramp Time                                       | t SS                             | R_SEL1 (Note                          | 7)                                  |                                  | 1.5                              |                                  | ms                               |
...
| PGM1-PGM3 PINS (ALSO SEE TABLES 2-7)                 | PGM1-PGM3 PINS (ALSO SEE TABLES 2-7) | PGM1-PGM3 PINS (ALSO SEE TABLES 2-7)                            | PGM1-PGM3 PINS (ALSO SEE TABLES 2-7) | PGM1-PGM3 PINS (ALSO SEE TABLES 2-7) | PGM1-PGM3 PINS (ALSO SEE TABLES 2-7) | PGM1-PGM3 PINS (ALSO SEE TABLES 2-7) |
...
(Unless otherwise noted: Tested on the MAX20745EVKIT# with component values per Table 8; V DDH  = 12V, V OUT  = 1V, f SW  = 400kHz, T A  = 25°C, Still Air, No Heatsink.)
...
CURVE INDICATES T J = 125°C, I OUT = I MAX , or I VDDH = I VDDH\_MAX ,

<!-- image -->

T A (°C) CONDITIONS:  STILL AIR / NO HEATSINK WHICHEVER HAPPENS FIRST
...
The IC exhibits a nonlinearity during startup. This behavior is normal and does not have an adverse effect on  system operation. With the circuit of Figure 6, the typical nonlinearity is &lt; 50mV with R GAIN  = 0.9mV/A or 1.8 mV/A, and 180mV with R GAIN  = 3.6mV/A. The nonlinearity gets proportionately smaller as C OUT  increases.
...
The parasitic loading on the PGM1:PGM3 pins must be limited to less than 20pF and greater than 20MΩ to avoid interfering with the R\_SEL and C\_SEL decoding.
...
And  assuming  I OUTRIPPLE   =  0.5  x  I OUT   for  a  typical inductor value, see Equation 12.

## Equation 12:

<!-- formula-not-decoded -->

So, for a 25A regulator running at 400kHz with V DDH  = 12V and V OUT  = 1V, Equation 13 shows the target value for the inductor.
...
In a typical MAX20745 application with a bank of 0805, X5R, 6.3V, and 22µF output capacitors, these three components are roughly equal.
...
The  selection  and  placement  of  input  capacitors  are important considerations. High-frequency input capacitors serve  to  control  switching  noise.  Bulk  input  capacitors are  designed  to  filter  the  pulsed  DC  current  drawn  by the regulator. For the best performance, lowest cost and smallest size of the MAX20745 systems, MLCC capacitors with 1210 or smaller case sizes, capacitance values of 47µF or smaller, 16V or 25V voltage ratings and X5R or better  temperature  characteristics  are  recommended  as bulk. The minimum recommended value of capacitance are 2 x 47µF (bulk) and 1.0µF + 0.1µF (high frequency). Smaller values of bulk capacitance can be used in direct proportion to the maximum load current.
...
|                 1 | 4/20            | Updated Absolute Maximum Ratings and Inductor Selection section | 2, 20           |
