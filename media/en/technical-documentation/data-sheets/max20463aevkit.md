...
The  EV  Kit  enables  testing  and  configuration  of  the MAX20463A's CC current advertisement behavior. The  device  provides  a  CC\_SEL  pin  for  this  purpose. Connecting  the  CC\_SEL  pin  to  BIAS  or  GND  through jumper J6  selects between the two different current levels (refer to Table 1).
...
The following procedure demonstrates the MAX20463A's capability and EV Kit in use with a MAX20037 EV kit.
...
- 7) Connect 3m USB captive cable from MAX20037 to MAX20463A.
...
- 9) Connect  DVM  2  (or  oscilloscope  channel  2)  to HVBUS and GND on the MAX20463A EV kit (this is the voltage that a portable device will see).
...
- 13) Connect the load to the USB Type-C connector on the MAX20463A EV kit.
...
- 17) Connect an oscilloscope, additional power supply (PS3), and inductor to the EV kit as shown below: The inductor, if used, should be chosen based on the expected vehicle wiring harness inductance. PS2 is only required if 3V3 is not provided by the MINIQUSB+.
...
- 21) The MAX20463A will open-circuit the USB SHIELD in response to a short-to-battery event.
- USB SHIELD will remain open-circuit for as long as USB SHIELD &gt; 150mV.
...
The MAX20463A EV kit comes fully assembled, tested, and installed with a MAX20463AGTCA/V+.
...
| PART            | TYPE   |
|-----------------|--------|
| MAX20463AEVKIT# | EV Kit |

# Denotes RoHS compliant.

│

## MAX20463A EV Kit Bill of Materials

|   QTY | REFERENCE                   | DESCRIPTION                                         | MANUFACTURER              | MANUFACTURER PART NUMBER   |
|-------|-----------------------------|-----------------------------------------------------|---------------------------|----------------------------|
|     5 | BIAS, CC1, CC2, GDRV, SENSE | TEST POINT                                          | KEYSTONE                  | 5011                       |
...
|     1 | Q1                          | N-CH POWER MOSFET 22A 30V                           | ON SEMICONDUCTOR          | NVTFS4C25NTAG              |
|     1 | R1                          | RESISTOR (0402) 4.7K Ω 1% 0.10W                     | PANASONIC                 | ERJ-2RKF4701               |
|     2 | R3, R5                      | RESISTOR (0402) 5.1KΩ 5% 0.063W                     | VISHAY DALE               | CRCW04025K10JN             |
|     2 | R4, R6                      | RESISTOR (0402) 1.2K 1% 0.063W                      | VISHAY DALE               | CRCW04021K20FK             |
|     1 | SU1                         | JUMPER                                              | SULLINS ELECTRONICS CORP. | QPC02SXGN-RC               |
|     1 | SW1                         | QUAD SWITCH SPST 24V 0.025A                         | C&K COMPONENTS            | TDA04H0SB1                 |
|     1 | T1                          | FEMALE USB 2.0 TYPE-C CONNECTOR 16 PINS             | HIROSE                    | CX90M-16P                  |
|     1 | U1                          | USB TYPE-A TO TYPE-C PORT CONVERTER WITH PROTECTION | MAXIM                     | MAX20463AGTCA/V+           |
|     1 | PCB                         | MAX20463A revA                                      | MAXIM                     | MAX20463A                  |

Evaluates: MAX20463A

## MAX20463A EV Kit Schematic Diagram

<!-- image -->

│

## MAX20463A EV Kit PCB Layout Diagrams

MAX20463A EV Kit PCB Layout - Top View

<!-- image -->

MAX20463A EV Kit PCB Layout - Layer 2

<!-- image -->

│

## MAX20463A EV Kit PCB Layout Diagrams (continued)

MAX20463A EV Kit PCB Layout - Layer 3

<!-- image -->

MAX20463A EV Kit PCB Layout - Bottom View
