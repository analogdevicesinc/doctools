...
The MAX1193 features parallel, multiplexed, CMOScompatible tri-state outputs. The digital output format is offset binary. A separate digital power input accepts a voltage from 1.8V to 3.6V for flexible interfacing to different logic levels. The MAX1193 is available in a 5mm × 5mm, 28-pin thin QFN package, and is specified for the extended industrial (-40°C to +85°C) temperature range.

For higher sampling frequency applications, refer to the MAX1195-MAX1198 dual 8-bit ADCs. Pin-compatible versions of the MAX1193 are also available. Refer to the MAX1191 data sheet for 7.5Msps, and the MAX1192 data sheet for 22Msps.
...
- ♦ Ultra-Low Power 57mW (Normal Operation: 45Msps) 0.3µW (Shutdown Mode)
- ♦ Excellent Dynamic Performance 48.5dB/48.3dB SNR at fIN = 5.5MHz/100MHz
...
|--------------|----------------|-----------------------------|
| MAX1193ETI-T | -40°C to +85°C | 28 Thin QFN-EP* (5mm x 5mm) |
...
(VDD = 3.0V, OVDD = 1.8V, VREFIN = VDD (internal reference), CL ≈ 10pF at digital outputs, fCLK = 45MHz, CREFP = CREFN = CCOM = 0.33µF, TA = -40°C to +85°C, unless otherwise noted. Typical values are at TA = +25°C.) (Note 1)
...
| Power-Supply Rejection                                        |                                                               | Gain (V DD ±5%)                                               |       | ±0.05    |        |         |
| ANALOG INPUT                                                  |                                                               |                                                               |       |          |        |         |
...
| Input Resistance                                              | R IN                                                          | Switched capacitor load                                       |       | 120      |        | k Ω     |
| Input Capacitance                                             | CIN                                                           |                                                               |       | 5        |        | pF      |
| CONVERSION RATE                                               |                                                               |                                                               |       |          |        |         |
| Maximum Clock Frequency                                       | f CLK                                                         |                                                               |    45 |          |        | MHz     |
...
| Signal-to-Noise Ratio (Note 2)                                | SNR                                                           | f IN = 3.75MHz                                                |       | 48.5     |        | dB      |
| Signal-to-Noise Ratio (Note 2)                                | SNR                                                           | f IN = 5.5MHz                                                 |    47 | 48.5     |        | dB      |
| Signal-to-Noise Ratio (Note 2)                                |                                                               | f IN = 22.5MHz                                                |       | 48.4     |        | dB      |
| Signal-to-Noise and Distortion (Note 2)                       |                                                               | f IN = 3.75MHz                                                |       | 48.5     |        | dB      |
| Signal-to-Noise and Distortion (Note 2)                       | SINAD                                                         | f IN = 5.5MHz                                                 |    47 | 48.5     |        | dB      |
| Signal-to-Noise and Distortion (Note 2)                       |                                                               | f IN = 22.5MHz                                                |       | 48.4     |        | dB      |
...
| PARAMETER                                                                                            | SYMBOL                                                                                               | CONDITIONS                                                                                           | MIN                                                                                                  | TYP                                                                                                  | MAX                                                                                                  | UNITS                                                                                                |
|------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|
| Spurious-Free Dynamic Range                                                                          | SFDR                                                                                                 | f IN = 3.75MHz                                                                                       |                                                                                                      | 70.7                                                                                                 |                                                                                                      | dBc                                                                                                  |
| (Note 2)                                                                                             |                                                                                                      | f IN = 22.5MHz                                                                                       |                                                                                                      | 71.5                                                                                                 |                                                                                                      | dBc                                                                                                  |
|                                                                                                      |                                                                                                      | f IN = 3.75MHz                                                                                       |                                                                                                      | -79.6                                                                                                |                                                                                                      | dBc                                                                                                  |
| Third-Harmonic Distortion (Note 2)                                                                   | HD3                                                                                                  | f IN = 5.5MHz                                                                                        |                                                                                                      | -79.0                                                                                                |                                                                                                      | dBc                                                                                                  |
|                                                                                                      |                                                                                                      | f IN = 22.5MHz                                                                                       |                                                                                                      | 76.1                                                                                                 |                                                                                                      | dBc                                                                                                  |
...
| Total Harmonic Distortion (Note 2)                                                                   | THD                                                                                                  | f IN = 3.75MHz                                                                                       |                                                                                                      | -70.8                                                                                                |                                                                                                      | dBc                                                                                                  |
|                                                                                                      |                                                                                                      | f IN = 5.5MHz                                                                                        |                                                                                                      | -70.0                                                                                                |                                                                                                      | dBc                                                                                                  |
|                                                                                                      |                                                                                                      | f IN = 22.5MHz                                                                                       |                                                                                                      | -70.1                                                                                                | -57.0                                                                                                | dBc                                                                                                  |
...
| REFP Input Voltage                                                                              |                                                                                                 | V REFP - V COM                                                                                  | 0.256                                                                                           | 0.256                                                                                           | 0.256                                                                                           | V                                                                                               |
| REFN Input Voltage                                                                              |                                                                                                 | V REFN - V COM                                                                                  | -0.256                                                                                          | -0.256                                                                                          | -0.256                                                                                          | V                                                                                               |
| COM Input Voltage                                                                               | V COM                                                                                           |                                                                                                 | V DD / 2                                                                                        | V DD / 2                                                                                        | V DD / 2                                                                                        | V                                                                                               |
| Differential Reference Input Voltage                                                            | V REF                                                                                           | V REFP - V REFN                                                                                 | 0.512                                                                                           | 0.512                                                                                           | 0.512                                                                                           | V                                                                                               |
| REFP Input Resistance                                                                           | R REFP                                                                                          | Measured between REFP and COM                                                                   | 4                                                                                               | 4                                                                                               | 4                                                                                               | k Ω                                                                                             |
| REFN Input Resistance                                                                           | R REFN                                                                                          | Measured between REFN and COM                                                                   | 4                                                                                               | 4                                                                                               | 4                                                                                               | k Ω                                                                                             |
...
| Input High Threshold                                                                            | V IH                                                                                            | CLK                                                                                             | 0.7 x V DD                                                                                      | 0.7 x V DD                                                                                      | 0.7 x V DD                                                                                      | V                                                                                               |
|                                                                                                 | V IH                                                                                            | PD0, PD1                                                                                        | 0.7 x OV DD                                                                                     | 0.7 x OV DD                                                                                     | 0.7 x OV DD                                                                                     | V                                                                                               |
| Input Low Threshold                                                                             | V IL                                                                                            | CLK                                                                                             | 0.3 x                                                                                           | 0.3 x                                                                                           | V DD                                                                                            | V                                                                                               |
|                                                                                                 | V IL                                                                                            | PD0, PD1                                                                                        | 0.3 x                                                                                           | 0.3 x                                                                                           | OV                                                                                              | V                                                                                               |
| Input Hysteresis                                                                                | V HYST                                                                                          |                                                                                                 | 0.1                                                                                             | 0.1                                                                                             | 0.1                                                                                             | V                                                                                               |
| Digital Input Leakage Current                                                                   | DI IN                                                                                           | CLK at GND or V DD PD0 and PD1 at OGND or OV                                                    | ±5                                                                                              | ±5                                                                                              | ±5                                                                                              | µA                                                                                              |
| Digital Input Capacitance                                                                       | DCIN                                                                                            |                                                                                                 | 5                                                                                               | 5                                                                                               | 5                                                                                               | pF                                                                                              |
...
| Output Voltage Low                                                                              | V OL                                                                                            | I SINK = 200µA                                                                                  | 0.2 x                                                                                           | 0.2 x                                                                                           | OV DD                                                                                           | V                                                                                               |
| Output Voltage High                                                                             | V OH                                                                                            | I SOURCE = 200µA                                                                                | 0.8 x OV DD                                                                                     | 0.8 x OV DD                                                                                     | 0.8 x OV DD                                                                                     | V                                                                                               |
| Tri-State Leakage Current                                                                       | I LEAK                                                                                          |                                                                                                 | ±5                                                                                              | ±5                                                                                              | ±5                                                                                              | µA                                                                                              |
...
| Digital Output Supply Voltage                                                                   | OV DD                                                                                           |                                                                                                 | 1.8                                                                                             | 1.8                                                                                             | V DD                                                                                            | V                                                                                               |
...
| PARAMETER                              | SYMBOL                       | CONDITIONS                                                                    | MIN                          | TYP                          | MAX                          | UNITS                        |
|----------------------------------------|------------------------------|-------------------------------------------------------------------------------|------------------------------|------------------------------|------------------------------|------------------------------|
| Analog Supply Current                  | I DD                         | Normal operating mode, f IN = 5.5MHz at -0.5dB FS, CLK input from GND to V DD |                              | 19                           | 22.5                         | mA                           |
| Analog Supply Current                  | I DD                         | Idle mode (tri-state), f IN = 5.5MHz at -0.5dB FS, CLK input from GND to V DD |                              | 19                           |                              | mA                           |
| Analog Supply Current                  | I DD                         | Standby mode, CLK input from GND to V DD                                      |                              | 8.5                          |                              | mA                           |
| Analog Supply Current                  | I DD                         | Shutdown mode, CLK = GND or V DD , PD0 = PD1 = OGND                           |                              | 0.1                          | 5.0                          | µA                           |
| Digital Output Supply Current (Note 3) | I ODD                        | Normal operating mode, f IN = 5.5MHz at -0.5dB FS, CL ≈ 10pF                  |                              | 5                            |                              | mA                           |
...
| Wake-Up Time from Standby Mode         | t WAKE, ST                   | (Note 5)                                                                      |                              | 2.6                          |                              | µs                           |
...
| Crosstalk Rejection                    |                              | f IN,X = 11MHz at -0.5dB FS, f IN,Y = 0.3MHz at -0.5dB FS (Note 6)            |                              | -75                          |                              | dB                           |
| Amplitude Matching                     |                              | f IN = 11MHz at -0.5dB FS (Note 7)                                            |                              | ±0.05                        |                              | dB                           |
| Phase Matching                         |                              | f IN = 11MHz at -0.5dB FS (Note 7)                                            |                              | ±0.2                         |                              | Degrees                      |
...
(VDD = 3.0V, OVDD = 1.8V, VREFIN = VDD (internal reference), CL ≈ 10pF at digital outputs, differential input at -0.5dB FS, fCLK = 45.005678MHz at 50% duty cycle, TA = +25°C, unless otherwise noted.)
...
The MAX1193 full-scale analog input range is ±VREF with a common-mode input range of VDD/2 ±0.2V. VREF is  the  difference between VREFP and VREFN. The MAX1193 provides three modes of reference operation. The voltage at REFIN (VREFIN) sets the reference operation mode (Table 1).
...
heavy capacitive loads. To improve the dynamic performance of the MAX1193, add 100 Ω resistors  in  series with the digital outputs close to the MAX1193. Refer to the MAX1193 Evaluation Kit schematic for an example of  the  digital  outputs  driving  a  digital  buffer  through 100 Ω series resistors.

## Power Modes (PD0, PD1)

The MAX1193 has four power modes that are controlled with PD0 and PD1. Four power modes allow the MAX1193 to efficiently use power by transitioning to a low-power state when conversions are not required (Table 3).
...
In  the  normal operating mode, all sections of the MAX1193 are powered.
...
With the outputs of the MAX4252 matching better than 0.1%, the buffers and subsequent lowpass filters support as many as 160 MAX1193 ADCs.
