<!-- lastmod 2022-08-02 -->
## MAX17631BEVKIT# Evaluation Kit

## General Description

The MAX17631BEVKIT# Evaluation Kit (EV kit) provides a  proven  design  to  evaluate  the  MAX17631B  highefficiency,  synchronous  step-down  DC-DC  converter. The EV kit provides 5V/1.5A at the output from a 6.5V to 36V input supply. The switching frequency of the EV kit is preset to 400kHz for optimum efficiency and component size.  The  EV  kit  features  adjustable  input  undervoltage lockout,  adjustable  soft-start,  open-drain RESET signal, and  external  clock  synchronization.The  EV  kit  layout is  optimized  for  thermal  performance.  For  more  details about the IC benefits and features, refer to the MAX17631 IC data sheet.
...
| SHUNT POSITION   | EN/UVLO PIN                                                | MAX17631B OUTPUT                                                        |
|------------------|------------------------------------------------------------|-------------------------------------------------------------------------|
...
| SHUNT POSITION   | MODE/SYNC PIN     | MAX17631B OUTPUT      |
|------------------|-------------------|-----------------------|
...
Indicate that you are using the MAX17631B when contacting these component suppliers.

## Ordering Information

| PART            | TYPE   |
|-----------------|--------|
| MAX17631BEVKIT# | EVKIT  |
...
The MAX17631BEVKIT# PCB layout provides an optional electrolytic capacitor (C6 = 22μF/50V). This capacitor lim -its the peak voltage at the input of the MAX17631B when the DC input source is 'Hot-Plugged' to the EV kit input terminals  with  long  input  cables.  The  equivalent  series resistance  (ESR)  of  the  electrolytic  capacitor  dampens the  oscillations  caused  by  interaction  of  the  inductance of the long input cables and the ceramic capacitors at the buck converter input.

## MAX17631BEVKIT# EV Kit Performance Report

(V IN = 24V, V OUT  = 5V, f SW  = 400kHz, unless otherwise noted)

<!-- image -->

CONDITIONS: PWM MODE, 20mA LOAD

Evaluates: MAX17631

50mV/div

## MAX17631BEVKIT# EV Kit Performance Report (continued)
...
LOAD TRANSIENT RESPONSE BETWEEN 40mA AND 0.75A
...
LOAD TRANSIENT RESPONSE BETWEEN 0.75A AND 1.5A

<!-- image -->

<!-- image -->

## MAX17631BEVKIT# EV Kit Bill of Materials
...
|     14 | U1               | HIGH-EFFICIENCY; SYNCHRONOUS STEP-DOWN DC-DC CONVERTER (TQFN16-EP 3mm x 3mm) |          1 | MAX17631BATE+              |
...
## MAX17631BEVKIT# EV Kit Schematic

<!-- image -->

## MAX17631BEVKIT# Evaluation Kit

## MAX17631BEVKIT# EV Kit PCB Layout

MAX17631BEVKIT# EV Kit -Top Silkscreen

<!-- image -->

MAX17631BEVKIT# EV Kit -Layer 2

<!-- image -->

## Evaluates: MAX17631 5V Output-Voltage Application

MAX17631BEVKIT# EV Kit -Top Layer

<!-- image -->

MAX17631BEVKIT# EV Kit -Layer 3

<!-- image -->

## MAX17631BEVKIT# EV Kit PCB Layout (continued)

MAX17631BEVKIT# EV Kit -Bottom Layer

<!-- image -->

MAX17631BEVKIT# EV Kit -Bottom Silkscreen
