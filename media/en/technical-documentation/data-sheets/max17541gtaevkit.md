<!-- lastmod 2022-08-02 -->
## MAX17541G 3.3V Output Evaluation Kit

## General Description

The MAX17541G 3.3V EV kit provides a proven design to evaluate the MAX17541G 3.3V high-efficiency, high-voltage, synchronous  step-down  DC-DC  converter.  The  EV  kit generates 3.3V at load currents up to 500mA from a 5V to 42V input supply. The EV kit features a 600kHz fixed switching frequency for optimum efficiency and component size. The EV kit features a forced-PWM control scheme that provides  constant  switching-frequency  operation  at  all load and line conditions.
...
## MAX17541G in 3.3V Output-Voltage Application

## Quick Start

## Recommended Equipment

- MAX17541G 3.3V EV kit
...
The  MAX17541G  3.3V  EV  kit  provides  a  proven  design to  evaluate  the  MAX17541G  3.3V  high-efficiency,  highvoltage,  synchronous  step-down  DC-DC  converter.  The EV  kit  generates  3.3V  at  load  currents  up  to  500mA from  a  5V  to  42V  input  supply.  The  EV  kit  features  a 600kHz  fixed  switching  frequency  for  optimum  efficiency and  component  size.  The  EV  kit  features  a  forcedPWM  control  scheme  that  provides  constant  switchingfrequency operation at all load and line conditions.
...
| SHUNT POSITION   | EV/UVLO PIN                                                | MAX17541G 3.3V OUTPUT                                          |
|------------------|------------------------------------------------------------|----------------------------------------------------------------|
...
Figure 1. MAX17541G 3.3V Output Load and Line Regulation

Figure 3. MAX17541G 3.3V Output No Load to 250mA Load Transient

<!-- image -->

Figure 5. MAX17541G 3.3V Output Full-Load Bode Plot (V IN  = 24V)

<!-- image -->

## MAX17541G in 3.3V Output-Voltage Application

Figure 2. MAX17541G 3.3V Output Efficiency

<!-- image -->

Figure 4. MAX17541G 3.3V Output 250mA to 500mA Load Transient
...
- MAX17541G 3.3V EV BOM
- MAX17541G 3.3V EV PCB Layout
- MAX17541G 3.3V EV Schematic

## Ordering Information

| PART              | TYPE   |
|-------------------|--------|
| MAX17541GTAEVKIT# | EV Kit |
...
|           9 | 33uH Inductor (5mm x 5mmx 4mm)                |          1 | L1               | Wurth Electronics 74404054330 |
|          10 | 3.32M ohm ±1%, resistor (0402)                |          1 | R1               |                               |
|          11 | 825k ohm ±1%, resistor (0402)                 |          1 | R2               |                               |
|          12 | 14.7k ohm ±1%, resistor (0402)                |          1 | R3               |                               |
|          13 | 48.7k ±1% ohm resistor (0402)                 |          1 | R4               |                               |
|          14 | 18.2k ±1% ohm resistor (0402)                 |          1 | R5               |                               |
|          15 | 10k ohm ±1%, resistor (0402)                  |          1 | R6               |                               |
|          16 | Not installed, resistor (0402)                |          0 | R7               |                               |
|          17 | Buck Converter (10TDFN 3mmx2mm) MAX17541GATB+ |          1 | U1               | MAX17541GATB+                 |
