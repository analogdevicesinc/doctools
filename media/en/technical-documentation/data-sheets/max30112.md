...
The  MAX30112 operates on a 1.8V main supply voltage, with a separate 3.1V to 5.25V LED driver power supply. The device supports a standard I 2 C compatible interface, as  well  as  shutdown  modes  through  the  software  with near-zero  standby  current,  allowing  the  power  rails  to remain powered at all times.
...
|----------------------|----------|-------------------------------------------------------------------------------------------------|---------------------------------------------------|-------|-------|---------|
| POWER SUPPLY         |          |                                                                                                 |                                                   |       |       |         |
| Power Supply Voltage | V DD     | Guaranteed by V DD DC PSR                                                                       | Guaranteed by V DD DC PSR                         |   1.8 |   2.0 | V       |
| LED Supply Voltage   | V LED    | Guaranteed by V LED DC PSR                                                                      | Guaranteed by V LED DC PSR                        |   3.3 |  5.25 | V       |
...
| V DD Supply Current  | I DD     | Low Power = On, LED1 or LED2 (FD1 = 0x01 or FD1 = 0x02, PPG_TINT = 0x0, LP_MODE = 0x1), Note 2  | Sample Rate = 25sps, single pulse (PPG_SR = 0x1)  |    24 |    43 | μA      |
...
| V LED Supply Current                                   |                         | Low Power = On, LED1 or LED2, LED driver full scale (FD1 = 0x01 or FD1 = 0x02, PPG_TINT = 0x0, LP_MODE = 0x1, LEDx_DRV = 0xFF)          | Sample Rate = 100sps, single pulse (PPG_SR = 0x4) |                         | 308                     |                         | μA                      |
| V LED Supply Current                                   |                         | Low Power = On, LED1 or LED2, LED driver full scale (FD1 = 0x01 or FD1 = 0x02, PPG_TINT = 0x0, LP_MODE = 0x1, LEDx_DRV = 0xFF)          | Sample Rete = 50sps, single pulse (PPG_SR = 0x2)  |                         | 155                     |                         | μA                      |
| V LED Supply Current                                   |                         | Low Power = On, LED1 or LED2, LED driver full scale (FD1 = 0x01 or FD1 = 0x02, PPG_TINT = 0x0, LP_MODE = 0x1, LEDx_DRV = 0xFF)          | Sample Rate = 25sps, single pulse (PPG_SR = 0x1)  |                         | 74                      | 110                     | μA                      |
| V LED Supply Current                                   |                         | Low Power = On, LED1 and LED2, LED driver full scale (FD1 = 0x1, FD2 = 0x2, FD3 = 0x0, PPG_TINT = 0x0, LP_MODE = 0x1, LEDx_ DRV = 0xFF) | Sample Rate = 100sps, single pulse (PPG_SR = 0x4) |                         | 616                     |                         | μA                      |
| V LED Supply Current                                   |                         | Low Power = On, LED1 and LED2, LED driver full scale (FD1 = 0x1, FD2 = 0x2, FD3 = 0x0, PPG_TINT = 0x0, LP_MODE = 0x1, LEDx_ DRV = 0xFF) | Sample Rate = 50sps, single pulse (PPG_SR = 0x2)  |                         | 304                     |                         | μA                      |
| V LED Supply Current                                   |                         | Low Power = On, LED1 and LED2, LED driver full scale (FD1 = 0x1, FD2 = 0x2, FD3 = 0x0, PPG_TINT = 0x0, LP_MODE = 0x1, LEDx_ DRV = 0xFF) | Sample Rate = 25sps, single pulse (PPG_SR = 0x1)  |                         | 149                     |                         | μA                      |
...
| ADC Full-Scale Input Current (Including DC Offset DAC) |                         | PPG_ADC_RGE = 0x1                                                                                                                       | PPG_ADC_RGE = 0x1                                 |                         | 12.0                    |                         | μA                      |
| ADC Full-Scale Input Current (Including DC Offset DAC) |                         | PPG_ADC_RGE = 0x2                                                                                                                       | PPG_ADC_RGE = 0x2                                 |                         | 24.0                    |                         | μA                      |
| ADC Full-Scale Input Current (Including DC Offset DAC) |                         | PPG_ADC_RGE = 0x3                                                                                                                       | PPG_ADC_RGE = 0x3                                 |                         | 48.0                    |                         | μA                      |
| ADC Integration Time                                   |                         | LED_SETLNG = 0x3                                                                                                                        | PPG_TINT = 0x0                                    |                         | 52                      |                         | μs                      |
...
| Transmit and Receive Channel V DD DC PSR      |                     | Loopback test, exposure current = 1.6μA nominal, PPG_TINT = 0x3, V LED = 3.3V, V DD = 1.7V to 2.0V | PPG_ADC_RGE = 0x0                                                                        |                     | 2420                |                     | LSB/V               |
| Transmit and Receive Channel V DD DC PSR      |                     | Loopback test, exposure current = 1.6μA nominal, PPG_TINT = 0x3, V LED = 3.3V, V DD = 1.7V to 2.0V | PPG_ADC_RGE = 0x1                                                                        |                     | 2010                |                     | LSB/V               |
| Transmit and Receive Channel V DD DC PSR      |                     | Loopback test, exposure current = 1.6μA nominal, PPG_TINT = 0x3, V LED = 3.3V, V DD = 1.7V to 2.0V | PPG_ADC_RGE = 0x2                                                                        |                     | 1790                |                     | LSB/V               |
| Transmit and Receive Channel V DD DC PSR      |                     | Loopback test, exposure current = 1.6μA nominal, PPG_TINT = 0x3, V LED = 3.3V, V DD = 1.7V to 2.0V | PPG_ADC_RGE = 0x3                                                                        |                     | 1664                |                     | LSB/V               |
...
| Driver DNL                                    |                     |                                                                                                    |                                                                                          |                     | 1                   |                     | LSB                 |
| Driver INL                                    |                     |                                                                                                    |                                                                                          |                     | 1                   |                     | LSB                 |
| Full-Scale LED Current                        | I LED               | LEDx_PA = 0xFF                                                                                     | LEDx_RGE = 0x0                                                                           | 45                  | 50                  | 55                  | mA                  |
| Full-Scale LED Current                        | I LED               | LEDx_PA = 0xFF                                                                                     | LEDx_RGE = 0x1                                                                           |                     | 100                 |                     | mA                  |
| Full-Scale LED Current                        | I LED               | LEDx_PA = 0xFF                                                                                     | LEDx_RGE = 0x2                                                                           |                     | 150                 |                     | mA                  |
| Full-Scale LED Current                        | I LED               | LEDx_PA = 0xF2, LEDx_RGE = 0x3                                                                     | LEDx_PA = 0xF2, LEDx_RGE = 0x3                                                           |                     | 190                 |                     | mA                  |
| Full-Scale LED Current                        | I LED               | LEDx_PA = 0xFF, LEDx_RGE = 0x3 (Note 3)                                                            | LEDx_PA = 0xFF, LEDx_RGE = 0x3 (Note 3)                                                  |                     | 200                 |                     | mA                  |
| Minimum Output Voltage                        |                     | LEDx_PA= 0xFF,                                                                                     | LEDx_RGE = 0x0                                                                           |                     | 0.16                | 0.25                | V                   |
| Minimum Output Voltage                        |                     | V DD = 1.8V,V LED = 3.3V, 95% of the desired LED                                                   | LEDx_RGE = 0x1                                                                           |                     | 0.32                |                     | V                   |
| Minimum Output Voltage                        |                     | current                                                                                            | LEDx_RGE = 0x2                                                                           |                     | 0.49                |                     | V                   |
| Minimum Output Voltage                        |                     | LEDx_RGE = 0x3 LEDx_PA = 0xF2, V DD = 1.8V, V LED = 3.3V, 95% of the desired LED current           | LEDx_RGE = 0x3 LEDx_PA = 0xF2, V DD = 1.8V, V LED = 3.3V, 95% of the desired LED current |                     | 0.64                |                     | V                   |
...
| PARAMETER                                       | SYMBOL                                         | CONDITIONS                                                            | CONDITIONS                                     | MIN                                            | TYP                                            | MAX                                            | UNITS                                          |
|-------------------------------------------------|------------------------------------------------|-----------------------------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|
| Transmit Driver V LED DC PSR                    |                                                | LEDx_PA = 0xFF, V DD = 1.8V, V LEDx_DRV = 0.9V, V LED = 3.1V to 5.25V | LEDx_RGE = 0x0                                 | -0.9                                           | -0.04                                          | +0.9                                           | mA/V                                           |
| Transmit Driver V LED DC PSR                    |                                                | LEDx_PA = 0xFF, V DD = 1.8V, V LEDx_DRV = 0.9V, V LED = 3.1V to 5.25V | LEDx_RGE = 0x1                                 |                                                | -0.06                                          |                                                | mA/V                                           |
| Transmit Driver V LED DC PSR                    |                                                | LEDx_PA = 0xFF, V DD = 1.8V, V LEDx_DRV = 0.9V, V LED = 3.1V to 5.25V | LEDx_RGE = 0x2                                 |                                                | -0.02                                          |                                                | mA/V                                           |
| Transmit Driver V LED DC PSR                    |                                                | LEDx_PA = 0xF2, V DD = 1.8V, V LEDx_DRV = 0.9V, V LED = 3.1V to 5.25V | LEDx_RGE = 0x3                                 |                                                | -0.025                                         |                                                | mA/V                                           |
| Transmit Driver V DD DC PSR                     |                                                | LEDx_PA = 0xFF, V LED = 3.3V, V LEDx_DRV = 0.9V, V DD = 1.7V to 2.0V  | LEDx_RGE = 0x0 LEDx_RGE = 0x1                  | -4                                             | ±0.08 0.014                                    | +4                                             | mA/V                                           |
| Transmit Driver V DD DC PSR                     |                                                | LEDx_PA = 0xFF, V LED = 3.3V, V LEDx_DRV = 0.9V, V DD = 1.7V to 2.0V  | LEDx_RGE = 0x2                                 |                                                | 0.16                                           |                                                | μA/V                                           |
...
| Output Low Voltage                              | V OL                                           | SDA, INT , I = 6mA                                                    | SDA, INT , I = 6mA                             |                                                |                                                | 0.4                                            | V                                              |
| I 2 C Input Voltage Low                         | V IL_I2C                                       | SINK SDA, SCL                                                         | SINK SDA, SCL                                  |                                                |                                                | 0.4                                            | V                                              |
| I 2 C Input Voltage High                        | V IH_I2C                                       | SDA, SCL                                                              | SDA, SCL                                       | 1.4                                            |                                                |                                                | V                                              |
| Input Hysteresis                                | V HYS                                          | SDA, SCL                                                              | SDA, SCL                                       |                                                | 200                                            |                                                | mV                                             |
| Pin Capacitance                                 | C PIN                                          | SDA, SCL, INT (when inactive)                                         | SDA, SCL, INT (when inactive)                  |                                                | 10                                             |                                                | pF                                             |
| Pin Leakage Current                             | I PIN                                          | SDA, SCL, INT (when inactive), T A = +25°C                            | SDA, SCL, INT (when inactive), T A = +25°C     |                                                | ±0.01                                          | ±1                                             | μA                                             |
| DIGITAL / I 2 C TIMING CHARACTERISTICS, NOTE 3  | DIGITAL / I 2 C TIMING CHARACTERISTICS, NOTE 3 | DIGITAL / I 2 C TIMING CHARACTERISTICS, NOTE 3                        | DIGITAL / I 2 C TIMING CHARACTERISTICS, NOTE 3 | DIGITAL / I 2 C TIMING CHARACTERISTICS, NOTE 3 | DIGITAL / I 2 C TIMING CHARACTERISTICS, NOTE 3 | DIGITAL / I 2 C TIMING CHARACTERISTICS, NOTE 3 | DIGITAL / I 2 C TIMING CHARACTERISTICS, NOTE 3 |
| I 2 C Write Address                             |                                                |                                                                       |                                                |                                                | C0                                             |                                                | Hex                                            |
| I 2 C Read Address                              |                                                |                                                                       |                                                |                                                | C1                                             |                                                | Hex                                            |
...
| SDATransmitting Fall Time       | t TF     | 20 + 0.1CB |       |   300 | ns      |
...
## Optimized Pulse-Oximeter and Heart Rate  AFE for Wearbl Health
...
| I 2 C CONTROL INTERFACE            | I 2 C CONTROL INTERFACE | I 2 C CONTROL INTERFACE                                                                                                                  |
| A3                                 | SCL                     | SCL Input. I 2 C clock input                                                                                                             |
| B3                                 | SDA                     | SDAInput/Output. I 2 C data I/O                                                                                                          |
...
The  MAX30112  integrates  two  precision  LED-drivercurrent  DACs  that  modulate  LED  pulses  for  both  SpO 2 and  HR  measurements.  The  LED  current  DACs  have 8-bits of dynamic range with four programmable full-scale ranges of 50mA, 100mA, 150mA, and 200mA. The LED drivers  are  low-dropout  current  sources,  allowing  for
...
The MAX30112 features an I 2 C/SMBus™ compatible, 2-wire serial  interface  consisting  of  a  serial  data  line  (SDA)  and  a serial clock line (SCL). SDA and SCL facilitate communication between the MAX30112 and the master at clock rates up to 400kHz.
...
| 0x09      | FIFO Data Control 1 | 00              | FD2[3:0]       | FD2[3:0]       | FD2[3:0]       | FD2[3:0]         | FD1[3:0]         | FD1[3:0]         | FD1[3:0]         | FD1[3:0]         |
| 0x0A      | FIFO Data Control 2 | 00              | FD4[3:0]       | FD4[3:0]       | FD4[3:0]       | FD4[3:0]         | FD3[3:0]         | FD3[3:0]         | FD3[3:0]         | FD3[3:0]         |
...
```
FD1[3:0] = 0x1 (LED1) FD2[3:0] = 0x2 (LED2)
```

```
FD3[3:0] = 0xC  (DIRECT_AMBIENT) FD4[3:0] = 0x0 (NONE)
```
...
```
FD1[3:0] = 0xD (LED1 and LED2) FD2[3:0] = 0xC (DIRECT_AMBIENT) FD3[3:0] = 0x0 (NONE) FD4[3:0] = 0x0 (NONE)
```
...
The optical timing diagram in Figure 13 represents only LED2 firing during the data sampling time with no direct ambient  sampling  enabled.  This  timing  mode  would  be used  when  heart  rateis  being  measured  with  a  single
...
If  the  proximity  feature  is  enabled,  it  will  be  switched to  proximity  mode  when  the  LED1  ADC  count  drops below  the  threshold  code,  PROX\_INT\_THRESH(0x10). At  this  point,  the  LED1  drive  current  will  be  set  from LED1\_PA(0x11) to LED\_PILOT\_PA(0x15). Note that the threshold  value  is  the  code  in  register  PROX\_INT\_ THRESH (0x10)  times  2048.  This  drop  in  LED  current should  generate  sufficient  hysteresis  to  guarantee  that the MAX30112 does not toggle back and forth between proximity and normal mode operation.
...
| 0x10                | Prox Interrupt Thresh- old[7:0]     | PROX_INT_THRESH[7:0] | PROX_INT_THRESH[7:0] | PROX_INT_THRESH[7:0] | PROX_INT_THRESH[7:0] | PROX_INT_THRESH[7:0] | PROX_INT_THRESH[7:0] | PROX_INT_THRESH[7:0] | PROX_INT_THRESH[7:0] |
...
| BIT         | 7                | 6                | 5   | 4           | 3           | 2   | 1 0           |
|-------------|------------------|------------------|-----|-------------|-------------|-----|---------------|
| Field       | PPG_ADC_RGE[1:0] | PPG_ADC_RGE[1:0] |     | PPG_SR[3:0] | PPG_SR[3:0] |     | PPG_TINT[1:0] |
| Reset       | 0x0              | 0x0              |     | 0x0         | 0x0         |     | 0x0           |
| Access Type | Write, Read      | Write, Read      |     | Write, Read | Write, Read |     | Write, Read   |
...
These bits set the integration time of PPG ADC as well as the pulse width of the LEDS as shown in the table below.

t LED\_SETLNG  is the delay programmed in the LED\_SETLNG[1:0] register.

|   PPG_TINT[1:0] | TPW, LED PULSE WIDTH (ΜS)   |   TINT, INTEGRATION TIME (ΜS) |   RESOLUTION BITS |
|-----------------|-----------------------------|-------------------------------|-------------------|
...
| BIT         | 7   | 6   | 5   | 4               | 3               | 2            | 0            |
|-------------|-----|-----|-----|-----------------|-----------------|--------------|--------------|
| Field       | -   | -   | -   | LED_SETLNG[1:0] | LED_SETLNG[1:0] | SMP_AVE[2:0] | SMP_AVE[2:0] |
...
|   LED_SETLNG[1:0] |   DELAY TLED_SETLNG (ΜS) |
|-------------------|--------------------------|
|                00 |                      2.5 |
|                01 |                      5.0 |
|                10 |                     10.0 |
