...
|-------------|----------------|---------------|
| MAX7408 CPA | 0°C to +70°C   | 8 Plastic DIP |
| MAX7408CUA  | 0°C to +70°C   | 8 µMAX        |
| MAX7408EPA  | -40°C to +85°C | 8 Plastic DIP |
| MAX7408EUA  | -40°C to +85°C | 8 µMAX        |
| MAX7411 CPA | 0°C to +70°C   | 8 Plastic DIP |
| MAX7411CUA  | 0°C to +70°C   | 8 µMAX        |
| MAX7411EPA  | -40°C to +85°C | 8 Plastic DIP |
| MAX7411EUA  | -40°C to +85°C | 8 µMAX        |
| MAX7412 CPA | 0°C to +70°C   | 8 Plastic DIP |
| MAX7412CUA  | 0°C to +70°C   | 8 µMAX        |
| MAX7412EPA  | -40°C to +85°C | 8 Plastic DIP |
| MAX7412EUA  | -40°C to +85°C | 8 µMAX        |
| MAX7415 CPA | 0°C to +70°C   | 8 Plastic DIP |
...
MAX74\_ \_C\_A.....................................................0°C to +70°C

MAX74\_ \_E\_A ..................................................-40°C to +85°C
...
|-------------------------------------------------|------------|-----------------------------------------------------------|--------------|-------------|--------------|---------|
| FILTER                                          |            |                                                           |              |             |              |         |
| Corner-Frequency Range                          | f C        | (Note 1)                                                  |              | 0.001 to 15 |              | kHz     |
...
| Input Resistance at COM                         | R COM      |                                                           | 110          | 180         |              | k Ω     |
...
| CLOCK                                           |            |                                                           |              |             |              |         |
| Internal Oscillator Frequency                   | f OSC      | C OSC = 1000pF (Note 3)                                   | 19           | 27          | 34           | kHz     |
| Clock Output Current (Internal Oscillator Mode) | I CLK      |                                                           |              | ±12         | ±20          | µA      |
...
| Supply Current               | I DD               | Operating mode, no load |                    | 1.16               | 1.5                | mA                 |
...
| Corner-Frequency Range                       | f C                    | (Note 1)                                                    | 0.001 to 15            | 0.001 to 15            | 0.001 to 15            | kHz                    |
...
| Output Offset Voltage                        | V OFFSET               | V IN = V COM = V DD / 2                                     | ±4                     |                        | ±25                    | mV                     |
| DC Insertion Gain with Output Offset Removed |                        | V COM = V DD / 2 (Note 2)                                   | 0                      | 0.2                    | 0.4                    | dB                     |
| Total Harmonic Distortion plus Noise         | THD+N                  | f IN = 200Hz, V IN = 2.5Vp-p, measurement bandwidth = 22kHz | -79                    | -79                    | -79                    | dB                     |
| Offset Voltage Gain                          | A OS                   | OS to OUT                                                   | 1                      | 1                      | 1                      | V/V                    |
| COM Voltage Range                            | V COM                  |                                                             | V DD - 0.1 2           | V DD 2                 | V DD + 0.1 2           | V                      |
| Input Voltage Range at OS                    | V OS                   | Measured with respect to COM                                | ±0.1                   | ±0.1                   | ±0.1                   | V                      |
| Input Resistance at COM                      | R COM                  |                                                             | 110                    | 180                    |                        | k Ω                    |
| Clock Feedthrough                            |                        | T A = +25°C                                                 | 3                      | 3                      | 3                      | mVp-p                  |
...
| CLOCK                                           |          |                         |       |       |       |         |
| Internal Oscillator Frequency                   | f OSC    | C OSC = 1000pF (Note 3) |    19 | 27    | 34    | kHz     |
| Clock Output Current (Internal Oscillator Mode) | I CLK    | V CLK = 0 or 3V         |       | ±12   | ±20   | µA      |
| Clock Input High                                | V IH     |                         |   2.5 |       |       | V       |
| Clock Input Low                                 | V IL     |                         |       |       | 0.5   | V       |
| POWER REQUIREMENTS                              |          |                         |       |       |       |         |
| Supply Voltage                                  | V DD     |                         |   2.7 |       | 3.6   | V       |
| Supply Current                                  | I DD     | Operating mode, no load |       | 1.13  | 1.5   | mA      |
| Shutdown Current                                | I SHDN   | SHDN = GND              |       | 0.2   | 1     | µA      |
| Power-Supply Rejection Ratio                    | PSRR     | Measured at DC          |       | 70    |       | dB      |
| SHUTDOWN                                        |          |                         |       |       |       |         |
...
(VDD = +5V for MAX7408, VDD = +3V for MAX7412; filter output measured at OUT; 10k Ω || 50pF load to GND at OUT; SHDN = VDD; VCOM = VOS = VDD / 2; fCLK = 100kHz; TA = TMIN to TMAX; unless otherwise noted. Typical values are at TA = +25°C.) (Note 3)

| PARAMETER                                          | CONDITIONS     |   MIN |   TYP |   MAX | UNITS   |
|----------------------------------------------------|----------------|-------|-------|-------|---------|
| Insertion Gain with DC Gain Error Removed (Note 4) | f IN = 0.34f C |  -0.4 |  -0.2 |   0.4 | dB      |
| Insertion Gain with DC Gain Error Removed (Note 4) | f IN = 0.63f C |  -0.4 |   0.2 |   0.4 | dB      |
| Insertion Gain with DC Gain Error Removed (Note 4) | f IN = 0.84f C |  -0.4 |  -0.2 |   0.4 | dB      |
| Insertion Gain with DC Gain Error Removed (Note 4) | f IN = 0.96f C |  -0.4 |   0.2 |   0.4 | dB      |
| Insertion Gain with DC Gain Error Removed (Note 4) | f IN = f C     |  -0.7 |  -0.2 |   0.2 | dB      |
| Insertion Gain with DC Gain Error Removed (Note 4) | f IN = 1.60f C |       | -53.4 |   -50 | dB      |
| Insertion Gain with DC Gain Error Removed (Note 4) | f IN = 1.90f C |       | -53.4 |   -50 | dB      |
| Insertion Gain with DC Gain Error Removed (Note 4) | f IN = 4.62f C |       | -53.4 |   -50 | dB      |
...
(VDD = +5V for MAX7411, VDD = +3V for MAX7415; filter output measured at OUT; 10k Ω || 50pF load to GND at OUT; SHDN = VDD, VCOM = VOS = VDD / 2; fCLK = 100kHz; TA = TMIN to TMAX; unless otherwise noted. Typical values are at TA = +25°C.) (Note 3)
...
Note 3: f OSC (kHz) ≈ 27 · 10 3 / COSC (COSC in pF).
...
(VDD = +5V for MAX7408/MAX7411, VDD = +3V for MAX7412/MAX7415; fCLK = 100kHz; SHDN = VDD; VCOM = VOS = VDD / 2; TA = +25°C; unless otherwise noted.)
...
MAX7411 TOTAL HARMONIC DISTORTION PLUS NOISE vs. INPUT SIGNAL AMPLITUDE
...
|   PIN | NAME   | FUNCTION                                                                                                                                                                           |
|-------|--------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|     1 | COM    | Common Input Pin. Biased internally at mid-supply. Bypass externally to GND with 0.1µF capacitor. To override internal biasing, drive with an external supply.                     |
|     2 | IN     | Filter Input                                                                                                                                                                       |
|     3 | GND    | Ground                                                                                                                                                                             |
|     4 | V DD   | Positive Supply Input, +5V for MAX7408/MAX7411 or +3V for MAX7412/MAX7415                                                                                                          |
|     5 | OUT    | Filter Output                                                                                                                                                                      |
...
| MAX7408  | 100     | 200    | 4      | TBD                                | TBD                                | TBD                                | TBD                                |
| MAX7411  | 500     | 1k     | 4      | TBD                                | TBD                                | TBD                                | TBD                                |
| MAX7411  | 100     | 200    | 4      | TBD                                | TBD                                | TBD                                | TBD                                |
| MAX7412  | 500     | 1k     | 2      | TBD                                | TBD                                | TBD                                | TBD                                |
| MAX7412  | 100     | 200    | 2      | TBD                                | TBD                                | TBD                                | TBD                                |
| MAX7415  | 500     | 1k     | 2      | TBD                                | TBD                                | TBD                                | TBD                                |
| MAX7415  | 100     | 200    | 2      | TBD                                | TBD                                | TBD                                | TBD                                |
...
Harmonic distortion arises from nonlinearities within the filter.  These  nonlinearities  generate  harmonics when a pure sine wave is applied to the filter input. Table 1 lists typical harmonic distortion values with a 10k Ω load at TA = +25°C.
