...
## Evaluates: MAX17545 in 3.3V Output-Voltage Application

## Features

- Operates from a 4.5V to 42V Input Supply
- 3.3V Output Voltage
...
| -             |     3 | Shunts (JU1-JU3)                                               |
| -             |     1 | PCB: MAX17545 - 3.3V OUTPUT EVKIT                              |
...
- MAX17545 3.3V output EV kit
- 4.5V to 42V, 4A DC input power supply
...
The  MAX17545  3.3V  output  EV  kit  provides  a  proven design  to  evaluate  the  MAX17545  high-voltage,  highefficiency, synchronous step-down DC-DC converter. The EV kit is preset for 3.3V output from 4.5V to 42V input at load currents up to 1.7A and features a 450kHz switching frequency for optimum efficiency and component size.
...
changes  on  the  MODE  pin  are  ignored  during  normal operation. Refer to the MAX17545 IC data sheet for more information on PWM, PFM, and DCM modes of operation.
...
Figure 1. MAX17545 3.3V Output Load and Line Regulation (PWM Mode)

<!-- image -->

Figure 2. MAX17545 3.3V Output Efficiency (PWM Mode)

<!-- image -->

Evaluates: MAX17545 in

Figure 3. MAX17545 3.3V Output Load and Line Regulation (PFM Mode)

<!-- image -->

Figure 4. MAX17545 3.3V Output Efficiency (PFM Mode)
...
Figure 5. MAX17545 3.3V Output Efficiency (DCM Mode)

<!-- image -->

## Evaluates: MAX17545 in 3.3V Output-Voltage Application

Figure 6. MAX17545 3.3V Output Full Load Bode Plot (VIN = 24V)

<!-- image -->

Figure 7. MAX17545 3.3V Output, No Load to 0.85A Load Transient (PWM Mode)
...
Figure 8. MAX17545 3.3V Output, 5mA to 0.85A Load Transient (PFM Mode)

<!-- image -->

## Evaluates: MAX17545 in 3.3V Output-Voltage Application

Figure 9. MAX17545 3.3V Output, 50mA to 0.85A Load Transient (DCM Mode)

<!-- image -->

Figure 10. MAX17545 3.3V Output, 0.85A to 1.7A Load Transient

<!-- image -->

## Evaluates: MAX17545 in 3.3V Output-Voltage Application

Figure 11. MAX17545 3.3V Output EV Kit Schematic

<!-- image -->

## MAX17545 3.3V Output Evaluation Kit

Figure 12. MAX17545 3.3V Output EV Kit Component Placement Guide-Component Side

<!-- image -->

Figure 13. MAX17545 3.3V Output EV Kit Component Side PCB layout

<!-- image -->

## Evaluates: MAX17545 in 3.3V Output-Voltage Application

Figure 14. MAX17545 3.3V Output EV Kit PCB LayoutInner Layer 1

<!-- image -->

Figure 15. MAX17545 3.3V Output EV Kit PCB Layout-Inner Layer 2

<!-- image -->

## MAX17545 3.3V Output Evaluation Kit

Figure 16. MAX17545 3.3V Output EV Kit PCB LayoutSolder Side

<!-- image -->

## Evaluates: MAX17545 in 3.3V Output-Voltage Application

Figure 17. MAX17545 3.3V Output EV Kit Component Placement Guide-Top Solder Mask

<!-- image -->

Figure 18. MAX17545 3.3V Output EV Kit Component Placement Guide-Bottom Solder Mask
