<!-- lastmod 2022-08-02 -->
## MAX17505 3.3V Output Evaluation Kit

## General Description

The MAX17505 3.3V output evaluation kit (EV kit) provides a proven design to evaluate the MAX17505 high-voltage, high-efficiency,  synchronous  step-down  DC-DC converter. The EV kit is preset for 3.3V output at load currents up to 1.7A and features a 450kHz switching frequency for optimum  efficiency  and  component  size.  The  EV  kit features  adjustable  input  undervoltage  lockout,  adjustable  soft-start,  open-drain RESET signal,  and  external frequency synchronization.
...
|---------------|-------|----------------------------------------------------------------------------|
| C1            |     1 | 2.2µF ±10%, 100V X7R ceramic capacitor (1210) Murata GRM32ER72A225KA35     |
...
| C4            |     1 | 47µF ±10%, 10V X7R ceramic capacitor (1210) Murata GRM32ER71A476K          |
...
## Evaluates: MAX17505 in 3.3V Output-Voltage Application
...
| DESIGNATION   |   QTY | DESCRIPTION                                                    |
|---------------|-------|----------------------------------------------------------------|
| L1            |     1 | 6.8μH inductor Coilcraft XAL6060-682ME Sumida 0420CDMCDS-6R8MC |
| R1            |     1 | 3.32MΩ ±1% resistor (0402)                                     |
| R2            |     1 | 1MΩ ±1% resistor (0402)                                        |
| R3            |     1 | 127kΩ ±1% resistor (0402)                                      |
| R4            |     1 | 47.5kΩ ±1% resistor (0402)                                     |
| R5            |     0 | 45.3kΩ ±1% resistor (0402)                                     |
| R6            |     1 | 10kΩ ±1% resistor (0402)                                       |
| TP1, TP2      |     2 | Test pads                                                      |
| U1            |     1 | Buck converter (20 TQFN-EP*) Maxim MAX17505ATP+                |
| -             |     3 | Shunts (JU1-JU3)                                               |
| -             |     1 | PCB: MAX17505 - 3.3V OUTPUT EVKIT                              |

* EP = Exposed pad.

Note: C7, R1, and R2 are optional components; R1 and R2 are not needed if the EN/UVLO pin is permanently connected to VIN. The electrolytic capacitor (C7) is required only when the VIN power supply is situated far from the MAX17505-based circuit. When R5 is open, the device switches at 500kHz switching frequency. The XAL6060 inductor has been used to prepare the EV kit test report.
...
| Sumida Corp.    | 408-321-9660 | www.sumida.com         |
...
- MAX17505 3.3V output EV kit
- 4.5V to 60V, 4A DC input power supply
...
The  MAX17505  3.3V  output  EV  kit  provides  a  proven design  to  evaluate  the  MAX17505  high-voltage,  highefficiency, synchronous step-down DC-DC converter. The EV kit is preset for 3.3V output from 4.5V to 60V input at load currents up to 1.7A and features a 450kHz switching frequency for optimum efficiency and component size.
...
The  device's  MODE  pin  can  be  used  to  select  among PWM, PFM, or DCM modes of operation. The logic state of the MODE pin is latched when VCC and EN/UVLO voltages exceed the respective UVLO rising thresholds and all internal voltages are ready to allow LX switching. State

## Table 1. Regulator Enable (EN/UVLO) Description (JU1)

| SHUNT POSITION   | EN/UVLO PIN                                                | MAX17505_ OUTPUT                                        |
|------------------|------------------------------------------------------------|---------------------------------------------------------|
...
changes  on  the  MODE  pin  are  ignored  during  normal operation. Refer to the MAX17505 IC data sheet for more information on PWM, PFM, and DCM modes of operation.
...
| SHUNT POSITION   | MODE PIN          | MAX17505_ MODE        |
|------------------|-------------------|-----------------------|
...
| SHUNT POSITION   | SYNC PIN                      | MAX17505_ SYNC                                       |
|------------------|-------------------------------|------------------------------------------------------|
...
Figure 1. MAX17505 3.3V Output Load and Line Regulation (PWM Mode)

<!-- image -->

Figure 2. MAX17505 3.3V Output Efficiency (PWM Mode)

<!-- image -->

Figure 3. MAX17505 3.3V Output Load and Line Regulation (PFM Mode)

<!-- image -->

Figure 4. MAX17505 3.3V Output Efficiency (PFM Mode)
...
Figure 5. MAX17505 3.3V Output Efficiency (DCM Mode)

<!-- image -->

## Evaluates: MAX17505 in 3.3V Output-Voltage Application

Figure 6. MAX17505 3.3V Output Full Load Bode Plot (VIN = 24V)

<!-- image -->

Figure 7. MAX17505 3.3V Output, No Load to 0.85A Load Transient (PWM Mode)
...
Figure 8. MAX17505 3.3V Output, 5mA to 0.85A Load Transient (PFM Mode)

<!-- image -->

## Evaluates: MAX17505 in 3.3V Output-Voltage Application

Figure 9. MAX17505 3.3V Output, 50mA to 0.85A Load Transient (DCM Mode)

<!-- image -->

Figure 10. MAX17505 3.3V Output, 0.85A to 1.7A Load Transient

<!-- image -->

## Evaluates: MAX17505 in 3.3V Output-Voltage Application

Figure 11. MAX17505 3.3V Output EV Kit Schematic

<!-- image -->

## MAX17505 3.3V Output Evaluation Kit

Figure 12. MAX17505 3.3V Output EV Kit Component Placement Guide-Component Side

<!-- image -->

Figure 13. MAX17505 3.3V Output EV Kit Component Side PCB layout

<!-- image -->

## Evaluates: MAX17505 in 3.3V Output-Voltage Application

Figure 14. MAX17505 3.3V Output EV Kit PCB LayoutInner Layer 1

<!-- image -->

Figure 15. MAX17505 3.3V Output EV Kit PCB Layout-Inner Layer 2

<!-- image -->

## MAX17505 3.3V Output Evaluation Kit

Figure 16. MAX17505 3.3V Output EV Kit PCB LayoutSolder Side

<!-- image -->

## Evaluates: MAX17505 in 3.3V Output-Voltage Application

Figure 17. MAX17505 3.3V Output EV Kit Component Placement Guide-Top Solder Mask

<!-- image -->

Figure 18. MAX17505 3.3V Output EV Kit Component Placement Guide-Bottom Solder Mask
