<!-- lastmod 2022-08-04 -->
## MAX38643A WLP Evaluation Kit

## General Description

The  MAX38643A  evaluation  kit  (EV  kit)  evaluates  the MAX38643A, an ultra-low quiescent  current step-down DC-DC  converter  in  the  wafer-level  package  (WLP). The EV kit operates over an input range of 1.8V to 5.5V, and  provides  resistor-configurable  output  voltages  from 1.0V to 3.3V. The EV kit delivers up to 700mA of current depending on the input voltage to the output voltage ratio.

The EV kit comes with the MAX38643AENT+ installed.

## Features

- Evaluates the MAX38643A in a 6-pin WLP
...
## MAX38643A EV Kit Files

| FILE                       | DECRIPTION              |
|----------------------------|-------------------------|
| MAX38643AWLP EV BOM        | EV Kit Bill of Material |
| MAX38643AWLP EV PCB Layout | EV Kit Layout           |
| MAX38643AWLP EV Schematic  | EV Kit Schematic        |

<!-- image -->

Evaluates: MAX38643 A in WLP

## Quick Start

## Required Equipment

- MAX38643A WLP EV kit
- 5.5V, 3A DC power supply
- Electronic load capable of 700mA
...
- 3) Connect the 700mA electronic load between the OUT and nearest GND terminal posts.
...
The MAX38643A EV kit evaluates the MAX38643A, an ultra-low quiescent current step-down DC-DC converter in the WLP. The EV kit operates over an input range of 1.8V to 5.5V, and provides resistor-configurable output voltages from  1.0V  to  3.3V.  The  EV  kit  delivers  up  to  700mA  of current  depending  on  the  input  voltage  to  the  output voltage ratio.

The EV kit comes with the MAX38643AENT+ installed.

## EN

The MAX38643A WLP EV kit provides a jumper JU1 to enable or disable the MAX38643A. Refer to Table 1 for jumper JU1 settings.
...
Note: Indicate that you are using the MAX38643A when contacting these component suppliers.

## Ordering Information

| PART             | TYPE   |
|------------------|--------|
| MAX38643AEVK#WLP | EV Kit |
...
The MAX38643A WLP EV kit provides a jumper JU2 to select  the  MAX38643A output voltage. Refer to Table 2 for jumper JU2 settings.

## Spare Inductor

The MAX38643A WLP EV kit provides a spare inductor on  the  PCB's  bottom  side.  This  spare  inductor  can  be used to reconfigure the EV kit for a smaller solution size.
...
## MAX38643A WLP EV Kit Bill of Materials
...
| 6      | L1        | -         |     1 | 74437324015                                   | WURTH ELECTRONICS INC                  | 1.5UH         | INDUCTOR; SMT; SHIELDED; 1.5UH; 20%; 3.8A                                                                           |            |
| 7      | L1A       | -         |     1 | DFE252012F-1R5M                               | MURATA                                 | 1.5UH         | INDUCTOR; SMT (1008); SHIELDED; 1.5UH; 20%; 2.7A                                                                    |            |
| 8      | R2        | -         |     1 | CRCW0603191KFK                                | VISHAY DALE                            | 191K          | RESISTOR; 0603; 191K OHM; 1%; 100PPM; 0.10W; METAL FILM                                                             |            |
| 9      | R3        | -         |     1 | ERJ-3EKF6343                                  | PANASONIC                              | 634K          | RES; SMT (0603); 634K; 1%; +/-100PPM/DEGC; 0.1W                                                                     |            |
| 10     | R4        | -         |     1 | CRCW060320K0FK                                | VISHAY DALE                            | 20K           | RESISTOR; 0603; 20K OHM; 1%; 100PPM; 0.1W; THICK FILM                                                               |            |
...
| 16     | U1        | -         |     1 | MAX38643AENT+                                 | MAXIM                                  | MAX38643AENT+ | EVKIT PART - IC; TINY 300NANO-AMP NANOPOWER BUCK CONVERTER; PACKAGE OUTLINE: 21-100128; PACKAGE CODE: N60E1+1; WLP6 |            |
| 17     | PCB       | -         |     1 | MAX38643AWLP                                  | MAXIM                                  | PCB           | PCB:MAX38643AWLP                                                                                                    | -          |
| 18     | MH1-MH4   | DNP       |     0 | 9032                                          | KEYSTONE                               |               | 9032 MACHINE FABRICATED; ROUND-THRU HOLE SPACER; NO THREAD; M3.5; 5/8IN; NYLON                                      |            |
| 19     | R1        | DNP       |     0 | CRCW06030000Z0                                | VISHAY DALE                            |               | 0 RESISTOR; 0603; 0 OHM; 0%; JUMPER; 0.1W; THICK FILM                                                               |            |
| 20     | C4        | DNP       |     0 | N/A                                           | N/A                                    | OPEN          | PACKAGE OUTLINE 0603 NON-POLAR CAPACITOR                                                                            |            |
| TOTAL  |           |           |    24 |                                               |                                        |               |                                                                                                                     |            |

## MAX38643A WLP EV Kit Schematic

<!-- image -->

Evaluates: MAX38643 A in WLP

## MAX38643A WLP EV Kit PCB Layout Diagrams

<!-- image -->

MAX38643A WLP EV Kit-Silk\_Top

<!-- image -->

MAX38643A WLP EV Kit-Bottom

MAX38643A WLP EV Kit-Top

<!-- image -->

MAX38643A WLP EV Kit-Silk\_Bot
