<!-- lastmod 2023-08-03 -->
## TMCS-20 Hardware Manual

Hardware Version V1.00 | Document Revision V1.50 • 2021-APR-16

TMCS-20 is a low-cost and small-size optical incremental encoder for use with stepper motors and 3-phase PMSM/BLDC motors. It comes with high resolution optical code wheels with a resolution of 512 lines (32.768 counts).
...
| TMCS-20-4-8k-AT-01   | TMCS-20-4-8192-AT-01   | Encoder Module 20mmm diameter, Resolution of 512lpr (32.768cpr), ABN, 4mm shaft diameter, TTL     | 20mm x 20mm x 13mm   |
|----------------------|------------------------|---------------------------------------------------------------------------------------------------|----------------------|
| TMCS-20-8k-KIT       | TMCS-20-KIT            | TRINAMIC TMCS-20- 8k-AT-01 encoder kit including encoder hous- ing, cable loom and assembly tools | 100mm x 150mm x 30mm |
...
| Resolution lpr       |       | 512    |       | lpr (lines per rotation)             |
| Resolution cpr       |       | 32.768 |       | increments (increments per rotation) |
...
Connector type on the hub and for the encoder cable is:
...
Figure 4: Required dimensions for motor assembly (units = mm) / D = 4mm

<!-- image -->

## 3 Figures Index

|    | driver outputs . . . . . . . . . 5   | cut view (units = mm) . . . . . . . . . .                       |
|----|--------------------------------------|-----------------------------------------------------------------|
|  2 | Example wave form for CCW rotation 6 | Required dimensions for motor as- sembly (units=mm)/D=4mm . . . |
...
|   1.00 | 22.02.2017   | SK   | Initial release.                                                                                                   |
|--------|--------------|------|--------------------------------------------------------------------------------------------------------------------|
|   1.1  | 11.09.2017   | SK   | Electrical ratings updated.                                                                                        |
|   1.2  | 06.11.2017   | SK   | Added connector speci/uniFB01cation.                                                                               |
|   1.21 | 21.12.2017   | OK   | Resolution entries clari/uniFB01ed.                                                                                |
|   1.22 | 27.08.2018   | SK   | Information on required shaft diameter D added.                                                                    |
|   1.23 | 29.11.2018   | SK   | Waveform image description updated.                                                                                |
|   1.3  | 01.07.2019   | SK   | Removed Start Torque Parameter since it is not needed/de/uniFB01ned for simply encoder kit without bearing inside. |
|   1.4  | 10.08.2020   | SK   | Corrected the lpr value.                                                                                           |
