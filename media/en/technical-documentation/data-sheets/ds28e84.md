...
## Dep Cover Radition-Resitant, High-Capacity , 1-Wire Authenticator

## DS28E84

## Absolute Maximum Ratings

Voltage Range on Any Pin Relative to GND ..........-0.5V to 4.0V Maximum Current into Any Pin......................... -20mA to +20mA

Operating Temperature Range  .................................0°C to 50°C Lead Temperature (soldering, 10s) .................................+300°C
...
| 1-Wire Pullup Voltage           | V PUP                | (Note 1)             | (Note 1)             | 3.3                  | 3.63                 | V                    |                      |
| 1-Wire Pullup Resistance        | R PUP                | (Notes 1, 2)         | (Notes 1, 2)         |                      | 1000                 | Ω                    |                      |
| Input Capacitance               | C IO                 | (Note 3)             | (Note 3)             | 0.1 + C X            |                      | nF                   |                      |
| Capacitor External              | C X                  | (Note 1)             | (Note 1)             | 470                  | 540.5                | nF                   |                      |
| Input Load Current              | I L                  | IO pin at V PUP      | Pre-radiation        | 40                   | 360                  | μA                   |                      |
|                                 | I L                  | IO pin at V PUP      | Post-radiation       | 120                  |                      | μA                   |                      |
| High-to-Low Switching Threshold | V TL                 | (Notes 4, 5, 6)      | (Notes 4, 5, 6)      | 0.65 x V PUP         |                      | V                    |                      |
| Input Low Voltage               | V IL                 | (Notes 4, 7)         | (Notes 4, 7)         |                      | 0.10 x V PUP         | V                    |                      |
| Low-to-High Switching Threshold | V TH                 | (Notes 4, 5, 8)      | (Notes 4, 5, 8)      | 0.75 x V PUP         |                      | V                    |                      |
| Switching Hysteresis            | V HY                 | (Notes 4, 5, 9)      | (Notes 4, 5, 9)      | 0.3                  |                      | V                    |                      |
| Output Low Voltage              | V OL                 | I OL = 4mA(Note 10)  | I OL = 4mA(Note 10)  |                      | 0.4                  | V                    |                      |

## Deep Cover Radiation-Resistant, High-Capacity, 1-Wire Authenticator
...
| Recovery Time                               | t REC                                       | Standard speed, Pre-radiation, R PUP = 1000Ω              |                                             | 25                                          |                                             |                                             | μs                                          |
| Recovery Time                               | t REC                                       | Standard speed, Pre-radiation, R PUP = 1000Ω              | Directly prior to reset pulse               | 100                                         |                                             |                                             | μs                                          |
| Recovery Time                               | t REC                                       | Standard speed, Post-radia- tion, R PUP = 1000Ω (Note 26) |                                             | 50                                          |                                             |                                             | μs                                          |
| (Notes 1, 11, 12)                           | t REC                                       | Standard speed, Post-radia- tion, R PUP = 1000Ω (Note 26) | Directly prior to reset pulse               | 1500                                        |                                             |                                             | μs                                          |
| Recovery Time                               | t REC                                       | Overdrive speed, R PUP = 1000Ω                            |                                             | 10                                          |                                             |                                             | μs                                          |
| Recovery Time                               | t REC                                       | Overdrive speed, R PUP = 1000Ω                            | Directly prior to reset pulse               | 100                                         |                                             |                                             | μs                                          |
| Rising-Edge Hold-off (Notes 4, 13)          | t REH                                       | Applies to standard speed only                            | Applies to standard speed only              | 1                                           | 1                                           | 1                                           | μs                                          |
| Time Slot Duration (Notes 1, 14)            | t SLOT                                      | Standard speed                                            | Pre-radiation                               | 85                                          |                                             |                                             | μs                                          |
|                                             | t SLOT                                      | Standard speed                                            | Post-radiation (Note 26)                    | 110                                         |                                             |                                             | μs                                          |
|                                             | t SLOT                                      | Overdrive speed                                           | Overdrive speed                             | 16                                          |                                             |                                             | μs                                          |
...
| Reset Low Time (Note 1)                     | t RSTL                                      | Standard speed                                            | Standard speed                              | 480                                         |                                             | 640                                         | μs                                          |
| Reset Low Time (Note 1)                     | t RSTL                                      | Overdrive speed                                           | Overdrive speed                             | 48                                          |                                             | 80                                          | μs                                          |
| Reset High Time (Note 1)                    | t RSTH                                      | Standard speed                                            | Standard speed                              | 480                                         |                                             |                                             | μs                                          |
| Reset High Time (Note 1)                    | t RSTH                                      | Overdrive speed                                           | Overdrive speed                             | 48                                          |                                             |                                             | μs                                          |
| Presence Detect High Time                   | t PDH                                       | Standard speed                                            | Standard speed                              | 15                                          |                                             | 60                                          | μs                                          |
| Presence Detect High Time                   | t PDH                                       | Overdrive speed                                           | Overdrive speed                             | 2                                           |                                             | 6                                           | μs                                          |
| Presence Detect Low Time                    | t PDL                                       | Standard speed                                            | Standard speed                              | 60                                          |                                             | 240                                         | μs                                          |
| Presence Detect Low Time                    | t PDL                                       | Overdrive speed                                           | Overdrive speed                             | 8                                           |                                             | 24                                          | μs                                          |
| Presence Detect Fall Time (Notes 4, 15)     | t FPD                                       | Standard speed                                            | Standard speed                              | 1.25                                        | 1.25                                        | 1.25                                        | μs                                          |
| Presence Detect Fall Time (Notes 4, 15)     | t FPD                                       | Overdrive speed                                           | Overdrive speed                             | 0.15                                        | 0.15                                        | 0.15                                        | μs                                          |
| Presence-Detect Sample Time (Notes 1, 16)   | t MSP                                       | Standard speed                                            | Standard speed                              | 65                                          |                                             | 75                                          | μs                                          |
| Presence-Detect Sample Time (Notes 1, 16)   | t MSP                                       | Overdrive speed                                           | Overdrive speed                             | 7                                           |                                             | 10                                          | μs                                          |
...
| Write-Zero Low Time (Notes 1, 17)           | t W0L                                       | Standard speed                                            | Standard speed                              | 60                                          |                                             | 120                                         | μs                                          |
| Write-Zero Low Time (Notes 1, 17)           | t W0L                                       | Overdrive speed                                           | Overdrive speed                             | 6                                           |                                             | 15.5                                        | μs                                          |
| Write-One Low Time (Notes 1, 17)            | t W1L                                       | Standard speed                                            | Standard speed                              | 0.25                                        |                                             | 15                                          | μs                                          |
| Write-One Low Time (Notes 1, 17)            | t W1L                                       | Overdrive speed                                           | Overdrive speed                             | 0.25                                        |                                             | 2                                           | μs                                          |
...
| Read Low Time (Notes 1, 18)                 | t RL                                        | Standard speed                                            | Standard speed                              | 0.25                                        |                                             | 15 - δ                                      | μs                                          |
| Read Low Time (Notes 1, 18)                 | t RL                                        | Overdrive speed                                           | Overdrive speed                             | 0.25                                        |                                             | 2 - δ                                       | μs                                          |
| Read Sample Time                            |                                             | Standard speed                                            | Standard speed                              | t RL + δ                                    |                                             | 15                                          | μs                                          |
| (Note 1, 18)                                | t MSR                                       | Overdrive speed                                           | Overdrive speed                             | t RL + δ                                    |                                             | 2                                           |                                             |
...
| STRONG PULLUP OPERATION                    | STRONG PULLUP OPERATION |                            |              |       |              |         |
| Strong Pullup Current                      | I SPU                   | (Note 19)                  |              |    11 | 15           | mA      |
| Strong Pullup Voltage                      | V SPU                   | (Note 19)                  | 2.8          |       |              | V       |
...
| Generate ECDSASignature                    | t GES                   |                            |              |       | 80           | ms      |
| Verify ECDSASignature or Compute ECDH Time | t VES                   |                            |              |       | 160          | ms      |
| TRNG Generation                            | t RNG                   |                            |              |       | 40           | ms      |
| TRNG On-Demand Check                       | t ODC                   |                            |              |       | 65           | ms      |
| OTP                                        |                         |                            |              |       |              |         |
| OTP Write Temperature                      | T OPTW                  |                            |              |       | 50           | ºC      |
| Data Retention                             | t DR                    | T A = +85°C (Note 21)      | 10           |       |              | Years   |
| FRAM                                       | FRAM                    |                            |              |       |              |         |
| FRAM Off Time                              | t OFF_FRAM              | (Note 22)                  | 50           |       |              | ms      |
| FRAM Read/Write Cycles (Endurance)         | N CY_FRAM               | (T A = +50°C (Note 23, 25) | 1 Trillion   |       |              |         |
| FRAM Data Retention                        | t DR_FRAM               | (T A = +50°C (Note 24, 25) | 10           |       |              | Years   |
| POWER                                      |                         |                            |              |       |              |         |
| Power-Up Time                              | t OSCWUP                | (Notes 1, 20)              | 2            |       |              | ms      |
...
Note 5: VTL , V TH , and V HY  are functions of the internal supply voltage, which is a function of V PUP , R PUP , 1-Wire timing, and capacitive loading on IO. Lower V PUP , higher R PUP , shorter t REC , and heavier capacitive loading all lead to lower values of V TL , V TH , and VHY .
...
Interval after t RSTL  during which a bus master can read a logic 0 on IO if there is a DS28E84 present.

Note 17: ε in Figure 4 represents the time required for the pullup circuitry to pull the voltage on IO up from V IL  to V TH .

Note 18: δ in threshold of the bus master.

Figure 4 represents the time required for the pullup circuitry to pull the voltage on IO up from V IL  to the input-high
...
| -     | -      | Exposed Pad (TDFN Only). Solder evenly to the board's ground plane for proper operation. Refer to Application Note 3273: Exposed Pads: A Brief Introduction for additional information. |
...
To get from idle to active, the voltage on the 1-Wire line needs to fall from V PUP  below the threshold V TL . To get from active to idle, the voltage needs to rise from V ILMAX past the threshold V TH . The time it takes for the voltage to make this rise is seen in Figure 3 as  ε,  and its dura -tion depends on the pullup resistor (R PUP ) used and the capacitance of the 1-Wire network attached. The voltage VILMAX  is relevant for the DS28E84 when determining a logical level, not triggering any events.
...
capable slaves return to standard speed at the next reset pulse of minimum 480μs duration. The Overdrive-Match ROM command can be used with a single device or multiple devices on the bus.
