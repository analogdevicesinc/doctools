...
| Voltage Range on V DD Relative to Ground...........-0.5V to +6.5V                                         |
|-----------------------------------------------------------------------------------------------------------|
| Voltage Range on V DDA Relative to Ground.........-0.5V to +6.5V                                          |
| Voltage Range on Any Pin Relative to Ground Pins CPA1, CPA2, CPB1, CPB2, and V UP .........-0.5V to +7.5V |
| All Other Pins...........................................-0.5V to (V DD +                                 |
| 0.5V)                                                                                                     |

| Maximum Junction Temperature .....................................+150°C   |
|----------------------------------------------------------------------------|
| Maximum Power Dissipation (T A = -25°C).......................900mW        |
...
| Power-Down V Current                   | Cards Inactive                         | I PD       | f XTAL = 0MHz                                                                     |            |            | 0.9        | mA         |
| Power-Down V Current                   | Cards Active                           | I PD       | f XTAL = 0MHz, f CLK = 0MHz, V CCx = 5V                                           |            |            | 2.2        | mA         |
...
|                                        | Current                                | I DD       | 2x V DD step-up: I CCA + I CCB = 80mA, f XTAL = 20MHz, f CLK = 10MHz, V DD = 2.7V |            |            | 225        | mA         |
| 3V Cards                               | 3V Cards                               | I DD       | No step-up: I CCA + I CCB = 80mA, f XTAL = 20MHz, f CLK = 10MHz, V DD = 5V        |            |            | 120 2.5    | V          |
|                                        |                                        | V RST      | Threshold voltage (falling)                                                       | 2.1        |            |            |            |
| Power-Fail Reset Voltage               | Power-Fail Reset Voltage               | V HYS      | Hysteresis                                                                        | 50         | 50         | 170        | mV         |
|                                        | Threshold                              | V DRST     |                                                                                   |            | 1.25       | V DD + 0.3 | V          |
|                                        | Output Voltage                         | V DO       |                                                                                   |            |            |            | mV         |
|                                        | Output Current                         | I DO       | V DELAY = 0V                                                                      | -2         | -2         |            | µA         |
|                                        |                                        | I DO       | V DELAY = V DD                                                                    | +2         | +2         |            | mA         |
...
|                                               |                                               |                                               | V UP         | 2x step-up                           |             |   4.1 |       |         |
| Voltage Detection of V DDA for 2x, 3x Step-Up | Voltage Detection of V DDA for 2x, 3x Step-Up | Voltage Detection of V DDA for 2x, 3x Step-Up | V DET        |                                      | 3.25        |  3.50 | 3.60  | V       |
...
|                                               | Card Active                                   | Fall Time                                     | t FRST       | C L = 30pF                           |             |       | 0.1   | µs      |
|                                               | Card Active                                   | Shutdown Current                              | I RST(SD)    |                                      |             |   -25 |       | mA      |
|                                               | Card Active                                   | Current Limitation                            | I RST(LIMIT) |                                      | -30         |       | +30   | mA      |
...
|                                               | Card Active Mode                              | Current Limitation                            | I CLK(LIMIT) |                                      | -90         |       | +90   | mA      |
|                                               |                                               |                                               | f            | Idle configuration (1MHz)            | 1           |       | 1.85  | MHz     |
|                                               | Clock Frequency                               | Clock Frequency                               | CLK          | Operational                          | 0           |       | 10    |         |
|                                               | Duty Factor                                   | Duty Factor                                   |              | C L = 30pF                           | 45          |       | 55    | %       |
...
|             |                    | Output Low Voltage        | V CCx       | I CC(5V) < 65mA                                                        | 4.72        | 5.00  | 5.25  | V       |
|             |                    | Output Low Voltage        | V CCx       | I CC(3V) < 50mA                                                        | 2.75        | 3.00  | 3.22  | V       |
|             |                    | Output Low Voltage        | V CCx       | I CC(1.8V) < 30mA                                                      | 1.62        | 1.80  | 1.95  | V       |
|             |                    | Output Low Voltage        | V CCx       | 5V card, current pulses of 40nC with I < 200mA, t < 400ns, f < 20MHz   | 4.6         |       | 5.4   | V       |
|             |                    | Output Low Voltage        | V CCx       | 3V card, current pulses of 24nC with I < 200mA, t < 400ns, f < 20MHz   | 2.75        |       | 3.25  | V       |
|             | Card Active        | Output Low Voltage        | V CCx       | 1.8V card, current pulses of 12nC with I < 200mA, t < 400ns, f < 20MHz | 1.62        |       | 1.98  | V       |
|             | Mode               |                           |             | V CCx(5V) = 0 to 5V                                                    |             |       | -65   | mA      |
|             |                    | Output Current            | I CC        | V CCx(3V) = 0 to 3V                                                    |             |       | -50   | mA      |
|             |                    |                           |             | V CCx(1.8V) = 0 to 1.8V                                                |             |       | -30   | mA      |
|             |                    | Total Current (Two Cards) | I CC(A+B)   |                                                                        |             |       | -80   | mA      |
|             |                    | Shutdown Current          | I CC(SD)    |                                                                        |             | -100  |       | mA      |
|             | Card Inactive Mode | Slew Rate Output Voltage  | V CCSR      | Up/down, C < 300nF (Note 3)                                            | 0.05        | 0.16  | 0.5   | V/µs    |
|             |                    | Low                       | V OLIO      | I OLIO = 1mA                                                           | 0           |       | 0.3   | V       |
|             |                    | Output Current            | I OLIO      | V OLIO = 0V                                                            | 0           |       | -1    | mA      |
|             |                    | Internal Pullup Resistor  | R PULLUP    | To V CCx                                                               | 9           | 14    | 19    | k       |
|             | Card Active Mode   | Output Low Voltage        | V OLIO      | I OLIO = 1mA                                                           | 0           |       | 0.3   | V       |
|             | Card Active Mode   | Output High               |             | I OHIO -20µA                                                           | 0.8 x V CCx |       | V CCx | V       |
|             | Card Active Mode   | Voltage                   | V OHIO      | I OHIO -40µA (3V/5V)                                                   | 0.75 x V    | CCx   | V CCx | V       |
|             | Card Active Mode   | Output Rise/Fall Time     | t OT        | C L = 30pF                                                             |             |       | 0.1   | µs      |
|             | Card Active Mode   | Input Low Voltage         | V ILIO      |                                                                        | -0.3        |       | +0.8  | V       |
|             | Card Active Mode   | Input High Voltage        | V IHIO      |                                                                        | 1.5         |       | V CC  |         |
|             | Card Active Mode   | Input Low Current         | I ILIO      | V ILIO = 0V                                                            |             |       | 700   | µA      |
|             | Card Active Mode   | Input High Current        | I IHIO      | V IHIO = V CCx                                                         |             |       | 20    | µA      |
|             | Card Active Mode   | Input Rise/Fall Time      | t IT        | C L = 30pF                                                             |             |       | 1.2   | µs      |
|             | Card Active Mode   | Current Limitation        | I IO(LIMIT) |                                                                        | -25         |       | +25   | mA      |
...
|                                                              | Internal Pullup Resistor                                     | R PULLUP                                                     | Between C4 or C8 and V CCx                                   | 6                                                            | 10                                                           | 14                                                           | k                                                            |                                                              |
|                                                              | Output Low Voltage                                           | V OLC48                                                      | I OLC48 = 1mA                                                | 0                                                            |                                                              | 0.35                                                         | V                                                            |                                                              |
|                                                              | Output High                                                  | V OHC48                                                      | I OHC48 -20µA                                                | 0.8 x V CCx                                                  |                                                              | V CCx                                                        | V                                                            |                                                              |
|                                                              | Voltage Output Rise/Fall Time                                | t OT                                                         | I OHC48 -40µA (3V/5V) C L = 30pF                             | 0.75 x V CCx                                                 |                                                              | V CCx 0.1                                                    | µs                                                           |                                                              |
|                                                              | Input Low Voltage                                            | V                                                            | ILC48                                                        | -0.3                                                         |                                                              | +0.8                                                         |                                                              |                                                              |
|                                                              | Input High Voltage                                           | V IHC48                                                      |                                                              | 1.5                                                          |                                                              | V CCx                                                        | V                                                            |                                                              |
|                                                              | Input Low Current                                            | I ILC48                                                      | V ILIO = 0V                                                  |                                                              |                                                              | 850                                                          | µA                                                           |                                                              |
|                                                              | Input High Current                                           | I IHC48                                                      | V IHIO = V CCx                                               |                                                              |                                                              | 20                                                           |                                                              |                                                              |
...
| Input High Current I IHPRES V IHPRES = V DD 40 µA I/OAUX PIN | Input High Current I IHPRES V IHPRES = V DD 40 µA I/OAUX PIN | Input High Current I IHPRES V IHPRES = V DD 40 µA I/OAUX PIN | Input High Current I IHPRES V IHPRES = V DD 40 µA I/OAUX PIN | Input High Current I IHPRES V IHPRES = V DD 40 µA I/OAUX PIN | Input High Current I IHPRES V IHPRES = V DD 40 µA I/OAUX PIN | Input High Current I IHPRES V IHPRES = V DD 40 µA I/OAUX PIN | Input High Current I IHPRES V IHPRES = V DD 40 µA I/OAUX PIN | Input High Current I IHPRES V IHPRES = V DD 40 µA I/OAUX PIN |
| Internal Pullup Resistor                                     | Internal Pullup Resistor                                     | R PULLUP                                                     | Between I/OAUX and V DD                                      | 9                                                            | 14                                                           | 19                                                           | k                                                            |                                                              |
...
|   PIN | NAME   | FUNCTION                                                                                                                                                                                                                                                                                              |
|-------|--------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|     1 | RSTOUT | Reset Output. This active-high output is provided for resetting external devices. The RSTOUT pin is driven high until the DELAY pin reaches V DRST . Once the DELAY pin reaches V DRST , the RSTOUT pin is tri-stated so it can externally be pulled down. The SUPL bit is set for each RSTOUT pulse. |
...
Bits 7 to 0: Guard Time Register Bits 7 to 0 (GTR.7 to GTR.0). These bits are used for storing the number of guard time units (ETU) requested during ATR. When transmitting, the DS8007A UART delays these numbers of extra guard time ETU before transmitting a character written to UTR.
...
The voltage supervisor circuitry monitors VDD and holds the device in reset until VDD is  at  a  satisfactory level.  The  DELAY pin is an external indicator of the state of internal power and can also be driven externally to hold the device in a reset state. An external capacitor  is  usually  attached  to  this  pin,  defining  the  time constant of a power-on delay for the DS8007A. When VDD is below the voltage threshold VRST, the charging path that exists between VDD and DELAY is disconnected and a strong pulldown is enabled on the DELAY pin. Once VDD exceeds VRST, the strong pulldown on the DELAY pin is released and the pullup to VDD is enabled, allowing the external DELAY capacitor to be charged.

The RSTOUT alarm pin is released (allowing it to be pulled up externally) whenever the DELAY pin voltage is less than VDRST, whether caused by VDD &lt; VRST or as a result of external hardware pulling the DELAY pin low. The minimum duration of the RSTOUT pulse (tW specification) is defined by the capacitor connected to the DELAY pin and is typically 1ms per 2nF. The RSTOUT pin is driven strongly low once the DELAY pin exceeds the VDRST voltage threshold.
...
| TA(1).Fi   | PSC 0 = /31 1 = /32   |   PDR SETTING FOR Di = |   PDR SETTING FOR Di = | PDR SETTING FOR Di =   | PDR SETTING FOR Di =   | PDR SETTING FOR Di =   | PDR SETTING FOR Di =   | PDR SETTING FOR Di =   | PDR SETTING FOR Di =   |
|------------|-----------------------|------------------------|------------------------|------------------------|------------------------|------------------------|------------------------|------------------------|------------------------|
| TA(1).Fi   | PSC 0 = /31 1 = /32   |                   0001 |                   0010 | 0011                   | 0100                   | 0101                   | 0110                   | 1000                   | 1001                   |
| 0000       | 0                     |                     12 |                      6 | 3                      | -                      | -                      | -                      | 1                      | -                      |
| 0001       | 0                     |                     12 |                      6 | 3                      | -                      | -                      | -                      | 1                      | -                      |
| 0010       | 0                     |                     18 |                      9 | -                      | -                      | -                      | -                      | -                      | -                      |
| 0011       | 0                     |                     24 |                     12 | 6                      | 3                      | -                      | -                      | 2                      | -                      |
