...
## MAX2121 Evaluation Kit Evaluates: MAX2121

## Features

- S Easy Evaluation of the MAX2121
- S 50 I RF Input SMA Connector
- S 50 I Baseband Output BNC Connector
- S Single 3.3V ±5% Supply
- S I 2 C 2-Wire Serial Interface
- S All Critical Peripheral Components Included
- S Proven PCB Layout
- S Fully Assembled and Tested
- S PC Control Software (Available at www.maximintegrated.com/evkitsoftware)
...
| U1            |     1 | DVBS tuner (28 TQFN-EP) Maxim MAX2121ETI+                                                                                                    |
...
The  EV  kit  includes  on-board  matching  circuitry  at  the MAX2121 RF input to convert the 50 I source to a 75 I input.  Note  that  the  input  power  to  the  device  must be  adjusted  to  account  for  the  -6dB  power  loss  of  the matching resistor network.
...
Figure 2. MAX2121 EV Kit Component Placement GuideComponent Side
...
Figure 5. MAX2121 EV Kit PCB Layout-Top Soldermask

<!-- image -->

## MAX2121 Evaluation Kit Evaluates: MAX2121

Figure 6. MAX2121 EV Kit PCB Layout-Bottom Soldermask
...
|                 1 | 5/15            | Updated the Test Equipment Required and the Connections and Setup sections | 2, 3            |
