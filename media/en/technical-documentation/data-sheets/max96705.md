...
The  MAX96705  is  a  compact  serializer  with  features especially suited for automotive camera applications. It is function and pin compatible with the MAX9271. In highbandwidth mode, the parallel-clock maximum is 116MHz for 12-bit linear or combined HDR data types.
...
| I 2C Address Translation. . . . . . . . . . . . . . . . . . . . . .                | . 74                            |
| Configuration Blocking. . . . . . . . . . . . . . . . . . . . . . .                | . 74                            |
| Cascaded/Parallel Devices . . . . . . . . . . . . . . . . . . .                    | . 74                            |
| UART . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .       | . 74                            |
| Base Mode. . . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .           | . 74                            |
| UART Timing . . . . . . . . . . . . . . . . . . . . . . . . . . . . . .            | . 74                            |
| UART-to-I 2C Conversion . . . . . . . . . . . . . . . . . . . . .                  | . 76                            |
| UART Bypass Mode . . . . . . . . . . . . . . . . . . . . . . . .                   | .77                             |
| Device Address . . . . . . . . . . . . . . . . . . . . . . . . . . . .             | .77                             |
| Spread Spectrum . . . . . . . . . . . . . . . . . . . . . . . . . . . . .          | .77                             |
...
| I 2 C/UART Pullup Resistors . . . . . . . . . . . . . . . . . . . . .                  | .80                             |
...
| Figure 6. I 2C Timing Parameters. . . . . . . . . . . . . . . . . . . . . .            | . 20                            |
...
| Figure 25. Format Conversion Between GMSL UART and I 2C with Register Address (I2CMETHOD = 0).                                                              | . 76                          |
| Figure 26. Format Conversion Between GMSL UART and I 2C with Register Address (I2CMETHOD = 1).                                                              | . 76                          |
...
| AVDD to EP* ........................................................-0.5V to +1.9V   | Continuous Power Dissipation, T A = +70°C                                        |
|--------------------------------------------------------------------------------------|----------------------------------------------------------------------------------|
...
|---------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------|
| SINGLE-ENDED INPUTS (LCCEN, DIN_, PCLKIN, HS, VS, DE, BWS, DBL, HIM, MS, HVEN, PWDNB) | SINGLE-ENDED INPUTS (LCCEN, DIN_, PCLKIN, HS, VS, DE, BWS, DBL, HIM, MS, HVEN, PWDNB) | SINGLE-ENDED INPUTS (LCCEN, DIN_, PCLKIN, HS, VS, DE, BWS, DBL, HIM, MS, HVEN, PWDNB) | SINGLE-ENDED INPUTS (LCCEN, DIN_, PCLKIN, HS, VS, DE, BWS, DBL, HIM, MS, HVEN, PWDNB) | SINGLE-ENDED INPUTS (LCCEN, DIN_, PCLKIN, HS, VS, DE, BWS, DBL, HIM, MS, HVEN, PWDNB) | SINGLE-ENDED INPUTS (LCCEN, DIN_, PCLKIN, HS, VS, DE, BWS, DBL, HIM, MS, HVEN, PWDNB) | SINGLE-ENDED INPUTS (LCCEN, DIN_, PCLKIN, HS, VS, DE, BWS, DBL, HIM, MS, HVEN, PWDNB) |
...
| Magnitude of Differential                             |                                                       | V OUT+ or V OUT- = 1.9V                               |                                                       |                                                       | 25                                                    | mA                                                    |
| Output Short-Circuit Current                          | I OSD                                                 | V OD = 0V                                             |                                                       |                                                       | 25                                                    |                                                       |
...
| Output Short-Circuit Current                          | I                                                     | V OUT+ or V OUT- = 0V                                 | -69                                                   |                                                       |                                                       | mA                                                    |
| Output Short-Circuit Current                          | OS                                                    | V OUT+ or V OUT- = 1.9V                               |                                                       |                                                       | 32                                                    | mA                                                    |
| Output-Termination Resistance (Internal)              | R O                                                   | From OUT+ or OUT- toAVDD                              | 45                                                    | 54                                                    | 63                                                    | Ω                                                     |
...
| PARAMETER                                                  | SYMBOL   | CONDITIONS                                                                           | MIN   | TYP   |   MAX | UNITS   |
|------------------------------------------------------------|----------|--------------------------------------------------------------------------------------|-------|-------|-------|---------|
| POWER SUPPLY Supply Current, Worst-Case Pattern (Figure 4) | I WCS    | f PCLKIN = 116MHz, HIBW = 0, BWS = 0, default register values, AVDD + DVDD (1.9V)    |       | 64    |    90 | mA      |
| POWER SUPPLY Supply Current, Worst-Case Pattern (Figure 4) | I WCS    | f PCLKIN = 116MHz, HIBW = 0, BWS = 0, default register values, IOVDD (3.6V)          |       | 1.8   |   2.7 | mA      |
| POWER SUPPLY Supply Current, Worst-Case Pattern (Figure 4) | I WCS    | f PCLKIN = 116MHz, HIBW = 0, BWS = 0, default register values, IOVDD (1.9V) (Note 4) |       | 0.45  |  0.69 | mA      |
| POWER SUPPLY Supply Current, Worst-Case Pattern (Figure 4) | I WCS    | f PCLKIN = 116MHz, HIBW = 1, BWS = 0, default register values, AVDD + DVDD (1.9V)    |       | 62    |    83 | mA      |
| POWER SUPPLY Supply Current, Worst-Case Pattern (Figure 4) | I WCS    | f PCLKIN = 116MHz, HIBW = 1, BWS = 0, default register values, IOVDD (3.6V)          |       | 1.8   |   2.7 | mA      |
| POWER SUPPLY Supply Current, Worst-Case Pattern (Figure 4) | I WCS    | f PCLKIN = 116MHz, HIBW = 1, BWS = 0, default register values, IOVDD (1.9V) (Note 4) |       | 0.45  |  0.69 | mA      |
| POWER SUPPLY Supply Current, Worst-Case Pattern (Figure 4) | I WCS    | f PCLKIN = 87MHz, BWS = 1, default register values, AVDD + DVDD (1.9V)               |       | 61    |    85 | mA      |
| POWER SUPPLY Supply Current, Worst-Case Pattern (Figure 4) | I WCS    | f PCLKIN = 87MHz, BWS = 1, default register values, IOVDD (3.6V)                     |       | 1.4   |   2.0 | mA      |
| POWER SUPPLY Supply Current, Worst-Case Pattern (Figure 4) | I WCS    | f PCLKIN = 87MHz, BWS = 1, default register values, IOVDD (1.9V) (Note 4)            |       | 0.37  |  0.61 | mA      |
...
| Clock Duty Cycle                    | DC                            | t HIGH /t T or t LOW /t T (Note 4, Figure 5)         | 35                            | 50                            | 65                            | %                             |
| Clock Transition Time               | t R, t F                      | (Note 4, Figure 5)                                   |                               |                               | 4                             | ns                            |
...
| Repeated START Condition Setup Time | t SU:STA                      | f SCL range, high                                    | 0.26                          |                               |                               |                               |
...
|                                                          |                                    | f SCL range, high                                                                                          | 50                                 |                                    |                                    | µs                                 |
| Setup Time for STOP                                      | t SU:STO                           | f SCL range, low                                                                                           | 4                                  |                                    |                                    |                                    |
| Condition                                                |                                    | f SCL range, mid                                                                                           | 0.6                                |                                    |                                    |                                    |
|                                                          |                                    | f SCL range, high                                                                                          | 0.26                               |                                    |                                    |                                    |
| Bus-Free Time                                            | t BUF                              | f SCL range, low                                                                                           | 4.7                                |                                    |                                    |                                    |
|                                                          |                                    | f SCL range, mid                                                                                           | 1.3                                |                                    |                                    | µs                                 |
|                                                          |                                    | f SCL range, high                                                                                          | 0.5                                |                                    |                                    | µs                                 |
|                                                          |                                    | f SCL range, low                                                                                           |                                    |                                    |                                    | µs                                 |
| Data Valid Time                                          | t VD:DAT                           | f SCL range, mid                                                                                           | 3.45 0.9 0.45                      | 3.45 0.9 0.45                      | 3.45 0.9 0.45                      |                                    |
|                                                          |                                    | f SCL range, low                                                                                           | 3.45                               | 3.45                               | 3.45                               |                                    |
|                                                          |                                    | f SCL range, high                                                                                          |                                    |                                    |                                    | µs                                 |
| Data Valid-Acknowledge Time                              | t VD:ACK                           | f SCL range, mid                                                                                           | 0.45 50                            | 0.45 50                            | 0.45 50                            |                                    |
|                                                          |                                    | f SCL range, high f SCL range, low                                                                         | 0.9 50                             | 0.9 50                             | 0.9 50                             | ns                                 |
| Pulse Width of Spikes Suppressed                         | t SP                               | f SCL range, mid                                                                                           |                                    |                                    |                                    |                                    |
|                                                          |                                    | f SCL range, high                                                                                          |                                    |                                    | 50                                 |                                    |
| Capacitive Load of Each                                  | C B                                |                                                                                                            |                                    |                                    |                                    | pF                                 |
| Bus Line                                                 |                                    | Note 4                                                                                                     | 100                                | 100                                | 100                                |                                    |
...
| Total Serial-Output Jitter (Differential Output)         | t TSOJ1                            | 1.74Gbps PRBS, measured at V OD = 0V differential, preemphasis disabled ( Figure 7)                        | 0.25                               | 0.25                               | 0.25                               | UI                                 |
| Deterministic Serial-Output Jitter (Differential Output) | t DSOJ2                            | 1.74Gbps PRBS, measured at V OD = 0V differential, preemphasis disabled ( Figure 7)                        | 0.15                               | 0.15                               | 0.15                               | UI                                 |
...
| Parallel Data-Input Setup Time                           | t SET                              | (Figure 8)                                                                                                 | 2                                  | 2                                  | 2                                  | ns                                 |
...
| Serializer Delay              | t SD     | Spread spectrum enabled (Figure 10) (Notes 4, 7)  |       |       |  2065 | Bits    |
| Serializer Delay              |          | Spread spectrum disabled (Figure 10) (Notes 4, 7) |       |       |  1095 |         |
...
toc12 SERIAL LINK SWITCHING PATTERN WITH 3.3dB PREEMPHASIS (1.5Gbps, 20m COAX CABLE)
...
| Multifunction Configuration (from LCCEN) | Multifunction Configuration (from LCCEN) | Multifunction Configuration (from LCCEN)                                                                                                                                                                                                                                                                           | Multifunction Configuration (from LCCEN) | Multifunction Configuration (from LCCEN) |
...
| 24                          | TX/SCL/DBL                  | Transmit/Serial Clock/Double Mode. Function is determined by the state of LCCEN. TX/SCL (LCCEN = high): Input/output with internal 30kΩ pullup to IOVDD. In UART mode, TX/SCL is the Tx output of the serializer's UART. In I 2 C mode, TX/SCL is the SCL input/output of the serializer's I 2 C master/slave. TX/SCL has an open-drain driver and requires a pullup resistor. DBL (LCCEN = low): Input with internal pulldown to EP. Set DBL = high to use double-input mode. Set DBL = low to use single-input mode.                                            | IOVDD                       | Digital                     |
...
| HIM PIN SETTING   | REVFAST BIT   | REVERSECONTROL-CHANNEL MODE                                              |   MAXIMUM UART/I 2 C BIT RATE (kBPS) |
|-------------------|---------------|--------------------------------------------------------------------------|--------------------------------------|
...
The  driver  output  is  programmable  for  two  kinds  of cable,100Ω  twisted  pair  and  50Ω  coax  (contact  the factory for devices compatible with 75Ω cables). In coax mode,  connect  OUT+  to  IN+  of  the  deserializer.  Leave the unused IN\_ pin unconnected, or connect it to ground through 50Ω, and a capacitor for increased power-supply rejection.  Connect  OUT-  to  V DD through  a  50Ω  resistor (Figure 16).

## 16-Bit GMSL Serializer with High-Immunity/ Bandwidth Mode and Coax/STP Cable Drive

## Crossbar Switch

The crossbar switch routes data between the parallel input/ output  and  the  SerDes.  The  anything-to-anything  routing  assures  the  mapping  between  the  video  source  and destination.  For  each  crossbar  output  (XBO\_)  an  input multiplexer  selects  from  the  available  crossbar  inputs (XBI\_)  using  the  CROSSBAR\_  register  bits  (Figure  17). Multiple crossbar outputs can use the same crossbar input. By default, the sync signals share the same inputs as the MSBs of the video data.
...
| 0x02 ss            | SS[2:0]            | SS[2:0]            | SS[2:0]            | RSVD               | PRNG[1:0]          | PRNG[1:0]          | PRNG[1:0]          | SRNG[1:0]          | SRNG[1:0]       |
| 0x03 sdiv          | AUTOFM[1:0]        | AUTOFM[1:0]        | AUTOFM[1:0]        |                    | SDIV[5:0]          | SDIV[5:0]          | SDIV[5:0]          | SDIV[5:0]          | SDIV[5:0]       |
| 0x04 main_control  | SEREN              | CLINKEN            | PRBSEN             | SLEEP              | INTTYPE[1:0]       | INTTYPE[1:0]       | REVCCENFWDCCEN     | REVCCENFWDCCEN     |                 |
| 0x05 prbs_len      | I2C- METHOD        | RSVD               | PRBS_LEN[1:0]      | PRBS_LEN[1:0]      | RSVD               | RSVD               | RSVD               | RSVD               | RSVD            |
...
| 0x0D i2c_config    | I2C_LOC_ ACK       | I2C_SLV_SH[1:0]    | I2C_SLV_SH[1:0]    | I2C_MST_BT[2:0]    | I2C_MST_BT[2:0]    | I2C_MST_BT[2:0]    | I2C_MST_BT[2:0]    | I2C_SLV_TO[1:0]    | I2C_SLV_TO[1:0] |
| 0x0E gpio_en       | RSVD               | RSVD               | GPIO_ EN_5         | GPIO_ EN_4         | GPIO_ EN_3         | GPIO_ EN_2         | GPIO_ EN_1         | RSVD               |                 |
| gpio_out           | EN_SET_ GPO        | RSVD               | GPIO_ OUT_5        | GPIO_ OUT_4        | GPIO_ OUT_3        | GPIO_ OUT_2        | GPIO_ OUT_1        | SET_GPO            | 0x0F            |
| gpio_in            | RSVD               | RSVD               | GPIO_ IN_5         | GPIO_ IN_4         | GPIO_ IN_3         | GPIO_ IN_2         | GPIO_ IN_1         | GPO_L              | 0x10            |
| 0x11 errg          | ERRG_RATE[1:0]     | ERRG_RATE[1:0]     | ERRG_TYPE[1:0]     | ERRG_TYPE[1:0]     | ERRG_CNT[1:0]      | ERRG_CNT[1:0]      | ERRG_ PER          | ERRG_EN            |                 |
...
| 0x14 pktcc_lock    | RSVD[1:0]          | RSVD[1:0]          | RSVD               | RSVD               | RSVD               | RSVD               | CC_ WBLOCK         | REM_ CCLOCK        |                 |
| input_status       | CX_TP              | RSVD               | LCCEN              | RSVD               | RSVD               | RSVD               | OUT- PUTEN         | PCLKDET            | 0x15            |
| 0x16 max_rt_err    | RSVD               | MAX_RT_ ERR        | RSVD[5:0]          | RSVD[5:0]          | RSVD[5:0]          | RSVD[5:0]          | RSVD[5:0]          | RSVD[5:0]          |                 |
| 0x17 rsvd_17       | RSVD[7:0]          | RSVD[7:0]          | RSVD[7:0]          | RSVD[7:0]          | RSVD[7:0]          | RSVD[7:0]          | RSVD[7:0]          | RSVD[7:0]          |                 |
| 0x18 crc 0         | CRC_VALUE_0[7:0]   | CRC_VALUE_0[7:0]   | CRC_VALUE_0[7:0]   | CRC_VALUE_0[7:0]   | CRC_VALUE_0[7:0]   | CRC_VALUE_0[7:0]   | CRC_VALUE_0[7:0]   | CRC_VALUE_0[7:0]   |                 |
| 0x19 crc 1         | CRC_VALUE_1[7:0]   | CRC_VALUE_1[7:0]   | CRC_VALUE_1[7:0]   | CRC_VALUE_1[7:0]   | CRC_VALUE_1[7:0]   | CRC_VALUE_1[7:0]   | CRC_VALUE_1[7:0]   | CRC_VALUE_1[7:0]   |                 |
| 0x1A crc 2         |                    |                    |                    | CRC_VALUE_2[7:0]   |                    |                    |                    |                    |                 |
| 0x1B crc 3         | CRC_VALUE_3[7:0]   | CRC_VALUE_3[7:0]   | CRC_VALUE_3[7:0]   | CRC_VALUE_3[7:0]   | CRC_VALUE_3[7:0]   | CRC_VALUE_3[7:0]   | CRC_VALUE_3[7:0]   | CRC_VALUE_3[7:0]   |                 |
| 0x1C cc_crc_errcnt |                    |                    |                    |                    |                    |                    |                    |                    |                 |
|                    | CC_CRC_ERRCNT[7:0] | CC_CRC_ERRCNT[7:0] | CC_CRC_ERRCNT[7:0] | CC_CRC_ERRCNT[7:0] | CC_CRC_ERRCNT[7:0] | CC_CRC_ERRCNT[7:0] | CC_CRC_ERRCNT[7:0] | CC_CRC_ERRCNT[7:0] |                 |

## GMSL Register Map (continued)

| OFFSET          | NAME        | MSB     |               |                |         |                  | LSB              |                  |
|-----------------|-------------|---------|---------------|----------------|---------|------------------|------------------|------------------|
| 0x1E            | id[7:0]     | ID[7:0] | ID[7:0]       | ID[7:0]        | ID[7:0] | ID[7:0]          | ID[7:0]          | ID[7:0]          |
| 0x1F            | revision    | RSVD    | RSVD          | RSVD           | HDCPCAP | REVISION[3:0]    | REVISION[3:0]    | REVISION[3:0]    |
| 0x20            | crossbar 0  | RSVD    | FORCE_ MUX_0  | INVERT_ MUX_0  |         |                  |                  |                  |
| 0x21            | crossbar 1  | RSVD    | FORCE_ MUX_1  | INVERT_ MUX_1  |         | CROSSBAR_1[4:0]  | CROSSBAR_1[4:0]  | CROSSBAR_1[4:0]  |
| 0x22            | crossbar 2  | RSVD    | FORCE_ MUX_2  | INVERT_ MUX_2  |         | CROSSBAR_2[4:0]  | CROSSBAR_2[4:0]  | CROSSBAR_2[4:0]  |
| 0x23            | crossbar 3  | RSVD    | FORCE_ MUX_3  | INVERT_ MUX_3  |         | CROSSBAR_3[4:0]  | CROSSBAR_3[4:0]  | CROSSBAR_3[4:0]  |
| 0x24 crossbar 4 |             | RSVD    | FORCE_ MUX_4  | INVERT_ MUX_4  |         | CROSSBAR_4[4:0]  | CROSSBAR_4[4:0]  | CROSSBAR_4[4:0]  |
| 0x25            | crossbar 5  | RSVD    | FORCE_ MUX_5  | INVERT_ MUX_5  |         |                  |                  |                  |
| 0x26            | crossbar 6  | RSVD    | FORCE_ MUX_6  | INVERT_ MUX_6  |         | CROSSBAR_6[4:0]  | CROSSBAR_6[4:0]  | CROSSBAR_6[4:0]  |
| 0x27 crossbar   | 7           | RSVD    | FORCE_ MUX_7  | INVERT_ MUX_7  |         | CROSSBAR_7[4:0]  | CROSSBAR_7[4:0]  | CROSSBAR_7[4:0]  |
| 0x28            | crossbar 8  | RSVD    | FORCE_ MUX_8  | INVERT_ MUX_8  |         | CROSSBAR_8[4:0]  | CROSSBAR_8[4:0]  | CROSSBAR_8[4:0]  |
| 0x29            | crossbar 9  | RSVD    | FORCE_ MUX_9  | INVERT_ MUX_9  |         | CROSSBAR_9[4:0]  | CROSSBAR_9[4:0]  | CROSSBAR_9[4:0]  |
| 0x2A            | crossbar 10 | RSVD    | FORCE_ MUX_10 | INVERT_ MUX_10 |         |                  |                  |                  |
| 0x2B            | crossbar 11 | RSVD    | FORCE_ MUX_11 | INVERT_ MUX_11 |         |                  |                  |                  |
| 0x2C crossbar   | 12          | RSVD    | FORCE_ MUX_12 | INVERT_ MUX_12 |         |                  |                  |                  |
| 0x2D            | crossbar 13 | RSVD    | FORCE_ MUX_13 | INVERT_ MUX_13 |         | CROSSBAR_13[4:0] | CROSSBAR_13[4:0] | CROSSBAR_13[4:0] |
| 0x2E crossbar   | 14          | RSVD    | FORCE_ MUX_14 | INVERT_ MUX_14 |         |                  |                  |                  |
| 0x2F            | crossbar 15 | RSVD    | FORCE_ MUX_15 | INVERT_ MUX_15 |         | CROSSBAR_15[4:0] | CROSSBAR_15[4:0] | CROSSBAR_15[4:0] |
| 0x30 crossbar   | 16          | RSVD    | FORCE_ MUX_16 | INVERT_ MUX_16 |         |                  |                  |                  |
| 0x31            | crossbar 17 | RSVD    | FORCE_ MUX_17 | INVERT_ MUX_17 |         |                  |                  |                  |
| 0x32            | crossbar 18 | RSVD    | FORCE_ MUX_18 | INVERT_ MUX_18 |         | CROSSBAR_18[4:0] | CROSSBAR_18[4:0] | CROSSBAR_18[4:0] |
| 0x33            | crossbar 19 | RSVD    | FORCE_ MUX_19 | INVERT_ MUX_19 |         |                  |                  |                  |
| 0x34            | crossbar 20 | RSVD    | FORCE_ MUX_20 | INVERT_ MUX_20 |         | CROSSBAR_20[4:0] | CROSSBAR_20[4:0] | CROSSBAR_20[4:0] |
...
| 0x36 crossbar 22     | RSVD              | FORCE_ MUX_22     | INVERT_ MUX_22 |                                                                                                             |                                                                                                             | CROSSBAR_22[4:0]                                                                                            |                                                                                                             |                                                                                                             |                                                                                                             |
| 0x37 crossbar 23     | RSVD              | FORCE_ MUX_23     | INVERT_ MUX_23 |                                                                                                             |                                                                                                             | CROSSBAR_23[4:0]                                                                                            |                                                                                                             |                                                                                                             |                                                                                                             |
| 0x38 crossbar 24     | RSVD              | FORCE_ MUX_24     | INVERT_ MUX_24 |                                                                                                             |                                                                                                             | CROSSBAR_24[4:0]                                                                                            |                                                                                                             |                                                                                                             |                                                                                                             |
| 0x39 crossbar 25     | RSVD              | FORCE_ MUX_25     | INVERT_ MUX_25 |                                                                                                             |                                                                                                             | CROSSBAR_25[4:0]                                                                                            |                                                                                                             |                                                                                                             |                                                                                                             |
| 0x3A crossbar 26     | RSVD              | FORCE_ MUX_26     | INVERT_ MUX_26 |                                                                                                             |                                                                                                             | CROSSBAR_26[4:0]                                                                                            |                                                                                                             |                                                                                                             |                                                                                                             |
| 0x3B crossbar 27     | RSVD              | FORCE_ MUX_27     | INVERT_ MUX_27 |                                                                                                             |                                                                                                             | CROSSBAR_27[4:0]                                                                                            |                                                                                                             |                                                                                                             |                                                                                                             |
| 0x3C crossbar 28     | RSVD              | FORCE_ MUX_28     | INVERT_ MUX_28 |                                                                                                             |                                                                                                             | CROSSBAR_28[4:0]                                                                                            |                                                                                                             |                                                                                                             |                                                                                                             |
| 0x3D crossbar 29     | RSVD              | FORCE_ MUX_29     | INVERT_ MUX_29 | CROSSBAR_29[4:0]                                                                                            | CROSSBAR_29[4:0]                                                                                            | CROSSBAR_29[4:0]                                                                                            | CROSSBAR_29[4:0]                                                                                            | CROSSBAR_29[4:0]                                                                                            | CROSSBAR_29[4:0]                                                                                            |
| 0x3E crossbar 30     | RSVD              | FORCE_ MUX_30     | INVERT_ MUX_30 | CROSSBAR_30[4:0]                                                                                            | CROSSBAR_30[4:0]                                                                                            | CROSSBAR_30[4:0]                                                                                            | CROSSBAR_30[4:0]                                                                                            | CROSSBAR_30[4:0]                                                                                            | CROSSBAR_30[4:0]                                                                                            |
| 0x3F crossbar_hs     | RSVD              | FORCE_ MUX_HS     | INVERT_ MUX_HS | CROSSBARHS[4:0]                                                                                             | CROSSBARHS[4:0]                                                                                             | CROSSBARHS[4:0]                                                                                             | CROSSBARHS[4:0]                                                                                             | CROSSBARHS[4:0]                                                                                             | CROSSBARHS[4:0]                                                                                             |
| 0x40 crossbar_vs     | RSVD              | FORCE_ MUX_VS     | INVERT_ MUX_VS | CROSSBARVS[4:0]                                                                                             | CROSSBARVS[4:0]                                                                                             | CROSSBARVS[4:0]                                                                                             | CROSSBARVS[4:0]                                                                                             | CROSSBARVS[4:0]                                                                                             | CROSSBARVS[4:0]                                                                                             |
| 0x41 crossbar_de     | RSVD              | FORCE_ MUX_DE     | INVERT_ MUX_DE | VS_DLY[7:0] VS_DLY[7:0] VS_DLY[7:0] VS_H[7:0] VS_H[7:0] VS_H[7:0] VS_L[7:0] VS_L[7:0] VS_L[7:0] HS_DLY[7:0] | VS_DLY[7:0] VS_DLY[7:0] VS_DLY[7:0] VS_H[7:0] VS_H[7:0] VS_H[7:0] VS_L[7:0] VS_L[7:0] VS_L[7:0] HS_DLY[7:0] | VS_DLY[7:0] VS_DLY[7:0] VS_DLY[7:0] VS_H[7:0] VS_H[7:0] VS_H[7:0] VS_L[7:0] VS_L[7:0] VS_L[7:0] HS_DLY[7:0] | VS_DLY[7:0] VS_DLY[7:0] VS_DLY[7:0] VS_H[7:0] VS_H[7:0] VS_H[7:0] VS_L[7:0] VS_L[7:0] VS_L[7:0] HS_DLY[7:0] | VS_DLY[7:0] VS_DLY[7:0] VS_DLY[7:0] VS_H[7:0] VS_H[7:0] VS_H[7:0] VS_L[7:0] VS_L[7:0] VS_L[7:0] HS_DLY[7:0] | VS_DLY[7:0] VS_DLY[7:0] VS_DLY[7:0] VS_H[7:0] VS_H[7:0] VS_H[7:0] VS_L[7:0] VS_L[7:0] VS_L[7:0] HS_DLY[7:0] |
| 0x42 link_config     | LINE_CRC_LOC[1:0] | LINE_CRC_LOC[1:0] | LINE_ CRC_EN   | MAX_ RT_EN                                                                                                  | RSVD                                                                                                        | GPI_ COMP_ EN                                                                                               | GPI_RT_ EN                                                                                                  | GPO_EN                                                                                                      |                                                                                                             |
| 0x43 sync_gen_config | RSVD              | RSVD              | GEN_VS         | GEN_HS                                                                                                      | GEN_DE                                                                                                      | VS_ TRIG                                                                                                    | VTG_MODE[1:0]                                                                                               |                                                                                                             |                                                                                                             |
| 0x44 vs_dly 2        |                   |                   |                |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |
| 0x45 vs_dly 1        |                   |                   |                |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |
| 0x46 vs_dly 0        |                   |                   |                |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |
| 0x47 vs_h 2          |                   |                   |                |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |
...
| 0x4B vs_l 1          |                   |                   |                |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |
| 0x4C vs_l 0          |                   |                   |                |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |
| 0x4D cxtp            | RSVD              | HIGHIMM CXTP      | RSVD           |                                                                                                             | VSYNC_ INV                                                                                                  | HSYNC_ INV                                                                                                  | DE_INV                                                                                                      | RSVD                                                                                                        |                                                                                                             |
| 0x4E hs_dly 2        |                   |                   |                |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |                                                                                                             |
...
| 0x50 hs_dly 0      | HS_DLY[7:0]   | HS_DLY[7:0]   | HS_DLY[7:0]   | HS_DLY[7:0]         | HS_DLY[7:0]         | HS_DLY[7:0]         | HS_DLY[7:0]         | HS_DLY[7:0]   |
| 0x51 rsvd51        |               |               |               | RSVD[7:0]           |                     |                     |                     |               |
| 0x52 rsvd52        | RSVD[7:0]     | RSVD[7:0]     | RSVD[7:0]     | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]     |
| 0x53 rsvd53        | RSVD[7:0]     | RSVD[7:0]     | RSVD[7:0]     | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]     |
| 0x54 hs_h 1        | HS_H[7:0]     | HS_H[7:0]     | HS_H[7:0]     | HS_H[7:0]           | HS_H[7:0]           | HS_H[7:0]           | HS_H[7:0]           | HS_H[7:0]     |
| 0x55 hs_h 0        | HS_H[7:0]     | HS_H[7:0]     | HS_H[7:0]     | HS_H[7:0]           | HS_H[7:0]           | HS_H[7:0]           | HS_H[7:0]           | HS_H[7:0]     |
| 0x56 hs_l 1        | HS_L[7:0]     | HS_L[7:0]     | HS_L[7:0]     | HS_L[7:0]           | HS_L[7:0]           | HS_L[7:0]           | HS_L[7:0]           | HS_L[7:0]     |
| 0x57 hs_l 0        |               |               |               | HS_L[7:0]           |                     |                     |                     |               |
| 0x58 hs_cnt 1      |               |               |               | HS_CNT[7:0]         |                     |                     |                     |               |
| 0x59 hs_cnt 0      |               |               |               | HS_CNT[7:0]         |                     |                     |                     |               |
| 0x5A de_dly 2      |               |               |               | DE_DLY[7:0]         |                     |                     |                     |               |
| 0x5B de_dly 1      |               |               |               | DE_DLY[7:0]         |                     |                     |                     |               |
| 0x5C de_dly 0      | DE_DLY[7:0]   | DE_DLY[7:0]   | DE_DLY[7:0]   | DE_DLY[7:0]         | DE_DLY[7:0]         | DE_DLY[7:0]         | DE_DLY[7:0]         | DE_DLY[7:0]   |
| 0x5D rsvd5D        | RSVD[7:0]     | RSVD[7:0]     | RSVD[7:0]     | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]     |
| 0x5E rsvd5E        | RSVD[7:0]     | RSVD[7:0]     | RSVD[7:0]     | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]     |
| 0x5F rsvd5F        | RSVD[7:0]     | RSVD[7:0]     | RSVD[7:0]     | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]           | RSVD[7:0]     |
| 0x60 de_h 1        |               |               |               | DE_H[7:0]           |                     |                     |                     |               |
| 0x61 de_h 0        |               |               |               | DE_H[7:0]           |                     |                     |                     |               |
| 0x62 de_l 1        |               |               |               | DE_L[7:0]           |                     |                     |                     |               |
| 0x63 de_l          |               |               |               | DE_L[7:0]           |                     |                     |                     |               |
| 0                  |               |               |               |                     |                     |                     |                     |               |
| 0x64 de_cnt 1      | DE_CNT_1[7:0] | DE_CNT_1[7:0] | DE_CNT_1[7:0] | DE_CNT_1[7:0]       | DE_CNT_1[7:0]       | DE_CNT_1[7:0]       | DE_CNT_1[7:0]       | DE_CNT_1[7:0] |
| 0x65 de_cnt 0      | DE_CNT_0[7:0] | DE_CNT_0[7:0] | DE_CNT_0[7:0] | DE_CNT_0[7:0]       | DE_CNT_0[7:0]       | DE_CNT_0[7:0]       | DE_CNT_0[7:0]       | DE_CNT_0[7:0] |
| 0x66 prbs_type     | REV_ DE_EN    | RSVD[1:0]     | PRBS_ TYPE    | FAST                | DIS_ RWAKE          | RSVD                | CXSEL               |               |
| 0x67 dbl_align_to  | RSVD[1:0]     |               | AUTO_ CLINK   | RSVD                | DBL_ALIGN_TO[2:0]   |                     | RSVD                |               |
| 0x68 cc_crc_length | RSVD          |               | RSVD[2:0]     |                     | RSVD[1:0]           | CC_CRC_ LENGTH[1:0] | CC_CRC_ LENGTH[1:0] |               |
...
| 0x99 rsvd_99  | RSVD      | RSVD      | RSVD      | RSVD      | RSVD      |           | RSVD      | RSVD[1:0]   | RSVD[1:0]   |
| 0x9A pktcc_en | RSVD[1:0] | RSVD[1:0] | RSVD[1:0] | RSVD[1:0] | PKTCC_ EN | RSVD[1:0] |           |             | RSVD        |
...
| 0xC9         | rsvd_c9 RSVD[7:0] | rsvd_c9 RSVD[7:0] | rsvd_c9 RSVD[7:0] | rsvd_c9 RSVD[7:0] | rsvd_c9 RSVD[7:0] | rsvd_c9 RSVD[7:0] | rsvd_c9 RSVD[7:0] | rsvd_c9 RSVD[7:0] |       |
...
| 0xFF rsvd_ff | RSVD              | RSVD              | RSVD              | RSVD              | RSVD[3:0]         | RSVD[3:0]         | RSVD[3:0]         | RSVD[3:0]         |       |
...
| BIT         | 7   | 6   | 5   | 4         | 3         | 2         | 1         | 0         |
|-------------|-----|-----|-----|-----------|-----------|-----------|-----------|-----------|
| Field       |     |     |     | ID[7:0]   | ID[7:0]   | ID[7:0]   | ID[7:0]   | ID[7:0]   |
| Reset       |     |     |     | XXXXXXXXb | XXXXXXXXb | XXXXXXXXb | XXXXXXXXb | XXXXXXXXb |
...
| Reset       | 0b          | 0b            | 0b             | 01110b          | 01110b          | 01110b          | 01110b          | 01110b          |
| Access Type | Write, Read | Write, Read   | Write, Read    | Write, Read     | Write, Read     | Write, Read     | Write, Read     | Write, Read     |
...
| CROSS- BARVS   | 4:0    | Crossbar Setting VS: Select 1 of 16 input pins for VS. Default values connect VS with the correspond- ing named input pin. | 00000: Mux sync signal from DIN0 00001: Mux sync signal from DIN1 01111: Mux sync signal from DIN15 1XXXX: Do Not Use |
...
| BIT         | 7                 | 6      | 5            | 4           | 3            | 2           | 1           | 0           |
|-------------|-------------------|--------|--------------|-------------|--------------|-------------|-------------|-------------|
| Field       | LINE_CRC_LOC[1:0] |        | LINE_CRC_ EN | MAX_RT_ EN  | RSVD COMP_EN | GPI_        | GPI_RT_EN   | GPO_EN      |
...
| BIT         | 7           | 6           | 5           | 4           | 3           | 2           | 1           | 0           |
|-------------|-------------|-------------|-------------|-------------|-------------|-------------|-------------|-------------|
| Field       | DE_DLY[7:0] | DE_DLY[7:0] | DE_DLY[7:0] | DE_DLY[7:0] | DE_DLY[7:0] | DE_DLY[7:0] | DE_DLY[7:0] | DE_DLY[7:0] |
| Reset       | 00000000b   | 00000000b   | 00000000b   | 00000000b   | 00000000b   | 00000000b   | 00000000b   | 00000000b   |
| Access Type | Write, Read | Write, Read | Write, Read | Write, Read | Write, Read | Write, Read | Write, Read | Write, Read |
...
| BIT         | 7           | 6   | 5           | 4           | 3           | 2                 | 1                 | 0                 |
|-------------|-------------|-----|-------------|-------------|-------------|-------------------|-------------------|-------------------|
| Field       | RSVD[1:0]   |     | AUTO_ CLINK | RSVD        | RSVD        | DBL_ALIGN_TO[2:0] | DBL_ALIGN_TO[2:0] | DBL_ALIGN_TO[2:0] |
| Reset       | 11b         |     | 0b          | 0b          | 0b          | 111b              | 111b              | 111b              |
| Access Type | Write, Read |     | Write, Read | Write, Read | Write, Read | Write, Read       | Write, Read       | Write, Read       |
...
The CMOS parallel interface-data width is programmable and  depends  on  the  application.  Using  a  larger  width

Table 3. Input Data-Width Selection

| REGISTER BIT SETTINGS   | REGISTER BIT SETTINGS   | REGISTER BIT SETTINGS   | REGISTER BIT SETTINGS   | REGISTER BIT SETTINGS   | INPUT MAPPING (WITH 96706)   | INPUT MAPPING (WITH OTHER)   |
|-------------------------|-------------------------|-------------------------|-------------------------|-------------------------|------------------------------|------------------------------|
| DBL                     | BWS                     | HIBW                    | PXL_CRC                 | HVEN                    | INPUT MAPPING (WITH 96706)   | INPUT MAPPING (WITH OTHER)   |
...
(BWS  =  1)  results  in  a  lower-pixel  clock  rate,  while  a smaller width (BWS = 0) allows a higher-pixel clock rate.
...
1.  For  the  crossbar-output  equivalent  of  DIN0  (XBO0, XBO16)  select  which  pin  to  map  (e.g.,  DIN4 /.notdef XBI4, XBI20).
...
| BIT SETTING   | BIT SETTING   | BIT SETTING   | BIT SETTING   | BIT SETTING   | BIT SETTING   |
|---------------|---------------|---------------|---------------|---------------|---------------|

## Table 6. Crossbar Output to Serial Link Map (D31:24 and Special Packets)

| BIT   | BIT   | BIT   | BIT   | BIT   | BIT   | SETTING   | SETTING   | SETTING   | SETTING   | SETTING   | SETTING   | SETTING   | SETTING   | SPECIAL PACKETS   | SPECIAL PACKETS   | SPECIAL PACKETS   | SPECIAL PACKETS   | SPECIAL PACKETS   | SPECIAL PACKETS   | SPECIAL PACKETS   |
|-------|-------|-------|-------|-------|-------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-----------|-------------------|-------------------|-------------------|-------------------|-------------------|-------------------|-------------------|
...
## Control-Channel Interfaces I 2 C
...
The  I 2 C  interface  accepts  bit  rates  from  9.6kbps  to 1Mbps. The local I 2 C  rate  is  set  by  the  microcontroller.
...
The  remote  I 2 C  rate  is  set  by  the  remote  device.  By default, the control channel is set up for a 400kbps I 2 C bit rate. Program the I2C\_MSTBT and SLV\_SH bits (register 0x0D) to match the desired microcontroller I 2 C rate.

between links to prevent timeout. If a link is unused, keep the control channel clear by turning on the configuration link,  disconnecting  the  I 2 C  lines,  or  powering  down  the unused device.
...
In  base  mode,  the  UART  idles  high  (through  a  pullup resistor). Each GMSL UART byte consists of a START bit, 8 data bits, an even-parity bit, and a STOP bit (Figure 21). Keep the idle time between bytes of the same UART packet to less than 4 bit times. The GMSL-UART protocol is listed in Figure 22.  A write packet consists of a SYNC byte (Figure 23), device  address  byte,  starting  register  address  byte, number of bytes to write, and the data bytes. The slave device responds with an ACK byte (Figure 24) if the write
...
was successful. A read packet consists of a SYNC byte, device address byte, starting register address byte, and number of bytes to read. The slave device responds with an ACK byte, and the read data bytes.

## UART-to-I 2 C Conversion

When using the UART control channel, the remote-side device  can  communicate  to  I 2 C  peripherals  through UART-to-I 2 C conversion. Set the INTTYPE  bits in the  remote-side  device  to  00  to  activate  UART-to-I 2 C

conversion.  The  converted  I 2 C  bit  rate  is  the  same  as the incoming UART bit rate. I 2 C peripherals must not use clock stretching in order to be compatible with UART-toI 2 C conversion.

There  are  two  possible  methods  the  devices  use  to convert UART to I 2 C. In the first method (I2CMETHOD = 0), the register address is sent with the I 2 C communication  (Figure  25).  For  devices  that  do  not  use  a  register address  (such  as  the  MAX7324),  set  I2CMETHOD  =  1
...
and send a dummy byte in place of the register address (Figure 26). In this method, the remote device omits sending the register address.
...
| BWS=0MODE, PCLKIN FREQUENCY (MH z )   | BWS=1MODE, PCLKIN FREQUENCY (MH z )   | SERIAL LINK BIT RATE (MBPS)   | AVAILABLESPREADRATES   |
|---------------------------------------|---------------------------------------|-------------------------------|------------------------|
...
ESD  tolerance  is  rated  for  Human  Body  Model,  IEC 61000-4-2,  and  ISO  10605.  The  ISO  10605  and  IEC
...
61000-4-2 standards specify ESD tolerance for electronic systems. The serial outputs are rated for ISO 10605 ESD protection  and  IEC  61000-4-2  ESD  protection.  All  pins are tested for the Human Body Model. The Human Body Model discharge components are CS = 100pF and RD = 1.5kΩ ( Figure 27). The IEC 61000-4-2 discharge components are CS = 150pF and RD = 330Ω ( Figure 28). The ISO 10605 discharge components are CS = 330pF and RD = 2kΩ ( Figure 29).

## Compatibility with Other GMSL Devices

The  device  is  designed  to  pair  with  the  MAX96705MAX96711 family of devices, but interoperates with any GMSL device. See Table 12 for operating limitations.
...
In  addition,  several  multifunction  pins  are  controlled  by the  LCCEN  input.  When  LCCEN  =  1,  the  local  control channel  (RX/SDA,  TX/SCL)  is  active,  and  the  GPIO1/ BWS and MS/HVEN pins behave as GPIO1 and the MS input  respectively.  When  LCCEN  =  0,  the  local  control channel is disabled, and these pins operate as their alternate function (DBL, BWS, HVEN inputs).
...
The  serializer  includes  a  PRBS  pattern  generator  that works  with  bit-error  verification  in  the  deserializer.  To run  the  PRBS  test,  set  PRBSEN  =  1  (0x04,  D5)  in  the

## MAX96705

## 16-Bit GMSL Serializer with High-Immunity/ Bandwidth Mode and Coax/STP Cable Drive

deserializer,  then  in  the  serializer.  To  exit  the  PRBS test,  set  PRBSEN  =  0  (0x04,  D5)  in  the  serializer.  The deserializer automatically ends PRBS checking and sets the PRBS\_OK bit high. During PRBS mode, the forward control channel is not available except to exit PRBS mode if autoacknowledge is enabled in the deserializer;  otherwise, the remote control channel is not available at all.
...
typical delay of 275μs in legacy mode and 21μs in packet mode  (with  5-bit  CRC).  Skew  between  multiple  GPI/ GPO channels is 115μs (max) in legacy mode and 21μs (max) in packet mode. If a lower skew signal is required in  legacy  mode, connect the camera's frame-sync input to  one  of  the  serializer's  GPIOs  and  use  an  I 2 C  broadcast-write  command  to  change  the  GPIO  output  state. This  has  a  maximum  skew  of  1.5μs,  independent  from the  used  I 2 C  bit  rate.  In  packet-based  control-channel mode, set GPI\_COMP\_EN = 1 in both the serializer and deserializer  to  turn  on  GPI/GPO  compensation.  This reduces the device-to-device skew to 0.35μs.
...
The GPI and GPO provide a simple solution for camera applications  that  require  a  frame-sync  signal  from  the ECU  (e.g.,  surround-view  systems).  Connect  the  ECU frame-sync signal to the GPI input and connect the GPO output to the camera frame-sync input. GPI/GPO have a
...
|-----------------|-----------------|---------------|
| MAX96705GTJ+    | -40°C to +115°C | 32 TQFN-EP*   |
| MAX96705GTJ+T   | -40°C to +115°C | 32 TQFN-EP*   |
| MAX96705GTJ/V+  | -40°C to +115°C | 32 TQFN-EP*   |
| MAX96705GTJ/V+T | -40°C to +115°C | 32 TQFN-EP*   |
...
|                 1 | 2/17            | Added HIM software controls, fxed typos, disclosed hidden registers, and added three new variants in Ordering Information (MAX96705GTJ+, MAX96705GTJ+T, and MAX96705GTJ/V+T) | 6, 29, 30, 32, 33-36, 39, 45, 46, 48-50 57, 58, 63, 66, 68, 72, 76, 79, 80, 82 |
|               1.1 |                 | Corrected formatting                                                                                                                                                         | 29, 31                                                                         |
