...
(V BAT = +1.8V to +5.5V, C BAT\_EFF = 5μF, C BBOUT\_EFF = See Figure 34 , T A = -40°C to +85°C, unless otherwise noted. Typical values are at T A = +25°C, V BAT = +3.7V, L = 1μH, limits are 100% tested at T A = +25°C.) (Note 1))
...
| Output Voltage Set Range        | V BBOUT    | 50mVstep resolution                                                                                                        | 50mVstep resolution                                                                                                                                        | 1.5 to 5.5 | 1.5 to 5.5 | 1.5 to 5.5 | V       |
...
| Load Regulation Error           | V LOAD_REG | V BAT = 3.7V, V BBOUT = 5V, I BBOUT = 500mA, BBFetScale = 00, C BBOUT = refer to Figure 34 , I PSET1 = default,            | V BAT = 3.7V, V BBOUT = 5V, I BBOUT = 500mA, BBFetScale = 00, C BBOUT = refer to Figure 34 , I PSET1 = default,                                            | -2.5       | -2.5       | -2.5       | %       |
...
|-----------------------------------------------------------|----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------|-----------|-------|---------|
|                                                           |                | I PSET2 = 300mA, BBL2P2Sel = 0, L = 1µH (DFE201210U-1R0M)                                                                                                                                   |       |           |       |         |
...
| Line Transient Response                                   | V LINE_TRAN    | V BBOUT = 3.4V, V BAT from 3.4V to 2.9V, 1μs fall time, I LOAD = 1mA, C BBOUT = refer to Figure 34                                                                                          |       | 20        |       | mV      |
...
| Maximum Output Load Current during StartUp                | I PWR_MAX_STUP | V BAT > 2.5V, I PSET1 = default, I PSET2 = 300mA, I VLY_STUP min setting (BBIPwpMaxP = 0)                                                                                                   |       | 40        |       | mA      |
...
| PARAMETER                                              | SYMBOL        | CONDITIONS/COMMENTS                                           | MIN           | TYP           | MAX           | UNITS   |
|--------------------------------------------------------|---------------|---------------------------------------------------------------|---------------|---------------|---------------|---------|
| Nominal Falling Voltage Scaling                        |               | BBFetScale = 00, 50mA steps                                   | -200 to -1800 | -200 to -1800 | -200 to -1800 | mA      |
| Dynamic Valley Inductor Current Limit Range            | I DVSF        | BBFetScale = 01 or 10, 25mA steps                             | -200 to -1000 | -200 to -1000 | -200 to -1000 | mA      |
| Dynamic Valley Inductor Current Limit Range            |               | BBFetScale = 11, 12.5mA steps                                 | -100 to -500  | -100 to -500  | -100 to -500  | mA      |
| Active Discharge Current                               | I ACTD        | Applied on BBOUTfor 50ms after shutdown if BBstActDsc = 1     | 20            | 20            | 20            | mA      |
| Passive Discharge Resistance                           | R PSVD        | AppliedonBBOUT after shutdown, if BBstPsvDsc = 1 or EN is low | 1.3           | 1.3           | 1.3           | kΩ      |
| Output UVLO                                            | V OUT_UVLO_F  | V BBOUT falling                                               | 1 1.1         | 1 1.1         | 1 1.1         | V       |
| Output UVLO                                            | V OUT_UVLO_R  | V BBOUT rising                                                | 1.13          |               | 1.25          | V       |
| VDDA UVLO                                              | V VDDA_UVLO_R | V VDDA rising                                                 |               | 1.658         | 1.7           | V       |
| VDDA UVLO                                              | V VDDA_UVLO_F | V VDDA falling                                                | 1.6 1.642     | 1.6 1.642     | 1.6 1.642     | V       |
| LXA, LXB Leakage                                       | I LX_LKG      | EN is low                                                     | 2.5           | 2.5           |               | µA      |
| BST1, BST2 Leakage                                     | I BST_LKG     | EN is low                                                     | 4.5           | 4.5           |               | µA      |
| BBOUTLeakage                                           | I BBOUT_LKG   | EN is high and BBstEna = 0                                    | 1             | 1             |               | µA      |
| DIGITAL                                                | DIGITAL       | DIGITAL                                                       | DIGITAL       | DIGITAL       | DIGITAL       | DIGITAL |
| SDA, SCL, EN, INT , DVSIN, CLKIN Input Leakage Current | I LK_IO       |                                                               | -1            | -1            | +1            | µA      |
| SDA, SCL, EN, DVSIN, CLKIN Input Logic High            | V IO_IH       |                                                               | 1.4           | 1.4           | 1.4           | V       |
| SDA, SCL, EN, DVSIN, CLKIN Input LogicLow              | V IO_IL       |                                                               | 0.4           | 0.4           |               | V       |
| INT Output LogicLow                                    | V IO_OL_INT   | I OL = 4mA                                                    | 0.4           | 0.4           |               | V       |
| SDA Output LogicLow                                    | V IO_OL_SDA   | I OL = 20mA                                                   | 0.4           | 0.4           |               | V       |
| SCL Clock Frequency                                    | f SCL         |                                                               | 0             | 0             | 1             | MHz     |
...
| LowPeriod of SCL Clock                         | t LOW      |                       |   0.5 |       |       | µs      |
...
| CLKINPulse Width High                          | t HIGH_SPI |                       |    20 |    20 |    20 | ns      |
...
|----------------|--------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| A1             | BAT    | Input Supply. Bypass to GNDwith effective capacitance at least the maximumbetween 5μF and the value of the derating curve ( Figure 34 ) for a bias voltage V BAT , placed as close to the device as possible. |
| A2             | LXA    | Switching Node A. Connect through 1µHor 2.2µH inductor to LXB.                                                                                                                                                |
...
| A6             | SDA    | I 2 C Serial Data Input/Open-Drain Output. Connect to GNDwhennotinuse.                                                                                                                                        |
| B1, B2, B3, B4 | GND    | Ground                                                                                                                                                                                                        |
| B5             | EN     | Enable. Active-high.                                                                                                                                                                                          |
| B6             | SCL    | I 2 C Serial Clock Input. Connect to GNDwhennotinuse.                                                                                                                                                         |
...
| C2             | LXB    | Switching Node B. Connect through 1µHor 2.2µH inductor to LXA.                                                                                                                                                |

<!-- image -->

| C3   | BST2   | Boostrap Cap 2. Connect through 100nF capacitor to LXB, placed as close to the device as possible.          |
|------|--------|-------------------------------------------------------------------------------------------------------------|
| C4   | CLKIN  | Dedicated SPI Clock Input. Connect to GNDwhennotin use.                                                     |
| C5   | DVSIN  | Dedicated SPI DVS Input. Connect to GNDwhennotinuse.                                                        |
| C6   | INT    | Interrupt Open-Drain Output. Active low. Externally connect through pullup resistor to system logic supply. |

## TYPICAL PERFORMANCE CHARACTERISTICS

(VBAT = +3.7V, C BAT = C BBOUT = 22µF, refer to Figure 34 single capacitor derating, L = 1µH, BBstLowEMIB = 1, BBstIpPadPEnb = 0, BBFetScale = 0, TA = +25°C, unless otherwise noted.)
...
Figure 25. Pseudo-SPI DVS Transitions in MultiMeasurement
...
| 0x55       | RRCfg1[7:0]                 | -                           | RRClkPola rity              | RRTimeoutRe s               | RRSize[4:0]                 | RRSize[4:0]                 | RRSize[4:0]                 | RRSize[4:0]                 | RRSize[4:0]                 |
...
| BIT         | 7   | 6   | 5            | 4            | 3            | 2            | 1            | 0            |
|-------------|-----|-----|--------------|--------------|--------------|--------------|--------------|--------------|
| Field       | -   | -   | BBIMaxP[5:0] | BBIMaxP[5:0] | BBIMaxP[5:0] | BBIMaxP[5:0] | BBIMaxP[5:0] | BBIMaxP[5:0] |
| Reset       | -   | -   |              |              |              |              |              |              |
| Access Type | -   | -   | Write, Read  | Write, Read  | Write, Read  | Write, Read  | Write, Read  | Write, Read  |
...
| BIT         | 7   | 6   | 5   | 4              | 3              | 2              | 1              | 0              |
|-------------|-----|-----|-----|----------------|----------------|----------------|----------------|----------------|
| Field       | -   | -   | -   | RRPointer[4:0] | RRPointer[4:0] | RRPointer[4:0] | RRPointer[4:0] | RRPointer[4:0] |
| Reset       | -   | -   | -   |                |                |                |                |                |
...
| REGISTER BITS   | MAX20363A       | MAX20363B       |
|-----------------|-----------------|-----------------|
| BBstLowEMIB     | Nominal Slope   | Nominal Slope   |
| BBstEna         | Enabled         | Disabled        |
| BBstFast        | Disabled        | Disabled        |
| BBFHighSh       | Enabled         | Enabled         |
| BBstActDsc      | Enabled         | Enabled         |
| BBstPsvDsc      | Enabled         | Enabled         |
| BBstFpwm        | Disabled        | Disabled        |
| BBstVSet        | 5V              | 5V              |
| BBstIPSet2      | 300mA           | 300mA           |
| BBstIPSet1      | 400mA           | 400mA           |
| BBIMaxN         | -1000mA         | -1000mA         |
| BBIMaxP         | 1000mA          | 1000mA          |
| BBIPwpMaxP      | 750mA           | 50mA            |
| ChgModDoneMsk   | Not Masked      | Not Masked      |
| BBstOnMsk       | Not Masked      | Not Masked      |
| BBL2P2Sel       | 1µH Inductor    | 1µH Inductor    |
| BBstIpPadPEnb   | Enabled         | Enabled         |
| BBFetScale      | Full Power FETS | Full Power FETS |

| LtchOffVddUvlo   | Autoretry enabled   | Autoretry enabled   |
|------------------|---------------------|---------------------|
| LtchOffBBOutUvlo | Autoretry Enabled   | Autoretry Enabled   |
| LtchOffBst       | Autoretry Enabled   | Autoretry Enabled   |
| LtchOffThm       | Autoretry Enabled   | Autoretry Enabled   |
| FpwmFast         | Fast                | Fast                |
| SPITimeoutEna    | Enabled             | Enabled             |
| DVSSource        | I 2 C               | I 2 C               |
| i2c_2nd_sid      | 0x68                | 0x68                |
| IPm60M50         | 300mA               | 300mA               |
| IPm50            | 250mA               | 250mA               |
| IPM70            | 400mA               | 400mA               |
| IPm70M60         | 350mA               | 350mA               |
| IPPwp2           | 200mA               | 200mA               |
| IPPwp1           | 200mA               | 200mA               |

Table 6. Register Default Values

| REGISTER   | NAME         | MAX20363A   | MAX20363B   |
|------------|--------------|-------------|-------------|
| 0x00       | ChipID       | 0x02        | 0x02        |
| 0x01       | BBstCfg0     | 0x6F        | 0x4F        |
| 0x02       | BBstVSet     | 0x46        | 0x46        |
| 0x03       | BBstISet     | 0xCC        | 0xCC        |
| 0x04       | BBstIMaxN    | 0x10        | 0x10        |
| 0x05       | BBstIMaxP    | 0x14        | 0x14        |
| 0x06       | BBstIPwpMaxP | 0x0F        | 0x01        |
| 0x08       | BBstCfg1     | 0x00        | 0x00        |
| 0x10       | Status       | -           | -           |
| 0x11       | Int          | 0x00        | 0x00        |
| 0x12       | Mask         | 0x10        | 0x10        |
| 0x13       | CommInt      | 0x00        | 0x00        |
| 0x14       | CommMsk      | 0x00        | 0x00        |
| 0x15       | BBFsmState   | -           | -           |
| 0x1E       | BBVset       | 0x46        | 0x46        |
| 0x1F       | RRpoint      | 0x00        | 0x00        |
| 0x20       | RRVset00     | 0x00        | 0x00        |
| 0x21       | RRVset01     | 0x00        | 0x00        |
| 0x22       | RRVset02     | 0x00        | 0x00        |
| 0x23       | RRVset03     | 0x00        | 0x00        |
| 0x24       | RRVset04     | 0x00        | 0x00        |
| 0x25       | RRVset05     | 0x00        | 0x00        |
| 0x26       | RRVset06     | 0x00        | 0x00        |
| 0x27       | RRVset07     | 0x00        | 0x00        |

| 0x28   | RRVset08   | 0x00   | 0x00   |
|--------|------------|--------|--------|
| 0x29   | RRVset09   | 0x00   | 0x00   |
| 0x2A   | RRVset0A   | 0x00   | 0x00   |
| 0x2B   | RRVset0B   | 0x00   | 0x00   |
| 0x2C   | RRVset0C   | 0x00   | 0x00   |
| 0x2D   | RRVset0D   | 0x00   | 0x00   |
| 0x2E   | RRVset0E   | 0x00   | 0x00   |
| 0x2F   | RRVset0F   | 0x00   | 0x00   |
| 0x30   | RRVset10   | 0x00   | 0x00   |
| 0x31   | RRVset11   | 0x00   | 0x00   |
| 0x32   | RRVset12   | 0x00   | 0x00   |
| 0x33   | RRVset13   | 0x00   | 0x00   |
| 0x50   | LockMsk    | 0x01   | 0x01   |
| 0x51   | LockUnlock | -      | -      |
| 0x54   | DVSCfg     | 0x00   | 0x00   |
| 0x55   | RRCfg1     | 0x00   | 0x00   |
| 0x56   | RRCfg2     | 0x00   | 0x00   |
| 0x57   | SPICfg     | 0x01   | 0x01   |
| 0x6E   | ConfOtp    | 0x08   | 0x08   |
| 0x6F   | FuncDef    | 0x00   | 0x00   |
...
| MAX20363BEWN+  | -40°C to +85°C     | 18 WLP(2.43mm x 1.25mm) | W181A2+1         |
| MAX20363BEWN+T | -40°C to +85°C     | 18 WLP(2.43mm x 1.25mm) | W181A2+1         |
...
|                 2 | 6/26            | Updated Table 5 and Table 6 | 46, 47, 48      |
|                 3 | 8/26            | Updated Table 7             | 49              |
