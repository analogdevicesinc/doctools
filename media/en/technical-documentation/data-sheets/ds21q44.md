...
- /g167/g32 Four E1 (CEPT or PCM-30)/ISDN-PRI framing transceivers
- /g167/g32 All four framers are fully independent; transmit and receive sections of each framer are fully independent
- /g167/g32 Frames to FAS, CAS, CCS, and CRC4 formats
- /g167/g32 Each of the four framers contain dual twoframe elastic store slip buffers that can connect to asynchronous backplanes up to 8.192MHz
...
- /g167/g32 Easy access to Si and Sa bits
- /g167/g32 Extracts and inserts CAS signaling
- /g167/g32 Large counters for bipolar and code violations, CRC4 code word errors, FAS word errors, and E-bits
- /g167/g32 Programmable output clocks for Fractional E1, per channel loopback, H0 and H12 applications
- /g167/g32 Integral HDLC controller with 64-byte buffers configurable for Sa bits or DS0 operation
- /g167/g32 Detects and generates AIS, remote alarm, and remote multiframe alarms
- /g167/g32 Pin compatible with DS21Q42 enhanced quad T1 framer
- /g167/g32 3.3V supply with 5V tolerant I/O; low-power CMOS
- /g167/g32 Available in 128-pin TQFP package
...
1.Alternate pinfunctions.Consult data sheetfor restrictions.
...
| 10.1 PROCESSOR-BASED SIGNALING........................................................................................46 10.2 HARDWARE-BASED SIGNALING........................................................................................49 |                                                                                                                                                |
...
| 19. OPERATING PARAMETERS .......................................................................................................92 20. 128-PIN TQFP PACKAGE SPECIFICATIONS ........................................................................105 |
...
| 052300 | /g167 Changed explanation on JTRST test access port pin. /g167 All instances of JTRST* changed to JTRST. /g167 Corrected errors in the JTAG portion of data sheet. |
...
|    17 | RFSYNC0         | O      | Receive Frame Sync from Framer 0                                |
|    51 | RFSYNC1         | O      | Receive Frame Sync from Framer 1                                |
|    85 | RFSYNC2 RFSYNC3 | O      | Receive Frame Sync from Framer 2 Receive Frame Sync from Framer |
|   109 |                 | O      | 3                                                               |
...
A 256-kHz clock which pulses high during the LSB of each channel.  Synchronous with RCLK when the receive side elastic store is disabled.  Synchronous with RSYSCLK when the receive side elastic store is enabled.  Useful for parallel to serial conversion of channel data.  This function is available when FMS = 1 (DS21Q43 emulation).
...
An extracted pulse, one RSYSCLK wide, is output at this pin which identifies multiframe boundaries.  If the receive side elastic store is disabled, then this output will output multiframe boundaries associated with RCLK.  This function is available when FMS = 1 (DS21Q43 emulation).
...
asynchronously reset the test access port controller.  The device enters the DEVICE ID MODE when JTRST is pulled high.  The device enters the DEVICE ID MODE when JTRST is pulled high.  The device operates as a T1/E1 transceiver if JTRST is pulled low.
...
| 1F        | R     | Receive Nonalign Frame                 | RNAF                    |
...
| 51        | R/W   | Transmit Si Bits Nonalign Frame | TSiNAF                  |
...
| 59        | R     | Receive Si bits Nonalign Frame | RSiNAF                  |
...
Note: See Figure 18-15 for more details about how the Transmit Control Registers affect the operation of the DS21Q44.
...
| SYMBOL   | POSITION   | NAME AND DESCRIPTION                                                                                                                      |
|----------|------------|-------------------------------------------------------------------------------------------------------------------------------------------|
| ODM      | TCR2.2     | Output Data Mode. 0 = pulses at TPOS and TNEG are one full TCLK period wide 1 = pulses at TPOSO and TNEGO are 1/2 TCLKO period wide       |
...
| RSRE     | CCR3.3     | Receive Side Signaling Re-Insertion Enable. See Section 10 for details. 0=do not re-insert signaling bits into the data stream presented at the RSER pin 1=re-insert the signaling bits into data stream presented at the                                     |
| THSE     | CCR3.2     | Transmit Side Hardware Signaling Insertion Enable. See Section 10 for details. 0=do not insert signaling from the TSIG pin into the data stream presented at the TSER pin 1=insert signaling from the TSIG pin into the data stream presented at the TSER pin |
...
| TCM4     | CCR4.4     | Transmit Channel Monitor Bit 4 . MSB of a channel decode that deter-mines which transmit channel data will appear in the TDS0M register. See Section 9 or details. |
...
|---------|----------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| -       | -        | -                                                                                                                                                                                                                                                                            | -                                                                                                                                                                                                                                                                            |                                                                                                                                                                                                                                                                              | TESR                                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                           |
| SYMBOL  | POSITION | NAME AND DESCRIPTION                                                                                                                                                                                                                                                         | NAME AND DESCRIPTION                                                                                                                                                                                                                                                         | NAME AND DESCRIPTION                                                                                                                                                                                                                                                         | NAME AND DESCRIPTION                                                                                                                                                                                                                                      |                                                                                                                                                                                                                                                           |
| -       | CCR6.7   | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                          |                                                                                                                                                                                                                                                           |
| -       | CCR6.6   | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                          |                                                                                                                                                                                                                                                           |
| -       | CCR6.5   | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                          |                                                                                                                                                                                                                                                           |
| -       | CCR6.4   | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                          |                                                                                                                                                                                                                                                           |
| -       | CCR6.3   | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                                             | Not Assigned. Should be set to zero when written                                                                                                                                                                                                          |                                                                                                                                                                                                                                                           |
| TCLKSRC | CCR6.2   | Transmit Clock Source Select. This function allows the user to internally select RCLK as the clock source for the transmit side formatter. 0 = Transmit side formatter clocked with signal applied at TCLK pin. LOTC Mux function is operational (TCR1.7)                    | Transmit Clock Source Select. This function allows the user to internally select RCLK as the clock source for the transmit side formatter. 0 = Transmit side formatter clocked with signal applied at TCLK pin. LOTC Mux function is operational (TCR1.7)                    | Transmit Clock Source Select. This function allows the user to internally select RCLK as the clock source for the transmit side formatter. 0 = Transmit side formatter clocked with signal applied at TCLK pin. LOTC Mux function is operational (TCR1.7)                    | Transmit Clock Source Select. This function allows the user to internally select RCLK as the clock source for the transmit side formatter. 0 = Transmit side formatter clocked with signal applied at TCLK pin. LOTC Mux function is operational (TCR1.7) | Transmit Clock Source Select. This function allows the user to internally select RCLK as the clock source for the transmit side formatter. 0 = Transmit side formatter clocked with signal applied at TCLK pin. LOTC Mux function is operational (TCR1.7) |
| RESR    | CCR6.1   | 1 = Transmit side formatter clocked with RCLK. Receive Elastic Store Reset. Setting this bit from a one will force the receive elastic store to a depth of one Receive data is lost during the reset. Should be toggled RSYSCLK has been applied and is stable. Do not leave | 1 = Transmit side formatter clocked with RCLK. Receive Elastic Store Reset. Setting this bit from a one will force the receive elastic store to a depth of one Receive data is lost during the reset. Should be toggled RSYSCLK has been applied and is stable. Do not leave | 1 = Transmit side formatter clocked with RCLK. Receive Elastic Store Reset. Setting this bit from a one will force the receive elastic store to a depth of one Receive data is lost during the reset. Should be toggled RSYSCLK has been applied and is stable. Do not leave | zero to a frame. after this bit                                                                                                                                                                                                                           |                                                                                                                                                                                                                                                           |
| TESR    | CCR6.0   | set high. Transmit Elastic Store Reset. Setting this bit from a one will force the transmit elastic store to a depth of one Transmit data is lost during the reset. Should be toggled                                                                                        | set high. Transmit Elastic Store Reset. Setting this bit from a one will force the transmit elastic store to a depth of one Transmit data is lost during the reset. Should be toggled                                                                                        | set high. Transmit Elastic Store Reset. Setting this bit from a one will force the transmit elastic store to a depth of one Transmit data is lost during the reset. Should be toggled                                                                                        | zero to a frame. after leave this bit                                                                                                                                                                                                                     |                                                                                                                                                                                                                                                           |
...
| F3HDLC   | F3SR   | F2HDLC   | F2SR                                                                                                                                   | F1HDLC                                                                                                                                 | F1SR                                                                                                                                   | F0HDLC                                                                                                                                 |                                                                                                                                        |
|----------|--------|----------|----------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
...
| F3HDLC   | F3HDLC | ISR.7    | FRAMER 3 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                                                          | FRAMER 3 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                                                          | FRAMER 3 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                                                          | FRAMER 3 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                                                          | FRAMER 3 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                                                          |
| F3SR     | F3SR   | ISR.6    | 1 = Interrupt request pending. FRAMER 3 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                | 1 = Interrupt request pending. FRAMER 3 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                | 1 = Interrupt request pending. FRAMER 3 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                | 1 = Interrupt request pending. FRAMER 3 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                | 1 = Interrupt request pending. FRAMER 3 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                |
| F2HDLC   | F2HDLC | ISR.5    | 1 = Interrupt request pending. FRAMER 2 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                           | 1 = Interrupt request pending. FRAMER 2 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                           | 1 = Interrupt request pending. FRAMER 2 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                           | 1 = Interrupt request pending. FRAMER 2 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                           | 1 = Interrupt request pending. FRAMER 2 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                           |
| F2SR     | F2SR   | ISR.4    | 1 = Interrupt request pending. FRAMER 2 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                | 1 = Interrupt request pending. FRAMER 2 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                | 1 = Interrupt request pending. FRAMER 2 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                | 1 = Interrupt request pending. FRAMER 2 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                | 1 = Interrupt request pending. FRAMER 2 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                |
| F1HDLC   | F1HDLC | ISR.3    | 1 = Interrupt request pending. FRAMER 1 HDLC CONTROLLER INTERRUPT REQUEST.                                                             | 1 = Interrupt request pending. FRAMER 1 HDLC CONTROLLER INTERRUPT REQUEST.                                                             | 1 = Interrupt request pending. FRAMER 1 HDLC CONTROLLER INTERRUPT REQUEST.                                                             | 1 = Interrupt request pending. FRAMER 1 HDLC CONTROLLER INTERRUPT REQUEST.                                                             | 1 = Interrupt request pending. FRAMER 1 HDLC CONTROLLER INTERRUPT REQUEST.                                                             |
| F1SR     | F1SR   | ISR.2    | FRAMER 1 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                                               | FRAMER 1 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                                               | FRAMER 1 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                                               | FRAMER 1 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                                               | FRAMER 1 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending.                                                               |
| F0HDLC   | F0HDLC | ISR.1    | 1 = Interrupt request pending. FRAMER 0 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                           | 1 = Interrupt request pending. FRAMER 0 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                           | 1 = Interrupt request pending. FRAMER 0 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                           | 1 = Interrupt request pending. FRAMER 0 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                           | 1 = Interrupt request pending. FRAMER 0 HDLC CONTROLLER INTERRUPT REQUEST. 0 = No interrupt request pending.                           |
| F0SR     | F0SR   | ISR.0    | 1 = Interrupt request pending. FRAMER 0 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending. 1 = Interrupt request pending. | 1 = Interrupt request pending. FRAMER 0 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending. 1 = Interrupt request pending. | 1 = Interrupt request pending. FRAMER 0 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending. 1 = Interrupt request pending. | 1 = Interrupt request pending. FRAMER 0 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending. 1 = Interrupt request pending. | 1 = Interrupt request pending. FRAMER 0 SR1 or SR2 INTERRUPT REQUEST. 0 = No interrupt request pending. 1 = Interrupt request pending. |
...
| CSC5   | CSC3     |                                                                                             | CASSA                                                                                       | CRC4SA                                                                                      |                                                                                             |                                                                                             |
|--------|----------|---------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------|
| SYMBOL | POSITION | NAME AND DESCRIPTION                                                                        | NAME AND DESCRIPTION                                                                        | NAME AND DESCRIPTION                                                                        | NAME AND DESCRIPTION                                                                        | NAME AND DESCRIPTION                                                                        |
| CSC5   | SSR.7    | CRC4 Sync Counter Bit 5. MSB of the 6-bit counter.                                          | CRC4 Sync Counter Bit 5. MSB of the 6-bit counter.                                          | CRC4 Sync Counter Bit 5. MSB of the 6-bit counter.                                          | CRC4 Sync Counter Bit 5. MSB of the 6-bit counter.                                          | CRC4 Sync Counter Bit 5. MSB of the 6-bit counter.                                          |
| CSC4   | SSR.6    | CRC4 Sync Counter Bit 4.                                                                    | CRC4 Sync Counter Bit 4.                                                                    | CRC4 Sync Counter Bit 4.                                                                    | CRC4 Sync Counter Bit 4.                                                                    | CRC4 Sync Counter Bit 4.                                                                    |
| CSC3   | SSR.5    | CRC4 Sync Counter Bit 3.                                                                    | CRC4 Sync Counter Bit 3.                                                                    | CRC4 Sync Counter Bit 3.                                                                    | CRC4 Sync Counter Bit 3.                                                                    | CRC4 Sync Counter Bit 3.                                                                    |
| CSC2   | SSR.4    | CRC4 Sync Counter Bit 2.                                                                    | CRC4 Sync Counter Bit 2.                                                                    | CRC4 Sync Counter Bit 2.                                                                    | CRC4 Sync Counter Bit 2.                                                                    | CRC4 Sync Counter Bit 2.                                                                    |
| CSC0   | SSR.3    | CRC4 Sync Counter Bit 0. LSB of the 6-bit counter. The next to LSB is not accessible.       | CRC4 Sync Counter Bit 0. LSB of the 6-bit counter. The next to LSB is not accessible.       | CRC4 Sync Counter Bit 0. LSB of the 6-bit counter. The next to LSB is not accessible.       | CRC4 Sync Counter Bit 0. LSB of the 6-bit counter. The next to LSB is not accessible.       | CRC4 Sync Counter Bit 0. LSB of the 6-bit counter. The next to LSB is not accessible.       |
| FASSA  | SSR.2    | FAS Sync Active. Set while the synchronizer is searching for alignment at the FAS level.    | FAS Sync Active. Set while the synchronizer is searching for alignment at the FAS level.    | FAS Sync Active. Set while the synchronizer is searching for alignment at the FAS level.    | FAS Sync Active. Set while the synchronizer is searching for alignment at the FAS level.    | FAS Sync Active. Set while the synchronizer is searching for alignment at the FAS level.    |
| CASSA  | SSR.1    | CAS MFSync Active. Set while the synchronizer is searching for the CAS MF alignment word.   | CAS MFSync Active. Set while the synchronizer is searching for the CAS MF alignment word.   | CAS MFSync Active. Set while the synchronizer is searching for the CAS MF alignment word.   | CAS MFSync Active. Set while the synchronizer is searching for the CAS MF alignment word.   | CAS MFSync Active. Set while the synchronizer is searching for the CAS MF alignment word.   |
| CRC4SA | SSR.0    | CRC4 MFSync Active. Set while the synchronizer is searching for the CRC4 MF alignment word. | CRC4 MFSync Active. Set while the synchronizer is searching for the CRC4 MF alignment word. | CRC4 MFSync Active. Set while the synchronizer is searching for the CRC4 MF alignment word. | CRC4 MFSync Active. Set while the synchronizer is searching for the CRC4 MF alignment word. | CRC4 MFSync Active. Set while the synchronizer is searching for the CRC4 MF alignment word. |
...
|--------|--------|----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SYMBOL | SYMBOL | POSITION | NAME AND DESCRIPTION                                                                                                                                                                                                                                                       | NAME AND DESCRIPTION                                                                                                                                                                                                                                                       | NAME AND DESCRIPTION                                                                                                                                                                                                                                                       | NAME AND DESCRIPTION                                                                                                                                                                                                                                                       | NAME AND DESCRIPTION                                                                                                                                                                                                                                                       |
| RSA1   | RSA1   | SR1.7    | Receive Signaling All Ones / Signaling Change. Set when over a full MF, the content of timeslot 16 contains less than three zeros. This alarm is not disabled in the CCS signaling mode. A change in the contents of RS1 through RS16 from one                             | Receive Signaling All Ones / Signaling Change. Set when over a full MF, the content of timeslot 16 contains less than three zeros. This alarm is not disabled in the CCS signaling mode. A change in the contents of RS1 through RS16 from one                             | Receive Signaling All Ones / Signaling Change. Set when over a full MF, the content of timeslot 16 contains less than three zeros. This alarm is not disabled in the CCS signaling mode. A change in the contents of RS1 through RS16 from one                             | Receive Signaling All Ones / Signaling Change. Set when over a full MF, the content of timeslot 16 contains less than three zeros. This alarm is not disabled in the CCS signaling mode. A change in the contents of RS1 through RS16 from one                             | Receive Signaling All Ones / Signaling Change. Set when over a full MF, the content of timeslot 16 contains less than three zeros. This alarm is not disabled in the CCS signaling mode. A change in the contents of RS1 through RS16 from one                             |
| RDMA   | RDMA   | SR1.6    | Receive Distant MFAlarm. Set when bit-6 of timeslot 16 in frame 0 has been set for two consecutive multiframes. This                                                                                                                                                       | Receive Distant MFAlarm. Set when bit-6 of timeslot 16 in frame 0 has been set for two consecutive multiframes. This                                                                                                                                                       | Receive Distant MFAlarm. Set when bit-6 of timeslot 16 in frame 0 has been set for two consecutive multiframes. This                                                                                                                                                       | Receive Distant MFAlarm. Set when bit-6 of timeslot 16 in frame 0 has been set for two consecutive multiframes. This                                                                                                                                                       | Receive Distant MFAlarm. Set when bit-6 of timeslot 16 in frame 0 has been set for two consecutive multiframes. This                                                                                                                                                       |
| RSA0   | RSA0   | SR1.5    | alarm is not disabled in the CCS signaling mode. Receive Signaling All Zeros / Signaling Change. Set when over a full MF, timeslot 16 contains all zeros. A change in the contents of RS1 through RS16 from one multiframe to the next will cause RSA1 and RSA0 to be set. | alarm is not disabled in the CCS signaling mode. Receive Signaling All Zeros / Signaling Change. Set when over a full MF, timeslot 16 contains all zeros. A change in the contents of RS1 through RS16 from one multiframe to the next will cause RSA1 and RSA0 to be set. | alarm is not disabled in the CCS signaling mode. Receive Signaling All Zeros / Signaling Change. Set when over a full MF, timeslot 16 contains all zeros. A change in the contents of RS1 through RS16 from one multiframe to the next will cause RSA1 and RSA0 to be set. | alarm is not disabled in the CCS signaling mode. Receive Signaling All Zeros / Signaling Change. Set when over a full MF, timeslot 16 contains all zeros. A change in the contents of RS1 through RS16 from one multiframe to the next will cause RSA1 and RSA0 to be set. | alarm is not disabled in the CCS signaling mode. Receive Signaling All Zeros / Signaling Change. Set when over a full MF, timeslot 16 contains all zeros. A change in the contents of RS1 through RS16 from one multiframe to the next will cause RSA1 and RSA0 to be set. |
| RSLIP  | RSLIP  | SR1.4    | Receive Side Elastic Store Slip. Set when the elastic store has either repeated or deleted a frame of data.                                                                                                                                                                | Receive Side Elastic Store Slip. Set when the elastic store has either repeated or deleted a frame of data.                                                                                                                                                                | Receive Side Elastic Store Slip. Set when the elastic store has either repeated or deleted a frame of data.                                                                                                                                                                | Receive Side Elastic Store Slip. Set when the elastic store has either repeated or deleted a frame of data.                                                                                                                                                                | Receive Side Elastic Store Slip. Set when the elastic store has either repeated or deleted a frame of data.                                                                                                                                                                |
| RUA1   | RUA1   | SR1.3    | Receive Unframed All Ones. Set when an unframed all ones code is received at RPOS and RNEG.                                                                                                                                                                                | Receive Unframed All Ones. Set when an unframed all ones code is received at RPOS and RNEG.                                                                                                                                                                                | Receive Unframed All Ones. Set when an unframed all ones code is received at RPOS and RNEG.                                                                                                                                                                                | Receive Unframed All Ones. Set when an unframed all ones code is received at RPOS and RNEG.                                                                                                                                                                                | Receive Unframed All Ones. Set when an unframed all ones code is received at RPOS and RNEG.                                                                                                                                                                                |
| RRA    | RRA    | SR1.2    | Receive Remote Alarm. Set when a remote alarm is received at RPOS and RNEG.                                                                                                                                                                                                | Receive Remote Alarm. Set when a remote alarm is received at RPOS and RNEG.                                                                                                                                                                                                | Receive Remote Alarm. Set when a remote alarm is received at RPOS and RNEG.                                                                                                                                                                                                | Receive Remote Alarm. Set when a remote alarm is received at RPOS and RNEG.                                                                                                                                                                                                | Receive Remote Alarm. Set when a remote alarm is received at RPOS and RNEG.                                                                                                                                                                                                |
| RCL    | RCL    | SR1.1    | Receive Carrier Loss. Set when 255 (or 2048 if CCR3.0=1) consecutive zeros have been detected at RPOS and RNEG.                                                                                                                                                            | Receive Carrier Loss. Set when 255 (or 2048 if CCR3.0=1) consecutive zeros have been detected at RPOS and RNEG.                                                                                                                                                            | Receive Carrier Loss. Set when 255 (or 2048 if CCR3.0=1) consecutive zeros have been detected at RPOS and RNEG.                                                                                                                                                            | Receive Carrier Loss. Set when 255 (or 2048 if CCR3.0=1) consecutive zeros have been detected at RPOS and RNEG.                                                                                                                                                            | Receive Carrier Loss. Set when 255 (or 2048 if CCR3.0=1) consecutive zeros have been detected at RPOS and RNEG.                                                                                                                                                            |
| RLOS   | RLOS   | SR1.0    | Receive Loss of Sync. Set when the device is not synchronized to the receive E1 stream.                                                                                                                                                                                    | Receive Loss of Sync. Set when the device is not synchronized to the receive E1 stream.                                                                                                                                                                                    | Receive Loss of Sync. Set when the device is not synchronized to the receive E1 stream.                                                                                                                                                                                    | Receive Loss of Sync. Set when the device is not synchronized to the receive E1 stream.                                                                                                                                                                                    | Receive Loss of Sync. Set when the device is not synchronized to the receive E1 stream.                                                                                                                                                                                    |
...
| LOTC     | SR2.2      | Loss of Transmit Clock. Set when the TCLK pin has not transitioned for one channel time (or 3.9 s). Will force the LOTC pin high if enabled via TCR2.0.                            |
...
FASCR2: FAS ERROR COUNT REGISTER 2
...
| SYMBOL     | POSITION          | NAME AND DESCRIPTION                                                |
|------------|-------------------|---------------------------------------------------------------------|
| FAS11 FAS0 | FASCR1.7 FASCR2.2 | MSB of the 12-Bit FAS Error Count LSB of the 12-Bit FAS Error Count |
...
| (MSB)   |       |       |       |       |       |         | (LSB)   |           |
|---------|-------|-------|-------|-------|-------|---------|---------|-----------|
| 0       | 0     | 0     | 0     | X     | Y     | X C(16) | X D(16) | RS1 (30)  |
| A(1)    | B(1)  | C(1)  | D(1)  | A(16) | B(16) |         |         | RS2 (31)  |
...
| (MSB)   |      |      |      |      |          |          | (LSB)   |           |
|---------|------|------|------|------|----------|----------|---------|-----------|
| CH8     | CH7  | CH6  | CH5  | CH4  | CH3 CH11 | CH2 CH10 | CH1     | TIR1 (26) |
| CH16    | CH15 | CH14 | CH13 | CH12 |          |          | CH9     | TIR2 (27) |
...
| (MSB)   |      |      |      |      |          |      | (LSB)   |            |
|---------|------|------|------|------|----------|------|---------|------------|
| CH8     | CH7  | CH6  | CH5  | CH4  | CH3 CH11 | CH2  | CH1     | RCBR1 (2B) |
| CH16    | CH15 | CH14 | CH13 | CH12 |          | CH10 | CH9     | RCBR2 (2C) |
...
| (MSB)   | (LSB)   |      |      |      |          |          |         |                       |
|---------|---------|------|------|------|----------|----------|---------|-----------------------|
| CH8     | CH7     | CH6  | CH5  | CH4  | CH3 CH11 | CH2 CH10 | CH1 CH9 | TCBR1 (22) TCBR2 (23) |
...
## TNAF: TRANSMIT NONALIGN FRAME REGISTER (Address=21 Hex)
...
## Table 15-1. HDLC CONTROLLER REGISTER LIST
...
| (MSB) -   | -        |                                                                        | IBOEN                                                                  | INTSEL                                                                 | (LSB) MSEL1                                                            |                                                                        |
|-----------|----------|------------------------------------------------------------------------|------------------------------------------------------------------------|------------------------------------------------------------------------|------------------------------------------------------------------------|------------------------------------------------------------------------|
| SYMBOL    | POSITION | NAME AND DESCRIPTION                                                   | NAME AND DESCRIPTION                                                   | NAME AND DESCRIPTION                                                   | NAME AND DESCRIPTION                                                   | NAME AND DESCRIPTION                                                   |
| -         | IBO.7    | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      |
| -         | IBO.6    | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      |
| -         | IBO.5    | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      |
| -         | IBO.4    | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      | Not Assigned. Should be set to 0.                                      |
| IBOEN     | IBO.3    | Interleave Bus Operation Enable 0 = Interleave Bus Operation disabled. | Interleave Bus Operation Enable 0 = Interleave Bus Operation disabled. | Interleave Bus Operation Enable 0 = Interleave Bus Operation disabled. | Interleave Bus Operation Enable 0 = Interleave Bus Operation disabled. | Interleave Bus Operation Enable 0 = Interleave Bus Operation disabled. |
| INTSEL    | IBO.2    | Interleave Type Select 0 = Byte interleave. 1 = Frame interleave.      | Interleave Type Select 0 = Byte interleave. 1 = Frame interleave.      | Interleave Type Select 0 = Byte interleave. 1 = Frame interleave.      | Interleave Type Select 0 = Byte interleave. 1 = Frame interleave.      | Interleave Type Select 0 = Byte interleave. 1 = Frame interleave.      |
| MSEL0     | IBO.1    | Master Device Bus Select Bit 0 See table 16-1.                         | Master Device Bus Select Bit 0 See table 16-1.                         | Master Device Bus Select Bit 0 See table 16-1.                         | Master Device Bus Select Bit 0 See table 16-1.                         | Master Device Bus Select Bit 0 See table 16-1.                         |
| MSEL1     | IBO.0    | Master Device Bus Select Bit 1 See table 16-1.                         | Master Device Bus Select Bit 1 See table 16-1.                         | Master Device Bus Select Bit 1 See table 16-1.                         | Master Device Bus Select Bit 1 See table 16-1.                         | Master Device Bus Select Bit 1 See table 16-1.                         |
...
Figure 16-1. 4.096MHz INTERLEAVED BUS EXTERNAL PIN CONNECTION EXAMPLE

<!-- image -->

Figure 16-2. 8.192MHz INTERLEAVED BUS EXTERNAL PIN CONNECTION EXAMPLE
...
| MSB              |                            | JEDEC         | LSB   | LSB   | LSB   |
|------------------|----------------------------|---------------|-------|-------|-------|
| Version Factory) | Device ID (See Table 17-3) | '00010100001' | '1'   | '1'   | '1'   |
| (Contact         |                            |               |       |       |       |
| 4 bits           | 16 bits                    |               | 1 bit | 1 bit | 1 bit |
|                  |                            | 11 bits       |       |       |       |
...
## Figure 18-3. RECEIVE SIDE 1.544 MHz BOUNDARY TIMING (With Elastic Store Enabled)

<!-- image -->

## Figure 18-4. RECEIVE SIDE 2.048 MHz BOUNDARY TIMING (With Elastic Store Enabled)
...
## Figure 18-5. RECEIVE SIDE, INTERLEAVED BUS OPERATION BYTE MODE TIMING
...
## Figure 18-6. RECEIVE SIDE, INTERLEAVED BUS OPERATION FRAME MODE TIMING
...
## Figure 18-9. TRANSMIT SIDE 1.544 MHz BOUNDARY TIMING (With Elastic Store Enabled)
...
## Figure 18-12. TRANSMIT SIDE, INTERLEAVED BUS OPERATION BYTE MODE TIMING
...
TSER FR2 CH32 FR3 CH32 FR0 CH1 FR1 CH1 FR2 CH1 FR3 CH1 FR0 CH2 FR1 CH2 FR2 CH2 FR3 CH2 2

TSIG FR2 CH32 FR3 CH32 FR0 CH1 FR1 CH1 FR2 CH1 FR3 CH1 FR0 CH2 FR1 CH2 FR2 CH2 FR3 CH2 2
...
## Figure 18-13. TRANSMIT SIDE, INTERLEAVED BUS OPERATION FRAME MODE TIMING
...
| Operating Temperature Range for DS21Q44T                 | 0ºC to +70ºC     |
| Operating Temperature Range for DS21Q44TN                | -40ºC to +85ºC   |
...
(0°C to +70°C; VDD = 2.97 to 3.63V for DS21Q44T; -40°C to +85°C; VDD = 2.97 to 3.63V for DS21Q44TN)
...
Figure 19-9. RECEIVE SYSTEM SIDE AC TIMING
...
## Figure 19-11. TRANSMIT SIDE AC TIMING
...
Figure 19-12. TRANSMIT SYSTEM SIDE AC TIMING
