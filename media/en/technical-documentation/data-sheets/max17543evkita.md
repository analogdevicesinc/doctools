...
## Evaluates: MAX17543 in 3.3V Output-Voltage Application
...
| -             |     1 | PCB: MAX17543 - 3.3V OUTPUT EVKIT                                     |
...
- MAX17543	3.3V	output	EV	kit
- 5V	to	42V,	5A	DC	input	power	supply
...
The  MAX17543  3.3V  output  EV  kit  provides  a  proven design  to  evaluate  the  MAX17543  high-voltage,  highefficiency, synchronous step-down DC-DC converter. The EV kit is preset for 3.3V output from 5V to 42V input at load currents up to 2.5A and features a 450kHz switching frequency for optimum efficiency and component size.
...
changes	 on	 the	 MODE	 pin	 are	 ignored	 during	 normal operation.	Refer	to	the	MAX17543	IC	data	sheet	for	more information	on	PWM,	PFM,	and	DCM	modes	of	operation.
...
Figure 1. MAX17543 3.3V Output Load and Line Regulation (PWM Mode)

<!-- image -->

Figure 2. MAX17543 3.3V Output Efficiency (PWM Mode)

<!-- image -->

Figure 3. MAX17543 3.3V Output Load and Line Regulation (PFM Mode)

<!-- image -->

Figure 4. MAX17543 3.3V Output Efficiency (PFM Mode)

<!-- image -->

## EV Kit Test Report (continued)

Figure 5. MAX17543 3.3V Output Efficiency (DCM Mode)

<!-- image -->

Evaluates: MAX17543 in

Figure 6. MAX17543 3.3V Output Full Load Bode Plot (VIN = 24V)

<!-- image -->

Figure 7. MAX17543 3.3V Output, No Load to 1A Load Transient (PWM Mode)

<!-- image -->

## EV Kit Test Report (continued)

Figure 8. MAX17543 3.3V Output, 5mA to 1A Load Transient (PFM Mode)

<!-- image -->

Figure 9. MAX17543 3.3V Output, 50mA to 1A Load Transient (DCM Mode)

<!-- image -->

Figure 10. MAX17543 3.3V Output, 1A to 2A Load Transient

<!-- image -->

## Evaluates: MAX17543 in 3.3V Output-Voltage Application

Figure 11. MAX17543 3.3V Output EV Kit Schematic

<!-- image -->

## MAX17543 3.3V Output Evaluation Kit

Figure 12. MAX17543 3.3V Output EV Kit Component Placement Guide-Component Side

<!-- image -->

Figure 13. MAX17543 3.3V Output EV Kit Component Side PCB layout

<!-- image -->

## Evaluates: MAX17543 in 3.3V Output-Voltage Application

Figure 14. MAX17543 3.3V Output EV Kit PCB LayoutInner Layer 1

<!-- image -->

Figure 15. MAX17543 3.3V Output EV Kit PCB Layout-Inner Layer 2

<!-- image -->

## MAX17543 3.3V Output Evaluation Kit

Figure 16. MAX17543 3.3V Output EV Kit PCB LayoutSolder Side

<!-- image -->

## Evaluates: MAX17543 in 3.3V Output-Voltage Application

Figure 17. MAX17543 3.3V Output EV Kit Component Placement Guide-Top Solder Mask

<!-- image -->

Figure 18. MAX17543 3.3V Output EV Kit Component Placement Guide-Bottom Solder Mask
