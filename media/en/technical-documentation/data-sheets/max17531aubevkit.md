<!-- lastmod 2022-10-10 -->
## MAX17531 5V Output Evaluation Kit (µMAX)

## General Description

The MAX17531 5V evaluation kit (EV kit) (µMAX) is a fully assembled and tested circuit board that demonstrates the performance  of  the  MAX17531  42V,  50mA  ultra-small, high-efficiency, synchronous step-down DC-DC converter in  a  10-pin  µMAX package. The EV kit operates over a wide input voltage range of 6V to 42V and provides up to 50mA load current at 5V output. It draws only 26µA supply current under no-load conditions (EN/UVLO connected to VIN). The EV kit is programmed to switch at a frequency of  300kHz.  The  device  is  simple  to  use  and  easily configurable with minimal external components. It features  cycle-by-cycle  peak  current-limit protection, undervoltage lockout, and thermal shutdown.

The EV kit comes installed with the MAX17531AUB+ in a  10-pin  (3mm  x  3mm)  lead(Pb)-free/RoHS-compliant µMAX package.
...
The MAX17531 5V EV kit (µMAX) is a fully assembled and tested  circuit  board  that  demonstrates  the  performance of  the  MAX17531 42V, 50mA ultra-small, high-efficiency, synchronous  step-down  DC-DC  converter  in  a  10-pin µMAX package. The  EV  kit  operates  over  a  wide  input voltage range of 6V to 42V and provides up to 50mA load current  at  5V  output.  It  draws  only  26µA  supply  current under no-load conditions (EN/UVLO connected to VIN). The EV kit is programmed to switch at a frequency of 300kHz. The  device  is  simple  to  use  and  easily  configurable  with minimal external components. It features cycle-by-cycle peak current-limit protection, undervoltage lockout, and thermal shutdown.
...
## MAX17531 5V EV Kit (µMAX) Performance Report
...
## MAX17531 5V EV Kit (µMAX) Component Suppliers
...
Note: Indicate that you are using the MAX17531AUB when contacting these component suppliers.

## MAX17531 5V EV Kit (µMAX) Bill of Materials

|   Serial No. | Description                                                                                                                                       |   Quantity | Designator       | Part Number            |
|--------------|---------------------------------------------------------------------------------------------------------------------------------------------------|------------|------------------|------------------------|
|            1 | 22 μ F, 50V electrolytic capacitor (6.3mm x 6.3mm)                                                                                                |          1 | C1               | PANASONIC EEEFK1H220P  |
|            2 | 1 μ F ±10%, 50V X7R ceramic capacitor (0805)                                                                                                      |          1 | C2               | MURATA GRM21BR71H105K  |
|            3 | 10 μ F ±10%, 6.3V X7R ceramic capacitor (0805)                                                                                                    |          1 | C3               | Murata GRM21BR70J106K  |
|            4 | Not installed, OPEN (0402)                                                                                                                        |          0 | C4               |                        |
|            5 | 0.22µF ±10%, 16V X7R ceramic capacitor (0402)                                                                                                     |          1 | C5               | Murata GRM155R71C224K  |
|            6 | 47pF ±5% 50V COG ceramic capacitor (0402)                                                                                                         |          1 | C6               | MURATA GRM1555C1E470J  |
|            7 | 2-pin headers                                                                                                                                     |          3 | JU1-JU3          | Sullins: PTC36SAAN     |
|            8 | 330µH, 150mA inductor                                                                                                                             |          1 | L1               | Coilcraft LPS5030-334M |
|            9 | 3.01M ohm ±1%, resistor (0402)                                                                                                                    |          1 | R1               |                        |
|           10 | 787k ohm ±1%, resistor (0402)                                                                                                                     |          1 | R2               |                        |
|           11 | 140k ohm ±1%, resistor (0402)                                                                                                                     |          1 | R3               |                        |
...
|           16 | 42V, 50mA, ultra-small, highefficiency, synchronous step- down DC-DC converter with 22 μ A noload supply current (10 µMAX-EP*) Maxim MAX17531AUB+ |          1 | U1               | MAX17531AUB+           |
...
## MAX17531 5V EV Kit (µMAX) PCB Layout Diagrams

<!-- image -->

MAX17531 5V EV Kit (µMAX) Component Placement GuideComponent Side

MAX17531 5V EV Kit (µMAX) PCB Layout-Component Side

<!-- image -->

MAX17531 5V EV Kit (µMAX) PCB Layout-Solder Side

<!-- image -->

│

## MAX17531 5V EV Kit (µMAX) Schematic
