...
| PART TEMP                    | PIN- PACKAGE            | RANGE PKG CODE        |
|------------------------------|-------------------------|-----------------------|
| -40°C to +85°C               | 32 Thin QFN (5mm x 5mm) | MAX17003 ETJ+ T3255-4 |
| MAX17004 ETJ+ -40°C to +85°C | 32 Thin QFN (5mm x 5mm) | T3255-4               |
...
| Feedback Input Leakage Current               |               | V FB3 = V FB5 = 2.1V                                                      | V FB3 = V FB5 = 2.1V                                                      | -0.1          |               | +0.1          | µA            |
| DC Load Regulation                           |               | Either SMPS, SKIP = LDO5, 0 < V CSH_ - V CSL < 50mV                       | Either SMPS, SKIP = LDO5, 0 < V CSH_ - V CSL < 50mV                       |               | -0.1          |               | %             |
| Line Regulation Error                        |               | Either SMPS, 6V < V IN < 26V                                              | Either SMPS, 6V < V IN < 26V                                              |               | 0.03          |               | %/V           |
| Operating Frequency (Note 1)                 |               | FSEL = GND                                                                | FSEL = GND                                                                | 170           | 200           | 230           |               |
| Operating Frequency (Note 1)                 | f OSC         | FSEL = REF                                                                | FSEL = REF                                                                | 270           | 300           | 330           | kHz           |
| Operating Frequency (Note 1)                 |               | FSEL = LDO5                                                               | FSEL = LDO5                                                               | 425           | 500           | 575           |               |
| Maximum Duty Factor                          | DMAX          | (Note 1)                                                                  | (Note 1)                                                                  | 97.5          | 99            |               | %             |
| Minimum On-Time                              | t ONMIN       |                                                                           |                                                                           |               | 100           |               | ns            |
| SMPS3-to-SMPS5 Phase Shift                   |               | SMPS5 starts after SMPS3                                                  | SMPS5 starts after SMPS3                                                  |               | 40            |               | %             |
...
| Current-Sense Input Leakage Current          |               | CSH3 = CSH5 = GND or LDO5                                                 | CSH3 = CSH5 = GND or LDO5                                                 | -1            |               | +1            | µA            |
| Current-Limit Threshold (Fixed)              | V LIMIT       | V CSH _ - V CSL _, ILIM = LDO5                                            | V CSH _ - V CSL _, ILIM = LDO5                                            | 45            | 50            | 55            | mV            |
| Current-Limit Threshold (Adjustable)         | V LIMIT       | V CSH _ - V CSL _                                                         | V ILIM = 2.00V                                                            | 185           | 200           | 215           | mV            |
| Current-Limit Threshold (Adjustable)         |               |                                                                           | V ILIM = 1.00V                                                            | 94            | 100           | 106           |               |
| Current-Limit Threshold (Negative)           | V NEG         | V CSH _ - V CSL _, SKIP = ILIM = LDO5                                     | V CSH _ - V CSL _, SKIP = ILIM = LDO5                                     | -67           | -60           | -53           | mV            |
| Current-Limit Threshold (Negative)           |               | V CSH _ - V CSL _, SKIP = LDO5, adjustable mode, percent of current limit | V CSH _ - V CSL _, SKIP = LDO5, adjustable mode, percent of current limit |               | -120          |               | %             |
| Current-Limit Threshold (Zero Crossing)      | V ZX          | V CSH _ - V CSL _, SKIP = GND, ILIM = LDO5                                | V CSH _ - V CSL _, SKIP = GND, ILIM = LDO5                                | 0             | 3             | 6             | mV            |
| Idle Mode™ Threshold                         |               | V CSH _ - V CSL _, SKIP = GND                                             | ILIM = LDO5                                                               | 6             | 10            | 14            | mV            |
| Idle Mode™ Threshold                         | V IDLE        |                                                                           | With respect to current-limit threshold (V LIMIT )                        |               | 20            |               | %             |
| Idle Mode Threshold (Low Audible-Noise Mode) |               | V CSH _ - V CSL _, SKIP = REF                                             | ILIM = LDO5                                                               | 2.5           | 5             | 7.5           | mV            |
| Idle Mode Threshold (Low Audible-Noise Mode) | V IDLE        | V CSH _ - V CSL _, SKIP = REF                                             | With respect to current-limit threshold (V LIMIT )                        |               | 10            |               | %             |
| ILIM Leakage Current                         |               | ILIM = GND or REF                                                         | ILIM = GND or REF                                                         | -1            |               | +1            | µA            |
...
| Output Overvoltage Fault Propagation Delay (MAX17003 Only) | t OVP                            | 50mV overdrive                                      |                                  | 10                               |                                  | µs                               |
...
| PGDALL Propagation Delay                      | t PGDALL           | Falling edge, 50mV overdrive                                                 | Falling edge, 50mV overdrive                                                 |                    | 10                 |                    | µs                 |
...
|                                               | R                  | DL_, high state                                                              | DL_, high state                                                              |                    | 1.7                | 5                  | Ω                  |
| DL_ Gate-Driver On-Resistance                 | DL                 | DL_, low state                                                               | DL_, low state                                                               |                    | 0.6                | 3                  |                    |
...
|                                               |                    | DL_low to DH_high                                                            | DL_low to DH_high                                                            | 15                 | 44                 |                    |                    |
...
|                                               |                    | Hysteresis = 600mV (typ)                                                     | Low                                                                          |                    |                    | 0.8                | V                  |
...
| DSCHG_ On-Resistance                          | R DSCHG_           | ON3 = ON5 = SHDN = 0; I DSCHG_ = 10mA                                        | ON3 = ON5 = SHDN = 0; I DSCHG_ = 10mA                                        | 5                  | 11                 | 25                 | Ω                  |
...
| Quiescent Power Consumption         | P Q                     | Both SMPS on, FB3 = FB5 = LDO5; SKIP = GND, V CSL3 = 3.5V, V CSL5 = 5.3V, V OUTA = 15V, P IN + P CSL3 + P CSL5 + P OUTA |                         | 4.5                     | mW                      |
...
| Operating Frequency (Note 1)        |                         | FSEL = LDO5                                                                                                             | 425                     | 575                     | kHz                     |
...
| GATE DRIVERS                                      |          |                                                             |      |              |       |       |         |
| DH_ Gate-Driver On-Resistance                     | R DH     | BST_ - LX_ forced to 5V                                     |      |              |       |     5 | Ω       |
| DL_ Gate-Driver On-Resistance                     | R DL     | DL_, high state                                             |      |              |       |     5 | Ω       |
|                                                   |          | DL_, low state                                              |      |              |       |     3 |         |
| INPUTS AND OUTPUTS                                |          |                                                             |      |              |       |       |         |
...
|                                                   |          | SMPS on level                                               |      | 2.4          |       |       |         |
| DSCHG_ On-Resistance                              | R DSCHG_ | ON3 = ON5 = SHDN = 0; I DSCHG_ = 10mA                       |      | 5            |       |    25 | Ω       |
| Tri-Level Input Logic                             |          | SKIP , FSEL                                                 | High | V LDO5 - 0.4 |       |     1 | µA      |
|                                                   |          |                                                             | REF  | 1.65         |       |  2.35 | V       |
|                                                   |          |                                                             | GND  |              |       |   0.5 |         |
...
## OUTPUT OVERVOLTAGE FAULT PROTECTION (MAX17003 ONLY)
...
## OUTPUT UNDERVOLTAGE (SHORT-CIRCUIT) FAULT PROTECTION
...
|    14 | DSCHG5 | Open-Drain Discharge Input for the 5V SMPS. DSCHG5 is pulled low when ON5 is low, discharging the SMPS5 output. DSCHG5 is also low under fault conditions. Connect a resistor from DSCHG5 to the SMPS5 output. Limit the peak discharge current to less than 100mA: where R DSCHG5(MIN) is 5 Ω , taken from the Electrical Characteristics . R V mA R DIS OUT DSCHG MIN 5 5 5 100 ≥ - ( )                                                                         |
...
|   PIN | NAME   | FUNCTION                                                                                                                                                                                                                                                                                                                                                                                                                  |
|-------|--------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|    15 | BST5   | Boost Flying Capacitor Connection for the 5V SMPS. The MAX17003/MAX17004 include an internal boost switch connected between LDO5 and BST5. Connect to an external capacitor as shown in Figure 1.                                                                                                                                                                                                                         |
...
|    22 | PGDALL | Open-Drain Power-Good Output for SMPS3 and SMPS5. PGDALL is pulled low if either SMPS3 or SMPS5 output drops more than 10% (typ) below the normal regulation point, or if either ON3 or ON5 are low. PGDALL becomes high impedance when both SMPS3 and SMPS5 are in regulation.                                                                                                                                           |
...
|    26 | BST3   | Boost Flying Capacitor Connection for the 3.3V SMPS. The MAX17003/MAX17004 include an internal boost switch connected between LDO5 and BST3. Connect to an external capacitor as shown in Figure 1.                                                                                                                                                                                                                       |
|    27 | DSCHG3 | Open-Drain Discharge Output for the 3.3V SMPS. DSCHG3 is pulled low when ON3 is low, discharging the SMPS3 output. DSCHG3 is also low under fault conditions. Connect a resistor from DSCHG3 to the SMPS3 output. Limit the peak discharge current to less than 100mA: where R DSCHG3(MIN) is 5 Ω , taken from the Electrical Characteristics . R V mA R DIS OUT DSCHG MIN 3 3 3 100 ≥ - ( )                              |
...
| 32    | OUTA   | Adjustable Auxiliary Linear-Regulator Output. Bypass OUTA to GND with 1µF or greater capacitor (1µF/25mA). When DRVA < OUTA, the secondary feedback control triggers the DL5 for 1µs forcing the controller to recharge the auxiliary storage capacitor. When DRVA exceeds 25V, the MAX17003/MAX17004 enable a 10mA shunt on OUTA, preventing the storage capacitor from rising to unsafe levels due to the transformer's leakage inductance. Pulling ONA high enables the linear-regulator driver and the secondary feedback control. |
...
| L3, Inductor               | 5.8µH, 8.6A, 16.2m Ω Sumida CORH127/LD-5R8NC                        | 3.9µH, 6.5A, 15m Ω Sumida CDRH124-3R9NC                             |
...
In  discontinuous conduction (IOUT &lt; ILOAD(SKIP)), the MAX17003/MAX17004 regulate the valley of the output ripple, so the output voltage has a DC regulation level higher than the error-comparator threshold. For PFM operation (discontinuous conduction), the output voltage is approximately defined by the following equation:
...
PGDALL is the open-drain output of a comparator that continuously monitors both SMPS output voltages for undervoltage conditions. PGDALL is actively held low in shutdown ( SHDN = GND), during soft-start, and softshutdown, and when either SMPS is disabled (either
...
| Output Overvoltage (OVP) Protection (MAX17003) | Either output > 111% of nominal level                                                                         | Exited by POR or cycling SHDN , ON3, or ON5.                                                                   |
...
The 40/60 optimal interleaved architecture of the MAX17003/MAX17004 allows the input voltage to go as low 8.3V before the duty cycles begin to overlap. This offers  improved efficiency over a regular 180° out-ofphase architecture where the duty cycles begin to overlap below 10V. Figure 8 shows the input-capacitor RMS current vs. input voltage for an application that requires 5V/5A and 3.3V/5A. This shows the improvement of the 40/60 optimal interleaving over 50/50 interleaving and in-phase operation.
...
The MAX17003/MAX17004 linear-regulator controller uses an internal transconductance amplifier to drive an external pnp pass transistor. The transconductance amplifier, the pass transistor, the base-to-emitter resistor, and the output capacitor determine the loop stability.
