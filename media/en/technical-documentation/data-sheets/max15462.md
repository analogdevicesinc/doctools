...
## 42V, 300mA, 8ltra-Small, High-Efficiency, Synchronous Step-Down DC-DC Converters
...
| EN/UVLO Input Leakage Current | I EN/UVLO             | V EN/UVLO = 42V, T A = +25°C                       | -100                  |                       | +100                  | nA                    |
...
| LX Leakage Current                                    | I LX-LKG                | V EN/UVLO = 0V, V IN = 42V, T A = +25°C, V LX = (V GND + 1V) to (V IN - 1V) | V EN/UVLO = 0V, V IN = 42V, T A = +25°C, V LX = (V GND + 1V) to (V IN - 1V) | -1                      |                         | +1                      | µA                      |
| SOFT-START (SS)                                       | SOFT-START (SS)         | SOFT-START (SS)                                                             | SOFT-START (SS)                                                             | SOFT-START (SS)         | SOFT-START (SS)         | SOFT-START (SS)         | SOFT-START (SS)         |
| Soft-Start Time                                       | t SS                    | 3.8                                                                         | 3.8                                                                         |                         | 4.1                     | 4.4                     | ms                      |
| FEEDBACK (FB)                                         | FEEDBACK (FB)           | FEEDBACK (FB)                                                               | FEEDBACK (FB)                                                               | FEEDBACK (FB)           | FEEDBACK (FB)           | FEEDBACK (FB)           | FEEDBACK (FB)           |
| FB Regulation Voltage                                 | V FB-REG                | MODE = GND, MAX15462C                                                       | MODE = GND, MAX15462C                                                       | 0.887                   | 0.9                     | 0.913                   | V                       |
| FB Regulation Voltage                                 | V FB-REG                | MODE = unconnected, MAX15462C                                               | MODE = unconnected, MAX15462C                                               | 0.887                   | 0.915                   | 0.936                   | V                       |
| FB Leakage Current                                    | I FB                    | MAX15462C                                                                   | MAX15462C                                                                   | -100                    | -25                     |                         | nA                      |
...
| V OUT Regulation Voltage                              | V OUT-REG               | MODE = GND, MAX15462A                                                       | MODE = GND, MAX15462A                                                       | 3.25                    | 3.3                     | 3.35                    | V                       |
| V OUT Regulation Voltage                              | V OUT-REG               | MODE = unconnected, MAX15462A                                               | MODE = unconnected, MAX15462A                                               | 3.25                    | 3.35                    | 3.42                    | V                       |
| V OUT Regulation Voltage                              | V OUT-REG               | MODE = GND, MAX15462B                                                       | MODE = GND, MAX15462B                                                       | 4.93                    | 5                       | 5.07                    | V                       |
| V OUT Regulation Voltage                              | V OUT-REG               | MODE = unconnected, MAX15462B                                               | MODE = unconnected, MAX15462B                                               | 4.93                    | 5.08                    | 5.18                    | V                       |
...
| Negative Current-Limit                                | I SINK-LIMIT            | MODE = GND                                                                  | MODE = GND                                                                  | 0.25                    | 0.3                     | 0.35                    | A                       |
| Threshold                                             | I SINK-LIMIT            |                                                                             |                                                                             |                         | 0.01                    |                         | mA                      |
...
## 42V, 300mA, 8ltra-Small, High-Efficiency,
...
|     4 | FB/V OUT | Feedback Input. For fixed-output voltage versions, connect FB/V OUT directly to the output. For the ad- justable output voltage version, connect FB/V OUT to a resistor-divider between V OUT and GND to adjust the output voltage from 0.9V to 0.89 x V IN .                                                                                               |
...
## GLYPH&lt;c=23,font=/LNJRRC+Arial-BoldMT&gt;2V , GLYPH&lt;c=22,font=/LNJRRC+Arial-BoldMT&gt;GLYPH&lt;c=19,font=/LNJRRC+Arial-BoldMT&gt;GLYPH&lt;c=19,font=/LNJRRC+Arial-BoldMT&gt;mA, Ultra-Small, High-Eႈciency , Synchronous Step-Down DC-DC Converters
...
## GLYPH&lt;c=23,font=/ACAVAY+ArialNarrow&gt;GLYPH&lt;c=21,font=/ACAVAY+ArialNarrow&gt;9 GLYPH&lt;c=15,font=/ACAVAY+ArialNarrow&gt;GLYPH&lt;c=3,font=/ACAVAY+ArialNarrow&gt;GLYPH&lt;c=22,font=/ACAVAY+ArialNarrow&gt;GLYPH&lt;c=19,font=/ACAVAY+ArialNarrow&gt;GLYPH&lt;c=19,font=/ACAVAY+ArialNarrow&gt;P$GLYPH&lt;c=15,font=/ACAVAY+ArialNarrow&gt;GLYPH&lt;c=3,font=/ACAVAY+ArialNarrow&gt;8OWUDGLYPH&lt;c=16,font=/ACAVAY+ArialNarrow&gt;6PDOOGLYPH&lt;c=15,font=/ACAVAY+ArialNarrow&gt;GLYPH&lt;c=3,font=/ACAVAY+ArialNarrow&gt;+LJ 6\QFKURQRXVGLYPH&lt;c=3,font=/ACAVAY+ArialNarrow&gt;6WHSGLYPH&lt;c=16,font=/ACAVAY+ArialNarrow&gt;'RZQGLYPH&lt;c=3,font=/ACAVAY+ArialNarrow&gt;'&amp;GLYPH&lt;c=16,font=/ACAVAY+ArialNarrow&gt;
...
When EN/UVLO voltage is above 1.21V (typ), the device's internal  error-amplifier  reference  voltage  starts  to  ramp  up. The  duration  of  the  soft-start  ramp  is  4.1ms,  allowing  a smooth  increase  of  the  output  voltage.  Driving  EN/UVLO low disables both power MOSFETs, as well as other internal circuitry, and reduces V IN quiescent current to below 2.2µA. EN/UVLO can be used as an input-voltage UVLO adjustment input. An external voltage-divider between V IN  and EN/UVLO to GND adjusts the input voltage at which the device turns on or turns  off.  If  input  UVLO  programming  is  not  desired, connect EN/UVLO to V IN  (see the Electrical Characteristics table for EN/UVLO rising and falling threshold voltages).
...
where V OUT  is the steady-state output voltage, I OUT  is the maximum load current, R DCR  is the DC resistance of the inductor, f SW  is the switching frequency (max), D MAX is  maximum  duty  cycle  (0.9),  and  t ONMIN   is  the  worstcase minimum controllable switch on-time (130ns).
...
| INPUT VOLTAGE RANGE V IN (V)   | V OUT (V)   |   I OUT (MA) |   L (ΜH) | RECOMMENDED PART NO.    |
|--------------------------------|-------------|--------------|----------|-------------------------|
...
| INPUT VOLTAGE RANGE V IN (V)   | V OUT (V)   |   I OUT (MA) | COUT (ΜF)          | RECOMMENDED PART NO.   |
|--------------------------------|-------------|--------------|--------------------|------------------------|
...
where C OUT is  the  output  capacitance in µF and V OUT is  the  output  voltage.  See  Table  2  to  select  the  output capacitor for typical applications. It should be noted that dielectric  materials  used  in  ceramic  capacitors  exhibit capacitance  loss  due  to  DC  bias  levels  and  should  be appropriately  derated  to  ensure  the  required  output capacitance is obtained in the application.
...
where V INU  is the voltage at which the device is required to turn on. If the EN/UVLO pin is driven from an external signal  source,  a  series  resistance  of  minimum  1kΩ  is recommended  to  be  placed  between  the  signal  source output  and  the  EN/UVLO  pin,  to  reduce  voltage  ringing on the line.

## MAX15462

## Adjusting the Output Voltage

The MAX15462C output voltage can be programmed from 0.9V to 0.89 x V IN . Set the output voltage by connecting a resistor-divider from output to FB to GND (see Figure 2).
...
## GLYPH&lt;c=23,font=/ACAVAY+ArialNarrow&gt;2V GLYPH&lt;c=15,font=/ACAVAY+ArialNarrow&gt; 300P$GLYPH&lt;c=15,font=/ACAVAY+ArialNarrow&gt; 8OWUDGLYPH&lt;c=16,font=/ACAVAY+ArialNarrow&gt;6PDOOGLYPH&lt;c=15,font=/ACAVAY+ArialNarrow&gt; HLJ 6\QFKURQRXV 6WHSGLYPH&lt;c=16,font=/ACAVAY+ArialNarrow&gt;'RZQ 'CGLYPH&lt;c=16,font=/ACAVAY+ArialNarrow&gt;
...
| PART          | TEMP RANGE      | PIN-PACK - AGE   | V OUT   |
|---------------|-----------------|------------------|---------|
