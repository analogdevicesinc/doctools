...
|-------------|----------------|----------------|--------------------------------|
| MAX1777 EEI | -40°C to +85°C | 28 QSOP        | 200kHz/300kHz                  |
| MAX1777EEI+ | -40°C to +85°C | 28 QSOP        | 200kHz/300kHz                  |
| MAX1977 EEI | -40°C to +85°C | 28 QSOP        | 400kHz/500kHz                  |
...
| V+, SHDN to GND..................................................-0.3V to +25V BST_ to GND..........................................................-0.3V to +30V LX_ to BST_..............................................................-6V to +0.3V CS_ to GND (MAX1777/MAX1977 only)......................-2V to +6V V CC , LDO5, LDO3, OUT3, OUT5, ON3, ON5, REF, FB3, FB5, SKIP , PRO , PGOOD to GND...............-0.3V to +6V DH3 to LX3 ..............................................-0.3V to (V BST3 + 0.3V) DH5 to LX5 ..............................................-0.3V to (V BST5 + 0.3V) ILIM3, ILIM5 to GND...................................-0.3V to (V CC + 0.3V) DL3, DL5 to GND....................................-0.3V to (V LDO5 + 0.3V)   | LDO3, LDO5, REF Short Circuit to GND....................Momentary LDO3 Current (Internal Regulator) Continuous ..............+100mA LDO3 Current (Switched Over to OUT3) Continuous.....+200mA LDO5 Current (Internal Regulator) Continuous ..............+100mA LDO5 Current (Switched Over to OUT5) Continuous.....+200mA Continuous Power Dissipation 28-Pin QSOP (derate 10.8mW/°C above +70°C).........860mW Operating Temperature Range ...........................-40°C to +85°C Junction Temperature......................................................+150°C Storage Temperature Range.............................-65°C to +150°C   |
|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| 5V Output Voltage in Fixed Mode                | V+ = 6V to 24V, FB5 = GND, V SKIP = 5V, MAX1777/MAX1999 (TON = V CC )       | V+ = 6V to 24V, FB5 = GND, V SKIP = 5V, MAX1777/MAX1999 (TON = V CC )       | 4.975                 | 5.050                 | 5.125                 | V                     |
| 5V Output Voltage in Fixed Mode                | V+ = 7V to 24V, FB5 = GND, V SKIP = 5V, MAX1977/MAX1999 (TON = GND)         | V+ = 7V to 24V, FB5 = GND, V SKIP = 5V, MAX1977/MAX1999 (TON = GND)         | 4.975                 | 5.050                 | 5.125                 | V                     |
...
| Current-Limit Threshold (Positive, Default)    | ILIM_ = V CC , GND - CS_ (MAX1777/MAX1977), GND - LX_ (MAX1999)             | ILIM_ = V CC , GND - CS_ (MAX1777/MAX1977), GND - LX_ (MAX1999)             | 93                    | 100                   | 107                   | mV                    |
| Current-Limit Threshold (Positive, Adjustable) | GND - CS_ (MAX1777/MAX1977), GND - LX_ (MAX1999)                            | V ILIM_ = 0.5V                                                              | 40                    | 50                    | 60                    | mV                    |
| Current-Limit Threshold (Positive, Adjustable) | GND - CS_ (MAX1777/MAX1977), GND - LX_ (MAX1999)                            | V ILIM_ = 1V                                                                | 93                    | 100                   | 107                   | mV                    |
| Current-Limit Threshold (Positive, Adjustable) | GND - CS_ (MAX1777/MAX1977), GND - LX_ (MAX1999)                            | V ILIM_ = 2V                                                                | 185                   | 200                   | 215                   | mV                    |
| Zero-Current Threshold                         | SKIP = GND, ILIM_ = V CC , GND - CS_ (MAX1777/MAX1977), GND - LX_ (MAX1999) | SKIP = GND, ILIM_ = V CC , GND - CS_ (MAX1777/MAX1977), GND - LX_ (MAX1999) | 3                     | 3                     | 3                     | mV                    |
| Current-Limit Threshold (Negative, Default)    | SKIP = ILIM_ = V CC , GND - CS_ (MAX1777/MAX1977), GND - LX_ (MAX1999)      | SKIP = ILIM_ = V CC , GND - CS_ (MAX1777/MAX1977), GND - LX_ (MAX1999)      | -120                  | -120                  | -120                  | mV                    |
...
|-------------------------------------------|------------------------------------------------------------|------------------------------------------------------------|----------------------------------|----------------------------------|----------------------------------|----------------------------------|
| Operating Frequency                       | MAX1777 or MAX1999                                         | 5V SMPS                                                    |                                  | 200                              |                                  | kHz                              |
| Operating Frequency                       | (V TON = 5V), SKIP = V CC                                  | 3.3V SMPS                                                  |                                  | 300                              |                                  | kHz                              |
| Operating Frequency                       | MAX1977 or MAX1999                                         | 5V SMPS                                                    |                                  | 400                              |                                  | kHz                              |
| Operating Frequency                       | (V TON = 0), SKIP = V CC                                   | 3.3V SMPS                                                  |                                  | 500                              |                                  | kHz                              |
| Operating Frequency                       | SKIP = REF                                                 |                                                            | 25                               | 36                               |                                  | kHz                              |
| On-Time Pulse Width                       | MAX1777 or MAX1999 (V = 5V)                                | V OUT5 = 5.05V                                             | 1.895                            | 2.105                            | 2.315                            | µs                               |
| On-Time Pulse Width                       | TON                                                        | V OUT3 = 3.33V                                             | 0.833                            | 0.925                            | 1.017                            | µs                               |
| On-Time Pulse Width                       | MAX1977 or MAX1999                                         | V OUT5 = 5.05V                                             | 0.895                            | 1.052                            | 1.209                            | µs                               |
| On-Time Pulse Width                       | (V TON = 0)                                                | V OUT3 = 3.33V                                             | 0.475                            | 0.555                            | 0.635                            | µs                               |
| Minimum Off-Time                          |                                                            |                                                            | 250                              | 300                              | 350                              | ns                               |
| Maximum Duty Cycle                        | MAX1777 or MAX1999                                         | V OUT5 = 5.05V                                             |                                  | 94                               |                                  | %                                |
| Maximum Duty Cycle                        | (V TON = 5V)                                               | V OUT3 = 3.33V                                             |                                  | 91                               |                                  | %                                |
| Maximum Duty Cycle                        | MAX1977 or MAX1999                                         | V OUT5 = 5.05V                                             |                                  | 88                               |                                  | %                                |
| Maximum Duty Cycle                        | (V TON = 0)                                                | V OUT3 = 3.33V                                             |                                  | 85                               |                                  | %                                |
...
| Quiescent Power Consumption               | Both SMPSs on, FB3 = FB5 = SKIP = GND, V OUT3 =            | Both SMPSs on, FB3 = FB5 = SKIP = GND, V OUT3 =            |                                  |                                  |                                  | mW                               |
|                                           | 3.5V, V OUT5 = 5.3V                                        | 3.5V, V OUT5 = 5.3V                                        |                                  | 3                                | 4.5                              |                                  |
...
|                                            | Low level                                                                        |       |       |   0.6 |         |
| PRO Input Voltage                          | High level                                                                       |   1.5 |       |       | V       |
|                                            | Low level                                                                        |       |       |   0.8 |         |
...
|                                            | SMPS on level                                                                    |   2.4 |       |       |         |
|                                            | V PRO or V TON = 0 or 5V                                                         |    -1 |       |    +1 | µA      |
|                                            | V ON_ = 0 or 5V                                                                  |    -2 |       |    +2 |         |
|                                            | V SKIP = 0 or 5V                                                                 |    -1 |       |    +1 |         |
| Input Leakage Current                      | V SHDN = 0 or 24V                                                                |    -1 |       |    +1 |         |
|                                            | V CS_ = 0 or 5V                                                                  |    -2 |       |    +2 |         |
|                                            | V ILIM3 , V ILIM5 = 0 or 2V                                                      |  -0.2 |       |  +0.2 |         |
| SHDN                                       | Rising edge                                                                      |   1.2 |   1.6 |   2.0 |         |
| Input Trip Level                           | Falling edge                                                                     |  0.96 |  1.00 |  1.04 | V       |
...
| DL_ Gate-Driver On-Resistance              | DL_, high state (pullup)                                                         |       |   2.2 |   5.0 | Ω       |
...
| 5V Output Voltage in Fixed Mode                | V+ = 6V to 24V, FB5 = GND, V SKIP = 5V, MAX1777/MAX1999 (TON = V CC ) | V+ = 6V to 24V, FB5 = GND, V SKIP = 5V, MAX1777/MAX1999 (TON = V CC ) | 4.95                             |                                  | 5.15                             | V                                |
| 5V Output Voltage in Fixed Mode                | V+ = 7V to 24V, FB5 = GND, V SKIP = 5V, MAX1977/MAX1999 (TON = GND)   | V+ = 7V to 24V, FB5 = GND, V SKIP = 5V, MAX1977/MAX1999 (TON = GND)   | 4.95                             |                                  | 5.15                             | V                                |
| Output Voltage in Adjustable Mode              | V+ = 6V to 24V, either SMPS                                           | V+ = 6V to 24V, either SMPS                                           | 1.97                             |                                  | 2.03                             | V                                |
| Output Voltage Adjust Range                    | Either SMPS                                                           | Either SMPS                                                           | 2.0                              |                                  | 5.5                              | V                                |
| FB3, FB5 Adjustable-Mode Threshold Voltage     | Dual-mode comparator                                                  | Dual-mode comparator                                                  | 0.1                              |                                  | 0.2                              | V                                |
| Current-Limit Threshold (Positive, Default)    | ILIM_ = V CC , GND - CS_ (MAX1777/MAX1977), GND - LX_ (MAX1999)       | ILIM_ = V CC , GND - CS_ (MAX1777/MAX1977), GND - LX_ (MAX1999)       | 90                               |                                  | 110                              | mV                               |
| Current-Limit Threshold (Positive, Adjustable) | V ILIM_ = V ILIM_ = 1V (MAX1777/MAX1977), (MAX1999)                   | 0.5V                                                                  | 40                               |                                  | 60                               | mV                               |
| Current-Limit Threshold (Positive, Adjustable) | V ILIM_ = V ILIM_ = 1V (MAX1777/MAX1977), (MAX1999)                   |                                                                       | 90                               |                                  | 110                              | mV                               |
| Current-Limit Threshold (Positive, Adjustable) | V ILIM_ = V ILIM_ = 1V (MAX1777/MAX1977), (MAX1999)                   | V ILIM_ = 2V                                                          | 180                              |                                  | 220                              | mV                               |
| On-Time Pulse Width                            | MAX1777 or MAX1999 (V TON = 5V)                                       | V OUT5 = 5.05V                                                        | 1.895                            |                                  | 2.315                            | µs                               |
| On-Time Pulse Width                            | MAX1777 or MAX1999 (V TON = 5V)                                       | V OUT3 = 3.33V                                                        | 0.833                            |                                  | 1.017                            | µs                               |
| On-Time Pulse Width                            | MAX1977 or MAX1999 (V TON = 0)                                        | V OUT5 = 5.05V                                                        | 0.895                            |                                  | 1.209                            | µs                               |
| On-Time Pulse Width                            | MAX1977 or MAX1999 (V TON = 0)                                        | V OUT3 = 3.33V                                                        | 0.475                            |                                  | 0.635                            | µs                               |
...
| SKIP Input Voltage                         | Float level                                                                      |   1.7 |       |   2.3 | V       |
| SKIP Input Voltage                         | High level                                                                       |   2.4 |       |       |         |
...
| 1               | -       | CS3   | 3.3V SMPS Current-Sense Input. Connect CS3 to a current-sensing resistor from the source of the synchronous rectifier to GND. The voltage at ILIM3 determines the current-limit threshold (see the Current-Limit (ILIM) Circuit section).                                                                                                                                                         |
...
| 5               | 5       | ILIM3 | 3.3V SMPS Current-Limit Adjustment. The GND-LX current-limit threshold defaults to 100mV if ILIM3 is tied to V CC . In adjustable mode, the current-limit threshold is 1/10th the voltage seen at ILIM3 over a 0.5V to 3V range. The logic threshold for switchover to the 100mV default value is approximately V CC - 1V. Connect ILIM3 to REF for a fixed 200mV threshold.                      |
...
| 10              | 10      | PRO   | Overvoltage and Undervoltage Fault Protection Enable/Disable. Connect PRO to V CC to disable undervoltage and overvoltage protection. Connect PRO to GND to enable undervoltage and overvoltage protection (see the Fault Protection section).                                                                                                                                                    |
| 11              | 11      | ILIM5 | 5V SMPS Current-Limit Adjustment. The GND-LX current-limit threshold defaults to 100mV if ILIM5 is tied to V CC . In adjustable mode, the current-limit threshold is 1/10th the voltage seen at ILIM5 over a 0.5V to 3V range. The logic threshold for switchover to the 100mV default value is approximately V CC - 1V. Connect ILIM5 to REF for a fixed 200mV threshold.                        |
| 12              | 12      | SKIP  | Low-Noise Mode Control. Connect SKIP to GND for normal idle-mode (pulse-skipping) operation or to V CC for PWM mode (fixed frequency). Connect to REF or leave floating for ultrasonic mode (pulse skipping, 25kHz minimum).                                                                                                                                                                      |
...
|-----------------|---------|------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| MAX1777 MAX1977 | MAX1999 | NAME | FUNCTION                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| 13              | -       | CS5  | 5V SMPS Current-Sense Input. Connect CS5 to a current-sensing resistor from the source of the synchronous rectifier to GND. The voltage at ILIM5 determines the current-limit threshold (see the Current-Limit Circuit section).                                                                                                                                                                                                                                                                                                                                         |
...
| 25              | 25      | LDO3 | 3.3V Linear-Regulator Output. LDO3 can provide a total of 100mA to external loads. If OUT3 is greater than the LDO3 bootstrap-switch threshold, the LDO3 regulator shuts down and the LDO3 pin connects to OUT3 through a 1.5 Ω switch. Bypass LDO3 with a minimum of 4.7µF. Use an additional 1µF per 5mA of load.                                                                                                                                                                                                                                                      |
...
|                                  | TON = V CC    | TON = GND     |
|----------------------------------|---------------|---------------|
| 5V/3.3V SMPS SWITCHING FREQUENCY | 200kHz/300kHz | 400kHz/500kHz |
| L3                               | 4.7 µ H       | 3.0 µ H       |
| L5                               | 7.6 µ H       | 5.6 µ H       |
| C3                               | 470 µ F       | 220 µ F       |
| C5                               | 330 µ F       | 150 µ F       |
...
Each step-down, power-switching circuit consists of two N-channel MOSFETs, a rectifier, and an LC output filter. The output voltage is the average AC voltage at the switching node, which is regulated by changing the duty cycle of the MOSFET switches. The gate-drive signal to the N-channel high-side MOSFET must exceed the battery voltage, and is provided by a flying-capacitor boost circuit that uses a 100nF capacitor connected to BST\_.
...
|--------------------------------------|-----------------------------|-----------------|-----------------------------------|
| MAX1777/MAX1999 (t ON = V CC ), 5V   |                         200 |             5.0 | ±10                               |
| MAX1777/MAX1999 (t ON = V CC ), 3.3V |                         300 |             3.3 | ±10                               |
| MAX1977/MAX1999 (t ON = GND), 5V     |                         400 |             2.5 | ±10                               |
| MAX1977/MAX1999 (t ON = GND), 3.3V   |                         500 |             2.0 | ±10                               |
...
Connect FB\_ to GND to enable the fixed, preset SMPS output voltages (3.3V and 5V). Connect a resistive voltage-divider at FB\_ between OUT\_ and GND to adjust the respective output voltage between 2V and 5.5V (Figure 11). Choose R2 to be about 10k Ω and solve for R1 using the equation:
...
The inductor ripple current also impacts transientresponse performance, especially at low V+ - VOUT\_ difference. Low inductor values allow the inductor current  to  slew  faster,  replenishing  charge  removed  from the output filter capacitors by a sudden load step. The peak amplitude of the output transient (VSAG) is also a function of the maximum duty factor, which can be calculated from the on-time and minimum off-time:
...
I LIMIT(LOW) &gt; ILOAD(MAX) - [(LIR / 2) x ILOAD(MAX)] where ILIMIT(LOW) = minimum current-limit threshold voltage divided by the RDS(ON) of N2/N4 (MAX1999). For the MAX1777/MAX1977/MAX1999, the minimum current-limit  threshold  voltage  is  93mV  (ILIM\_  =  VCC). Use the worst-case maximum value for RDS(ON) from the MOSFET N2/N4 data sheet and add some margin for the rise in RDS(ON) with temperature. A good gener- al rule is to allow 0.5% additional resistance for each °C of temperature rise.
...
Connect the source of the synchronous rectifier to a current-sense resistor to GND (MAX1777/MAX1977), and connect CS\_ to that junction to set the current limit for  the  device.  The  MAX1777/MAX1977/MAX1999 limit the current with the sense resistor instead of the RDS(ON) of N2/N4. The maximum value of the sense resistor can be calculated with the equation
...
where LIR is the inductor ripple current ratio and ILOAD is  the  average DC load. Using a LIR = 0.35 and an average load current of 5A, the ESR needed to support 50mVP-P ripple is 28m Ω .
...
Calculating the power dissipation in N1/N3 due to switching losses is difficult since it must allow for quantifying  factors  that  influence  the  turn-on  and  turn-off times. These factors include the internal gate resistance, gate charge, threshold voltage, source induc- tance, and PC board layout characteristics. The following switching loss calculation provides only a very rough estimate and is no substitute for bench evaluation,  preferably  including  verification  using  a  thermocouple mounted on N1/N3:

<!-- image -->

<!-- formula-not-decoded -->

where CRSS is the reverse transfer capacitance of N1/N3 and IGATE is the peak gate-drive source/sink current.
...
MAX1977: With VOUT5 = 5V, fsw = 400kHz, K = 2.25µs, t OFF(MIN) = 350ns, VDROP1 = VDROP2 = 100mV, and h = 1.5, the minimum V+ is:
...
- 2) Mount the controller IC adjacent to the synchronous rectifier  MOSFETs, preferably on the back side in order to keep DH\_, GND, and the DL\_ gate drive lines  short  and  wide.  The  DL\_  gate  trace  must  be short and wide measuring 50mils to 100mils wide if the MOSFET is 1in from the controller device.
- 3) Group the gate-drive component (BST\_ diode and capacitor, V+ bypass capacitor) together near the controller device.
