...
|--------------|----------------|-----------------------|
| MAX1533A ETJ | -40°C to +85°C | 32 Thin QFN 5mm x 5mm |
| MAX1533AETJ+ | -40°C to +85°C | 32 Thin QFN 5mm x 5mm |
| MAX1537A ETX | -40°C to +85°C | 36 Thin QFN 6mm x 6mm |
...
|                                           |                                  | FSEL = GND                                               | FSEL = GND                                               | 170                              | 200                              | 230                              |                                  |
| Operating Frequency (Note 1)              | f OSC                            | FSEL = REF                                               | FSEL = REF                                               | 270                              | 300                              | 330                              | kHz                              |
|                                           |                                  | FSEL = V CC                                              | FSEL = V CC                                              | 425                              | 500                              | 575                              |                                  |
|                                           |                                  | FSEL = GND                                               | FSEL = GND                                               | 91                               | 93                               |                                  |                                  |
| Maximum Duty Factor (Note 1)              | DMAX                             | FSEL = REF                                               | FSEL = REF                                               | 91                               | 93                               |                                  | %                                |
|                                           |                                  | FSEL = V CC                                              | FSEL = V CC                                              | 91                               | 93                               |                                  |                                  |
| Minimum On-Time                           | t ON(MIN)                        | (Note 3)                                                 | (Note 3)                                                 |                                  |                                  | 200                              | ns                               |
| SMPS3 to SMPS5 Phase Shift                |                                  |                                                          |                                                          |                                  | 40                               |                                  | %                                |
|                                           |                                  | SMPS5 starts after SMPS3                                 | SMPS5 starts after SMPS3                                 |                                  | 144                              |                                  | Deg                              |
...
| Current-Sense Input Range                 |                                  | CSH_, CSL_                                               | CSH_, CSL_                                               | 0                                |                                  | 5.5                              | V                                |
| Current-Sense Input Leakage Current       |                                  | CSH_, V CSH _ = 5.5V                                     | CSH_, V CSH _ = 5.5V                                     | -1                               |                                  | +1                               | µA                               |
| Current-Limit Threshold (Fixed)           | V LIMIT _                        | V CSH _ - V CSL _, ILIM_ = V CC                          | V CSH _ - V CSL _, ILIM_ = V CC                          | 70                               | 75                               | 80                               | mV                               |
|                                           |                                  | V ILIM _ =                                               | 2.00V                                                    | 170                              | 200                              | 230                              |                                  |
| Current-Limit Threshold (Adjustable)      | V LIMIT _                        | V CSH _ - V CSL _                                        | V ILIM _ = 1.00V                                         | 91                               | 100                              | 109                              | mV                               |
...
| Idle Mode  Threshold                     | V IDLE                           | V CSH _ - V CSL _                                        | With respect to limit threshold (V                       |                                  | 20                               |                                  | %                                |
| ILIM_ Leakage Current                     |                                  | ILIM3 = ILIM5 = GND or V CC                              | ILIM3 = ILIM5 = GND or V CC                              | -0.1                             |                                  | +0.1                             | µA                               |
...
| LDO5 Output Voltage                       | V LDO5                           | ON3 = ON5 = GND, 6V < V IN < 26V, 0 < I LDO5 < 100mA     | ON3 = ON5 = GND, 6V < V IN < 26V, 0 < I LDO5 < 100mA     | 4.80                             | 4.95                             | 5.10                             | V                                |
| LDO5 Undervoltage-Lockout Fault Threshold |                                  | Rising edge, hysteresis = 1%                             | Rising edge, hysteresis = 1%                             | 3.75                             | 4.0                              | 4.25                             | V                                |
| LDO5 Bootstrap Switch Threshold           |                                  | Rising edge of CSL5, hysteresis = 1%                     | Rising edge of CSL5, hysteresis = 1%                     | 4.41                             |                                  | 4.75                             | V                                |
...
| AUXILIARY LINEAR REGULATOR (MAX1537A ONLY)    | AUXILIARY LINEAR REGULATOR (MAX1537A ONLY) | AUXILIARY LINEAR REGULATOR (MAX1537A ONLY)                          | AUXILIARY LINEAR REGULATOR (MAX1537A ONLY) | AUXILIARY LINEAR REGULATOR (MAX1537A ONLY) | AUXILIARY LINEAR REGULATOR (MAX1537A ONLY) | AUXILIARY LINEAR REGULATOR (MAX1537A ONLY) |
...
| DH_ Gate-Driver Source/Sink Current DL_ Gate-Driver Source Current | I DH I DL          | DH_ forced to 2.5V, BST_ - LX_ forced to 5V DL_ forced to 2.5V | DH_ forced to 2.5V, BST_ - LX_ forced to 5V DL_ forced to 2.5V |                    | 2 1.7       |          | A A     |
| DL_ Gate-Driver Sink Current                                       | I DL (SINK)        | DL_ forced to 2.5V                                             | DL_ forced to 2.5V                                             |                    | 3.3         |          | A       |
|                                                                    |                    | DL_ rising                                                     | DL_ rising                                                     |                    | 35          |          |         |
| Dead Time                                                          | t DEAD             | DH_ rising                                                     | DH_ rising                                                     |                    | 26          |          | ns      |
| LX_, BST_ Leakage Current                                          |                    | V BST _ = V LX _ = 26V                                         | V BST _ = V LX _ = 26V                                         |                    | <2          | 20       | µA      |
| INPUTS AND OUTPUTS                                                 | INPUTS AND OUTPUTS | INPUTS AND OUTPUTS                                             | INPUTS AND OUTPUTS                                             | INPUTS AND OUTPUTS |             |          |         |
...
|                                                                    |                    | Rising trip level                                              | Rising trip level                                              | 1.10               | 1.6         | 2.20     |         |
| SHDN Input Trip Level                                              |                    | Falling trip level                                             | Falling trip level                                             | 0.96               | 1           | 1.04     | V       |
...
| FSEL Three-Level Input Logic                  |          | High                                                        | High                                                        | V CC - 0.2 |          |         |
|                                               |          | REF                                                         | REF                                                         | 1.7        | 2.3      | V       |
|                                               |          | GND                                                         | GND                                                         |            | 0.4      | V       |
...
where VNOM is the nominal output voltage, ASLOPE equals 1%, and VRIPPLE is the output ripple voltage (VRIPPLE = ESR x Δ I INDUCTOR as described in the Output Capacitor Selection section).
...
where DMAX is the maximum duty factor (see the Electrical Characteristics table), T is the switching period (1/fOSC), and Δ T equals VOUT/VIN x T when in PWM mode, or L x 0.2 x IMAX/(VIN - VOUT) when in skip mode. The amount of overshoot during a full-load to no-load transient due to stored inductor energy can be calculated as:
