...
| Package Code                            | T1633Y+7C                               |
|-----------------------------------------|-----------------------------------------|
| Outline Number                          | 21-100446                               |
| Land Pattern Number                     | 90-100157                               |
| Thermal Resistance, Single-Layer Board: | Thermal Resistance, Single-Layer Board: |
| Junction to Ambient (θ JA )             | 68°C/W                                  |
| Junction to Case (θ JC )                | 10°C/W                                  |
| Thermal Resistance, Four-Layer Board:   | Thermal Resistance, Four-Layer Board:   |
...
|                                               |                 | MAX25520ATEC                                                                 | 4.5      |       |   5.5 | V       |
| IN UVLO Threshold                             | V IN_UVLO       | IN Voltage Rising                                                            | 2.4      | 2.5   |  2.57 |         |
...
|                                               | f BOOSTL        | MAX25520ATEA, dither disabled. Switching frequency for boost and inverter.   | 390      | 420   |   450 | kHz     |
...
| AVDD Output Voltage Range                     | V AVDD          | MAX25520ATEC                                                                 | 6        |       |    12 | V       |
...
| INN Voltage Range                   | V INN_RNG           | MAX25520ATEC                                                                                                  | 4.5                 |                     | 5.5                 | V                   |
...
| FLTB Output Leakage Current            | I LEAK_FLTB              | V FLTB = 5.5V                                                         |                          |                          | +1                       | µA                       |
...
Note 1: Limits are 100% tested at T A  = +25ºC and +125°C. Limits over the operating temperature range and relevant supply voltage range are guaranteed by design and characterization.
...
The converter has an internal soft-start that ramps the voltage up to its final value in 5ms. The negative source-driver supply voltage (NAVDD) is either tightly regulated to -AVDD within ±34mV (when FBN is connected to IN), or its output voltage is set by the resistors connected between V18, FBN, and NAVDD.
...
|                 4 | 6/26            | Added TQFN-SW package information                                    | 3                |
