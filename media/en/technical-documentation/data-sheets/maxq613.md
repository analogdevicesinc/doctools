...
- S Memory Features 48KB Program Flash Memory 512-Byte Sectors 20,000 Erase/Write Cycles per Sector Masked ROM Available 1.5KB Data SRAM
...
One SPI and One USART Port Programmable Watchdog Timer 8kHz Nanopower Ring Oscillator Wake-Up Timer

Up to 24 General-Purpose I/Os

- S Low Power Consumption

0.2µA (typ), 2.0µA (max) in Stop Mode, TA = +25 N C, Power-Fail Monitor Disabled 3.25mA (typ) at 12MHz in Active Mode
...
|----------------|------------------|-------------------------|-----------------------|--------------------|--------|---------------|
| MAXQ613A-0000+ | 0 N C to +70 N C | 1.7 to 3.6              | 48 Flash              |                1.5 |     20 | 32 TQFN-EP*   |
| MAXQ613J-0000+ | 0 N C to +70 N C | 1.7 to 3.6              | 48 Flash              |                1.5 |     24 | 44 TQFN-EP*   |
| MAXQ613X-0000+ | 0 N C to +70 N C | 1.7 to 3.6              | 48 Flash              |                1.5 |     24 | Bare die      |
...
(derate 27mW/ N C above +70 N

C).............................2162.2mW

44 TQFN (multilayer board)

(derate 37mW/ N C above +70 N C)................................2963mW

Operating Temperature Range ............................. 0 N C to +70 N C

Storage Temperature Range  ............................ -65 N C to +150 N C

Lead Temperature (excluding dice; soldering, 10s) ......+300
...
| POR Voltage                                                 | V POR    | Monitors VDD            | Monitors VDD            | 1                                                 |                                                   | 1.42                                              | V       |
| RAM Data-Retention Voltage                                  | V DRV    | (Note 4)                | (Note 4)                | 1.0                                               |                                                   |                                                   | V       |
| Active Current                                              | I DD_1   | Sysclk = 12MHz (Note 5) | Sysclk = 12MHz (Note 5) |                                                   | 3.25                                              | 4                                                 | mA      |
| Stop-Mode Current                                           | I S1     | Power-Fail Off          | T A = +25 N C           |                                                   | 0.2                                               | 2.0                                               | F A     |
| Stop-Mode Current                                           | I S1     | Power-Fail Off          | T A = 0 ° C to +70 N C  |                                                   | 0.2                                               | 8                                                 | F A     |
| Stop-Mode Current                                           | I S2     | Power-Fail On           | T A = +25 N C           |                                                   | 22                                                | 29.5                                              | F A     |
| Stop-Mode Current                                           | I S2     | Power-Fail On           | T A = 0 ° C to +70 N C  |                                                   | 27.6                                              | 42                                                | F A     |
...
| Power-Fail Warning Detection Time                           | t PFW    | (Note 8)                | (Note 8)                | 10                                                | 10                                                | 10                                                | F s     |
| Input Low Voltage for IRTX, IRRX, RESET , and All Port Pins | V IL     |                         |                         | VGND                                              | VGND                                              | 0.3 x VDD                                         | V       |
| Input High Voltage for IRTX, IRRX, , and All Port Pins      | V IH     | RESET                   | RESET                   | 0.7 x VDD                                         | 0.7 x VDD                                         | VDD                                               | V       |

## 16-Bit Microcontroller with Infrared Module MAXQ613
...
|---------------------------------------------------------|----------------------------|------------------------------------------------|----------------------------|----------------------------|----------------------------|----------------------------|
| Input Hysteresis (Schmitt)                              | V IHYS                     | VDD = 3.3V, T A = +25 N C                      |                            | 300                        |                            | mV                         |
| Input Low Voltage for HFXIN                             | VIL_HFXIN                  |                                                | VGND                       |                            | 0.3 x VDD                  | V                          |
| Input High Voltage for HFXIN                            | V IH_HFXIN                 |                                                | 0.7 x VDD                  |                            | VDD                        | V                          |
| IRRX Input Filter Pulse-Width Reject                    | t IRRX_R                   |                                                |                            |                            | 50                         | ns                         |
| IRRX Input Filter Pulse-Width Accept                    | t IRRX_A                   |                                                | 300                        |                            |                            | ns                         |
| Output Low Voltage for IRTX                             | V                          | VDD = 3.6V, I OL = 25mA (Note 3)               |                            |                            | 1.0                        | V                          |
| Output Low Voltage for IRTX                             | OL_IRTX                    | VDD = 2.35V, I OL = 10mA (Note 3)              |                            |                            | 1.0                        | V                          |
| Output Low Voltage for IRTX                             | V                          | VDD = 1.85V, I OL = 4.5mA                      |                            |                            | 1.0                        | V                          |
| Output Low Voltage for RESET and All Port Pins (Note 9) |                            | VDD = 3.6V, I OL = 11mA (Note 3)               |                            | 0.4                        | 0.5                        | V                          |
| Output Low Voltage for RESET and All Port Pins (Note 9) | V OL                       | VDD = 2.35V, I OL = 8mA (Note 3)               |                            | 0.4                        | 0.5                        | V                          |
| Output Low Voltage for RESET and All Port Pins (Note 9) |                            | VDD = 1.85V, I OL = 4.5mA                      |                            | 0.4                        | 0.5                        | V                          |
...
| Input Pullup Resistor for                               |                            | VDD = 3.0V, V OL = 0.4V (Note 4)               | 16                         | 28                         | 39                         | k W                        |
...
| System Clock Period                                     | t CK                       | HFXOUT = GND                                   |                            | f XCLK 1/f CK              |                            | ns                         |
...
| Flash Programming Time per Word             | tPROG      | (Note 10)     | 20      |       | 100           | F s     |
...
(VDD = VRST to 3.6V, TA = 0 N C to +70 N C, unless otherwise noted.) (Note 11)
...
| 14             | 14          | 18             | REGOUT     | 1.8V Regulator Output. This pin must be connected to ground through a 1.0 F F external ceramic-chip capacitor. The capacitor must be placed as close to this pin as possible. No devices other than the capacitor should be connected to this pin. |
...
| RESET PIN                                     | RESET PIN                                     | RESET PIN                                     | RESET PIN                                     | RESET PIN                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | RESET PIN                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
| CLOCK PINS                                    | CLOCK PINS                                    | CLOCK PINS                                    | CLOCK PINS                                    | CLOCK PINS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | CLOCK PINS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| 20                                            | 18                                            | 23                                            | HFXIN                                         | High-Frequency Crystal Input. Connect an external crystal or resonator between HFXIN and HFXOUT for use as the high-frequency system                                                                                                                                                                                                                                                                                                                                                                                                                                     | High-Frequency Crystal Input. Connect an external crystal or resonator between HFXIN and HFXOUT for use as the high-frequency system                                                                                                                                                                                                                                                                                                                                                                                                                                     |
| 21                                            | 19                                            | 24                                            | HFXOUT                                        | clock. Alternatively, HFXIN is the input for an external, high-frequency clock source when HFXOUT is unconnected.                                                                                                                                                                                                                                                                                                                                                                                                                                                        | clock. Alternatively, HFXIN is the input for an external, high-frequency clock source when HFXOUT is unconnected.                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| IR FUNCTION PINS                              | IR FUNCTION PINS                              | IR FUNCTION PINS                              | IR FUNCTION PINS                              | IR FUNCTION PINS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | IR FUNCTION PINS                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| 38                                            | 31                                            | 43                                            | IRTX                                          | IR Transmit Output. IR transmission pin capable of sinking 25mA. This pin defaults to a high-impedance input with the weak pullup disabled during all forms of reset. Software must configure this pin after release from reset to remove the high-impedance input condition.                                                                                                                                                                                                                                                                                            | IR Transmit Output. IR transmission pin capable of sinking 25mA. This pin defaults to a high-impedance input with the weak pullup disabled during all forms of reset. Software must configure this pin after release from reset to remove the high-impedance input condition.                                                                                                                                                                                                                                                                                            |
| 39                                            | 32                                            | 44                                            | IRRX                                          | IR Receive Input. This pin defaults to a high-impedance input with the weak pullup disabled during all forms of reset. Software must configure this pin after release from reset to remove the high-impedance input                                                                                                                                                                                                                                                                                                                                                      | IR Receive Input. This pin defaults to a high-impedance input with the weak pullup disabled during all forms of reset. Software must configure this pin after release from reset to remove the high-impedance input                                                                                                                                                                                                                                                                                                                                                      |
...
| 6                                             | 6                                             | 8                                             | P0.5/TBA0/ TBA1/INT13                         | P0.5                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Type B Timer 0 Pin A or Type Timer 1 Pin A/INT13                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
|                    |                    |                              |                    | by the PD2, PO2, and PI2 registers. All port pins default to high- impedance mode after a reset. Software must configure these pins after release from reset to remove the high-impedance condition. All special functions must be enabled from software before they can be used.                                                                                                                                                                         | by the PD2, PO2, and PI2 registers. All port pins default to high- impedance mode after a reset. Software must configure these pins after release from reset to remove the high-impedance condition. All special functions must be enabled from software before they can be used.                                                                                                                                                                         |
|                    |                    |                              |                    | GPIO PORT PIN                                                                                                                                                                                                                                                                                                                                                                                                                                             | SPECIAL FUNCTION                                                                                                                                                                                                                                                                                                                                                                                                                                          |
...
| -                  | 23                 | 2, 4, 15, 16, 30, 31, 36, 37 | N.C.               | No Connection. Not internally connected.                                                                                                                                                                                                                                                                                                                                                                                                                  | No Connection. Not internally connected.                                                                                                                                                                                                                                                                                                                                                                                                                  |
| -                  | -                  | -                            | EP                 | Exposed Pad. Connect EP directly to the ground plane.                                                                                                                                                                                                                                                                                                                                                                                                     | Exposed Pad. Connect EP directly to the ground plane.                                                                                                                                                                                                                                                                                                                                                                                                     |
...
-    User-callable routines for in-application flash program -ming,  buffer  copying,  and  fast  table  lookup  (more information  on  these  routines  can  be  found  in  the MAXQ610 User's Guide)
...
-  IR Input Clock (f IRCLK) = fSYS/2 IRDIV[2:0]
-    Carrier  Frequency  (f CARRIER)  =  fIRCLK/(IRCAH  + IRCAL + 2)
...
```
* Dest must be aligned to 16 bits. * Returns 0 = failure, 1 = OK. */ int  flash_write  (uint16_t  dest,  uint16_t
```
...
-  Background mode: CPU is executing the normal user program Allows the host to configure and set up the in-circuit
...
|                 1 | 7/10            | Corrected bare die numbers in the Pin Descriptio n table for V DD, GND, RESET , IRTX, IRRX, P2.5/TDI, P2.6/TMS, and P2.7/TDO                                                                                                                                | 9, 10, 11          |
...
|                 4 | 7/12            | Removed the ESR reference from the REGOUT description in the Pin Description table; changed the MAXQ core reference to MAXQ20S core in the Microprocessor section; updated the IRDIV bit range from [1:0] to [2:0] in the Carrier Generation Module section | 8, 11, 14          |
