...
|---------------|-------|----------------------------------------------------------------------------|
| C1, C8        |     2 | 2.2µF ±10%, 100V X7R ceramic capacitors (1210) Murata GRM32ER72A225KA35    |
...
| C7            |     1 | 47µF, 80V aluminum electrolytic capacitor (D = 10mm) Panasonic EEEFK1K470P |
| JU1-JU3       |     3 | 3-pin headers                                                              |

## Evaluates: MAX17504 in 3.3V Output-Voltage Application
...
| TP1, TP2      |     2 | Test pads                                                              |
| U1            |     1 | Buck converter (20 TQFN-EP*) Maxim MAX17504ATP+                        |
| -             |     3 | Shunts (JU1-JU3)                                                       |
| -             |     1 | PCB: MAX17504 - 3.3V Output EVKIT                                      |

Note: C7,  R1,  and  R2  are  optional  components;  R1  and  R2 are not needed if the EN/UVLO pin is permanently connected to  VIN.  The  electrolytic  capacitor  (C7)  is  required  only  when the VIN power supply is situated far from the MAX17504-based circuit. When R5 is open, the device switches at 500kHz switching frequency. The MSS1048 inductor has been used to prepare the EV kit test report.
...
The  MAX17504  3.3V  output  EV  kit  provides  a  proven design  to  evaluate  the  MAX17504  high-voltage,  highefficiency, synchronous step-down DC-DC converter. The EV	kit	is	preset	for	3.3V	output	from	5V	to	60V	input	at load currents up to 3.5A and features a 450kHz switching frequency for optimum efficiency and component size.
...
| SHUNT POSITION   | EN/UVLO PIN                                                | MAX17504_ OUTPUT                                        |
|------------------|------------------------------------------------------------|---------------------------------------------------------|
...
changes	 on	 the	 MODE	 pin	 are	 ignored	 during	 normal operation.	Refer	to	the	MAX17504	IC	data	sheet	for	more information	on	PWM,	PFM,	and	DCM	modes	of	operation.
...
| SHUNT POSITION   | MODE PIN          | MAX17504_ MODE        |
|------------------|-------------------|-----------------------|
...
| SHUNT POSITION   | SYNC PIN                      | MAX17504_ SYNC                                       |
|------------------|-------------------------------|------------------------------------------------------|
...
Figure 1. MAX17504 3.3V Output Load and Line Regulation (PWM Mode)
...
Figure 3. MAX17504 3.3V Output Load and Line Regulation (PFM Mode)
...
Figure 6. MAX17504 3.3V Output Full Load Bode Plot (VIN = 24V)

<!-- image -->

Figure 7. MAX17504 3.3V Output, No Load to 1.75A Load Transient (PWM Mode)
...
Figure 8. MAX17504 3.3V Output, 5mA to 1.75A Load Transient (PFM Mode)
...
Figure 9. MAX17504 3.3V Output, 50mA to 1.75A Load Transient (DCM Mode)

<!-- image -->

Figure 10. MAX17504 3.3V Output, 1.75A to 3.5A Load Transient

<!-- image -->

## Evaluates: MAX17504 in 3.3V Output-Voltage Application

Figure 11. MAX17504 3.3V Output EV Kit Schematic

<!-- image -->

Figure 12. MAX17504 3.3V Output EV Kit Component Placement Guide-Component Side

<!-- image -->

Figure 13. MAX17504 3.3V Output EV Kit Component Side PCB layout

<!-- image -->

## Evaluates: MAX17504 in 3.3V Output-Voltage Application

Figure 14. MAX17504 3.3V Output EV Kit PCB LayoutInner Layer 1

<!-- image -->

Figure 15. MAX17504 3.3V Output EV Kit PCB Layout-Inner Layer 2

<!-- image -->

## MAX17504 3.3V Output Evaluation Kit

Figure 16. MAX17504 3.3V Output EV Kit PCB LayoutSolder Side

<!-- image -->

## Evaluates: MAX17504 in 3.3V Output-Voltage Application

Figure 17. MAX17504 3.3V Output EV Kit Component Placement Guide-Top Solder Mask

<!-- image -->

Figure 18. MAX17504 3.3V Output EV Kit Component Placement Guide-Bottom Solder Mask
...
|                 1 | 2/14            | Corrected typo in Figure 6 | 5               |
