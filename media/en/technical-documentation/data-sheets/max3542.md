...
The MAX3542 includes a variable-gain low-noise amplifier (LNA), multiband tracking filters, a harmonic-rejection mixer, a low-noise IF amplifier, an IF power detector, and a variable-gain IF amplifier. The MAX3542 also includes fully  monolithic VCOs and tank circuits, as well as a complete frequency synthesizer. This highly integrated design allows for low-power tuner-on-board applications without the cost and power dissipation issues of dualconversion tuner solutions.
...
|-------------|-----------------|---------------|
| MAX3542CLM+ | 0 ° Cto +70 ° C | 48 LGA-EP*    |
...
|-----------------------------------------------------------------------------------------|
| UHF_IN, VHF_IN, IFIN_, IFOUT1_, IFOUT2_, IFAGC, RFAGC, VTUNE, LDO, MUX, CP,             |
| XTAL_ to GND........................................-0.3V to (V CC + 0.3V)              |
| SDA, SCL, ADDR2, ADDR1 to GND......................-0.3V to +3.6V                       |
| IFOUT__ Short-Circuit Duration .....................................Indefinite          |
| RF Input Power...............................................................+10dBm     |

| Continuous Power Dissipation (T A = +70°C) 48-Pin LGA (derate 25mW/°C above +70°C) .................1.4W   |
|------------------------------------------------------------------------------------------------------------|
...
(MAX3542 EV kit, VCC = +3.1V to +3.5V, TA = 0°C to +70°C, no RF signals at RF inputs, default register settings, VRFAGC = VIFAGC = +3V (minimum attenuation), unless otherwise noted. Typical values are at VCC = +3.3V, TA = +25°C, unless otherwise noted.) (Note 1)
...
(MAX3542 EV kit, VCC = +3.1V to +3.5V, TA = 0°C to +70°C, 75 Ω system impedance, default register settings, VRFAGC = VIFAGC = +3V (minimum attenuation), unless otherwise noted. Typical values are at VCC = +3.3V, TA = +25°C, unless otherwise noted.) (Note 1)

| PARAMETER                                 | CONDITIONS                                                        |                                                                   | MIN                        | TYP MAX                    |                            | UNITS                      |
|-------------------------------------------|-------------------------------------------------------------------|-------------------------------------------------------------------|----------------------------|----------------------------|----------------------------|----------------------------|
| RF INPUT TO IFOUT1_ OUTPUT                |                                                                   |                                                                   |                            |                            |                            |                            |
| Operating Frequency Range (see Table 7)   | Gain specification met across this frequency band                 | Gain specification met across this frequency band                 | 47                         |                            | 862                        | MHz                        |
| Output Frequency                          | Analog channel PIX carrier                                        | Analog channel PIX carrier                                        |                            | 38.9                       |                            | MHz                        |
|                                           | Digital channel center frequency                                  | Digital channel center frequency                                  |                            | 36                         |                            | MHz                        |
| Voltage Gain                              | Source impedance = 75 Ω , load impedance = 200 Ω                  | Maximum gain (V RFAGC = 3V)                                       | 34                         | 41                         | 49.5                       | dB                         |
| Voltage Gain                              | Source impedance = 75 Ω , load impedance = 200 Ω                  | Minimum gain (V RFAGC = 0.5V)                                     |                            | -10                        |                            | dB                         |
| Input Return Loss                         | Selected channel                                                  | Selected channel                                                  |                            | 10                         |                            | dB                         |
| Noise Figure                              | Maximum gain (V RFAGC = 3V)                                       | Maximum gain (V RFAGC = 3V)                                       |                            | 4.9                        |                            | dB                         |
| Input IP2 (In-Band and Out-of-Band Tones) | Maximum gain (V RFAGC = 3V)                                       | Maximum gain (V RFAGC = 3V)                                       |                            | 20                         |                            | dBm                        |
| Input IP2 (In-Band and Out-of-Band Tones) | At 12.5dB of gain                                                 | At 12.5dB of gain                                                 |                            | 30                         |                            | dBm                        |
| Input IP3 (In-Band and Out-of-Band Tones) | Maximum gain (V RFAGC = 3V)                                       | Maximum gain (V RFAGC = 3V)                                       |                            | -10                        |                            | dBm                        |
| Input IP3 (In-Band and Out-of-Band Tones) | At 12.5dB of gain                                                 | At 12.5dB of gain                                                 | 13                         |                            |                            | dBm                        |
| Input P 1dB                               | Maximum gain (V RFAGC = 3V)                                       | Maximum gain (V RFAGC = 3V)                                       |                            | -38                        |                            | dBm                        |
| Input P 1dB                               | At 12.5dB of gain                                                 | At 12.5dB of gain                                                 |                            | -5                         |                            | dBm                        |
| Beats Within Output                       | 0dBmV PIX carrier level                                           | 0dBmV PIX carrier level                                           |                            | -40                        |                            | dBc                        |
| Beats Within Output                       | VHF input, 140MHz to 500MHz                                       | VHF input, 140MHz to 500MHz                                       |                            | -60                        |                            | dBc                        |
| Beats, Converted to Output                | VHF input, 500MHz to 1400MHz                                      | VHF input, 500MHz to 1400MHz                                      |                            | -50                        |                            | dBc                        |
| Beats, Converted to Output                | UHF input, 950MHz to 1400MHz                                      | UHF input, 950MHz to 1400MHz                                      |                            | -60                        |                            | dBc                        |
| Gain Flatness                             | 47MHz to 54MHz                                                    | 47MHz to 54MHz                                                    |                            |                            | 2.5                        | dB P-P                     |
| Isolation                                 | 5MHz to 50MHz, RF input to IF output, relative to desired channel | 5MHz to 50MHz, RF input to IF output, relative to desired channel |                            | 60                         |                            | dBc                        |
| Port-to-Port Isolation                    | Isolation between RF input ports at 215MHz                        | Isolation between RF input ports at 215MHz                        |                            | 27                         |                            | dB                         |
| Image Rejection                           | Measured at 77.8MHz above desired channel's center frequency      | Measured at 77.8MHz above desired channel's center frequency      | 57                         | 70                         |                            | dBc                        |
| Spurious Leakage at RF Input              | 5Hz to 65MHz                                                      | 5Hz to 65MHz                                                      |                            | -40                        |                            | dBmV                       |
|                                           | 65MHz to 878MHz                                                   | 65MHz to 878MHz                                                   |                            | -40                        |                            |                            |
| Phase Noise (Single-Sideband)             | 1kHz                                                              | 1kHz                                                              |                            | -80                        |                            |                            |
| Phase Noise (Single-Sideband)             | 10kHz offset                                                      | 10kHz offset                                                      |                            |                            |                            |                            |
| Phase Noise (Single-Sideband)             | 100kHz offset (1.5kHz loop bandwidth)                             | 100kHz offset (1.5kHz loop bandwidth)                             |                            | -105                       |                            | dBc/Hz                     |
| Phase Noise (Single-Sideband)             | 1MHz offset (1.5kHz loop bandwidth)                               | 1MHz offset (1.5kHz loop bandwidth)                               |                            | -125                       |                            |                            |
| Output Return Loss                        | Balanced 50 Ω load                                                | Balanced 50 Ω load                                                |                            | 20                         |                            | dB                         |
...
| Input Impedance                           | Balanced                                                          | Balanced                                                          |                            | 2000                       |                            | Ω                          |
| Output Impedance                          | Balanced (Note 2)                                                 | Balanced (Note 2)                                                 |                            | 300                        |                            | Ω                          |
...
| Passband Gain Flatness                                      | 32MHz to 40MHz (Note 2)                                                | 32MHz to 40MHz (Note 2)                                                |                                                             |                                                             | 1.2                                                         | dB                                                          |
| Output Voltage                                              | V IFAGC = 3V (Note 2)                                                  | V IFAGC = 3V (Note 2)                                                  |                                                             |                                                             | 2.5                                                         | V P-P                                                       |
| AGC Gain Slope                                              | V IFAGC = 3V to 0.5V (Note 2)                                          | V IFAGC = 3V to 0.5V (Note 2)                                          |                                                             |                                                             | 27                                                          | dB/V                                                        |
| Equivalent Input-Voltage Noise Density                      | At 36MHz, maximum gain (V IFAGC = 3V) (Note 2)                         | At 36MHz, maximum gain (V IFAGC = 3V) (Note 2)                         |                                                             |                                                             | 7.3                                                         | nV/ √ Hz                                                    |
| Noise Figure Change vs. Attenuation                         |                                                                        |                                                                        |                                                             | < 0.35                                                      |                                                             | dB/dB                                                       |
| IM3                                                         | V OUT = 1V P-P , 40dB < gain < 60dB (Note 2)                           | V OUT = 1V P-P , 40dB < gain < 60dB (Note 2)                           | -56                                                         |                                                             |                                                             | dBc                                                         |
...
| FREQUENCY SYNTHESIZER-REFERENCE OSCILLATOR                  | FREQUENCY SYNTHESIZER-REFERENCE OSCILLATOR                             | FREQUENCY SYNTHESIZER-REFERENCE OSCILLATOR                             | FREQUENCY SYNTHESIZER-REFERENCE OSCILLATOR                  | FREQUENCY SYNTHESIZER-REFERENCE OSCILLATOR                  | FREQUENCY SYNTHESIZER-REFERENCE OSCILLATOR                  | FREQUENCY SYNTHESIZER-REFERENCE OSCILLATOR                  |
...
| Comparison                                                  | Frequency                                                              | Frequency                                                              | 63                                                          |                                                             | 500                                                         | kHz                                                         |
...
| -     | EP       | Exposed Paddle. Internally connected to GND. Solder evenly to the PCB ground plane for proper operation.                                                       |
...
|---------|------------------------|-----------|------------------------------|-------|---------|------------------------|-----------|-------------------|-------|-------------------|--------|--------|
| START   | 11000[ADDR2][ADDR1]    | 0 -       | 0x00                         | -     |         | 11000[ADDR2][ADDR1]    | 1 -       | D7-D0             | -     | D7-D0             | -      |        |
...
The IF overload detector is calibrated at the factory to attack at 0.7VP-P at the IFOUT1. Upon power-up, the baseband processor must read OD[2:0] from the ROM table and store it in the IFOVLD register.
...
|----------------|----------------|---------------|--------------------|
| 48 LGA-EP      | L4877A+1       | 21-0157       | 90-0302            |
...
|                 1 | 12/07           | CorrectTOC01graphandafewerrors                                                             | 1, 2, 5,7       |
|                 2 | 4/11            | Added soldering temperature and corrected lead temperature in the Absolute Maximum Ratings | 2               |
