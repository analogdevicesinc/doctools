...
The MAX1276/MAX1278 come in a 12-pin TQFN package, and are available in the extended (-40°C to +85°C) temperature range.
...
|---------------|--------------------|----------------|----------|
| MAX1276 ETC+T | -40 ° C to +85 ° C | 12 TQFN        | Unipolar |
| MAX1278 ETC+T | -40 ° C to +85 ° C | 12 TQFN        | Bipolar  |
...
| Temperature Range MAX127_ ETC................................................-40°C to +85°C        |
| Operating                                                                                          |
...
| Differential Input Voltage Range                                                         | V IN                                                                                     | AIN+ - AIN-, MAX1276                                                                     | 0                                                                                        |                                                                                          | V REF                                                                                    | V                                                                                        |
| Differential Input Voltage Range                                                         | V IN                                                                                     | AIN+ - AIN-, MAX1278                                                                     | -V REF / 2                                                                               |                                                                                          | +V REF / 2                                                                               |                                                                                          |
...
| Load Regulation                    |          | I SOURCE = 0 to 2mA                            |            | 0.3 0.5 |           | mV/mA   |
|                                    |          | I SINK = 0 to 200µA                            |            |         |           |         |
...
| Input Leakage Current              | I IL     | Output high impedance                          |            | ±0.2    | ±10       | µA      |
| POWER REQUIREMENTS                 |          |                                                |            |         |           |         |
...
| Partial Power-Down Mode            | I DD     | No SCLK                                        |            | 2       |           |         |
| Analog Supply Current,             | I DD     | f SCLK = 28.8MHz                               |            | 1       |           | µA      |
| Full Power-Down Mode               |          | No SCLK                                        |            | 0.3     | 1         |         |
|                                    |          | Operational, full-scale input at 1.8Msps       |            | 1       | 2.5 1     |         |
|                                    |          | Static, f SCLK = 28.8MHz                       |            | 0.4     |           | mA      |
| Digital Supply Current (Note 8)    |          | Partial/full power-down mode, f SCLK = 28.8MHz |            | 0.2     | 0.5       |         |
...
| SCLK Rise to DOUT Transition     | t DOUT   | CL = 30pF, V L = 4.75V to V DD | 14        | 14        | 14        | 14        |
|                                  | t DOUT   | CL = 30pF, V L = 2.7V to V DD  |           |           | 17        | ns        |
|                                  | t DOUT   | CL = 30pF, V L = 1.8V to V DD  | 24        | 24        | 24        | 24        |
...
| Power-Up Time; Full Power-Down   | t PWR-UP |                                | 2 ms      | 2 ms      | 2 ms      | 2 ms      |
| Restart Time; Partial Power-Down | t RCV    |                                | 16 Cycles | 16 Cycles | 16 Cycles | 16 Cycles |
...
(VDD = +5V, VL = VDD, fSCLK = 28.8MHz, fSAMPLE = 1.8Msps, TA = -40°C to +85°C, unless otherwise noted. Typical values are meas- ured at TA = +25°C.)
...
Figure 8 shows the unipolar transfer function for the MAX1276. Figure 9 shows the bipolar transfer function for the MAX1278. The MAX1276 output is straight binary, while the MAX1278 output is two's complement.
...
The MAX1276/MAX1278 serial interface is fully compatible with SPI/QSPI and MICROWIRE (see Figure 11). If a serial interface is available, set the CPU's serial interface in  master mode so the CPU generates the serial clock. Choose a clock frequency up to 28.8MHz.
...
The MAX1276/MAX1278 can be directly connected to  the  TMS320C54\_  family  of  DSPs  from  Texas Instruments, Inc. Set the DSP to generate its own clocks or use external clock signals. Use either the standard or buffered serial port. Figure 15 shows the simplest interface between the MAX1276/MAX1278 and the TMS320C54\_, where the transmit serial clock (CLKX) drives the receive serial clock (CLKR) and SCLK, and the transmit frame sync (FSX) drives the receive frame sync (FSR) and CNVST.
