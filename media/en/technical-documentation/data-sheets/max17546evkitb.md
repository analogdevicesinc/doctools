...
## Evaluates: MAX17546 5V Output-Voltage Application
...
- MAX17546EVKITB#
- 6.5V to 42V, 10A DC input power supply
...
- 2) Connect the positive terminal of the power supply to the VIN PCB pad and the negative terminal to the nearest PGND PCB pad. Connect the positive terminal terminal to the nearest PGND PCB pad.
...
The  EV  kit  provides  a  proven  design  to  evaluate  the MAX17546  high-voltage,  high-efficiency,  synchronous step-down DC-DC converter. The EV kit is preset for a 5V output from a 6.5V to 42V input at load currents up to 5A and features a 450kHz switching frequency for optimum efficiency and component size.

The EV kit includes an EN/UVLO PCB pad and JU1 to enable the output at a desired input voltage. The SYNC PCB  pad  allow  an  external  clock  to  synchronize  the device. JU2 allows the selection of a particular mode of operation  based  on  light-load  performance  requirements. An additional RESET PCB pad is available for monitoring when the converter output is in regulation.
...
installed  across pins 1-2 on JU1. To disable the output, install  a  shunt  across pins 2-3 on JU1 and pull the EN/ UVLO pin to GND. See Table 1 for JU1 settings.
...
| SHUNT POSITION   | EN/UVLO PIN                                                | MAX17546_ OUTPUT                                        |
|------------------|------------------------------------------------------------|---------------------------------------------------------|
...
| SHUNT POSITION   | MODE PIN          | MAX17546_ MODE        |
|------------------|-------------------|-----------------------|
...
LOAD CURRENT STEPPED FROM NO LOAD TO 2.5A 5V OUTPUT, PWM MODE
...
Note: Indicate that you are using the MAX17546 when contact- ing these component suppliers.
...
| PART            | TYPE   |
|-----------------|--------|
| MAX17546EVKITB# | EV Kit |

#Denotes RoHS compliant.

## MAX17546 5V Output Evaluation Kit Bill of Materials

|   Serial No. | Description                                    |   Quantity | Designator       | Part Number                       |
|--------------|------------------------------------------------|------------|------------------|-----------------------------------|
|            1 | 2.2μF ±10%, 50V X7R ceramic capacitor (1210)   |          2 | C1, C2           | TDK C3225X7R1H225K                |
|            2 | 0.1μF ±10%, 50V X7R ceramic capacitor (0603)   |          3 | C3,C4,C13        | MURATA GCM188R71H104K             |
|            3 | 47uF 50V aluminum electrolytic (D=10mm)        |          1 | C5               | NICHICON UUD1H470MCL              |
...
|            7 | 0.1μF ±10%, 50V X7R ceramic capacitor (0402)   |          1 | C11              | MURATA GRM155R71H104KE14          |
...
|           21 | Buck Converter MAX17546ATP+                    |          1 | U1               | MAX17546ATP+                      |
...
## MAX17546 5V Output Evaluation Kit Schematic

<!-- image -->

## MAX17546 5V Output Evaluation Kit PCB Layout

MAX17546 5V Output Evaluation Kit PCB Layout-Silk Top

<!-- image -->

MAX17546 5V Output Evaluation Kit PCB Layout-Top Layer

<!-- image -->

Evaluates: MAX17546

## MAX17546 5V Output Evaluation Kit PCB Layout (continued)

MAX17546 5V Output Evaluation Kit PCB Layout-Layer 2 Ground

<!-- image -->

MAX17546 5V Output Evaluation Kit PCB Layout-Layer 3 Power
...
MAX17546 5V Output Evaluation Kit PCB Layout-Bottom Layer
...
|                 1 | 8/17            | Updated the Quick Start and Soft-Start Input (SS) sections, and C omponent Suppliers table. Added a note to and updated Table 2. Replaced Bill of Materials, Schematic, and PCB Layout . | 1-2, 4-9        |
|                 2 | 4/18            | Updated the Title, Quick Start section, Table 2, Component Suppliers table and Jumper table, and replaced TOC10.                                                                         | 1-10            |
