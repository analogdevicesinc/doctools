...
Revision B | 1/2026 Update to the legend on Figure 8

Revision C | 7 /2026 Update to Table 30
...
-  SPI read: Rb/W bit and Address[5:0] on SDI, Data[15:0], the bit permanently set high, and conversion count[1:0] on SDO.
- 
...
| Bit   | Function                                                    | Description                                                                                                                                                                                                                                                                        | Status     | Access   |
|-------|-------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------|----------|
|       |                                                             | • A GMRquadrant sensor decode error occurs.                                                                                                                                                                                                                                        |            |          |
...
The ECCEDC register stores the error correction and detection codes (ECC) required when the user-configuration registers are updated. The ECC provides single bit error correction and double bit error detection capability. The hex value of 0x000F should be included in the ECC calculation, as shown in Table 30.
...
| [7:0]  | ECC_CONFIG0 | ECC for: GENERAL DIGIOEN 0x000F H1MAG H1PH H2MAG H2PH H3MAG[7:0] | R/W      |
