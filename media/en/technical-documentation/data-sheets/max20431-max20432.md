...
The  MAX20431/MAX20432  are  high-efficiency,  four-/ three-output DC-DC converters with a windowed watchdog.  The  OUT1  is  a  synchronous  step-down converter that converts vehicle battery voltage to 3.3V at up to 2.5A. The OUT3 boosts the OUT1 to 5V at up to 500mA,  while  the  OUT2/OUT4  (MAX20431)  or  OUT2 (MAX20432) low-voltage synchronous step-down converters  operate  from  OUT1  and  provide  a  0.5V  to 3.6875V output voltage range at up to 3A. All outputs achieve ±1.5% output error over load, line, and temperature range.
...
- Dual (MAX20431)/Single (MAX20432) Synchronous Buck Converters up to 3A
