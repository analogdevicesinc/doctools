...
## MAX17223 EV Kit Files

| FILE                                    | DESCRIPTION               |
|-----------------------------------------|---------------------------|
| MAX17223 EV BOM                         | EV Kit Bill of Material   |
| MAX17223 EV PCB Layout Diagrams         | EV Kit Layout             |
| MAX17223 EV Schematic                   | EV Kit Schematic          |
| MAX17223 EV Minimal Component Schematic | Minimal Component Circuit |
...
The  MAX17223  EV  kit  evaluates  the  MAX17220MAX17225 IC family of ultra-low quiescent current stepup DC-DC converters. The MAX17223 EV kit features two independent circuits to evaluate two different IC packages of the MAX17220-MAX17225 family. Both circuits on the EV  kit  operate  over  an  input  range  of  400mV  to  5.5V. Each circuit provides resistor-configurable output voltages from 1.8V to 5V in 100mV/step.

The  MAX17223  EV  Kit  comes  with  a  MAX17223ELT+ (µDFN)  and  a  MAX17223ENT+  (WLP)  installed.  The MAX17223ELT+ circuit is configured for a 3V output, and can deliver 225mA with 1.8V input. The MAX17223ENT+ circuit  is  configured  for  a  5V  output,  and  can  deliver 225mA with 3V input.

## EN for the WLP Circuit

The WLP circuit on the EV kit provides a jumper (JU1) to enable or disable the MAX17223ENT+. Refer to Table 1 for JU1 jumper settings.

## EN for the µDFN Circuit

The µDFN circuit on the EV kit provides a jumper (JU101) to enable/disable the MAX17223ELT+. Refer to Table 2 for JU101 jumper settings.

## Battery Holders

The MAX17223 EV kit provides battery holders for each of the two circuits. The battery holder V1 can accommodate a  CR1632  Lithium  Coin  cell  to  power  the  WLP  circuit, while the V101 can hold an Energizer 364/363 silver oxide cell to power the µDFN circuit.

Table 1. EN on MAX17223ENT+ (JU1)
...
## Table 2. EN on MAX17223ELT+ (JU101)
...
The MAX17223 EV kit can also evaluate other ICs in the MAX17220-MAX17225 IC family. To evaluate the other ICs, replace U1 and/or U101 with the desired IC/IC package. Refer  to  the  MAX17220 -MAX17225  IC  data  sheet  for additional information.
...
| PART           | TYPE   |
|----------------|--------|
| MAX17223EVKIT# | EV Kit |

# Denotes RoHS

## MAX17223 EV Kit Bill of Materials
...
|      7 | L101                      | -         |     1 | XFL4020-222ME                | COILCRAFT                              | 2.2µH        | INDUCTOR; SMT; METAL COMPOSITE CORE; 2.29H; TOL = ±20%; 8A; -40°C TO +125°C                                                             |
...
|     13 | U1                        | -         |     1 | MAX17223ENT+                 | MAXIM                                  | MAX17223ENT+ | IC; CONV; 0.4V TO 5.5V INPUT; NANOPOWER SYNCHRONOUS BOOST CONVERTER WITH TRUE SHUTDOWN; WLP6                                            |
|     14 | U101                      | -         |     1 | MAX17223ELT+                 | MAXIM                                  | MAX17223ELT+ | IC; CONV; 0.4V TO 5.5V INPUT; NANOPOWER SYNCHRONOUS BOOST CONVERTER WITH TRUE SHUTDOWN; UDFN6                                           |
...
## MAX17223 EV Kit Bill of Materials (continued)
...
| 17     | PCB                | -         |     1 | MAX17223                     | MAXIM                                | PCB     | PCB:MAX17223                                                                                                |
...
| 28     | R101A              | Spare     |     1 | RMCF1206FT768K; ERJ-8ENF7683 | STACKPOLE ELECTRONICS INC; PANASONIC | 768K    | RESISTOR; 1206; 768K Ω ; 1%; 100PPM; 0.25W; THICK FILM                                                      |
| 29     | R101B              | Spare     |     1 | RMCF1206FT324K               | STACKPOLE ELECTRONICS INC            | 324K    | RESISTOR; 1206; 324KΩ; 1%; 100PPM; 0.25W; THICK FILM                                                        |
...
## MAX17223 EV Kit Schematic

<!-- image -->

## MAX17223 Minimal Component Circuit Schematic

<!-- image -->

## MAX17223 EV Kit PCB Layout Diagrams

MAX17223 EV Kit-Top Silkscreen
...
MAX17223 EV Kit-Bottom

<!-- image -->

MAX17223 EV Kit-Bottom Silkscreen
...
|                 1 | 9/20            | Replaced TDFN with μDFN | 2               |
