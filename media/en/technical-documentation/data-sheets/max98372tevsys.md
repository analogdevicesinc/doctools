...
Communication  with  the  DEV  board  is  facilitated  by Windows® 7 (or newer) compatible software that provides a simple and intuitive graphical user interface (GUI). The MAX98372 evaluation  software  is  only  for  use  with  the MAX98372 EV System.
...
- User-supplied PC with Windows 7 or newer OS with two available USB ports
...
- 1) Visit www.maximintegrated.com/products/MAX98372 under the Design &amp; Development tab to download the latest version of the MAX98372 EV kit GUI software. Save the software to a temporary folder and unpack the zip file.
...
- 15) After the EV system is fully connected, configure the device  by  loading  the usb\_audio.98372 configura -tion file. This file is located in the Config\_Files folder in the Documents | Maxim Integrated | MAX98372 Software Files directory.
...
The Block  Diagram tab  provides  access  to  all  device registers  through  dialog  windows  that  contain  GUI  con-
...
trols  for  configuring  the  device. The dialog windows are opened  by  clicking  on  the  dialog  blocks  in  the  blockdiagram. The Control Registers tab provides access to the valid registers in the range from 0x01-0x51 as well as to the revision ID register 0xFF.

The  MAX98372  evaluation  software  is  compatible  with Windows 7 or newer OS. Visit www.maximintegrated.com/ products/MAX98372 under the Design &amp; Development tab to download the latest version of the MAX98372 EV kit GUI software. Refer to the MAX98372 IC data sheet for device register information.
...
| PART            | TYPE              |
|-----------------|-------------------|
| MAX98372TEVSYS# | Evaluation System |

# Denotes RoHS compliant.

## MAX98372 (TQFN) EV Kit Bill of Materials
...
|      3 | C4, C5                   | -         |     2 | GRM033R60J105MEA2; C0603X5R0J105M030; CL03A105MQ3CSN | MURATA/TDK/SAMSUNG        | 1UF                                                     | CAPACITOR; SMT (0201); CERAMIC CHIP; 1UF; 6.3V; TOL=20%; MODEL=GRM SERIES; TG=-55 DEGC TO +85 DEGC; TC=X5R                   |            |
...
|      7 | DVDD                     | -         |     1 | 5010 ?                                               | 5010 ?                    | 5010 TESTPOINT WITH 1.80MM HOLE DIA, RED, MULTIPURPOSE  | 5010 TESTPOINT WITH 1.80MM HOLE DIA, RED, MULTIPURPOSE                                                                       |            |
|      8 | FB1, FB2                 | -         |     2 | RC0805JR-070RL                                       | YAGEO PHYCOMP             | 0 RESISTOR; 0805; 0 OHM; 5%; JUMPER; 0.125W; THICK FILM | 0 RESISTOR; 0805; 0 OHM; 5%; JUMPER; 0.125W; THICK FILM                                                                      |            |
...
|     17 | TP1, TP2, TP4            | -         |     3 |                                                      | 5011 ?                    |                                                         | 5011 TEST POINT; PIN DIA=0.125IN; TOTAL LENGTH=0.445IN; BOARD HOLE=0.063IN; BLACK; PHOSPHOR BRONZE WIRE SILVER PLATE FINISH; | GND        |
|     18 | TP3                      | -         |     1 |                                                      | 5001 KEYSTONE             | N/A                                                     | TEST POINT; PIN DIA=0.1IN; TOTAL LENGTH=0.3IN; BOARD HOLE=0.04IN; BLACK; PHOSPHOR BRONZE WIRE SILVER PLATE FINISH;           | OUTN       |
|     19 | TP9                      | -         |     1 |                                                      | 5000 KEYSTONE             | N/A                                                     | TEST POINT; PIN DIA=0.1IN; TOTAL LENGTH=0.3IN; BOARD HOLE=0.04IN; RED; PHOSPHOR BRONZE WIRE SILVER PLATE FINISH;             | OUTP       |
|     20 | U1                       | -         |     1 | MAX98372                                             | MAXIM                     | MAX98372                                                | EVKIT PART-IC; MAX98372; TQFN32-EP; PKG. CODE: T3255+4C; PKG. OUTLINE NO.: 21-0140                                           |            |
|     21 | X1-X5                    | -         |     5 | 9020 BUSS                                            | WEICO WIRE                | MAXIMPAD                                                | EVK KIT PARTS; MAXIM PAD; WIRE; NATURAL; SOLID; WEICO WIRE; SOFT DRAWN BUS TYPE-S; 20AWG                                     |            |
|     22 | C1-C3, C9-C14            | DNP       |     0 | N/A                                                  | N/A                       | OPEN                                                    | CAPACITOR; 0402 PACKAGE; GENERIC                                                                                             |            |
|     23 | R7-R9, R12-R20           | DNP       |     0 | N/A                                                  | N/A                       | OPEN                                                    | RESISTOR; 0402 PACKAGE; GENERIC                                                                                              |            |
|     24 | PCB                      | -         |     1 | MAX98372_TQFN_DEV_APPS_A                             | MAXIM                     | PCB                                                     | PCB Board:MAX98372 TQFN DEV APPLICATION BOARD                                                                                |            |

## MAX98372 (TQFN) EV Kit Schematic
...
## MAX98372 (TQFN) EV Kit PCB Layout Diagrams

<!-- image -->

MAX98372 (TQFN) EV Kit Component Placement Guide-Top Silkscreen

<!-- image -->

MAX98372 (TQFN) EV Kit PCB Layout-Mask Top

MAX98372 (TQFN) EV Kit PCB Layout-Top

<!-- image -->

MAX98372 (TQFN) EV Kit PCB Layout-GND Layer 2

<!-- image -->

│

## MAX98372 (TQFN) EV Kit PCB Layout Diagrams (continued)

<!-- image -->

MAX98372 (TQFN) EV Kit PCB Layout-Signal GND Layer 3

<!-- image -->

MAX98372 (TQFN) EV Kit PCB Layout-Power Layer 4

MAX98372 (TQFN) EV Kit PCB Layout-GND Layer 5

<!-- image -->

MAX98372 (TQFN) EV Kit PCB Layout-Bottom
...
MAX98372 (TQFN) EV Kit PCB Layout-Mask Bottom

<!-- image -->

MAX98372 (TQFN) EV Kit Component Placement GuideBottom Silkscreen

MAX98372 (TQFN) EV Kit PCB Layout-Paste Top

<!-- image -->

MAX98372 (TQFN) EV Kit PCB Layout-Paste Bottom
