...
The DAC output range is 0V to VREF. For bipolar operation,  matched scaling resistors are provided in the MAX542 for use with an external precision op amp (such as the MAX400), generating a ±VREF output swing. The MAX542 also includes Kelvin-sense connections for the reference and analog ground pins to reduce layout sensitivity.
...
The MAX541 is available in 8-pin plastic DIP and SO packages. The MAX542 is available in 14-pin plastic DIP and SO packages.
...
|-------------|---------------|---------------|-------------|
| MAX541 ACPA | 0°C to +70°C  | 8 Plastic DIP | ±1          |
...
| REF, REFF, REFS to AGND........................-0.3V to (V DD + 0.3V)                 |
| AGND, AGNDF, AGNDS to DGND........................-0.3V to +0.3V                      |
| OUT, INV to AGND, DGND......................................-0.3V to V DD             |
...
| Operating Temperature Ranges MAX541 _C_ A/MAX542_C_D..............................0°C to +70°C                             |
...
| Resolution                                                   | N                                                            |                                                              |                                                              |                                                              |                                                              | Bits                                                         |                                                              |
| Integral Nonlinearity                                        | INL                                                          |                                                              | MAX54_A                                                      | ±0.5                                                         | ±1.0                                                         | LSB                                                          |                                                              |
| Integral Nonlinearity                                        |                                                              |                                                              | MAX54_B                                                      | ±0.5                                                         | ±2.0                                                         | LSB                                                          |                                                              |
| Integral Nonlinearity                                        |                                                              |                                                              | MAX54_C                                                      | ±0.5                                                         | ±4.0                                                         | LSB                                                          |                                                              |
| Differential Nonlinearity                                    | DNL                                                          | Guaranteed monotonic                                         | Guaranteed monotonic                                         | ±0.5                                                         | ±1.0                                                         | LSB                                                          |                                                              |
| Zero-Code Offset Error                                       | ZSE                                                          | T A = +25°C                                                  | T A = +25°C                                                  |                                                              | ±1                                                           | LSB                                                          |                                                              |
| Zero-Code Offset Error                                       |                                                              | T A = T MIN to T MAX                                         | T A = T MIN to T MAX                                         |                                                              | ±2                                                           | LSB                                                          |                                                              |
| Zero-Code Tempco                                             | ZS TC                                                        | T A = T MIN to T MAX                                         | T A = T MIN to T MAX                                         | ±0.05                                                        |                                                              | ppm/°C                                                       |                                                              |
| Gain Error (Note 1)                                          |                                                              | T A = +25°C                                                  | T A = +25°C                                                  |                                                              | ±5                                                           | LSB                                                          |                                                              |
| Gain Error (Note 1)                                          |                                                              | T A = T MIN to T MAX                                         | T A = T MIN to T MAX                                         |                                                              | ±10                                                          | LSB                                                          |                                                              |
| Gain-Error Tempco                                            |                                                              |                                                              |                                                              | ±0.1                                                         |                                                              | ppm/°C                                                       |                                                              |
| DAC Output Resistance                                        | R OUT                                                        | (Note 2)                                                     | (Note 2)                                                     | 6.25                                                         |                                                              | k Ω                                                          |                                                              |
| Bipolar Resistor Matching                                    |                                                              | MAX542                                                       | R FB /R INV                                                  | 1.0                                                          |                                                              |                                                              |                                                              |
| Bipolar Resistor Matching                                    |                                                              | MAX542                                                       | Ratio error                                                  |                                                              | ±0.015                                                       | %                                                            |                                                              |
| Bipolar Zero Offset Error                                    |                                                              | MAX542                                                       | T A = +25°C                                                  |                                                              | ±10                                                          | LSB                                                          |                                                              |
| Bipolar Zero Offset Error                                    |                                                              | MAX542                                                       | T A = T MIN to T MAX                                         |                                                              | ±20                                                          | LSB                                                          |                                                              |
| Bipolar Zero Tempco                                          | BZS TC                                                       | MAX542                                                       | MAX542                                                       | ±0.5                                                         |                                                              | ppm/°C                                                       |                                                              |
| Power-Supply Rejection                                       | PSR                                                          | 4.75V ≤ V DD ≤ 5.25V                                         | 4.75V ≤ V DD ≤ 5.25V                                         |                                                              | ±1.0                                                         | LSB                                                          |                                                              |
...
| Reference Input Range                                        | V REF                                                        | (Note 3)                                                     | (Note 3)                                                     |                                                              | 3.0                                                          | V                                                            |                                                              |
| Reference Input Resistance (Note 4)                          | R REF                                                        | Unipolar mode                                                | Unipolar mode                                                |                                                              |                                                              | k Ω                                                          |                                                              |
| Reference Input Resistance (Note 4)                          |                                                              | MAX542, bipolar mode                                         | MAX542, bipolar mode                                         |                                                              |                                                              | k Ω                                                          |                                                              |
...
| Voltage-Output Slew Rate                                     | SR                                                           | CL = 10pF (Note 5)                                           | CL = 10pF (Note 5)                                           | 25                                                           |                                                              | V/µs                                                         |                                                              |
| Output Settling Time                                         |                                                              | to ± 1 / 2 LSB of FS, CL = 10pF                              | to ± 1 / 2 LSB of FS, CL = 10pF                              | 1                                                            |                                                              | µs                                                           |                                                              |
...
| Digital Feedthrough                   |                                       | Code = 0000 hex; CS = V DD; LDAC = 0; SCLK, DIN = 0 to V DD levels |                                       | 10                                    |                                       | nVs                                   |
...
| LDAC Pulse Width                     | t LDAC   | MAX542          |    50 |       |       | ns      |
| CS High to LDAC Low Setup            | t LDACS  | MAX542 (Note 6) |    50 |       |       | ns      |
...
## \_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_\_Pin Descriptions (continued)
...
The MAX541/MAX542 voltage-output, 16-bit digital-toanalog converters (DACs) offer full 16-bit performance with less than 1LSB integral linearity error and less than 1LSB differential linearity error, thus ensuring monotonic performance. Serial data transfer minimizes the number of package pins required.

The MAX541/MAX542 are composed of two matched DAC sections, with a 12-bit inverted R-2R DAC forming the 12 LSBs and the 4 MSBs derived from 15 identically matched resistors. This architecture allows the lowest glitch  energy to be transferred to the DAC output on major-carry transitions. It also lowers the DAC output impedance by a factor of eight compared to a standard R-2R ladder, allowing unbuffered operation in mediumload applications.
...
The digital interface for the 16-bit DAC is based on a 3-wire standard that is compatible with SPI, QSPI, and MICROWIRE interfaces. The three digital inputs ( CS , DIN, and SCLK) load the digital input data serially into the DAC. LDAC (MAX542) updates the DAC output asynchronously.

All of the digital inputs include Schmitt-trigger buffers to accept slow-transition interfaces. This means that optocouplers can interface directly to the MAX541/MAX542 without additional external logic. The digital inputs are compatible with TTL/CMOS-logic levels.
...
| PART        | TEMP. RANGE     | PIN-PACKAGE     | INL (LSB)   |
|-------------|-----------------|-----------------|-------------|
| MAX541AEPA  | -40°C to +85°C  | 8 Plastic DIP   | ±1          |
| MAX541BEPA  | -40°C to +85°C  | 8 Plastic DIP   | ±2          |
| MAX541CEPA  | -40°C to +85°C  | 8 Plastic DIP   | ±4          |
| MAX541AESA  | -40°C to +85°C  | 8 SO            | ±1          |
| MAX541BESA  | -40°C to +85°C  | 8 SO            | ±2          |
| MAX541CESA  | -40°C to +85°C  | 8 SO            | ±4          |
| MAX542 ACPD | 0°C to +70°C    | 14 Plastic DIP  | ±1          |
