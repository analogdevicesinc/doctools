<!-- lastmod 2022-08-02 -->
## MAX17505EVKITBE# Evaluation Kit

## General Description

The MAX17505EVKITBE# evaluation kit (EV kit) provides a proven design to evaluate the MAX17505 high-voltage, high-efficiency,  synchronous  step-down  DC-DC converter. The EV kit is preset for 5V output at load currents up to  1.7A  and  features  a  500kHz  switching  frequency  for optimum  efficiency  and  component  size.  The  EV  kit features adjustable input undervoltage lockout, adjustable soft-start,  open-drain RESET signal,  and  external  clock synchronization. The EV kit also provides a good layout example, which is optimized for conducted, radiated EMI, and thermal performance. For more details about the IC benefits and features, refer to the MAX17505 data sheet.

## Features

- Operates from a 6.5V to 60V Input Supply
- Programmed 5V Output Voltage, 1.7A Load Current
...
## Evaluates: MAX17505 in 5V Output-Voltage Application
...
MAX17505EVKITBE# provides a proven design to evaluate the MAX17505 high-voltage, high-efficiency, synchronous step-down DC-DC converter. The EV kit is preset for 5V output from 6.5V to 60V input at load currents up to  1.7A  and  features  a  500kHz  switching  frequency  for optimum efficiency and component size.
...
For more details about setting the undervoltage lockout level, refer to the MAX17505 data sheet.

## Mode Selection (MODE)

The  EV  kit  provides  a  jumper  (JU2)  that  allows  the MAX17505 to operate in PWM, PFM, and DCM modes. Refer to the MAX17505 data sheet for more details on the modes of operation.
...
| SHUNT POSITION   | EN/UVLO PIN                                                | MAX17505 OUTPUT                                         |
|------------------|------------------------------------------------------------|---------------------------------------------------------|
...
| SHUNT POSITION   | MODE PIN          | MAX17505 MODE         |
|------------------|-------------------|-----------------------|
...
The EV kit provides a SYNC PCB pad to synchronize the MAX17505 to an optional external clock. Leave Jumper (JU3)  open  when  external  clock  signals  are  applied.  In the presence of a valid external clock for synchronization, the  MAX17505  operates  in  PWM  mode  only.  For  more details about external clock synchronization, refer to the MAX17505 data sheet.
...
| SHUNT POSITION   | SYNC PIN                      | MAX17505 SYNC                                        |
|------------------|-------------------------------|------------------------------------------------------|
...
The  MAX17505EVKITBE#  PCB  layout  provides  an optional electrolytic capacitor (CIN4 = 68μF/100V).

This capacitor limits the peak voltage at the input of the MAX17505 when the DC input source is 'Hot-Plugged' to the EV kit input terminals with long input cables. The equivalent  series  resistance  (ESR)  of  the  electrolytic capacitor  dampens  the  oscillations  caused  by  interaction  of  the  inductance  of  the  long  input  cables,  and  the ceramic capacitors at the buck converter input.
...
The MAX17505EVKITBE# PCB has designated footprints for  the  placement  of  conducted  EMI  filter  components as per the optional Bill of Material (BOM). Use of these filter  components  results  in  lower  conducted  EMI  below CISPR22 Class B limits. Remove the 0Ω resistor, which is  placed on the L1 footprint before installing conducted EMI filter components.  The MAX17505EVKITBE# EV kit PCB layout is also designed to limit radiated emissions from switching nodes of the power converter, resulting in radiated emissions below CISPR22 Class B limits.

## Ordering Information

| PART             | TYPE   |
|------------------|--------|
| MAX17505EVKITBE# | EV Kit |

# Denotes RoHS compliant.

## EV Kit Performance Report

(V IN  = 24V, V OUT  = 5V, I OUT  = 1.7A, f SW  = 500kHz, T A  = +25°C, unless otherwise noted.)
...
## MAX17505EVKITBE# Bill of Materials
...
|    18 | U1            | HIGH-EFFICIENCY; SYNCHRONOUS STEP-DOWN DC-DC CONVERTER; (TQFN20- EP 4mm x 4mm) |          1 | MAX17505ATP+                   |
...
|    25 | CO2, CIN3     | OPEN: Capacitor (1210)                                                         |          0 |                                |
...
## MAX17505EVKITBE# Schematic

<!-- image -->

## MAX17505EVKITBE# Evaluation Kit

## MAX17505EVKITBE# PCB Layout

MAX17505EVKITBE# PCB Layout-Top Silkscreen

<!-- image -->

MAX17505EVKITBE# PCB Layout-Layer 2

<!-- image -->

## Evaluates: MAX17505 in 5V Output-Voltage Application

MAX17505EVKITBE# PCB Layout-Top Layer

<!-- image -->

MAX17505EVKITBE# PCB Layout-Layer 3

<!-- image -->

│

## MAX17505EVKITBE# PCB Layout (Continued)

MAX17505EVKITBE# PCB Layout-Bottom Layer

<!-- image -->

MAX17505EVKITBE# PCB Layout-Bottom Silkscreen
