...
The  devices  are  in  lead-free,  48-pin,  7mm  x  7mm TQFN  and  side-wettable  TQFN  (SWTQFN)  packages with exposed pad and 0.5mm lead pitch.
...
| Figure 32. Format Conversion Between GMSL UART and I 2 C with Register Address (I2CMETHOD = 1).                                                              | 38                            |
...
| Table 19. HDCP Authentication and Normal Operation (One Repeater, Two µCs) -First and Second Parts of the HDCP Authentication Protocol . . . . . . . . . . . . . . . . . . . . . . . . . . . .                              |   56 |
...
| Continuous Power Dissipation (T A = +70°C) TQFN/SWTQFN (derate 47.6mW/°C above +70°C) ............................................................3200mW   |
|------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| SINGLE-ENDED INPUTS (IN+, IN-)                     | SINGLE-ENDED INPUTS (IN+, IN-)              | SINGLE-ENDED INPUTS (IN+, IN-)                                   | SINGLE-ENDED INPUTS (IN+, IN-)                                   |               |       |               |         |
...
| THREE-LEVEL LOGIC INPUTS (BWS, ADD_, CX/TP)        | THREE-LEVEL LOGIC INPUTS (BWS, ADD_, CX/TP) | THREE-LEVEL LOGIC INPUTS (BWS, ADD_, CX/TP)                      | THREE-LEVEL LOGIC INPUTS (BWS, ADD_, CX/TP)                      |               |       |               |         |
...
| LVDS OUTPUTS (TXOUT_, TXCLKOUT_ (Figure 4)         | LVDS OUTPUTS (TXOUT_, TXCLKOUT_ (Figure 4)  | LVDS OUTPUTS (TXOUT_, TXCLKOUT_ (Figure 4)                       | LVDS OUTPUTS (TXOUT_, TXCLKOUT_ (Figure 4)                       |               |       |               |         |
| Differential Output Voltage                        | V OD                                        |                                                                  |                                                                  | 250           |       | 450           | mV      |
| Change in V OS Between Complementary Output States | ΔV OD                                       |                                                                  |                                                                  |               |       | 25            | mV      |
| Output Offset Voltage                              | V OS                                        |                                                                  |                                                                  | 1.125         |       | 1.375         | V       |
| Cange in V OS Between Complementary Output States  | ΔV OS                                       |                                                                  |                                                                  |               |       | 25            | mV      |
| Output Short-Circuit Current                       | I OS                                        | V OUT = 0 or 3.6V                                                | 3.5mA LVDS output                                                | -7.5          |       | +7.5          | mA      |
|                                                    | I OS                                        | 7mALVDS output                                                   | 7mALVDS output                                                   | -15           |       | +15           | mA      |
| Magnitude of Differential Output                   | I OSD                                       | 3.5mA LVDS output                                                | 3.5mA LVDS output                                                |               |       | 7.5           | mA      |
| Short-Circuit Current                              | I OSD                                       | 7mALVDS output                                                   | 7mALVDS output                                                   |               |       | 15            | mA      |
...
| Data Setup Time                     | t SU:DAT | f SCL range  | Low  |   250 |       |       | µs      |
| Data Setup Time                     | t SU:DAT | f SCL range  | Mid  |   100 |       |       | µs      |
| Data Setup Time                     | t SU:DAT | f SCL range  | High |    50 |       |       | µs      |
...
| Deserializer Delay                                    | t SD                      | (Note 11) Figure 11                                                      | (Note 11) Figure 11                                                      | 38                        |                           | 48                        | t PCLK                    |
...
Note 7: I IOVDD  not production tested. HDCP not enabled (MAX9282 only). See Table 21 for additional supply current when HDCP is enabled
...
Note 11: Measured in pixel clock bit times. t PCLK  = 1/ x f TXCLKOUT\_ .
...
| 8             | HIM    | High-Immunity Mode Input with Internal Pulldown to EP. Default HIGHIMM bit value is latched at power- up or when resuming from power-down mode ( PWDN = low) and is active-high. HIGHIMM can be programmed to a different value after power-up. HIGHIMM in the serializer must be set to the same value. |
...
| PIN    | NAME   | FUNCTION                                                                                                                                                                                                                                                                                                          |
|--------|--------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 9      | EQS    | Equalizer Select Input with Internal Pulldown to EP. The state of EQS is latched at power-up or when resuming from power-down mode ( PWDN = low). EQS = low selects 10.7dB boost. EQS = high selects 5.7dB boost.                                                                                                 |
...
| 18     | SD     | I 2 S/TDM Serial-Data Output. Disable I 2 S/TDM encoding to serial data to use SD as an additional control/data output valid on the selected edge of TXCLKOUT_. Encrypted when HDCP is enabled (MAX9282 only).                                                                                                    |
...
| 40                    | ADD0                 | Three-Level Address Selection Input with Internal Pulldown to EP. The state of ADD0 is latched at power-up or when resuming from power-down mode ( PWDN = low). See Table 1.                                                                                                                                           |
| 41                    | ADD1                 | Three-Level Address Selection Input with Internal Pulldown to EP. The state of ADD1 is latched at power-up or when resuming from power-down mode ( PWDN = low). See Table 1.                                                                                                                                           |
...
| 46                    | DRS                  | Data-Rate Select Input with Internal Pulldown to EP (Default). The state of DRS is latched at power- up or when resuming from power-down mode ( PWDN = low). Set DRS = high for slow TXCLKOUT_ frequencies (Table 4). Set SSEN = low for fast TXCLKOUT_ frequencies.                                                   |
...
The control channel enables a µC to program the serializer  and deserializer registers and program registers on peripherals. The control channel is also used to perform HDCP functions (MAX9282 only). The µC can be located at  either  end  of  the  link,  or  when  using  two  µCs,  at both ends. Two modes of control-channel operation are available.  Base  mode  uses  either  I 2 C  or  GMSL  UART protocol, while bypass mode uses a user-defined UART protocol.  UART  protocol  allows  full-duplex  communication, while I 2 C allows half-duplex communication.
...
## MAX9278/MAX9282 3.12Gbps GMSL Deserializers for Coax or STP Input and LVDS Output
...
The  µC  cannot  access  the  serializer/deserializer's  registers  in  this  mode.  Peripherals  accessed  through  the forward  control  channel  using  the  UART  interface  need to handle at least one TXCLKOUT period ±10ns of jitter due  to  the  asynchronous  sampling  of  the  UART  signal by TXCLKOUT. Set MS/HVEN = high to put the control channel into bypass mode. For applications with the µC connected  to  the  deserializer,  there  is  a  1ms  wait  time between setting MS high and the bypass control channel being  active.  There  is  no  delay  time  when  switching  to bypass  mode  when  the  µC  is  connected  to  the  serializer. Do not send a logic-low value longer than 100µs to ensure proper GPO functionality. Bypass mode accepts bit  rates  down  to  10kbps  in  either  direction.  See  the GPO/GPI Control section for GPI functionality limitations. The control-channel data pattern should not be held low longer than 100µs if GPI control is used.

Figure 32. Format Conversion Between GMSL UART and I 2 C with Register Address (I2CMETHOD = 1)
...
| 7     | Starts and completes the first part of the authentication protocol between TX_B1, RX_R1 (see steps 6-10 in Table 11).                                                                                                                                                                                                                                                         | -                                                                                                                                                                                           | TX_B1: According to commands from µC_B, generates AN, computes R0.           | RX_R1: According to commands from µC_B, computes R0'.                               |
...
|-------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|
| NO.   | µC_B                                                                                                                                                                                                                                                                                           | µC_R                                                                                                                                                                              | TX_B1 CDS = 0 TX_R1 CDS = 0 TX_R2 CDS = 0                                 | RX_R1 CDS = 1 RX_D1 CDS = 0 RX_D2 CDS = 0                                                                               |
| 8     | -                                                                                                                                                                                                                                                                                              | When GPIO_1 = 1 is detected, starts and completes the first part of the authentication protocol between the (TX_R1, RX_D1) and (TX_R2, RX_D2) links (see steps 6-10 in Table 11). | TX_R1, TX_R2: According to commands from µC_R, generates AN, computes R0. | RX_D1, RX_D2: According to commands from µC_R, computes R0'.                                                            |
...
The  serializers  include  a  PRBS  pattern  generator  that works with bit-error verification in the deserializer. To run the PRBS test, First disable HDCP enctyption. Next, set DISHSFILT, DISVSFILT, and DISDEFILT to 1, to disable glitch  filter  in  the  deserializer.  Then,  set  PRBSEN  =  1 (0x04, D5) in the serializer and then in the deserializer. To exit the PRBS test, set PRBSEN = 0 (0x04, D5) in the deserializer and then in the serializer.
...
| I 2 S encoding                | If feature not supported in serializer, must disable I 2 S in the MAX9278/MAX9282.                                                                                        |
...
HDCP  operation  (MAX9282  only)  draws additional current. This is shown in Table 21.
...
| 0x01               |        | SS        | 1           | Registers 0x00 to 0x1F are read only                                                                           |                 |
|                    | D[7:6] |           | 00          | No spread spectrum. Power-up default when SSEN = low.                                                          | 00              |
|                    | D[7:6] |           | 01          | ±2% spread spectrum. Power-up default when SSEN = high.                                                        | 00              |
|                    | D[7:6] |           | 10          | No spread spectrum                                                                                             | 00              |
|                    | D[7:6] |           | 11          | ±4% spread spectrum                                                                                            | 00              |
...
| 0x03               | D[4:0] | SDIV      | 00000 XXXXX | Auto calibrate sawtooth divider Manual SDIV setting. See the Manual Programming of the Spread-Spectrum Divider | 00000           |
...
| 0x04               | D6     | OUTENB    | 0       | Enable CNTL and I 2 S outputs                                                                    | 0               |
| 0x04               | D6     | OUTENB    | 1       | Disable CNTL and I 2 S outputs                                                                   | 0               |
...
| 0x04               | D[3:2] | INTTYPE   | 00      | Deserializer control channel uses UART-to-I 2 C when I2CSEL = 0                                  | 01              |
| 0x04               | D[3:2] | INTTYPE   | 01      | Deserializer control channel uses UART-to UART when I2CSEL = 0                                   | 01              |
| 0x04               | D[3:2] | INTTYPE   | 10, 11  | Deserializer control channel disabled                                                            | 01              |
...
|                    | D[3:0] | EQTUNE    | 0100    | 5.2dB equalizer boost gain. Power-up default when SSEN = high.                                   | 0100, 1001      |
...
|                    | D[3:0] | EQTUNE    | 1001    | 10.7dB equalizer boost gain. Power-up default when SSEN = low.                                   | 0100, 1001      |
...
| 0x06               | D6     | AUTORST   | 0        | No automatic reset of error registers and outputs                 | 0                    |
...
| 0x08               | D0     | DISHSFILT | 0        | Enable HS glitch filter. Power-up default BwhnWS = low or high.   | 0, 1                 |
...
| 0x0F               | D2        | INVDE              | 0 1               | No DE inversion at the output                                                                         | 0               |
| 0x0F               | D1        | DISRWAKE           | 0 1               | Invert DE at the output Enable remote wake-up Disable remote wake-up                                  | 0               |
| 0x0F               | D0        | INTOUT             | 0 1               | Drive INTOUT low Drive INTOUT high                                                                    | 0               |
| 0x10               | D[7:0]    | -                  | XXXXXXXX          | Reserved                                                                                              | (Read only)     |
| 0x10               |           |                    | 0 1               | High-immunity reverse 500kbps bit rate High-immunity reverse control-channel mode uses 1Mbps bit rate | 0100010         |
| 0x11               | D[6:0]    |                    |                   |                                                                                                       |                 |
|                    | D7        | REVFAST            |                   | control-channel mode uses                                                                             | 0               |
| 0x12               | D7 D[6:0] | MCLKDIV            | 1 0000000 XXXXXXX | MCLK derived from TXCLKOUT (see Table 6) MCLK derived from internal oscillator                        | 0               |
|                    |           | -                  | 0100010           | Reserved                                                                                              |                 |
|                    |           | MCLKSRC            | 0                 | MCLK disabled MCLK divider                                                                            | 0000000         |
|                    | D[7:0]    | -                  | 0X010000          | Reserved                                                                                              | 0X010000        |
| 0x13               |           |                    |                   | No VS inversion at the                                                                                |                 |
| 0x14               | D7        | INVVSYNC           | 0                 | output                                                                                                | 0               |
| 0x14               | D6        |                    | 1 0               | Invert VS at the output No HS inversion at the output                                                 | 0               |
| 0x14               | D5        | INVHSYNC FORCELVDS | 1 0               | Invert HS at the output Normal LVDS output operation                                                  | 0               |
| 0x14               | D4        | DCS                | 1 0               | LVDS output forced low Normal CMOS output driver current Boosted CMOS output driver                   | 0               |
| 0x14               | D3        |                    | 1 0               | current Serial-data bit 27 mapped to CNTL1                                                            | 1               |
| 0x14               | D2        | DISCNTL            | 1                 | (when BWS = high) CNTL1 forced low (when BWS = high)                                                  | 0               |
| 0x14               |           | DISRES             | 0 1               | Serial-data bit 27 mapped to RES bit (when BWS = high)                                                |                 |
| 0x14               |           |                    | 00                | RES bit forced low (when BWS = high)                                                                  |                 |
| 0x14               | D[1:0]    |                    |                   | 1.75mA LVDS driver current                                                                            | 01              |
| 0x14               |           | ILVDS              | 01 10             | 3.5mA LVDS driver current 5.25mA LVDS driver current                                                  |                 |
| 0x14               |           |                    | 11                | 7mALVDS driver current                                                                                |                 |
...
| 0x1D               | D[4:3] | HVSRC     | 00      | D18/D19 used for HS/VS (normal opeartion) D14/D15 used for HS/VS (D[19:16] shifted to            |              00 |
...
| 0x1F               | D4     | CAPS      | 0        | Not HDCP capable (MAX9278)                                     | (Read only)          |
| 0x1F               | D4     | CAPS      | 1        | HDCP capable (MAX9282)                                         | (Read only)          |
...
|                 2 | 3/18            | Deleted QFND package and added side-wettable TQFN (SWTQFN) package in General Description , Absolute Maximum Ratings , Package Thermal Characteristics , Pin Configuration , Ordering Information , and Package Information sections | 1,8, 18, 74                                   |
