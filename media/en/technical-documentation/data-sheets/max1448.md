...
- ♦ Excellent Dynamic Performance 59dB SNR at fIN = 20MHz 74dBc SFDR at fIN = 20MHz
...
| DC ACCURACY                                               |                                                           |                                                           |       |               |       |         |
| Resolution                                                |                                                           |                                                           |    10 |               |       | Bits    |
| Integral Nonlinearity                                     | INL                                                       | f IN = 7.47MHz, T A ≥ +25°C                               |       | ± 0.7         | ± 2.2 | LSB     |
| Differential Nonlinearity                                 | DNL                                                       | f IN =7.47MHz,nomissing codes                             |       | ± 0.4         | ± 1.0 | LSB     |
...
| DYNAMIC CHARACTERISTICS (F CLK = 83.3MHZ, 4096-POINT FFT) | DYNAMIC CHARACTERISTICS (F CLK = 83.3MHZ, 4096-POINT FFT) | DYNAMIC CHARACTERISTICS (F CLK = 83.3MHZ, 4096-POINT FFT) |       |               |       |         |
| Signal-to-Noise Ratio                                     | SNR                                                       | f IN = 7.47MHz                                            |  56.5 | 59.1          |       | dB      |
| Signal-to-Noise Ratio                                     | SNR                                                       | f IN = 20MHz                                              |    56 | 59            |       | dB      |
| Signal-to-Noise Ratio                                     | SNR                                                       | f IN = 39.9MHz (Note 1)                                   |       | 58.5          |       | dB      |
| Signal-to-Noise + Distortion (Up to 5th Harmonic)         | SINAD                                                     | f IN = 7.47MHz                                            |  55.8 | 59            |       | dB      |
| Signal-to-Noise + Distortion (Up to 5th Harmonic)         | SINAD                                                     | f IN = 20MHz                                              |  55.3 | 58.8          |       | dB      |
| Signal-to-Noise + Distortion (Up to 5th Harmonic)         | SINAD                                                     | f IN = 39.9MHz (Note 1)                                   |       | 58            |       | dB      |
...
| PARAMETER                                      | SYMBOL                                         | CONDITIONS                                                  | MIN                                            | TYP                                            | MAX                                            | UNITS                                          |
|------------------------------------------------|------------------------------------------------|-------------------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|------------------------------------------------|
| Spurious-Free Dynamic Range                    | SFDR                                           | f IN = 7.47MHz                                              | 61                                             | 74                                             |                                                | dBc                                            |
|                                                | SFDR                                           | f IN = 20MHz                                                | 61                                             | 74                                             |                                                | dBc                                            |
|                                                | SFDR                                           | f IN = 39.9MHz (Note 1)                                     |                                                | 73                                             |                                                | dBc                                            |
| Third-Harmonic Distortion                      | HD3                                            | f IN = 7.47MHz                                              |                                                | -74                                            |                                                | dBc                                            |
| Third-Harmonic Distortion                      | HD3                                            | f IN = 20MHz                                                |                                                | -74                                            |                                                | dBc                                            |
| Third-Harmonic Distortion                      | HD3                                            | f IN = 39.9MHz (Note 1)                                     |                                                | -73                                            |                                                | dBc                                            |
| Intermodulation Distortion Two-Tone            | IMD TT                                         | f 1 = 24MHz at -6.5dB FS, f 2 = 26MHz at -6.5dB FS (Note 2) |                                                | -74                                            |                                                | dBc                                            |
| Third-Order Intermodulation Distortion         | IM3                                            | f 1 = 24MHz at -6.5dB FS, f 2 = 26MHz at -6.5dB FS (Note 2) |                                                | -74                                            |                                                | dBc                                            |
| Total Harmonic Distortion (First 5 Harmonics)  | THD                                            | f IN = 7.47MHz                                              |                                                | -72                                            | -60                                            | dBc                                            |
|                                                | THD                                            | f IN = 20MHz                                                |                                                | -70                                            | -60                                            | dBc                                            |
|                                                | THD                                            | f IN = 39.9MHz (Note 1)                                     |                                                | -69                                            |                                                | dBc                                            |
...
| DIGITALINPUTS(CLK, PD, OE )                                                                       | DIGITALINPUTS(CLK, PD, OE )                                                                       | DIGITALINPUTS(CLK, PD, OE )                                                                       | DIGITALINPUTS(CLK, PD, OE )                                                                       | DIGITALINPUTS(CLK, PD, OE )                                                                       | DIGITALINPUTS(CLK, PD, OE )                                                                       | DIGITALINPUTS(CLK, PD, OE )                                                                       |
| Input High Threshold                                                                              | V IH                                                                                              | CLK                                                                                               | 0.8 x V DD                                                                                        |                                                                                                   |                                                                                                   | V                                                                                                 |
| Input High Threshold                                                                              | V IH                                                                                              | PD, OE                                                                                            | 0.8 x OV DD                                                                                       |                                                                                                   |                                                                                                   | V                                                                                                 |
| Input Low Threshold                                                                               | V IL                                                                                              | CLK                                                                                               |                                                                                                   |                                                                                                   | 0.2 x OV DD                                                                                       | V                                                                                                 |
| Input Low Threshold                                                                               | V IL                                                                                              | PD, OE                                                                                            |                                                                                                   |                                                                                                   | 0.2 x OV DD                                                                                       | V                                                                                                 |
| Input Capacitance                                                                                 | CIN                                                                                               |                                                                                                   |                                                                                                   | 5                                                                                                 |                                                                                                   | pF                                                                                                |
| Input Hysteresis                                                                                  | V HYST                                                                                            |                                                                                                   |                                                                                                   | 0.1                                                                                               |                                                                                                   | V                                                                                                 |
| Input Leakage                                                                                     | I IH                                                                                              | V IH = V DD = 0V DD                                                                               |                                                                                                   |                                                                                                   | ±5                                                                                                | µA                                                                                                |
|                                                                                                   | I IL                                                                                              | V IL = 0                                                                                          |                                                                                                   |                                                                                                   | ±5                                                                                                |                                                                                                   |
...
| Analog Supply Current         | I VDD                  | Operating, f IN = 20MHz at -0.5dB FS            |                        | 40                     | 47                     | mA                     |
| Analog Supply Current         | I VDD                  | Shutdown, clock idle, PD = OE = OV DD           |                        | 4                      | 15                     | µA                     |
| Output Supply Current         | I OVDD                 | Operating, CL = 15pF, f IN = 20MHz at -0.5dB FS |                        | 8                      |                        | mA                     |
| Output Supply Current         | I OVDD                 | Shutdown, clock idle, PD = OE = OV DD           |                        | 1                      | 20                     | µA                     |
| Power-Supply Rejection        | PSRR                   | Offset                                          |                        | ± 0.2                  |                        | mV/V                   |
...
| CLK Pulse Width High          | t CH                   | Figure 6, clock period 12ns                     |                        | 6±1                    |                        | ns                     |
| CLK Pulse Width Low           | t CL                   | Figure 6, clock period 12ns                     |                        | 6±1                    |                        | ns                     |
...
(VDD = 3.0V, OVDD = 2.7V, internal reference, differential input at -0.5dB FS, fCLK = 83.3MHz, CL ≈ 10pF, TA = +25°C, unless other-
...
| 31                  | REFIN  | Reference Input. V REFIN = 2 × (V REFP - V REFN ). Bypass to GND with a >0.1µF capacitor.                 |
...
The MAX1448 uses a 10-stage, fully differential, pipelined architecture (Figure 1) that allows for highspeed conversion while minimizing power consumption.  Each sample moves through a pipeline stage every half clock-cycle. Counting the delay through the output latch, the clock-cycle latency is 5.5.
...
The capacitive load on the digital outputs D0-D9 should be kept as low as possible (&lt;15pF) to avoid large digital currents that could feed back into the analog portion of the MAX1448, degrading its dynamic performance. Using buffers on the ADC's digital outputs can further isolate the digital outputs from heavy capacitive loads. To further improve the MAX1448's dynamic performance, small series resistors (e.g., 100 Ω ) may be added to the digital output paths, close to the ADC.
...
Multiple-converter systems based on the MAX1448 are well  suited  for  use  with  a  common  reference  voltage. The REFIN pin of those converters can be connected directly  to  an  external  reference  source.  A  precision bandgap reference like the MAX6062 generates an external DC level of 2.048V (Figure 10), and exhibits a noise voltage density of 150nV/ √ Hz .  Its  output  passes through a 1-pole lowpass filter (with 10Hz cutoff fre- quency) to the MAX4250, which buffers the reference before its output is applied to a second 10Hz lowpass filter.  The  MAX4250 provides a low offset voltage (for high-gain accuracy) and a low noise level. The passive 10Hz filter following the buffer attenuates noise produced in the voltage reference and buffer stages. This filtered  noise  density,  which  decreases  for  higher  frequencies, meets the noise levels specified for precision ADC operation.
