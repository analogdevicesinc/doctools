...
The  MAX3784A  evaluation  kit  (EV  kit)  simplifies evaluation of the MAX3784A 5Gbps equalizer with increased  output  signal  amplitude.    The  EV  kit enables testing of all device functions.    SMA connectors  with  50 Ω controlled  impedance  to  the MAX3784A are provided for all high-speed ports to facilitate connection to test equipment.
...
| U1                 |     1 | MAX3784A, 16-pin QFN Note: U1 has an exposed pad, which requires that it be solder-attached to the circuit board to ensure proper functionality of the part. |
...
|---------------|--------------|--------------|
| MAX3784AEVKIT | 0 C to +85 C | 16 QFN       |
...
Figure 2. MAX3784A EV Kit PC Component Placement Guide-Component Side

Figure 3. MAX3784A EV Kit PC Board LayoutComponent Side

<!-- image -->

Figure 4. MAX3784A EV Kit PC Board LayoutGround Plane
...
Figure 5. MAX3784A EV Kit PC Board LayoutPower Plane

<!-- image -->

Figure 6. MAX3784A EV Kit PC Board LayoutSolder Side
