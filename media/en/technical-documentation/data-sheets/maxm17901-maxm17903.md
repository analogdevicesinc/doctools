...
(V IN  = V EN/UVLO  = 12V, V GND  = 0V, C VCC = 1μF, FB = 1V (MAXM17903), FB = 3.6V (MAXM17901), LX = MODE = RESET = OUT = unconnected; T A  = -40°C to +125°C, unless otherwise noted. Typical values are at T A  = +25°C. All voltages are referenced to GND, unless otherwise noted.) (Note 3)
...
| FEEDBACK (FB)                                 |                  |                               |                  |                  |                  |                  |
| FB-Regulation Voltage                         | V FB-REG         | MODE = GND, MAXM17903         | 0.887            | 0.90             | 0.913            | V                |
|                                               | V FB-REG         | MODE = unconnected, MAXM17903 | 0.887            | 0.915            | 0.936            | V                |
|                                               | V FB-REG         | MODE = GND, MAXM17901         | 3.25             | 3.30             | 3.35             | V                |
|                                               | V FB-REG         | MODE = unconnected, MAXM17901 | 3.25             | 3.35             | 3.42             | V                |
| FB-Leakage Current                            | I FB             | MAXM17903                     | -100             | -25              |                  | nA               |
| TIMING                                        |                  |                               |                  |                  |                  |                  |
...
MAXM17901 EFFICIENCY vs. LOAD CURRENT FIXED VOUT = 3.3V, PFM MODE

<!-- image -->

MAXM17903 OUTPUT VOLTAGE vs. LOAD CURRENT ADJUSTABLE VOUT = 2.5V, PWM MODE

<!-- image -->

MAXM17903 OUTPUT VOLTAGE vs. LOAD CURRENT ADJUSTABLE VOUT = 0.9V, PFM MODE

<!-- image -->

MAXM17903 OUTPUT VOLTAGE vs. LOAD CURRENT ADJUSTABLE VOUT = 0.9V, PWM MODE

<!-- image -->

MAXM17903 OUTPUT VOLTAGE vs. LOAD CURRENT ADJUSTABLE VOUT = 3.3V, PWM MODE

<!-- image -->

MAXM17903 OUTPUT VOLTAGE vs. LOAD CURRENT ADJUSTABLE VOUT = 1.5V, PFM MODE

<!-- image -->

MAXM17903 OUTPUT VOLTAGE vs. LOAD CURRENT ADJUSTABLE VOUT = 1.5V, PWM MODE

<!-- image -->

<!-- image -->

MAXM17903 OUTPUT VOLTAGE vs. LOAD CURRENT ADJUSTABLE VOUT = 2.5V, PFM MODE
...
CONDITIONS: V IN  = 12V, V OUT  = 3.3V, I OUT  = 0.3A
...
| 2     | GND     | Ground Pin. Connect GND to the ground plane. See the PCB Layout Guidelines section for more details. Refer to the MAXM17903 EV kit for a sample layout.                                                                                                                                             |
...
| 6     | FB      | Output Feedback Connection. Connect FB to a resistor-divider between OUT and GND to set the output voltage for MAXM17903. Connect to output voltage node (V OUT ) for MAXM17901. See Output-Voltage Setting section for more details.                                                               |
...
For MAXM17901, V IN(MIN)  = 5.5V, V IN(MAX)  = 24V
...
Connect FB of MAXM17901 directly to V OUT  for feedback control.
...
|---------------|-----------------|-----------------|---------------|---------------------------------------------|------------------------------------------------|------------|------------|
| MAXM17903     |             4.5 |            12.5 |           0.9 | 1 x 1µF 0805 25V (Murata GR219R71E105KA88D) | 1 x 47µF 1210 6.3V (Murata GRM32ER70J476KE20L) | SHORT      | OPEN       |
| MAXM17903     |             4.5 |              14 |             1 | 1 x 1µF 0805 25V (Murata GR219R71E105KA88D) | 1 x 47µF 1210 6.3V (Murata GRM32ER70J476KE20L) | 8.33       | 75         |
| MAXM17903     |             4.5 |              17 |           1.2 | 1 x 1µF 0805 25V (Murata GR219R71E105KA88D) | 1 x 47µF 1210 6.3V (Murata GRM32ER70J476KE20L) | 25         | 75         |
| MAXM17903     |             4.5 |            21.5 |           1.5 | 1 x 1µF 0805 25V (Murata GR219R71E105KA88D) | 1 x 22µF 1206 6.3V (Murata GRM31CR70J226KE19L) | 50         | 75         |
| MAXM17903     |             4.5 |              24 |           1.8 | 1 x 1µF 0805 50V (Murata GRM21BR71105KA12L) | 1 x 22µF 1206 6.3V (Murata GRM31CR70J226KE19L) | 75         | 75         |
| MAXM17903     |             4.5 |              24 |           2.5 | 1 x 1µF 0805 50V (Murata GRM21BR71105KA12L) | 1 x 22µF 1206 6.3V (Murata GRM31CR70J226KE19L) | 133        | 75         |
| MAXM17903     |             5.5 |              24 |           3.3 | 1 x 1µF 0805 50V (Murata GRM21BR71105KA12L) | 1 x 10µF 1206 6.3V (Murata GRM31CR70J106KA01L) | 200        | 75         |
| MAXM17903     |              12 |              24 |             5 | 1 x 1µF 0805 50V (Murata GRM21BR71105KA12L) | 1 x 10µF 1206 6.3V (Murata GRM31CR70J106KA01L) | 348        | 75         |
| MAXM17901     |             5.5 |              24 |           3.3 | 1 x 1μF 0805 50V (Murata GRM21BR71105KA12L) | 1 x 10μF 1206 6.3V (Murata GRM31CR70J106KA01L) | N/A        | N/A        |
...
## 4.5V to 24V, 300mA Himaly uSLIC Step-Down Power Module
...
## 4.5V to 24V , 30mA Himaly uSLIC Step-Down Power Module
