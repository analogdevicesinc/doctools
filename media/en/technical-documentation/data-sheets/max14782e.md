...
## 50Kbps 3.V to 5V RS-485 Transceiver with ±35kV HBM ESD Protection

## General Description

The MAX14782E is a half duplex RS-485 transceiver that operates at either 3.3V or 5V rails with high ±35kV ESD performance and up to 500kbps data rate.
...
- Integrated Protection Increases End Equipment Up-Time
- High ESD Protection
-  ±35kV HBM ESD per JEDEC JS-001-2012
-  ±20kV Air Gap ESD per IEC 61000-4-2
-  ±12kV Contact ESD per IEC 61000-4-2
- ± 4kV EFT per IEC 61000-4-4
- Short-Circuit-Protected Outputs
- True Fail-Safe Receiver Prevents False Transitionon Receiver Input Short or Open Events
...
|------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
| V CC .....................................................................-0.3V to +6.0V | V CC .....................................................................-0.3V to +6.0V |
| RO............................................................ -0.3V to (V CC + 0.3V)    | RO............................................................ -0.3V to (V CC + 0.3V)    |
| RE, DE, DI............................................................-0.3V to +6.0V     | RE, DE, DI............................................................-0.3V to +6.0V     |
| A, B (V CC ≥ 3.6V) .............................................-8.0V to +13.0V          | A, B (V CC ≥ 3.6V) .............................................-8.0V to +13.0V          |
| A, B (V CC < 3.6V) .............................................-9.0V to +13.0V          | A, B (V CC < 3.6V) .............................................-9.0V to +13.0V          |
| Short-Circuit Duration (RO, A, B) to GND.................Continuous                      | Short-Circuit Duration (RO, A, B) to GND.................Continuous                      |
| Operating Temperature Range                                                              | MAX14782EA_............................................. -40 ° C to +125 ° C             |
...
| PACKAGE TYPE: 8 SO                   | PACKAGE TYPE: 8 SO                   |
|--------------------------------------|--------------------------------------|
| Package Code                         | S8+4                                 |
...
| Driver Short-Circuit Output Current                | &#124;I OST &#124;                | 0 ≤ V OUT ≤ +12V, output low -7V ≤ V ≤ V , output | high        |            |          | 250 250 | mA      |
| RECEIVER                                           |                                   |                                                   |             |            |          |         |         |
| Input Current                                      | I A, B                            | DE = GND, V CC = GND or +5.5V                     | V IN = +12V |            | 400      | 1000    | µA      |
|                                                    |                                   | V IN = -7V                                        | V IN = -7V  | -800       | +300     |         |         |
| Differential Input Capacitance                     | C A, B                            | Between A and B, DE = GND,                        | f = 4MHz    |            | 12       |         | pF      |
...
| Receiver Three-State Output Current                | I OZR                             | RE = V CC , 0 ≤ V RO ≤ V CC                       |             |            |          | ±1      | µA      |
...
|--------------------------------------------------------------|-------------|--------------------------------------------------|-------|-------|-------|---------|
| DRIVER                                                       |             |                                                  |       |       |       |         |
| Driver Propagation Delay                                     | t DPLH      | R L = 54Ω, C L = 50pF, Figures 2 and 3           |       |       | 20    | ns      |
| Driver Propagation Delay                                     | t DPHL      | R L = 54Ω, C L = 50pF, Figures 2 and 3           |       |       | 20    | ns      |
| Driver Differential Output Rise or Fall Time                 | t HL , t LH | R L = 54Ω, C L = 50pF, Figures 2 and 3           | 200   |       | 600   | ns      |
...
| Driver Enable to Output High                                 | t DZH       | R L = 110Ω, C L = 50pF, Figures 4 and 5 (Note 5) |       |       | 2500  | ns      |
| Driver Enable to Output Low                                  | t DZL       | R L = 110Ω, C L = 50pF, Figures 4 and 5 (Note 5) |       |       | 2500  | ns      |
| Driver Disable Time from Low                                 | t DLZ       | R L = 110Ω, C L = 50pF, Figures 4 and 5          |       |       | 100   | ns      |
| Driver Disable Time from High                                | t DHZ       | R L = 110Ω, C L = 50pF, Figures 4 and 5          |       |       | 100   | ns      |
| Driver Enable from Shutdown to Output High                   | t DLZ(SHDN) | R L = 110Ω, C L = 15pF, Figures 4 and 5 (Note 5) |       |       | 5.5   | µs      |
| Driver Enable from Shutdown to Output Low                    | t DHZ(SHDN) | R L = 110Ω, C L = 15pF, Figures 4 and 5 (Note 5) |       |       | 5.5   | µs      |
| Time to Shutdown                                             | t SHDN      | (Note 6)                                         | 50    | 340   | 700   | ns      |
...
| Maximum Data Rate                            | DR MAX      |                                          | 500   |       |       | kbps    |
| Receiver Enable to Output High               | t RZH       | R L = 1kΩ, C L = 15pF, Figure 8 (Note 5) |       |       | 50    | ns      |
| Receiver Enable to Output Low                | t RZL       | R L = 1kΩ, C L = 15pF, Figure 8 (Note 5) |       |       | 50    | ns      |
...
| Receiver Enable from Shutdown to Output High | t RLZ(SHDN) | R L = 1kΩ, C L = 15pF, Figure 8 (Note 5) |       |       | 5.5   | µs      |
| Receiver Enable from Shutdown to Output Low  | t RHZ(SHDN) | R L = 1kΩ, C L = 15pF, Figure 8 (Note 5) |       |       | 5.5   | µs      |
| Time to Shutdown                             | t SHDN      | (Note 6)                                 | 50    | 340   | 700   | ns      |
...
## 500Kbps 3.3V to 5V RS-485 Transceiver with ±35kV HBM ESD Protection
...
Figure 5. Driver Enable and Disable Times (t DZL , t DZL )
...
## 500Kbps 3.3V to 5V RS-485 Transceivr with ±35kV HBM ESD Protection
...
(V CC  = +5V, T A  = +25 ° C, unless otherwise specified.)

<!-- image -->

│

## 50Kbps 3.3V to 5V RS-485 Transceiver with ±35kV HBM ESD Protecin
...
DIFFERENTIAL DRIVER SKEW vs. TEMPERATURE
...
DIFFERENTIAL INPUT CAPACITANCE vs. FREQUENCY
...
The MAX14782E is a  3.3V to 5V ESD-protected RS-485 transceiver intended for high-speed, half-duplex communications. Integrated hot-swap functionality eliminates false transitions on the bus during power-up or hot insertion.
...
RE and DE can be connected together and driven simultaneously.  The  MAX14782E  is  guaranteed  not  to  enter shutdown if RE is high and DE is low for less than 50ns. If the inputs are in this state for at least 800ns (max), the device is guaranteed to enter shutdown.
...
| MAX14782EAUA+ | 3.0V to 5.5V   | 500kbps           | -40°C to +125°C | 8 µMAX        |
...
|                 3 | 8/24            | Removed all instances and conditions of RS-422                            | 1-17            |
