<!-- lastmod 2023-09-25 -->
## QSH2818-x-8k Hardware Manual

Hardware Version V1.00 | Document Revision V1.50 • 24.04.2023

QSH2818-x-8k is a NEMA11 (28mm) 2-phase stepper motor including a small size optical incremental encoder kit. It comes with a resolution of 512 lines (32768 counts). Trinamic's Stepper motors are quality motors for universal use. They feature a long life due to ball bearings and no wearing out parts.
...
|                 | 2.2                                                                                                          | Diagrams . . . . . . . . . . . . . . . 2.2.1                                                                                              |       |
|                 |                                                                                                              | QSH2818-32-07-006-8k . . . . . . . . . . . . . . . . . QSH2818-51-07-012-8k                                                               | 5     |
|                 | 2.2.2                                                                                                        | . . . . . . . . . . . . . . . . .                                                                                                         | 6     |
...
| QSH2818-32-07-006-8k   | QSH2818-32-07-006-8192-AT   | Motor + Encoder Mod- ule, NEMA11 2-phase stepper motor (0.67A / 6Ncm) with incremental encoder kit, resolution of 512lpr (32.768cpr), ABN, TTL    | 28 x 28 x 45   |
|------------------------|-----------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------|----------------|
| QSH2818-51-07-012-8k   | QSH2818-51-07-012-8192-AT   | Motor + Encoder Mod- ule, NEMA11 2-phase stepper motor (0.67A / 12Ncm) with incre- mental encoder kit, resolution of 512lpr (32.768cpr), ABN, TTL | 28 x 28 x 64   |
...
- NEMA11 mounting con/uniFB01guration

The main characteristics are:

- /uniFB02ange max. 28.0mm x 28.0mm
- step angle: 1.8°
...
| Rated Voltage                                   | V           | 3.8     | 6.2       |
|-------------------------------------------------|-------------|---------|-----------|
| Rated Phase Current                             | A           | 0.67    | 0.67      |
| Phase Resistance at 20°C                        | Ω           | 5.6     | 9.2       |
| Phase Inductance (typ.)                         | mH          | 3.4     | 7.2       |
| Holding Torque (typ.)                           | Ncm (oz in) | 6 (8.5) | 12 (17.0) |
...
| MaximumRadialForce(20mmfrom front /uniFB02ange) | N           | 28      | 28        |

QSH2818-51-07-012-9k

<!-- image -->

Unit

QSH2818-32-07-006-8k
...
| Winding Thermal Time Constant        | min     |          10 | 18          |
...
## 2.2.1 QSH2818-32-07-006-8k

Testing conditions: Driver Supply 24V, 0.67A / Phase.

<!-- image -->

Figure 1: QSH2818-32-07-006-8k velocity vs. torque characteristic

<!-- image -->

10

## 2.2.2 QSH2818-51-07-012-8k

Testing conditions: Driver Supply 24V, 0.67A / Phase.

Figure 2: QSH2818-51-07-012-8k velocity vs. torque characteristics
...
| Disc lines           |       | 512    |       | lines      |
| Resolution           |       | 32.768 |       | increments |
...
The required encoder cable connectors are:

- HSUAN MAO TECHNOLOGY CO., LTD.: W9110-XXPBTWXSR, SH 1.0mm Wafer 1XXXP SMT Side Entry, type tin plated, white color, ROHS
- HSUAN MAO TECHNOLOGY CO., LTD.: H9010-XXPWSY00R, SH 1.0mm Housing 1XXXP White single row, ROHS, low lead
- http://www.hsm.net.tw/index.php
...
| QSH2818-32-07-006-8k   | 32mm   |
|------------------------|--------|
| QSH2818-51-07-012-8k   | 51mm   |
...
|     | torque characteristic . . . . . . . . . . QSH2818-51-07-012-8k velocity vs. .   | Dimensions of motor & encoder kit (all units = mm) . . . . . . . . . . . . .   |
|-----|---------------------------------------------------------------------------------|--------------------------------------------------------------------------------|
| 2   | torque characteristics . . . . . . . . .                                        | 10 Length of motor wires/cables (all units = mm) . . . . . . . . . . . . . . . |
| 3 4 | Lead wire con/uniFB01guration . . . . . . . Connection and circuit diagram      | 10                                                                             |
|     | for the line driver outputs . . . . . . . . .                                   |                                                                                |
...
| 3   | Electrical Characteristics Encoder Mechanical Speci/uniFB01cations . . . .              | 6 7 | Driver supply voltage considerations 17 full-                        | 13               |
| 4   | . . .                                                                                   | 7   | Comparing microstepping and stepping . . . . . . . . . . . . . . . . | . 15             |
| 5 7 | Environmental Speci/uniFB01cations . . . .                                              |     | Hardware Revision . .                                                | 20               |
|     | . Connector and signals of motor Connector and signals of the                           | 7   | 18 . . .                                                             | . . . . . . .    |
| 9   | . . . encoder                                                                           | 8   | 19 Document Revision . . .                                           | . . . . . . . 20 |
...
|    1.2 | 23.04.2020   | SK   | Overal lengths parameter corrected.                                                       |
