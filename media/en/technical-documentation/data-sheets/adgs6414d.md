...
- Flat R ON across signal range of 0.004Ω
...
- 1.8V logic compatibility with 2.7V ≤ V L ≤ 3.3V (excludes SPI read-back to a 1.8V device)
...
1 Protected by US Patent number 10,642,769 and 11,222,834.

## 0.56Ω On Resistance High Density Octal SPST Switch

## GENERAL DESCRIPTION

The ADGS6414D 1  contains eight independent, low on-resistance, single-pole/single-throw (SPST) switches in a 4mm × 5mm, 30-terminal LGA package.
...
Each switch has an input signal range from V SS to V DD - 2V. When on, each switch conducts equally well in both directions, and in the off condition, signal levels up to the supplies are blocked.
...
| Cyclic Redundancy Check (CRC) Error Detection........................................................22 |     |
| SCLK Count Error Detection............................23                                                |     |
| Invalid Read and Write Address Error..............23                                                    |     |
...
| Large Voltage, High Frequency Signal Tracking..........................................................26 |    |
| System Channel Density..................................26                                                |    |
| Route Through Pins.........................................                                               | 26 |
| Integrated Passive Components......................26                                                     |    |
| Break-Before-Make Switching..........................27                                                   |    |
| Digital Input Buffers..........................................27                                         |    |
| Power Supply Rails..........................................27                                            |    |
| Power Supply Recommendations....................27                                                        |    |
| 1.8V Logic Compatibility...................................27                                             |    |
| Register Summary...............................................28                                         |    |
| Register Details...................................................                                       | 29 |
| Switch Data Register........................................29                                            |    |
| Error Configuration Register.............................29                                               |    |
| Error Flags Register.........................................30                                           |    |
| Burst Enable Register......................................                                               | 30 |
| Software Reset Register..................................                                                 | 31 |
| Outline Dimensions.............................................                                           | 32 |
| Ordering Guide.................................................32                                         |    |
| Evaluation Boards............................................32                                           |    |
...
VDD  = +20V ± 10%, V SS = -20V ± 10%, V L = 2.7V to 5.5V, and GND = 0V, unless otherwise noted.
...
| Analog Signal Range On Resistance, R ON                        | 0.56                  |                  | V DD - 2V to V SS  | V Ω typ                     | Source voltage, (V S ) = -18V to +14.5V, source current, (I S ) = -100mA, see Figure 35   |
|                                                                | 0.7 0.6 0.75          | 0.85             | 1.0                | Ω max Ω typ Ω max           | V S = -18V to +15.5V, I S = -100mA                                                        |
| On-Resistance Match Between Channels, ∆R ON                    | 0.045 0.12            | 0.9 0.14         | 1.05 0.16          | Ω typ Ω max Ω typ           | V S = -18V to +15.5V, I S = -100mA                                                        |
| On Resistance Flatness, R FLAT(ON)                             | 0.004 0.035 0.04 0.08 | 0.035 0.1        | 0.035 0.1          | Ω max Ω typ Ω max           | V S = -18V to +14.5V, I S = -100mA V S = -18V to +15.5V, I S = -100mA                     |
| LEAKAGE CURRENTS Source Off Leakage, I S (Off)                 | ±4 ±12.5              | +90/-14          | +400/-14           | nA typ                      | V DD = +22V, V SS = -22V V S = +15V/-15V, drain voltage, V D = -15V/+15V, see Figure 36   |
| Drain Off Leakage, I D (Off)                                   | ±4 ±12.5              | +90/-14          | +400/-14           | nA max nA typ nA max nA typ | V S = +15V/-15V, V D = -15V/+15V, see Figure 36                                           |
| Channel On Leakage, I D (On), I S (On) OUTPUT Output Voltage   | ±0.2                  |                  | +50/-5             |                             | V S = V D = ±15V, see Figure 37                                                           |
| DIGITAL                                                        | ±1.3                  | ±5               | 0.4 0.3 V L -      | nA max                      |                                                                                           |
| Low, V OL High, V OH                                           | 4                     |                  | 1.25V V L - 0.125V | V max V max V min V min     | Sink current, I SINK = 1mA I SINK = 100µA Source current, I SOURCE = 1mA I SOURCE = 100µA |
| Digital Output Capacitance, C OUT DIGITAL INPUTS Input Voltage |                       |                  |                    | pF typ                      |                                                                                           |
| High, V                                                        |                       |                  | 2 1.35             | V min V min                 | 3.3V < V L ≤ 5.5V 2.7V ≤ V L ≤ 3.3V                                                       |
| INH                                                            |                       |                  | 0.8                | V                           | 3.3V < V L ≤ 5.5V                                                                         |
|                                                                |                       |                  |                    | max                         |                                                                                           |
| Low, V                                                         |                       |                  |                    |                             |                                                                                           |
| INL                                                            |                       |                  | 0.8                | V max                       | 2.7V ≤ V L ≤ 3.3V                                                                         |

## SPECIFICATIONS

Table 2. ±20V Dual Supply (Continued)

| Parameter                                            | +25°C       | -40°C to +85°C   | -40°C to +125°C   | Unit                               | Test Conditions/Comments                                                                      |
|------------------------------------------------------|-------------|------------------|-------------------|------------------------------------|-----------------------------------------------------------------------------------------------|
| Input Current                                        |             |                  |                   |                                    |                                                                                               |
| Low, I INL or High, I INH                            | 0.001       |                  | ±0.1              | µA typ µA max                      | Input voltage, V IN = ground voltage, V GND or V L                                            |
| Digital Input Capacitance, C IN                      | 4           |                  |                   | pF typ                             |                                                                                               |
| DYNAMIC CHARACTERISTICS On Time, t ON                | 638         |                  |                   | ns typ                             | Load resistance, R L = 300Ω, load capacitance, C L = 35pF, V S = 10V, see Figure 44           |
|                                                      | 746         | 778              | 815               | ns max                             |                                                                                               |
| Off Time, t OFF                                      | 162 202     | 205              | 207               | ns typ ns max                      | R L = 300Ω, C L = 35pF, V S = 10V, see Figure 44                                              |
| Break-Before-Make Time Delay, t D                    | 485         |                  |                   | ns typ                             | R L = 300Ω, C L = 35pF, Source 1 voltage, V S1 = Source 2 voltage, V S2 = 10V, see Figure 43  |
|                                                      | 396         | 418              | 445               | ns min                             |                                                                                               |
| Charge Injection, Q INJ                              | -2.2        |                  |                   | nC typ                             | V S = 0V, source resistance R S = 0Ω, C L = 1 nF, see Figure 45                               |
| Off Isolation                                        | -78         |                  |                   | dB typ                             | R L = 50Ω, C L = 5pF, frequency, f = 100kHz, see Figure 39                                    |
| Channel to Channel Crosstalk                         | -85         |                  |                   | dB typ                             | R L = 50Ω, C L = 5pF, f = 100kHz, see Figure 38                                               |
| Total Harmonic Distortion + Noise, THD + N           | 0.001       |                  |                   | %typ                               | R L = 1kΩ, 20V p-p, f = 20Hz to 20kHz, see Figure 40                                          |
| Total Harmonic Distortion, THD                       | -128        |                  |                   | dB typ                             | R L = 1kΩ, 20V p-p, f = 1kHz                                                                  |
| -3dB Bandwidth                                       | 184         |                  |                   | MHz typ                            | R L = 50Ω, C L = 5pF, and signal = 0dBm, see Figure 41                                        |
| Insertion Loss                                       | -0.06       |                  |                   | dB typ                             | R L = 50Ω, C L = 5pF, f = 1MHz, see Figure 41                                                 |
| Source Capacitance, C S (Off)                        | 70          |                  |                   | pF typ                             | V S = 0V, f = 1MHz                                                                            |
| Drain Capacitance, C D (Off)                         | 70          |                  |                   | pF typ                             | V = 0V, f = 1MHz                                                                              |
| C (On), C (On)                                       | 25          |                  |                   | pF typ                             | S                                                                                             |
| D S POWER REQUIREMENTS Positive Supply Current, I DD | 330 350 350 |                  | 440 460           | µA typ µA max µA typ µA max µA typ | V S = 0V, f = 1MHz V DD = +22V, V SS = -22V All switches open All switches closed, V L = 5.5V |
| Load Current, I                                      |             |                  | 460               | µA max                             |                                                                                               |
|                                                      |             |                  |                   | µA typ                             | All switches closed, V L = 2.7V                                                               |
| Inactive                                             | 6.3         |                  | 8.5               | µA max µA typ                      | Digital inputs = 0V or V L                                                                    |
| L                                                    | 2.5         |                  | 4.0               | µA max                             | Digital inputs = 0V or 3V                                                                     |
| Inactive, SCLK = 1MHz                                | 14 7        |                  |                   | µA typ µA typ                      | CS = V L and SDI = 0V or V L , V L = 5V CS = V and SDI = 0V or V , V = 3V                     |
| SCLK = 50MHz                                         | 390         |                  |                   | µA typ                             | L L L CS = V L and SDI = 0V or V L , V L = 5V                                                 |
|                                                      | 210         |                  |                   |                                    | CS = V L and SDI = 0V or V L , V L = 3V                                                       |
| Inactive, SDI = 1MHz                                 | 15          |                  |                   |                                    |                                                                                               |
|                                                      |             |                  |                   | µA typ                             |                                                                                               |
|                                                      |             |                  |                   | µA typ                             | CS and SCLK = 0V or V L , V L = 5V                                                            |
|                                                      | 7.5         |                  |                   | µA typ                             | CS and SCLK = 0V or V , V = 3V                                                                |
|                                                      |             |                  |                   | µA typ                             | L L                                                                                           |
| SDI = 25MHz                                          | 230         |                  |                   | µA typ                             | CS and SCLK = 0V or V L , V L = 5V                                                            |
|                                                      | 120         |                  |                   |                                    | CS and SCLK = 0V or V L , V L = 3V                                                            |
...
| Parameter                                | +25°C       | -40°C to +85°C   | -40°C to +125°C   | Unit                                      | Test Conditions/Comments                                                                                                               |
|------------------------------------------|-------------|------------------|-------------------|-------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------|
| Active at 50MHz Negative Supply Current, | 7.0 3.3 180 |                  | 9.0 5.0 250       | mA typ mA max mA typ mA max µA typ µA max | Digital inputs toggle between 0V and V L , V L = 5.5V Digital inputs toggle between 0V and V L , V L = 2.7V Digital inputs = 0V or V L |

## 36V SINGLE SUPPLY

VDD  = 36V ± 10%, V SS = 0V, V L = 2.7V to 5.5V, and GND = 0V, unless otherwise noted.
...
| Analog Signal Range       |             |                  | 0V to V -         | V             |                                           |
| R                         | 0.56        |                  | DD 2V             |               | Figure                                    |
| ON                        |             |                  | 1.0               | Ω typ         | V S = 0V to 28.9V, I S = -100mA, see      |
|                           | 0.7         | 0.85             |                   | Ω max         |                                           |
|                           | 0.6         |                  |                   | Ω typ         | V S = 0V to 29.9V, I S = -100mA           |
|                           | 0.75        | 0.9              | 1.05              | Ω max         |                                           |
| ∆R ON                     | 0.045       |                  |                   | Ω typ         | V S = 0V to 29.9V, I S = -100mA           |
|                           |             |                  |                   | Ω max         |                                           |
|                           | 0.12        | 0.14             | 0.16              | Ω typ         |                                           |
| R FLAT (ON)               | 0.004 0.035 | 0.035            | 0.035             | Ω max         | V S = 0V to 28.9V, I S = -100mA           |
|                           | 0.04        |                  |                   | Ω typ         | V S = 0V to 29.9V, I S = -100mA           |
|                           | 0.08        | 0.1              | 0.1               | Ω max         |                                           |
| LEAKAGE CURRENTS          |             |                  |                   |               | V DD = 39.6V, V SS = 0V                   |
| I S (Off)                 | ±4          |                  |                   | nA typ        | V S = 1V/30V, V D = 30V/1V, see Figure 36 |
|                           |             | +90/-14          | +400/-14          | max           |                                           |
|                           | ±12.5       |                  |                   | nA            |                                           |
| I D (Off)                 | ±4 ±12.5    | +90/-14          | +400/-14          | nA typ nA max | V S = 1V/30V, V D = 30V/1V, see Figure 36 |
| I D (On), I S (On)        | ±0.2        |                  |                   | nA typ        | V S = V D = 1V/30V, see Figure 37         |
|                           | ±1.3        | ±5               | +50/-5            | nA max        |                                           |
| DIGITAL OUTPUT            |             |                  |                   |               |                                           |
| Output Voltage            |             |                  |                   |               |                                           |
| Low, V                    |             |                  |                   |               |                                           |
| OL                        |             |                  | 0.4               | V max         | I SINK = 1mA                              |
|                           |             |                  | 0.3               | V max         | I SINK = 100µA                            |
| High, V OH                |             |                  | V L - 1.25V       | V min         | I SOURCE = 1mA                            |
|                           | 4           |                  |                   | pF typ        |                                           |
| C                         |             |                  | V L - 0.125V      | V min         | I SOURCE = 100µA                          |
| OUT                       |             |                  |                   |               |                                           |
| Input Voltage             |             |                  |                   |               |                                           |
| High, V INH               |             |                  |                   |               |                                           |
|                           |             |                  | 2                 | V min         | 3.3V < V L ≤ 5.5V                         |
|                           |             |                  | 1.35              | V min         | 2.7V ≤ V L ≤ 3.3V                         |
| Low, V INL                |             |                  | 0.8               | V max         | 3.3V < V L ≤ 5.5V                         |
|                           |             |                  |                   |               | L                                         |
| Input Current             |             |                  |                   |               |                                           |
| Low, I INL or High, I INH | 0.001       |                  |                   | µA typ        | V IN = V GND or V L                       |
| C IN                      | 4           |                  |                   | pF typ        |                                           |
...
| t ON                         | 490     |                  |                   | ns typ  | R L = 300Ω, C L = 35pF, V S = 18V, see Figure 44               |
|                              | 574     | 583              | 596               | ns max  |                                                                |
| t                            |         |                  |                   | ns typ  | R L = 300Ω, C L = 35pF, V S = 18V, see Figure 44               |
| OFF                          | 256 298 | 305              | 311               | ns max  |                                                                |
| t D                          | 294     |                  |                   | ns typ  | R L = 300Ω, C L = 35pF, V S1 = V S2 = 18V, see Figure 43       |
|                              | 242     | 249              | 258               | ns min  |                                                                |
| Q INJ                        | -2.0    |                  |                   | nC typ  | V S = 18V, R S = 0Ω, C L = 1nF                                 |
| Off Isolation                | -65     |                  |                   | dB typ  | R L = 50Ω, C L = 5pF, f = 100kHz, see Figure 39                |
| Channel to Channel Crosstalk | -85     |                  |                   | dB typ  | R L = 50Ω, C L = 5pF, f = 100kHz, see Figure 38                |
| THD + N                      | 0.005   |                  |                   | %typ    | R L = 1kΩ, 18V p-p, f = 20Hz to 20kHz, seeFigure 40            |
| THD                          | -113    |                  |                   | dB typ  | R L = 1kΩ, 18V p-p, f = 1kHz                                   |
|                              | -87     |                  |                   | dB typ  | R L = 1kΩ, 18V p-p, f = 20kHz                                  |
|                              | -72     |                  |                   | dB typ  | R L = 1kΩ, 18V p-p, f = 100kHz                                 |
| -3dB Bandwidth               | 134     |                  |                   | MHz typ | R L = 50Ω, C L = 5pF and signal = 0dBm, see Figure 41          |
| Insertion Loss               | -0.06   |                  |                   | dB typ  | R L = 50Ω, C L = 5pF, f = 1MHz, see Figure 41                  |
| C S (Off)                    | 72      |                  |                   | pF typ  | V S = 18V, f = 1MHz                                            |
| C D (Off)                    | 72      |                  |                   | pF typ  | V S = 18V, f = 1MHz                                            |
| C D (On), C S (On)           | 26      |                  |                   | pF typ  | V S = 18V, f = 1MHz                                            |
| POWER REQUIREMENTS           |         |                  |                   |         | V DD = 39.6V                                                   |
| I DD                         | 330     |                  |                   | µA typ  | All switches open                                              |
|                              |         |                  | 440               | µA max  |                                                                |
|                              | 350     |                  |                   | µA typ  | All switches closed, V L = 5.5V                                |
|                              |         |                  | 460               | µA max  |                                                                |
|                              | 350     |                  |                   | µA typ  | All switches closed, V = 2.7V                                  |
|                              |         |                  |                   | µA max  | L                                                              |
|                              |         |                  | 460               |         |                                                                |
| I L                          |         |                  |                   |         |                                                                |
| Inactive                     | 6.3     |                  |                   | µA typ  | Digital inputs = 0V or V L                                     |
|                              |         |                  | 8.5               | µA max  |                                                                |
|                              | 2.5     |                  |                   | µA typ  | Digital inputs = 0V or 3V                                      |
|                              |         |                  | 4.0               | µA max  |                                                                |
| Inactive, SCLK = 1MHz        | 14      |                  |                   | µA typ  | CS = V L and SDI = 0V or V L , V L = 5V                        |
|                              | 7       |                  |                   | µA typ  | CS = V L and SDI = 0V or V L , V L = 3V                        |
| SCLK = 50MHz                 | 390     |                  |                   | µA typ  | CS = V L and SDI = 0V or V L , V L = 5V                        |
|                              | 210     |                  |                   | µA typ  | CS = V L and SDI = 0V or V L , V L = 3V                        |
| Inactive, SDI = 1MHz         | 15      |                  |                   | µA typ  | CS and SCLK = 0V or V L , V L = 5V                             |
|                              |         |                  |                   | µA typ  | 3V                                                             |
| SDI = 25MHz                  | 7.5 230 |                  |                   | µA typ  | CS and SCLK = 0V or V L , V L = CS and SCLK = 0V or V , V = 5V |
|                              | 120     |                  |                   | µA typ  | L L CS and SCLK = 0V or V L , V L = 3V                         |
| Active at 50MHz              | 7.0     |                  |                   | mA typ  | Digital inputs toggle between 0V and V L , V L = 5.5V          |
|                              |         |                  | 9.0               | mA max  |                                                                |
|                              | 3.3     |                  |                   | mA typ  | Digital inputs toggle between 0V and V L , V L =               |
|                              |         |                  | 5.0               | mA max  | 2.7V                                                           |
...
| V DD = +20V, V SS = -20V (θ JA = 56.74°C/W) | 439    | 232    | 112     | mA maximum |
| V DD = +36V, V SS = 0V (θ JA = 56.74°C/W)   | 439    | 232    | 112     | mA maximum |
...
|---------------------------------------------|--------|--------|---------|------------|
| CONTINUOUS CURRENT, Sx OR Dx 1              |        |        |         |            |
| V DD = +20V, V SS = -20V (θ JA = 56.74°C/W) | 768    | 313    | 122     | mA maximum |
| V DD = +36V, V SS = 0V (θ JA = 56.74°C/W)   | 768    | 313    | 122     | mA maximum |

## SPECIFICATIONS

## TIMING CHARACTERISTICS

VL = 2.7V to 5.5V, GND = 0V, and all specifications T MIN to T MAX , unless otherwise noted. See Figure 2 to Figure 4 for the timing diagrams.
...
| V L to GND                                 |                                                            |
| For V DD ≤ 5.5V                            | -0.3V to V DD + 0.3V                                       |
| For V DD > 5.5V                            | -0.3V to +6V                                               |
| SDO                                        | -0.3V to V L + 0.3V or 6mA, whichever occurs first         |
| Analog Inputs 1                            | V SS - 0.3V to V DD + 0.3V or 30mA, whichever occurs first |
| Digital Inputs 1                           | -0.3V to +6V                                               |
| Peak Current, Sx or Dx 2                   | 1180mA (pulsed at 1ms, 10% duty cycle maximum)             |
...
| 12, 28    | RESET/V L  | RESET/Logic Power Supply Input (V L ). Under normal operation, drive RESET)/V L with a 2.7V to 5.5V supply. Pull RESET/V L low to complete a hardware reset. After a reset, all switches open, and the appropriate registers are set to their default. Both RESET and V L are connected internally. |
...
Figure 6. On Resistance vs. V S or V D for ±20V Dual Supply

<!-- image -->

Figure 7. On Resistance vs. V S or V D for +36V Single Supply

<!-- image -->

Figure 8. On Resistance vs. V S or V D for Various Temperatures, ±20V Dual Supply

<!-- image -->

Figure 9. On Resistance vs. V S or V D for Various Temperatures, +36V Single Supply

Figure 10. On Leakage Currents vs. Temperature, ±20V Dual Supply
...
Figure 26. Charge Injection vs. V S
...
Figure 32. Capacitance vs. V S , ±20 V Dual Supply

Figure 33. T ON /T OFF Time vs. Temperature for Single Supply (SS) and Dual Supply (DS)

<!-- image -->

Figure 34. I L vs. SCLK Frequency When CS Is High
...
Figure 35. On Resistance (I DS = Drain and Source Current)
...
Figure 43. Break-Before-Make Time Delay, t D

<!-- image -->

## TEST CIRCUITS

Figure 45. Charge Injection, Q INJ (ΔV OUT = Change in Output Voltage)
...
The interface pins of the ADGS6414D are CS, SCLK, SDI, and SDO. Hold CS low when using the SPI. Data is captured on the SDI on the rising edge of SCLK, and data is propagated out on the SDO on the falling edge of SCLK.

## ADDRESS MODE

Address mode is the default mode for the ADGS6414D upon power-up. A single SPI frame in address mode is bounded by a CS falling edge and the succeeding CS rising edge. The SPI frame is comprised of 16 SCLK cycles. The timing diagram for address mode is shown in Figure 46. The first SDI bit indicates if the SPI command is a read or write command. When the first bit is set to 0, a write command is issued, and if the first bit is set to 1, a read command is issued. The next seven bits determine the target register address. The remaining eight bits provide the data to the addressed register. The last eight bits are ignored during a read command because, during these clock cycles, SDO propagates out the data contained in the addressed register.
...
The connection of several ADGS6414D devices in a daisy-chain configuration is possible, and Figure 49 illustrates this setup. All devices share the same CS, SCLK, and V L line, whereas the SDO of a device forms a connection to the SDI of the next device, creating a shift register. In daisy-chain mode, SDO is an eight-cycle delayed version of SDI. When in daisy-chain mode, all commands target the switch data register. Therefore, it is not possible to make configuration changes while in daisy-chain mode.

When in address mode, the ADGS6414D can only enter daisychain mode by sending the 16-bit SPI command, 0x2500 (see Figure 50). When the ADGS6414D receives this command, the SDO of the device sends out the same command because the alignment bits at the SDO are 0x25, which allows multiple daisyconnected devices to enter daisy-chain mode in a single SPI frame. A hardware reset is required to exit daisy-chain mode.

For the timing diagram of a typical daisy-chain SPI frame, see Figure 51. When CS goes high, Device 1 writes Command 0, Bits[7:0] to its switch data register, Device 2 writes Command 1, Bits[7:0] to its switches, and so on. The SPI block uses the last eight bits it received through SDI to update the switches. After entering daisy-chain mode, the first eight bits sent out by SDO on each device in the chain are 0x00. When CS goes high, the internal shift register value does not reset back to zero.
...
The digital section of the ADGS6414D goes through an initialization phase during V L power-up. This initialization also occurs after a hardware or software reset. After V L power-up or a reset, ensure that a minimum of 120µs passes from the time of power-up or reset before any SPI command is issued. Ensure that V L does not drop out during the 120µs initialization phase because it may result in the incorrect operation of the ADGS6414D.
...
When multiple ADGS6414D devices are used in a system, the route through pins allow for a greater channel density layout. The route through pins enable the passing of power supplies and digital lines between devices with ease. The V DD , RESET/V L , and GND power lines, as well as the SCLK, CS, SDI, and SDO digital lines, are available on both the top and bottom pins of the package. These route through pins simplify PCB routing and reduce the need for vias when connecting many ADGS6414D devices together. Figure 52 shows an example layout where the route through pins on four ADGS6414D devices configured in daisy-chain mode are used to reduce the overall size of the layout.

## INTEGRATED PASSIVE COMPONENTS

Note the lack of external passive components in the layout in Figure 52. The ADGS6414D has integrated decoupling capacitors for the V DD , V SS , and RESET/V L power supplies. Therefore, the need for external decoupling capacitors is eliminated, reducing the total system footprint of the ADGS6414D. If additional decoupling is required for extremely noise-sensitive applications, add an external decoupling capacitor. Figure 27 shows the AC PSRR performance with and without external decoupling capacitors. The ADG6414D also contains an integrated pullup resistor to V L for the SDO pin.
...
The ADGS6414D exhibits break-before-make switching action. This feature allows for the use of the device in multiplexer applications. To use the device as a multiplexer, externally hardwire a device into the desired mux configuration, as shown in Figure 53.
...
The ADGS6414D can operate with bipolar supplies between ±4.5V and ±22V. The supplies on V DD and V SS do not have to be symmetrical. However, the V DD to V SS range must not exceed 44V. The ADGS6414D can also operate with single supplies between 5V and 40V with V SS connected to GND. The voltage range that can be supplied to V L is from 2.7V to 5.5V. The device is fully specified at ±20V and +36V analog supply voltage ranges.
...
The ADP7142 can generate the V L voltage that is required to power the digital circuitry within the ADGS6414D.
...
The SDI, CS, and SCLK digital inputs of the ADGS6414D are compatible with 1.8V logic when V L is between or equal to 2.7V and 3.3V.

The SDO digital output levels are proportional to the V L voltage. For example, if V L = 3V, a logic high on the SDO is approximately 3V. When performing an SPI readback from the ADGS6414D with a controller device using 1.8V logic, there may be an issue if the digital pins on the controller cannot tolerate digital input signals that exceed 1.8V.

Figure 55 describes how to use the ADG3231 level translator to perform a 1.8V SPI readback with a device that has 1.8V logic ports, such as a microcontroller or field programmable gate array (FPGA). Place the ADG3231 between the SDO of the ADGS6414D and the microcontroller or FPGA. Supply V CC1 of the ADG3231 with the V L voltage of the ADGS6414D and connect V CC2 to the 1.8V supply from the microcontroller or FPGA. The ADG3231 then translates the logic level of the SDO from V L to 1.8V.
...
|-------|------------|-----------|---------------------------------------------------------------------|-----------|----------|
|     7 | SW8_EN     |           | Enable the SW8_EN bit for Switch 8. Switch 8 open. Switch 8 closed. | 0x0       | R/W      |
...
|     0 | SW1_EN     |           | Enable the SW1_EN bit for Switch 1. Switch 1 open. Switch 1 closed. | 0x0       | R/W      |
...
Figure 56. 30-Terminal Land Grid Array [LGA] (CC-30-3) 4mm × 5mm Body and 1.63mm Package Height Dimensions shown in millimeters
