...
- ♦ Ultra-Low Power 42mW at fCLK = 22MHz (Transceiver Mode) 34mW at fCLK = 15.36MHz (Transceiver Mode) Low-Current Idle and Shutdown Modes
- ♦ Excellent Dynamic Performance 48.5dB SINAD at fIN = 5.5MHz (ADC) 71.7dB SFDR at fOUT = 2.2MHz (DAC)
...
| V DD Supply Current   |                    | ADC operating mode, f IN = 5.5MHz, f CLK = 22MHz, DACoperating mode, f OUT = 2.2MHz                    |                    | 14                 | 16.5               | mA                 |
| V DD Supply Current   |                    | ADC operating mode, f IN = 5.5MHz, f CLK = 15.36MHz, DACoperating mode, f OUT = 2.2MHz                 |                    | 11.4               |                    | mA                 |
| V DD Supply Current   |                    | ADC operating mode (Rx), f IN = 5.5MHz, f CLK = 15.36MHz, DAC off, DAC digital inputs at zero or DV DD |                    | 8.25               |                    | mA                 |
| V DD Supply Current   |                    | DAC operating mode (Tx), f OUT = 2.2MHz, f CLK = 15.36MHz, ADC off                                     |                    | 8                  |                    | mA                 |
| V DD Supply Current   |                    | Standby mode, DAC digital inputs and CLK at zero or OV DD                                              |                    |                    | 2.0                | mA                 |
| V DD Supply Current   |                    | Idle mode, DAC digital inputs at zero or OV DD , f CLK = 22MHz                                         |                    |                    | 6.7                | mA                 |
| V DD Supply Current   |                    | Shutdown mode, digital inputs and CLK at zero or OV DD , CS = OV DD                                    |                    | 1                  |                    | µA                 |
| OV DD Supply Current  |                    | ADC operating mode, f IN = 5.5MHz, f CLK = 22MHz, DAC operating mode, f OUT = 2.2MHz                   | 2.3                |                    |                    | mA                 |
|                       |                    | Idle mode, DAC digital inputs at zero or OV DD, f CLK = 22MHz                                          |                    | 20.6               |                    | µA                 |
|                       |                    | Shutdown mode, DAC digital inputs and CLK at zero or OV DD , CS = OV DD                                |                    | 1                  |                    | µA                 |
...
| Power-Supply Rejection                 | PSRR                                 | Offset error (V DD ± 5%) Gain error (V ± 5%) | ±0.2 ±0.07                           |                                      | LSB                                  |                                      |
...
|                                        |                                      | Channel Q                                    | 5.5                                  |                                      |                                      |                                      |
| ADC DYNAMIC CHARACTERISTICS (Note 3)   | ADC DYNAMIC CHARACTERISTICS (Note 3) | ADC DYNAMIC CHARACTERISTICS (Note 3)         | ADC DYNAMIC CHARACTERISTICS (Note 3) | ADC DYNAMIC CHARACTERISTICS (Note 3) | ADC DYNAMIC CHARACTERISTICS (Note 3) | ADC DYNAMIC CHARACTERISTICS (Note 3) |
| Signal-to-Noise Ratio                  | SNR                                  | f IN = 5.5MHz                                | 48.6                                 |                                      | dB                                   |                                      |
|                                        |                                      | f IN = 11MHz                                 | 48.6                                 |                                      | dB                                   |                                      |
| Signal-to-Noise and Distortion Ratio   | SINAD                                | f IN = 5.5MHz                                | 48.5                                 |                                      | dB                                   |                                      |
|                                        |                                      | f IN = 11MHz                                 | 48.5                                 |                                      | dB                                   |                                      |
| Spurious-Free Dynamic Range            | SFDR                                 | f IN = 5.5MHz                                | 69                                   |                                      | dBc                                  |                                      |
|                                        |                                      | f IN = 11MHz                                 | 71.5                                 |                                      | dBc                                  |                                      |
| Third-Harmonic Distortion              | HD3                                  | f IN = 5.5MHz f IN = 11MHz                   | -70.3 -75.5                          |                                      | dBc                                  |                                      |
| Intermodulation Distortion             | IMD                                  | f 1 = 2MHz, -7dBFS; f 2 = 2.01MHz, -7dBFS    | -64                                  |                                      | dBc                                  |                                      |
| Third-Order Intermodulation Distortion | IM3                                  | f 1 = 2MHz, -7dBFS; f 2 = 2.01MHz, -7dBFS    | -67                                  |                                      | dBc                                  |                                      |
| Total Harmonic Distortion              | THD                                  | f IN = 5.5MHz                                | -68.2                                | -57                                  | dBc                                  |                                      |
|                                        |                                      | f IN = 11MHz                                 | -68                                  |                                      |                                      |                                      |
...
| PARAMETER                              | SYMBOL                           | CONDITIONS                                                      |                                                                 | MIN                              | TYP                              | MAX                              | UNITS                            |
|----------------------------------------|----------------------------------|-----------------------------------------------------------------|-----------------------------------------------------------------|----------------------------------|----------------------------------|----------------------------------|----------------------------------|
| Small-Signal Bandwidth                 | SSBW                             | A IN = -20dBFS                                                  | A IN = -20dBFS                                                  | 440                              | 440                              | 440                              | MHz                              |
| Large-Signal Bandwidth                 | FBW                              | A IN = -0.5dBFS                                                 | A IN = -0.5dBFS                                                 | 440                              | 440                              | 440                              | MHz                              |
| Aperture Delay                         |                                  |                                                                 |                                                                 | 3.3                              | 3.3                              | 3.3                              | ns                               |
| Aperture Jitter                        |                                  |                                                                 |                                                                 | 2.7                              | 2.7                              | 2.7                              | ps RMS                           |
| Overdrive Recovery Time                |                                  | 1.5 × full-scale input                                          | 1.5 × full-scale input                                          | 2                                | 2                                | 2                                | ns                               |
...
| Crosstalk Rejection                    |                                  | f INX = 5.5MHz at -0.5dBFS, f INY = 0.3MHz at -0.5dBFS (Note 5) | f INX = 5.5MHz at -0.5dBFS, f INY = 0.3MHz at -0.5dBFS (Note 5) | -75                              | -75                              | -75                              | dB                               |
| Amplitude Matching                     |                                  | f IN = 5.5MHz at -0.5dBFS (Note 6)                              | f IN = 5.5MHz at -0.5dBFS (Note 6)                              | ± 0.03                           | ± 0.03                           | ± 0.03                           | dB                               |
| Phase Matching                         |                                  | f IN = 5.5MHz at -0.5dBFS (Note 6)                              | f IN = 5.5MHz at -0.5dBFS (Note 6)                              | ± 0.1                            | ± 0.1                            | ± 0.1                            | Degrees                          |
...
| Resolution                             | N                                |                                                                 |                                                                 | 10                               | 10                               | 10                               | Bits                             |
| Integral Nonlinearity                  |                                  | INL                                                             | INL                                                             | ± 1                              | ± 1                              | ± 1                              | LSB                              |
| Differential Nonlinearity              | DNL                              | Guaranteed monotonic                                            | Guaranteed monotonic                                            | ± 0.5                            | ± 0.5                            | ± 0.5                            | LSB                              |
| Zero-Scale Error                       |                                  | Residual DC offset                                              | Residual DC offset                                              | ± 3                              | ± 3                              | ± 3                              | LSB                              |
| Full-Scale Error                       |                                  | Include Reference Error                                         | Include Reference Error                                         | -35 +35                          | -35 +35                          | -35 +35                          | LSB                              |
...
| DAC Conversion Rate                    |                                  | (Note 2)                                                        | (Note 2)                                                        | 22                               | 22                               |                                  | Msps                             |
| Noise over Nyquist                     | ND                               | f OUT = 2.2MHz, f CLK = 22MHz                                   | f OUT = 2.2MHz, f CLK = 22MHz                                   | -128.4                           | -128.4                           | -128.4                           | dBc/Hz                           |
| Output-of-Band Noise Power Density     | NO                               | f OUT = 1.2MHz, f CLK = 15.36MHz, offset = 10MHz                | f OUT = 1.2MHz, f CLK = 15.36MHz, offset = 10MHz                | -131.5                           | -131.5                           | -131.5                           | dBc/Hz                           |
| Adjacent Channel Power Ratio           | ACPR                             | WCDMA at offset = 5MHz, f CLK = 15.36Msps                       | WCDMA at offset = 5MHz, f CLK = 15.36Msps                       | 57                               | 57                               | 57                               | dB                               |
| Glitch Impulse                         |                                  |                                                                 |                                                                 | 10                               | 10                               | 10                               | pVs                              |
| Spurious-Free Dynamic Range            | SFDR                             | f CLK = 22MHz                                                   | f OUT = 2.2MHz                                                  | 60 71.7                          | 60 71.7                          | 60 71.7                          | dBc                              |
| Spurious-Free Dynamic Range            | SFDR                             | f CLK = 15.36MHz f                                              | OUT = 200kHz                                                    | 72.5                             | 72.5                             | 72.5                             | dBc                              |
| Total Harmonic Distortion (to Nyquist) | THD                              | f CLK = 22MHz, f OUT = 2.2MHz                                   | f CLK = 22MHz, f OUT = 2.2MHz                                   | -70                              | -59                              |                                  | dB                               |
| Signal-to-Noise Ratio (to Nyquist)     | SNR                              | f CLK = 22MHz, f OUT = 2.2MHz                                   | f CLK = 22MHz, f OUT = 2.2MHz                                   | 57                               | 57                               | 57                               | dB                               |
...
| DAC-to-DAC Output Isolation            |                                  | f OUTX, Y = 2.2MHz, f OUTX, Y = 2.0MHz                          | f OUTX, Y = 2.2MHz, f OUTX, Y = 2.0MHz                          | 80                               | 80                               | 80                               | dB                               |
| Gain Mismatch Between DAC Outputs      |                                  | f OUT = 2.2MHz, f CLK = 22MHz                                   | f OUT = 2.2MHz, f CLK = 22MHz                                   | ±0.05                            | ±0.05                            | ±0.05                            | dB                               |
| Phase Mismatch Between DAC Outputs     |                                  | f OUT = 2.2MHz, f CLK = 22MHz                                   | f OUT = 2.2MHz, f CLK = 22MHz                                   | ± 0.15                           | ± 0.15                           | ± 0.15                           | Degrees                          |
...
| ADC-DAC Isolation                                    |                                         | ADC f INI = f INQ = 5.5MHz, DAC f OUTI = f OUTQ = 2.2MHz, f CLK = 22MHz |                                         | 75                                      |                                         | dB                                      |
...
| Shutdown Wake-Up Time                                | t WAKE,SD                               | From shutdown to Tx mode, Figure 6, DAC settles to within 1 LSB error   |                                         | 40                                      |                                         | µs                                      |
...
| PARAMETER                                                                                          | SYMBOL                                                                                             | CONDITIONS                                                                                         | MIN                                                                                                | TYP                                                                                                | MAX UNITS                                                                                          |                                                                                                    |
|----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------|
| Idle Wake-Up Time (with CLK)                                                                       | t WAKE,ST                                                                                          | From idle to Rx mode with CLK present during idle, Figure 6, ADC settles to within 1dB SINAD       | 10                                                                                                 |                                                                                                    |                                                                                                    |                                                                                                    |
|                                                                                                    |                                                                                                    | From idle to Tx mode with CLK present during idle, Figure 6, DAC settles to 10 LSB error           |                                                                                                    | 10                                                                                                 | µs                                                                                                 |                                                                                                    |
...
| Enable Time from Xcvr or Rx to Tx                                                                  | t ENABLE, Tx                                                                                       | DAC settles to 1 LSB error                                                                         |                                                                                                    | 10                                                                                                 | µs                                                                                                 |                                                                                                    |
...
| Reference Input                                                                                    | V REFIN                                                                                            |                                                                                                    | 1.024                                                                                              | 1.024                                                                                              | V                                                                                                  |                                                                                                    |
...
(VDD = DVDD = 3V, OVDD = 1.8V, internal reference (1.024V), CL ≈ 10pF on all digital outputs, fCLK = 22MHz 50% duty cycle, ADC input  amplitude = -0.5dBFS, DAC output amplitude = 0dBFS, differential ADC input, differential DAC output, CREFP = CREFN = CCOM = 0.33µF, Xcvr mode, TA = +25 ° C, unless otherwise noted.)
...
Clock jitter is especially critical for undersampling applications. Consider the clock input as an analog input and route away from any analog input or other digital signal lines. The MAX5864 clock input operates with an OVDD/2 voltage threshold and accepts a 50% ±15% duty cycle.
...
The MAX5864 can be used in diverse applications operating FDD or TDD modes. The MAX5864 operates in  Xcvr  mode for FDD applications such as WCDMA3GPP (FDD) and 4G technologies. Also, the MAX5864 can switch between Tx and Rx modes for TDD applications l i k e   TD-SCDMA,  WCDMA-3GPP  (TDD), IEEE802.11a/b/g, and IEEE802.16.
