...
The device offers an SS\_ pin used to adjust the soft-start time to limit inrush current during startup. Soft-start times are controlled by the values of C21 and C30 for V OUT1 and V OUT2 , respectively. An internal 5µA current source charges the capacitor at the SS\_ pin, providing a linear
...
ramping  voltage  for  output  voltage  reference.  The  softstart time of V OUT1  and V OUT2  are calculated based on the following equation:
...
|----------|-------------------|-------------------------------------------------|---------------------------------------------------------------------|
| JU4      | Not installed 1-2 | Unconnected Connected to the midpoint of        | Enabled Enabled, UVLO level is set by the                           |
...
Figure 1. MAX17558 EV Kit Component Placement GuideComponent Top Side
...
Figure 2. MAX17558 EV Kit PCB LayoutComponent Top Side
...
Figure 5. MAX17558 EV Kit Component Placement GuideSolder Bottom Side
...
Figure 6. MAX17558 EV Kit PCB LayoutComponent Bottom Side
...
| U1                                                                              |   1 | Wide 4.5V to 60V Input, Dual Output, Step-Down DC-DC Controller (32 TQFN-EP) Maxim MAX17558ATJ+ |
