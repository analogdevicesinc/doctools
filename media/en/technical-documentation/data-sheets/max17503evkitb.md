<!-- lastmod 2022-08-02 -->
## MAX17503 5V Output Evaluation Kit
...
| -             |     1 | PCB: MAX17503 - 5V Output EVKIT                                        |
...
The  MAX17503  5V  output  EV  kit  provides  a  proven design  to  evaluate  the  MAX17503  high-voltage,  highefficiency, synchronous step-down DC-DC converter. The EV	kit	is	preset	for	5V	output	from	6.5V	to	60V	input	at load currents up to 2.5A and features a 500kHz switching frequency for optimum efficiency and component size.
...
operation.	Refer	to	the	MAX17503	IC	data	sheet	for	more information	on	PWM,	PFM,	and	DCM	modes	of	operation.
...
Figure 1. MAX17503 5V Output Load and Line Regulation (PWM Mode)

<!-- image -->

Figure 2. MAX17503 5V Output Efficiency (PWM Mode)

<!-- image -->

Figure 3. MAX17503 5V Output Load and Line Regulation (PFM Mode)

<!-- image -->

Figure 4. MAX17503 5V Output Efficiency (PFM Mode)
...
Figure 5. MAX17503 5V Output Efficiency (DCM Mode)

Figure 6. MAX17503 5V Output Full Load Bode Plot (VIN = 24V)

<!-- image -->

Figure 7. MAX17503 5V Output, No Load to 1A Load Transient (PWM Mode)

<!-- image -->

## EV Kit Test Report (continued)

Figure 8. MAX17503 5V Output, 5mA to 1A Load Transient (PFM Mode)

<!-- image -->

Figure 9. MAX17503 5V Output, 50mA to 1A Load Transient (DCM Mode)

<!-- image -->

Figure 10. MAX17503 5V Output, 1A to 2A Load Transient

<!-- image -->

## Evaluates: MAX17503 in 5V Output-Voltage Application

Figure 11. MAX17503 5V Output EV Kit Schematic

<!-- image -->

## MAX17503 5V Output Evaluation Kit

Figure 12. MAX17503 5V Output EV Kit Component Placement Guide-Component Side

<!-- image -->

Figure 13. MAX17503 5V Output EV Kit Component Side PCB layout

<!-- image -->

## Evaluates: MAX17503 in 5V Output-Voltage Application

Figure 14. MAX17503 5V Output EV Kit PCB LayoutInner Layer 1

<!-- image -->

Figure 15. MAX17503 5V Output EV Kit PCB Layout-Inner Layer 2

<!-- image -->

## MAX17503 5V Output Evaluation Kit

Figure 16. MAX17503 5V Output EV Kit PCB LayoutSolder Side

<!-- image -->

## Evaluates: MAX17503 in 5V Output-Voltage Application

Figure 17. MAX17503 5V Output EV Kit Component Placement Guide-Top Solder Mask

<!-- image -->

Figure 18. MAX17503 5V Output EV Kit Component Placement Guide-Bottom Solder Mask
...
|                 1 | 12/13           | Corrected error in Figure 3 and 4 captions | 4               |
