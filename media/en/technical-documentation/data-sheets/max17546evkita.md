<!-- lastmod 2022-08-02 -->
## MAX17546EVKITA# Evaluation Kit

## General Description

The MAX17546 3.3V output evaluation kit (EV kit) provides a proven design to evaluate the MAX17546 high-voltage, high-efficiency, synchronous step-down DC-DC converter. The  EV  kit  is  preset  for  a  3.3V  output  at  load  currents up to  5A and features a 450kHz switching frequency for optimum  efficiency  and  component  size.  The  EV  kit features adjustable input undervoltage lockout, adjustable  soft-start,  open-drain RESET signal,  and  external frequency synchronization.
...
- MAX17546EVKITA#
- 4.5V to 42V, 10A DC input power supply
...
The  MAX17546  EV  kit  provides  a  proven  design  to evaluate  this  high-voltage,  high-efficiency,  synchronous step-down DC-DC converter. The EV kit is preset for a 3.3V output from a 4.5V to 42V input at load currents of up to 5A and features a 450kHz switching frequency for optimum efficiency and component size.
...
## Evaluates: MAX17546 3.3V Output-Voltage Application
...
| Not in- stalled  | Connected to the center node of resistor-divider R1 and R2 | Enabled, UVLO level set through the R1 and R2 resistors |
...
Indicate that you are using the MAX17546 when contacting these component suppliers.

## Ordering Information

| PART            | TYPE   |
|-----------------|--------|
| MAX17546EVKITA# | EV Kit |
...
## MAX17546 3.3V Output Evalution Kit Bill of Materials
...
## MAX17546 3.3V Output Evalution Kit Schematic

<!-- image -->

## MAX17546 3.3V Output Evalution Kit PCB Layout

MAX17546 3.3V Output EV Kit PCB Layout-Silk Top

<!-- image -->

MAX17546 3.3V Output EV Kit PCB Layout-Top Layer
...
## MAX17546 3.3V Output Evalution Kit PCB Layout (continued)

MAX17546 3.3V Output EV Kit PCB Layout-Layer 2 Ground

<!-- image -->

MAX17546 3.3V Output EV Kit PCB Layout-Layer 3 Power
...
MAX17546 3.3V Output EV Kit PCB Layout-Bottom Layer
...
|                 1 | 10/17           | Updated the Detailed Description , Quick Start and Soft-Start Input (SS) sections, and Component Suppliers table. Added a note to and updated Table 2. Replaced Bill of Materials, Schematic , and PCB Layout . | 1-2, 4-9        |
