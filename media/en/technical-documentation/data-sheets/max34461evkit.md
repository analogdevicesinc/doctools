...
The MAX34461 evaluation kit (EV kit) provides the hardware and software graphical user interface (GUI) necessary  to  evaluate  the  MAX34461  PMBus K 16-channel MAX34461ETM+  installed,  as  well  as  four  power  supplies that can be sequenced, monitored, and margined by the IC.

## EV Kit Contents

- S Assembled Circuit Board Including MAX34461ETM+
- S Mini USB Cable

## MAX34461 Evaluation Kit Evaluates: MAX34461

## Features

- S Easy Evaluation of the MAX34461
...
## MAX34461 EV Kit Photo

<!-- image -->

PMBus is a trademark of SMIF, Inc. Windows and Windows XP are registered trademarks and

registered service marks of Microsoft Corp.

## MAX34461 Evaluation Kit Evaluates: MAX34461

## MAX34461 EV Kit Files
...
- 2)  Ensure	that	switch	S1	is	in	the	high	position	and	S4,	S5, and	S6	are	in	the	on	position.
...
If the MAX34461 EV kit is connected when the software is  opened,  the  software  first  initializes  the  hardware  to communicate. Next, the software searches for all slave addresses on the I 2 C bus and connects to the first slave address that is valid. The model number is then read to see which device is connected. The GUI displays EV Kit Hardware Connected at the bottom.
...
The Calculator is	used	to	find	the	DS4424	external	resistor	 (RFS), which determines the full-scale and step-size current	for	the	DAC.	If	RFS is calculated to be outside its limits (40k I &lt;	RFS &lt; 160k I ), then the resistor is forced to  the  edge  of  the  limit  and  the DS4424 RFS edit  box turns  red.  The  equations  used  to  calculate  the  outputs are given in Table 1.
...
Figure 5. MAX34461 EV Kit GUI (Status Tab)

<!-- image -->

## MAX34461 Evaluation Kit Evaluates: MAX34461

Figure 6. MAX34461 EV Kit GUI (Data Log Graph Tab)

<!-- image -->

## MAX34461 Evaluation Kit Evaluates: MAX34461

Figure 7. MAX34461 EV Kit GUI (Fault Log Tab)

<!-- image -->

## MAX34461 Evaluation Kit Evaluates: MAX34461

Figure 8. MAX34461 EV Kit GUI (Registers Tab)
...
| S3       | S3       | Pressed           | Reset: Pulls the reset pin low to reset the MAX34461.               |
| S4       | 1        | On*               | DAC0: Connects DAC0 of DS4424 to FB0 of the channel 0 power supply. |
| S4       | 2        | On*               | DAC1: Connects DAC1 of DS4424 to FB1 of the channel 1 power supply. |
| S4       | 3        | On*               | DAC2: Connects DAC2 of DS4424 to FB2 of the channel 2 power supply. |
| S4       | 4        | On*               | DAC3: Connects DAC3 of DS4424 to FB3 of the channel 3 power supply. |
| S5       | 1        | On*               | RS0: Connects RS0 of MAX34461 to the channel 0 power supply.        |
| S5       | 2        | On*               | RS1: Connects RS1 of MAX34461 to the channel 1 power supply.        |
| S5       | 3        | On*               | RS2: Connects RS2 of MAX34461 to the channel 2 power supply.        |
| S5       | 4        | On*               | RS3: Connects RS3 of MAX34461 to the channel 3 power supply.        |
| S6       | 1        | On*               | PSEN0: Connects PSEN0 of MAX34461 to the channel 0 power supply.    |
| S6       | 2        | On*               | PSEN1: Connects PSEN1 of MAX34461 to the channel 1 power supply.    |
| S6       | 3        | On*               | PSEN2: Connects PSEN2 of MAX34461 to the channel 2 power supply.    |
| S6       | 4        | On*               | PSEN3: Connects PSEN3 of MAX34461 to the channel 3 power supply.    |

Table 4. Description of Jumpers

| JUMPER   | JUMPER POSITION   | DESCRIPTION                                                          |
|----------|-------------------|----------------------------------------------------------------------|
| J1       | VDD-VDUT          | MAX34461 Power: Connects VDD to VDUT (MAX34461).                     |
| J23      | 5V-5V             | 5V: Supplies 5V from the USB I 2 C dongle to the EV kit board.       |
| J23      | SDA-SDA           | SDA: Connects SDA from the USB I 2 C dongle to the MAX34461 SDA.     |
| J23      | GND-GND           | GND: Connects GND from the USB I 2 C dongle to the EV kit board GND. |
| J23      | SCL-SCL           | SCL: Connects SCL from the USB I 2 C dongle to the MAX34461 SCL.     |

## MAX34461 Evaluation Kit
...
| No slave address found and read/writes fail       | Jumper J1                                                    | Make sure jumper J1 is installed to power the MAX34461.                                                                                                                                                                                                                |
| No slave address found and read/writes fail       | Jumper J23                                                   | Make sure 4 jumpers on J23 are installed.                                                                                                                                                                                                                              |
| Channels do not turn on                           | Is there a CONTROL# fault on the Status Tab of the GUI?      | Default configuration Control is active high. Make sure S1 is in the high position                                                                                                                                                                                     |
| Channels do not turn on                           | Is the ALERT LED on and all channel LEDs off?                | If so, make sure switch PSEN (S6) is in the on position to connect the PSENs of MAX34461 to the channels.                                                                                                                                                              |
| Channels do not turn on                           | Is the ALERT LED on and Channel 0 LED on?                    | If so, make sure switch RS (S5) is in the on position to connect the power-supply outputs to the MAX34461.                                                                                                                                                             |
...
| D2, D7, DA-DD |     6 | Red LEDs (1206) Kingbright APTR3216EC             |
| D6            |     1 | Green LED (1206) Lumex SML-LX1206GC-TR            |
...
| Q2            |     1 | 60V, 340mA nMOSFET (SC70) ON Semi 2N7002WT1G      |
...
| C06                                               |     0 | Do not populate, ceramic capacitor                                 |
| C1A-C1D, C04, C21, C24, C203, C214                |     9 | 0.01 F F, X7R ceramic capacitors (0805) TDK C2012X7R1H103KT        |
| C02, C03, C07, C08, C10, C11, C212                |     7 | 0.1 F F, X7R ceramic capacitors (0805) TDK CGJ4J2X7R1H104K         |
...
| DESIGNATION                                                          |   QTY | DESCRIPTION                                            |
|----------------------------------------------------------------------|-------|--------------------------------------------------------|
| R0-R17, R36, R37, R102, R107, R108, R201, R202, R214                 |    26 | 0 I Q 1% resistors (0805) Vishay CRCW08050000Z0EA      |
| R0A-R0D, R77, R79-R95, R103, R109, R123, R133, R135, R204            |    28 | 100k I Q 1% resistors (0805) Vishay CRCW0805100KFKEA   |
...
| R101, R161, R164, R207                                               |     4 | 10k I Q 1% resistors (0805) Vishay CRCW080510K0FKEB    |
...
| R20-R35, R40-R55, R76, R78, R110, R121, R132, R134, R162, R215, R216 |     0 | Do not populate, resistors (0805)                      |
...
| R104, R120, R124, R211, R212                                         |     5 | 330 I Q 1% resistors (0805) Vishay CRCW0805330RFKEA    |
...
| TP15-TP42, TP50          |    29 | White test points Keystone 5012                                   |
| U1                       |     1 | PMBus 16-channel voltage monitor (48 TQFN-EP*) Maxim MAX34461ETM+ |
...
Figure 9a. MAX34461 EV Kit Schematic (Sheet 1 of 3)

<!-- image -->

## MAX34461 Evaluation Kit Evaluates: MAX34461

Figure 9b. MAX34461 EV Kit Schematic (Sheet 2 of 3)

<!-- image -->

## MAX34461 Evaluation Kit Evaluates: MAX34461

Figure 9c. MAX34461 EV Kit Schematic (Sheet 3 of 3)

<!-- image -->

## MAX34461 Evaluation Kit Evaluates: MAX34461

Figure 10. MAX34461 EV Kit PCB Layout-Top

<!-- image -->

Figure 11. MAX34461 EV Kit PCB Layout-Bottom
