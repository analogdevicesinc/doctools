<!-- lastmod 2022-08-03 -->
## MAX40111 Evaluation Kit

## General Description

The MAX40111 evaluation kit (EV kit) provides a proven design to evaluate the MAX40111 low-offset, low-power, rail-to-rail  I/O  operational amplifier in a 6-pin wafer-level package  (WLP).  The  EV  kit  circuit  is  preconfigured  as noninverting  amplifiers,  but  can  be  adapted  to  other topologies by changing a few components.

The EV kit comes with a MAX40111ANT+ installed.
...
The  MAX40111  EV  kit  provides  a  proven  layout  for  the MAX40111 low-power op amp. The device is a single-supply op  amp  that  is  ideal  for  sensor  interfaces,  loop-powered systems, and various types of medical and data-acquisition instruments.
...
The EV kit comes preconfigured as a noninverting amplifier. The  gain  is  set  by  the  ratio  of  R5  and  R1.  The  EV  kit comes  preconfigured  for  a  gain  of  +11V/V.  The  output voltage for the noninverting configuration is given by the following equation:
...
| JU4      | Pin 1*           | Disconnect GND from V SS                                      |
| JU4      | 1-2              | Connect GND from V SS                                         |
...
| PART           | TYPE   |
|----------------|--------|
| MAX40111EVKIT# | EV Kit |

#Denotes RoHS compliant.

│

## MAX40111 EV Kit Bill of Materials

|   ITEM | REF_DES                       | DNI/DNP   |   QTY | MFG PART #                                                              | MANUFACTURER                          | VALUE        | DESCRIPTION                                                                                                             |
|--------|-------------------------------|-----------|-------|-------------------------------------------------------------------------|---------------------------------------|--------------|-------------------------------------------------------------------------------------------------------------------------|
|      1 | C1, C7                        | -         |     2 | C0603X7R500103JNP; C0603C103J5RAC                                       | VENKEL LTD; KEMET                     | 0.01UF       | CAP; SMT (0603); 0.01UF; 5%; 50V; X7R; CERAMIC                                                                          |
|      2 | C2, C10                       | -         |     2 | GRM31CR71H475KA12; GRJ31CR71H475KE11; GXM31CR71H475KA10; UMK316AB7475KL | MURATA; MURATA; MURATA; TAIYO YUDEN   | 4.7UF        | CAP; SMT (1206); 4.7UF; 10%; 50V; X7R; CERAMIC                                                                          |
...
|      6 | MH1-MH4                       | -         |     4 | 9032                                                                    | KEYSTONE                              | 9032         | MACHINE FABRICATED; ROUND-THRU HOLE SPACER; NO THREAD; M3.5; 5/8IN; NYLON                                               |
...
|     11 | TP1, TP2                      | -         |     2 | 5000                                                                    | KEYSTONE                              | N/A          | TEST POINT; PIN DIA=0.1IN; TOTAL LENGTH=0.3IN; BOARD HOLE=0.04IN; RED; PHOSPHOR BRONZE WIRE SILVER PLATE FINISH;        |
...
|     13 | U1                            | -         |     1 | MAX40111ANT+                                                            | MAXIM                                 | MAX40111ANT+ | EVKIT PART - IC; MAX40111; PACKAGE OUTLINE DRAWING: 21-100055; PACKAGE CODE: N60C1+1; WLP6                              |
...
|     15 | PCB                           | -         |     1 | MAX40111                                                                | MAXIM                                 | PCB          | PCB:MAX40111                                                                                                            |
...
## MAX40111 EV Kit Schematic Diagram

<!-- image -->

## MAX40111 EV Kit PCB Layout Diagrams

MAX40111 EV Component Placement Guide-Top Silkscreen

<!-- image -->

MAX40111 EV PCB Layout Diagram-Top View
...
## MAX40111 EV Kit PCB Layout Diagrams (continued)

MAX40111 EV PCB Layout Diagram-Bottom View
