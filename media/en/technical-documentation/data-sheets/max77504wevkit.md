...
## Evaluates: MAX77504 (MAX77504AAWE+/MAX77504BAWE+)
...
| J2       | FPWM               | 1-2              | Enables FPWM function.                                                                                                        |
| J2       | FPWM               | 2-3*             | Enables SKIP mode function.                                                                                                   |
...
|-------------|-------------|-----------|------------------------------------------|--------------------------|
| MSB         | Bit 4       | FSW[1:0]  | Switching Frequency Control. Sets F SW . | 00 = 0.5MHz 01 = 0.75MHz |
| MSB         | Bit 3       | FSW[1:0]  | Switching Frequency Control. Sets F SW . | 10 = 1.0MHz 11 = 1.5MHz  |
| MSB         | Bit 2       | GAIN[1:0] | Mid-band gain control. Sets R COMP .     | 00 = 75kΩ 01 = 100kΩ     |
| MSB         | Bit 1       | GAIN[1:0] | Mid-band gain control. Sets R COMP .     | 10 = 150kΩ 11 = 200kΩ    |
...
|-----------------|---------------|--------------------------|----------------|---------------|
| MAX77504WEVKIT# | MAX77504AAWE+ | 3.3V                     | 2.4V           | 2.6V          |
...
| U1                                                                                                           | 1                                                                                                            | MAX77504AAWE+                                                                                                | MAXIM                                                                                                        | BUCK (16 WLP), MAX77504AAWE+                                                                                     |
...
| PCB                                                                                                          | 1                                                                                                            | MAX77504 SOLDERDOWN                                                                                          | MAXIM                                                                                                        | PCB:MAX77504SOLDERDOWN                                                                                           |
