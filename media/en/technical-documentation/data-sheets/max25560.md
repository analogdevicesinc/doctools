...
Extensive diagnostics and an I 2 C interface are included in the device.
...
| V5 Undervoltage                                        | V V5_UVLOR                 | V5 voltage rising                               | 3.75  | 3.9   | 4.05  |         |
...
| NGATE OUTPUT/INPUT CURRENT                             | NGATE OUTPUT/INPUT CURRENT | SENSING                                         |       |       |       |         |
...
| Boost Converter Maximum Duty Cycle,                |                          | f SW = 400kHz to 500kHz                                        | 94                       |                          | 98                       | %                        |
...
|------------------------------------|-----------------|------------------------------|--------------------------------------------------|-------|-------|-------|---------|
| OUT_ Regulation High Threshold     |                 | V OUT_ falling               | V OUT_ falling                                   | 0.82  | 0.85  | 0.87  | V       |
| OUT_ Regulation Low Threshold      |                 | V OUT_ rising                | V OUT_ rising                                    | 0.55  | 0.58  | 0.61  | V       |
...
| MOSFET DRIVER                      |                 |                              |                                                  |       |       |       |         |
| NDRV On-Resistance, High Side      |                 | I NDRV = 100mA               | I NDRV = 100mA                                   |       | 1.5   | 3     | Ω       |
| NDRV On-Resistance, Low Side       |                 | I NDRV = -100mA              | I NDRV = -100mA                                  |       | 1.2   | 2     | Ω       |
| NDRV Rise Time                     |                 | C NDRV = 1nF                 | C NDRV = 1nF                                     |       | 8     |       | ns      |
| NDRV Fall Time                     |                 | C NDRV = 1nF                 | C NDRV = 1nF                                     |       | 8     |       | ns      |
| NDRVS Input Logic-Low              | V IL_NDRVS      | V NDRVS falling              | V NDRVS falling                                  |       | 2     | 2.4   | V       |
| NDRVS Input Logic- High            | V IH_NDRVS      | V NDRVS rising               | V NDRVS rising                                   | 2.55  | 3.3   |       | V       |
| NDRVS Input Current                | I NDRVS         | V NDRVS = 5V                 | V NDRVS = 5V                                     |       | 60    | 80    | μA      |
| LED CURRENT SINKS                  |                 |                              |                                                  |       |       |       |         |
...
| Current-Setting Resolution         | I OUT_LSB       |                              |                                                  |       | 1.5   |       | mA      |
...
| PARAMETER                                          | SYMBOL                                             | CONDITIONS                                         | MIN                                                | TYP                                                | MAX                                                | UNITS                                              |
|----------------------------------------------------|----------------------------------------------------|----------------------------------------------------|----------------------------------------------------|----------------------------------------------------|----------------------------------------------------|----------------------------------------------------|
| LED Short-Detection Threshold                      | V THSHRT                                           | SLDET[1:0] = 11                                    | 7.7                                                | 8                                                  | 8.1                                                | V                                                  |
| LED Short-Detection Threshold                      | V THSHRT                                           | SLDET[1:0] = 10                                    | 5.6                                                | 6                                                  | 6.4                                                | V                                                  |
| LED Short-Detection Threshold                      | V THSHRT                                           | SLDET[1:0] = 01                                    | 2.8                                                | 3                                                  | 3.2                                                | V                                                  |
| OUT_ Check-LED- Source Current                     | I OUT_CKLED                                        | V OUT_ = 0.5V                                      | 45                                                 | 60                                                 | 75                                                 | µA                                                 |
...
After the boost soft-start is completed, the MAX25560 continues to operate with BATT voltages lower than 5V while maintaining 5V drive for the external MOSFET at NDRV. When the voltage at BATT drops to V BATT\_LVF , the V5 regulator switches its input from BATT to BOOST, the boost converter current limit is automatically increased to V CSP\_LV,  and the switching frequency is reduced if it is greater than 1.4MHz. Switchover occurs as long as the voltage on BOOST is above VBATT\_LVF . In this mode, if the standard current limit is exceeded on four consecutive cycles, a 100ms timer is started, which returns the current limit to its original value when it expires.
...
current value determined by the resistor on ISET is loaded into the iset[6:0] field in ISET\_REG and can be adjusted subsequently using the I 2 C interface. Select the ISET resistor value using Table 1 .
...
## MAX25560 Diagnostics and FLTB Output
...
where 0.95V (typ) is the overvoltage threshold on BSTMON (see the Functional Diagram ). Select VOUT\_BSTMON according to the formula below.
...
The MAX25560 features an I 2 C, two-wire serial interface consisting of a serial-data line (SDA) and a serial-clock line (SCL).

SDA and SCL facilitate communication between the device and the controller at clock rates up to 400kHz. The controller, typically a microcontroller, generates SCL and initiates data transfer on the bus. Figure 7 shows the two-wire interface timing diagram.
...
Figure 8. Figure 9. Data Format of I 2 C Interface
...
| 0x02           | SET_REG[7:0]              | -                         | -                         | -                         | BL_ILIM                   | BSTFORCE                  | FAST_S S                  | ENA                       | PSEN                      |
| 0x03           | IMODE_REG[7:0]            | -                         | -                         | -                         | DIS_ISNS_S D              | DIM_EXT                   | HDIM                      | HDIM_THR_1_0[1:0]         | HDIM_THR_1_0[1:0]         |
...
| 0x08           | TON2L_REG[7:0]            |                           |                           |                           | TON2L[7:0]                |                           |                           |                           |                           |
| 0x09           | TON3H_REG[7:0]            |                           |                           |                           | TON3H[7:0]                |                           |                           |                           |                           |
...
| 0x0E           | TON5H_REG[7:0]            | TON5H[7:0]                | TON5H[7:0]                | TON5H[7:0]                | TON5H[7:0]                | TON5H[7:0]                | TON5H[7:0]                | TON5H[7:0]                | TON5H[7:0]                |
...
| 0x12           | TON5_6LSB_REG[7:0]        | -                         | -                         | -                         | TON_ALL                   | TON6LSB[1:0]              | TON6LSB[1:0]              | TON5LSB[1:0]              | TON5LSB[1:0]              |
| 0x13           | SETTING_REG[7:0]          | - FPWM[2:0]               | - FPWM[2:0]               | - FPWM[2:0]               | - FPWM[2:0]               | SS_OFF                    | SSL                       | SLDET[1:0]                | SLDET[1:0]                |
| 0x14           | DISABLE_REG[7:0]          | -                         | SLDET_DI S                | CP_DIS                    | DIS6                      | DIS5                      | DIS4                      | DIS3                      | DIS2                      |

## 6 x 220mA LED Backlight Driver with Boost Controller

| ADDRES S   | NAME                  | MSB              |                  |                  |                  |                  |                  |                  | LSB              |
|------------|-----------------------|------------------|------------------|------------------|------------------|------------------|------------------|------------------|------------------|
| 0x15       | FADING_REG[7:0]       | -                | -                | -                | FADE_GAIN        | FADE_IN_OU T     | TDIM[2:0]        | TDIM[2:0]        | TDIM[2:0]        |
| 0x16       | LO_DIM[7:0]           | -                | -                | LO_DIM6          | LO_DIM5          | LO_DIM4          | LO_DIM 3         | LO_DIM2          | LO_DIM 1         |
| 0x17       | OPEN_REG[7:0]         | -                | -                | OUT6O            | OUT5O            | OUT4O            | OUT3O            | OUT2O            | OUT1O            |
| 0x18       | SHORTGND_REG[7:0]     | -                | -                | OUT6SG           | OUT5SG           | OUT4SG           | OUT3S G          | OUT2SG           | OUT1S G          |
| 0x19       | SHORTED_LED_REG[7 :0] | -                | -                | OUT6SL           | OUT5SL           | OUT4SL           | OUT3SL           | OUT2SL           | OUT1SL           |
| 0x1A       | MASK1_REG[7:0]        | -                | -                | -                | BSTUVMAS K       | OMASK            | SGMAS K          | OTWMAS K         | SLMAS K          |
| 0x1B       | MASK2_REG[7:0]        | -                | -                | BATT_UVMAS K     | -                | -                | -                | -                | -                |
| 0x1C       | DIAG1_REG[7:0]        | RTOOR            | ISETOOR          | IREFOOR          | BSTUV            | BSTOV            | HW_RS T          | OTW              | OT               |
| 0x1D       | DIAG2_REG[7:0]        | V18OO R          | -                | BATT_UV          | -                | V5OOR            | -                | -                | ISNS_S D         |
...
| PSEN       |      0 | When 0, phase shifting is disabled. When 1, shifting is enabled.                                         | phase                                                  |
...
| BIT         | 7   | 6           | 5           | 4           | 3           | 2           | 1           | 0           |
|-------------|-----|-------------|-------------|-------------|-------------|-------------|-------------|-------------|
| Field       | -   | FPWM[2:0]   | FPWM[2:0]   | FPWM[2:0]   | SS_OFF      | SSL         | SLDET[1:0]  | SLDET[1:0]  |
| Reset       | -   | 0b001       | 0b001       | 0b001       | 0b0         | 0b0         | 0b00        | 0b00        |
| Access Type | -   | Write, Read | Write, Read | Write, Read | Write, Read | Write, Read | Write, Read | Write, Read |
...
|------------|--------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| FPWM       | 6:4    | These bits set thePWM frequency in internal PWM mode.                                                                                                                                                                                                                                                   | These bits set thePWM frequency in internal PWM mode.                                                                                                                                                                                                                                                   | These bits set thePWM frequency in internal PWM mode.                                                                                                                                                                                                                                                   | These bits set thePWM frequency in internal PWM mode.                                                                                                                                                                                                                                                   | These bits set thePWM frequency in internal PWM mode.                                                                                                                                                                                                                                                   |
| FPWM       | 6:4    | FPWM2                                                                                                                                                                                                                                                                                                   | FPWM1                                                                                                                                                                                                                                                                                                   | FPWM0                                                                                                                                                                                                                                                                                                   | FPWM0                                                                                                                                                                                                                                                                                                   | PWM FREQUENCY (Hz)                                                                                                                                                                                                                                                                                      |
| FPWM       | 6:4    | 0                                                                                                                                                                                                                                                                                                       | 0                                                                                                                                                                                                                                                                                                       | 0                                                                                                                                                                                                                                                                                                       | 0                                                                                                                                                                                                                                                                                                       | 153                                                                                                                                                                                                                                                                                                     |
| FPWM       | 6:4    | 0                                                                                                                                                                                                                                                                                                       | 0                                                                                                                                                                                                                                                                                                       | 1                                                                                                                                                                                                                                                                                                       | 1                                                                                                                                                                                                                                                                                                       | 203                                                                                                                                                                                                                                                                                                     |
| FPWM       | 6:4    | 0                                                                                                                                                                                                                                                                                                       | 1                                                                                                                                                                                                                                                                                                       | 0                                                                                                                                                                                                                                                                                                       | 0                                                                                                                                                                                                                                                                                                       | 305                                                                                                                                                                                                                                                                                                     |
| FPWM       | 6:4    | 0                                                                                                                                                                                                                                                                                                       | 1                                                                                                                                                                                                                                                                                                       | 1                                                                                                                                                                                                                                                                                                       | 1                                                                                                                                                                                                                                                                                                       | 610                                                                                                                                                                                                                                                                                                     |
| FPWM       | 6:4    | 1                                                                                                                                                                                                                                                                                                       | 0                                                                                                                                                                                                                                                                                                       | 0                                                                                                                                                                                                                                                                                                       | 0                                                                                                                                                                                                                                                                                                       | 980                                                                                                                                                                                                                                                                                                     |
| FPWM       | 6:4    | 1                                                                                                                                                                                                                                                                                                       | 0                                                                                                                                                                                                                                                                                                       | 1                                                                                                                                                                                                                                                                                                       | 1                                                                                                                                                                                                                                                                                                       | 1220                                                                                                                                                                                                                                                                                                    |
| FPWM       | 6:4    | 1                                                                                                                                                                                                                                                                                                       | 1                                                                                                                                                                                                                                                                                                       | 0                                                                                                                                                                                                                                                                                                       | 0                                                                                                                                                                                                                                                                                                       | 1401                                                                                                                                                                                                                                                                                                    |
| FPWM       | 6:4    | 1                                                                                                                                                                                                                                                                                                       | 1                                                                                                                                                                                                                                                                                                       | 1                                                                                                                                                                                                                                                                                                       | 1                                                                                                                                                                                                                                                                                                       | 1634                                                                                                                                                                                                                                                                                                    |
| SS_OFF     | 3      | When 1, spread-spectrum switching is disabled. Default value is 0.                                                                                                                                                                                                                                      | When 1, spread-spectrum switching is disabled. Default value is 0.                                                                                                                                                                                                                                      | When 1, spread-spectrum switching is disabled. Default value is 0.                                                                                                                                                                                                                                      | When 1, spread-spectrum switching is disabled. Default value is 0.                                                                                                                                                                                                                                      | When 1, spread-spectrum switching is disabled. Default value is 0.                                                                                                                                                                                                                                      |
...
| SLDET      | 1:0    | Shorted-LED threshold Settings.                                                                                                                                                                                                                                                                         | Shorted-LED threshold Settings.                                                                                                                                                                                                                                                                         | Shorted-LED threshold Settings.                                                                                                                                                                                                                                                                         | Shorted-LED threshold Settings.                                                                                                                                                                                                                                                                         | Shorted-LED threshold Settings.                                                                                                                                                                                                                                                                         |
| SLDET      | 1:0    |                                                                                                                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                                         |                                                                                                                                                                                                                                                                                                         | 8V                                                                                                                                                                                                                                                                                                      | 8V                                                                                                                                                                                                                                                                                                      |
| SLDET      | 1:0    | 01                                                                                                                                                                                                                                                                                                      | 01                                                                                                                                                                                                                                                                                                      | 01                                                                                                                                                                                                                                                                                                      | 3V                                                                                                                                                                                                                                                                                                      | 3V                                                                                                                                                                                                                                                                                                      |
| SLDET      | 1:0    | 10                                                                                                                                                                                                                                                                                                      | 10                                                                                                                                                                                                                                                                                                      | 10                                                                                                                                                                                                                                                                                                      | 6V                                                                                                                                                                                                                                                                                                      | 6V                                                                                                                                                                                                                                                                                                      |
| SLDET      | 1:0    | 11                                                                                                                                                                                                                                                                                                      | 11                                                                                                                                                                                                                                                                                                      | 11                                                                                                                                                                                                                                                                                                      | 8V                                                                                                                                                                                                                                                                                                      | 8V                                                                                                                                                                                                                                                                                                      |
...
The MAX25560 backlight controller generates a current ramp for slope compensation. This ramp current is synchronized to the switching frequency, starting from zero at the beginning of every clock cycle and rising linearly to reach 50μA at the end of the clock cycle. The slope-compensating resistor (R SC ) is connected between the CSP input and the source of the external MOSFET. This adds a programmable ramp voltage to the CSP input voltage to provide slope compensation.
...
RCOMP = f ZRHP  × R CS  × I LED  × A OVP /(5 × f P1  × GM COMP  × V LED × (1 - D MAX))
...
| MAX25560ATJ/VY+ | -40°C to +125°C | T3255Y+6C      | 32-TQFN-EP*   |
...
|                 2 | 4/24            | Updated Ordering Information table                                                                                                       | 47              |
|                 3 | 1/26            | Added T3255Y+6C in Package Information; updated units of measure in Pin Descriptions; updated part number in Typical Application Circuit | 3, 11, 12, 47   |

<!-- image -->

## 6 x 220mA LED Backlight Driver with Boost