...
319-100952; Rev 0; 9/22

Figure 1. MAX77857 Typical Application Circuit

<!-- image -->

Figure 2. MAX77857Q Evaluation Board
...
With the default jumper settings listed in Table 1 and the EV kit component values of R SEL  (R9) = 0 Ω, RTOP (R10) = 0Ω, and R BOT (R11) = OPEN, the MAX77857Q EV kit is configured with the following settings:
...
Typical bench setups for the MAX77857Q EV kit with different configurations are shown in Figure 3 , Figure 4 , and Figure 5 .
...
5.  Confirm the DVM2 reads the default output voltage of the EV kit (5V). Confirm the ammeter reads the expected input supply current (about 200μA).
6. Now that the EV kit is confirmed working, short out the series ammeter and increase the power supply's current limit. Connect an electronic load across OUT and PGND2 terminals to evaluate the performance of the MAX77857 buckboost regulator.
...
7.  Install GUI software. Visit the product webpage at https://www.maximintegrated.com/products/MAX77857QEVKIT and navigate  to Design  Resources to  download  the  latest  version  of  the  EV  kit  software.  Save  the  EV  kit  software installation file to a temporary folder and decompress the ZIP file. Run the .EXE installer and follow the on-screen instructions to complete the installation.
8.  Turn off the input power supply connected in step 4.
9.  Remove jumper J2. V IO is later powered from MAXUSB\_INTERFACE#'s on -board LDO. Move jumper J1 to position 2-3.
...
header jumper J2. This connects V IO  to V L  so that V IO  is powered from V L , eliminating the need for an external V IO  power supply.
...
Figure 7. MAX77857Q EV Kit GUI Software Configuration Tab

<!-- image -->

## Installation

Visit  the  product  webpage  at https://www.maximintegrated.com/products/MAX77857QEVKIT and  navigate  to Design Resources to download the latest version of the EV kit software. Save the EV kit software installation file to a temporary folder  and  decompress  the  ZIP  file.  Run  the  .EXE  installer  and  follow  the  on-screen  instructions  to  complete  the installation.
...
Careful circuit board layout is critical to achieving low switching power losses and clean, stable operation. The EV kit also serves as a recommended layout of the MAX77857. Figure 15 shows an example layout for the MAX77857 in a FC2QFN package. Use the provided layout files for guidance when designing with the IC. The IC data sheet contains a list of useful tips and guidelines for achieving the best possible layout. They are repeated here for convenience:
...
|-----------------|----------------|--------------------------|--------|
| MAX77857QEVKIT# | MAX77857BEFE+T | 5V                       | EV Kit |

## MAX77857Q Evaluation Kit

## Evaluates: MAX77857 (FC2QFN)

## MAX77857Q EV Kit Bill of Materials
...
| U1                                                                                                           | 1                                                                                                            | MAX77857BEFE+                                                                                                | ANALOG DEVICES                                                                                               | MAX77 857BE FE+                                                                                              | EVKIT PART - IC; MAX77857BEFE+; 2.5V TO 16V INPUT; 7A SWITCHING CURRENT HIGH EFFICIENCY BUCK- BOOST CONVERTER; PACKAGE OUTLINE DRAWING: 21-100410; LAND PATTERN NUMBER: 90- 100141; PACKAGE CODE: F163A3F+1; FC2QFN16 |
...
| INS, OUTS, VIO, VL                                                                                           | 4                                                                                                            | 5000                                                                                                         | KEYSTONE                                                                                                     | N/A                                                                                                          | TEST POINT; PIN DIA=0.1IN; TOTAL LENGTH=0.3IN; BOARD HOLE=0.04IN; RED; PHOSPHOR                                                                                                                                       |
...
| J2             | 1   | PBC02SAAN                    | SULLINS ELECTRONICS CORP.              | PBC02 SAAN       | CONNECTOR; MALE; THROUGH HOLE; BREAKAWAY; STRAIGHT; 2PINS                                                          |
...
| PCB            | 1   | MAX77857Q                    | MAXIM                                  | PCB              | PCB:MAX77857Q                                                                                                      |
...
| SU1-SU3        | 3   | S1100-B; SX1100-B; STC02SYAN | KYCON;KYCON;SU LLINS ELECTRONICS CORP. | SX110 0-B        | TEST POINT; JUMPER; STR; TOTAL LENGTH=0.24IN; BLACK; INSULATION=PBT;PHOSPHOR BRONZE CONTACT=GOLD PLATED            |
| C3, C12        | DNP | N/A                          | N/A                                    | OPEN             | CAPACITOR; SMT (0805); OPEN; FORMFACTOR                                                                            |
| J3             | DNP | PBC02SAAN                    | SULLINS ELECTRONICS CORP.              | PBC02 SAAN       | CONNECTOR; MALE; THROUGH HOLE; BREAKAWAY; STRAIGHT; 2PINS                                                          |
...
## MAX77857Q EV Kit Schematic

<!-- image -->

## Evaluates: MAX77857 (FC2QFN)

## MAX77857Q EV Kit PCB Layouts

MAX77857Q EV Kit Component Placement Guide -Top Silkscreen

<!-- image -->

MAX77857Q EV Kit PCB Layout -Top View

<!-- image -->

## MAX77857Q Evaluation Kit

MAX77857Q EV Kit PCB Layout -Internal 2

<!-- image -->

MAX77857Q EV Kit PCB Layout -Internal 3

<!-- image -->

## Evaluates: MAX77857 (FC2QFN)

## MAX77857Q EV Kit PCB Layouts (continued)

<!-- image -->

MAX77857Q EV Kit PCB Layout -Internal 4

MAX77857Q EV Kit PCB Layout -Internal 5

<!-- image -->

MAX77857Q EV Kit PCB Layout -Bottom View
