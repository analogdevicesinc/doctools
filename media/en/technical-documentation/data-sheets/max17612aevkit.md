<!-- lastmod 2022-08-03 -->
## MAX17612A Evaluation Kit

## General Description

The MAX17612A evaluation kit (EV kit) is a fully assembled  and  tested  circuit  board  that  demonstrates  the MAX17612A 4.5V to 60V, 250mA, current-limiter with OV, UV, and reverse protection in a 10-pin TDFN-EP package. The EV kit can be configured to demonstrate adjustable overvoltage,  undervoltage,  different  current-limit  types, and different current-limit thresholds.
...
The EV kit provides on-board output capacitors to enable a demonstration of the MAX17612A protection features.
...
## Evaluates: MAX17612A 4.5V to 60V, 250mA, Current-Limiter with OV, UV, and Reverse Protection
...
## MAX17612A EV Kit Performance Report
...
## Evaluates: MAX17612A 4.5V to 60V, 250mA, Current-Limiter
...
Note: Indicate that you are using the MAX17612A when contacting these component suppliers.

## Ordering Information

| PART            | TYPE   |
|-----------------|--------|
| MAX17612AEVKIT# | EV Kit |
...
## MAX17612A EV Kit Bill of Materials
...
| U1                  |     1 | 4.5V to 60V, 250mA, Current-Limiter with OV, UV and Reverse Protection (10-pin TDFN-EP, 3mmx3mm) | MAX17612AATB+                                  |
...
| PCB                 |     1 | PCB: MAX17612A Evaluation Kit                                                                    | -                                              |
...
## MAX17612A EV Kit Schematic

<!-- image -->

## MAX17612A Evaluation Kit

## MAX17612A EV Kit  PCB Layout

MAX17612A EV Kit  PCB Layout-Top Silkscreen

<!-- image -->

## Evaluates: MAX17612A 4.5V to 60V, 250mA, Current-Limiter with OV, UV, and Reverse Protection

MAX17612A EV Kit  PCB Layout-Top Layer

<!-- image -->

MAX17612A EV Kit  PCB Layout-Bottom Layer
...
|                 1 | 8/18            | Updated TOC01 and the Bill of Materials | 4-6             |
