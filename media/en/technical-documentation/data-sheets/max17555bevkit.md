...
## Evaluates: MAX17555 (MAX17555B)

## General Description

The  MAX17555B  evaluation  kit  (EV  kit)  is  a  fully assembled and tested circuit board that demonstrates the performance of the MAX17555B, a 4V to 60V, 50mA, ultra-small,  high  efficiency,  Synchronous  Step-Down DC-DC  Converter  in  an  8-pin  TDFN  (2mm  x  2mm) package. The EV kit is designed to operate over a 10V to 60V input and provides a 5V, 50mA output. The EV kit is set up to turn ON at 13V (max) and turn OFF at 10V (max) using the EN/UV and HYST pins. The step-down converter is switch at a fixed 70kHz frequency and delivers a peak efficiency of 87.3% with supplied components.

The EV kit is simple to use and easily configurable with minimal external components. The MAX17555B features programmable input EN/UV and HYST threshold, and an open-drain RESET signal. The device offers built-in hiccup mode protection for overload and short circuit conditions, and thermal shutdown. The EV kit is complaint with the CISPR32 class B standard.
...
Figure 1. MAX17555B EV Kit Setup Diagram
...
A typical bench setup for the MAX17555B EV kit is shown in Figure 1 .
...
1.  Set the power supply to a voltage between 13V and 60V. Disable the power supply.
...
6.  If required, vary the input voltage from 10V to 60V and the load current from 0mA to 50mA, then verify that the output voltage is 5V with respect to GND.

## Evaluates: MAX17555 (MAX17555B)

## Detailed Description

The MAX17555B EV kit provides a proven design to evaluate the MAX17555B, a 4V to 60V, 50mA ultra-small, high efficiency, synchronous step-down DC-DC converter. The EV kit comes with installed components for delivering 5V, 50mA (max) output current from a 10V to 60V input. The EV kit can be used to verify the EN/UV and HYST features of the MAX17555B. The IC switch at a fixed frequency of 70kHz. The EV kit can also be used to verify the output overload or short circuit protection as well as the thermal shutdown protection. Refer to the MAX17555 IC data sheet to change the EV kit configuration to a different specification.
...
## MAX17555B EV Kit Bill of Materials
...
|      7 |     1 | R2           | 412kΩ, ±1%, 1/16W, resistor (0402)               | VISHAY CRCW0402412KFK       |
...
|     11 |     1 | L1           | INDUCTOR, 220μH, 0.24A                           | COILCRAFT LPS4018-224MR     |
|     12 |     1 | U1           | 4V to 60V, 50mA, Step-Down DC-DC Converter       | ANALOG DEVICE MAX17555BATA+ |
...
## MAX17555B EV Kit PCB Layout

MAX17555B EV Kit PCB Layout -Top Silkscreen

<!-- image -->

MAX17555B EV Kit PCB Layout -Layer 2

<!-- image -->

## MAX17555B Evaluation Kit

MAX17555B EV Kit PCB Layout -Top Layer

<!-- image -->

MAX17555B EV Kit PCB Layout -Layer 3

<!-- image -->

## Evaluates: MAX17555 (MAX17555B)

## MAX17555B EV Kit PCB Layout (continued)

MAX17555B EV Kit PCB Layout -Bottom Layer
...
MAX17555B EV Kit PCB Layout -Bottom Silkscreen
