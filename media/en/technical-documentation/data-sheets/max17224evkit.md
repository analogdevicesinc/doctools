...
## MAX17224 EV Kit Files

| FILE                                    | DESCRIPTION               |
|-----------------------------------------|---------------------------|
| MAX17224 EV BOM                         | EV Kit Bill of Material   |
| MAX17224 EV PCB Layout Diagrams         | EV Kit Layout             |
| MAX17224 EV Schematic                   | EV Kit Schematic          |
| MAX17224 EV Minimal Component Schematic | Minimal Component Circuit |
...
The  MAX17224  EV  kit  evaluates  the  MAX17220MAX17225 IC family of ultra-low quiescent current stepup DC-DC converters. The MAX17224 EV kit features two independent circuits to evaluate two different IC packages of the MAX17220-MAX17225 family. Both circuits on the EV  kit  operate  over  an  input  range  of  400mV  to  5.5V. Each circuit provides resistor-configurable output voltages from 1.8V to 5V in 100mV/step.

The  MAX17224  EV  Kit  comes  with  a  MAX17224ELT+ (µDFN)  and  a  MAX17224ENT+  (WLP)  installed.  The MAX17224ELT+ circuit is configured for a 3V output, and can deliver 425mA with 1.8V input. The MAX17224ENT+ circuit  is  configured  for  a  5V  output,  and  can  deliver 425mA with 3V input.

## EN for the WLP Circuit

The WLP circuit on the EV kit provides a jumper (JU1) to enable or disable the MAX17224ENT+. See Table 1 for JU1 jumper settings.

## EN for the µDFN Circuit

The µDFN circuit on the EV kit provides a jumper (JU101) to enable/disable the MAX17224ELT+. See Table 2 for JU101 jumper settings.

## Battery Holders

The MAX17224 EV kit provides battery holders for each of the two circuits. The battery holder V1 can accommodate a  CR1632  Lithium  Coin  cell  to  power  the  WLP  circuit, while the V101 can hold an Energizer 364/363 silver oxide cell to power the µDFN circuit.

Table 1. EN on MAX17224ENT+ (JU1)
...
## Table 2. EN on MAX17224ELT+ (JU101)
...
The MAX17224 EV kit can also evaluate other ICs in the MAX17220-MAX17225 IC family. To evaluate the other ICs, replace U1 and/or U101 with the desired IC/IC package. Refer  to  the  MAX17220-MAX17225  IC  data  sheet  for additional information.
...
| PART           | TYPE   |
|----------------|--------|
| MAX17224EVKIT# | EV Kit |

# Denotes RoHS

## MAX17224 EV Kit Bill of Materials
...
|     13 | U1                        | -         |     1 | MAX17224ENT+                 | MAXIM                                  | MAX17224ENT+ | IC; CONV; 0.4V TO 5.5V INPUT; NANOPOWER SYNCHRONOUS BOOST CONVERTER WITH TRUE SHUTDOWN; WLP6                                            |
|     14 | U101                      | -         |     1 | MAX17224ELT+                 | MAXIM                                  | MAX17224ELT+ | IC; CONV; 0.4V TO 5.5V INPUT; NANOPOWER SYNCHRONOUS BOOST CONVERTER WITH TRUE SHUTDOWN; UDFN6                                           |
...
## MAX17224 EV Kit Bill of Materials (continued)

|   ITEM | REF_DES            | DNI/DNP   |   QTY | MFG PART #                   | MANUFACTURER                         | VALUE   | DESCRIPTION                                                                                                 |
|--------|--------------------|-----------|-------|------------------------------|--------------------------------------|---------|-------------------------------------------------------------------------------------------------------------|
|     17 | PCB                | -         |     1 | MAX17224                     | MAXIM                                | PCB     | PCB:MAX17224                                                                                                |
...
## MAX17224 EV Kit Schematic

<!-- image -->

## MAX17224 Minimal Component Circuit Schematic

<!-- image -->

## MAX17224 EV Kit PCB Layout Diagrams

MAX17224 EV Kit-Top Silkscreen
...
MAX17224 EV Kit-Bottom

<!-- image -->

MAX17224 EV Kit-Bottom Silkscreen
...
|                 2 | 9/20            | Replaced TDFN with µDFN                     | 2               |
