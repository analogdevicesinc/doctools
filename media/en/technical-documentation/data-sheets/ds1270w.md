...
| Logic 0 Input Voltage | V IL     |   0.0 |       | +0.4  | V       |         |
...
| Standby Current CE = 2.2V        | I CCS1   |       |   150 |   300 | µ A     |         |
| Standby Current CE = V CC - 0.2V | I CCS2   |       |   100 |   200 | µ A     |         |
...
| Input/Output Capacitance | C I/O    |       |    20 |    40 | pF      |         |
...
| PARAMETER                       | SYMBOL      | DS1270W-100   | DS1270W-100   | UNITS   | NOTES   |
|---------------------------------|-------------|---------------|---------------|---------|---------|
|                                 |             | MIN           | MAX           |         |         |
...
9. Each DS1270 has a built-in switch that disconnects the lithium source until VCC is first applied by the user. The expected tDR is defined as accumulative time in the absence of VCC starting from the time power is first applied by the user.
...
|-----------------|----------------|--------------------|----------------|--------------------|
| DS1270W-100#    | 0°C to +70°C   | 3.3V ± 0.3V        | 36 740 EDIP    |                100 |
| DS1270W-100IND# | -40°C to +85°C | 3.3V ± 0.3V        | 36 740 EDIP    |                100 |
