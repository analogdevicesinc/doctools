...
The MAX2366/MAX2367/MAX2368 come in a 48-pin QFN-EP package and are specified for the extended (-40°C to +85°C) temperature range.
...
|-------------|----------------|---------------|
| MAX2366 EGM | -40°C to +85°C | 48 QFN-EP*    |
| MAX2367 EGM | -40°C to +85°C | 48 QFN-EP*    |
| MAX2368 EGM | -40°C to +85°C | 48 QFN-EP*    |
...
|------------------------------------------------------------------------------------------------------------------------------------|
| RFL, RFH0, RFH1................................................................+5.5V                                               |
| DI, CLK, CS , VGC, SHDN , TXGATE , IDLE, LOCK...........................................-0.3V to (V CC + 0.3V)                     |
| AC Input Pins (IFINL, IFINH, Q, I, TANKL, TANKH, REF, RFPLL, LOL, LOH)..........................................1.0V peak          |
...
( MAX2366/7/8 test fixture: VCC = VBATT = +2.75V, SHDN = IDLE = TXGATE = +2.0V, VGC = +2.5V, RBIAS = 16k Ω , TA = -40°C to +85°C, unless otherwise noted. Typical values are at TA = +25°C, and operating modes are defined in Table 6.)
...
|                                      |                            |                            |                         |    26 |    34 |         |
|                                      |                            | RFPLL off                  |                         |    11 |       |         |
|                                      | SHDN = 0.6V, sleep mode    | SHDN = 0.6V, sleep mode    | SHDN = 0.6V, sleep mode |       |    20 | µA      |
| Logic High                           | (Note 7)                   | (Note 7)                   | 2.0                     |       |       | V       |
| Logic Low                            | (Note 7)                   | (Note 7)                   | (Note 7)                |       |   0.6 | V       |
| Logic Input Current                  | (Note 7)                   | (Note 7)                   | -5                      |       |    +5 | µA      |
| VGC Input Current                    | (Note 7)                   | (Note 7)                   | -10                     |       |   +10 | µA      |
| VGC Input Resistance During Shutdown | SHDN = 0.6V (Note 7)       | SHDN = 0.6V (Note 7)       | 225                     |   280 |       | k Ω     |
| Lock Indicator High                  | 50k Ω pullup load (Note 7) | 50k Ω pullup load (Note 7) | V CC - 0.4              |       |       | V       |
| Lock Indicator Low                   | 50k Ω pullup load (Note 7) | 50k Ω pullup load (Note 7) | 0.4                     |   0.4 |   0.4 | V       |
...
| IF Frequency Range                              | IF_BAND = 0                                      | IF_BAND = 0                                      | 120-235                                        | 120-235                                        | 120-235                                        | MHz                                            |
|                                                 | IF_BAND = 1                                      | IF_BAND = 1                                      | 120-300                                        | 120-300                                        | 120-300                                        | MHz                                            |
| I/Q Common-Mode Input Voltage                   | V CC = 2.7V to 3.0V (Notes 2, 3, 7)              | V CC = 2.7V to 3.0V (Notes 2, 3, 7)              | 1.35 V                                         | CC /2                                          | V CC - 1.25                                    | V                                              |
...
|                                                 | VGC = 2.5V, IFG = 111, direct VCO modulation     | VGC = 2.5V, IFG = 111, direct VCO modulation     | -5.5                                           | -5.5                                           | -5.5                                           | dBm                                            |
...
| IF Frequency Range                              | IF_BAND = 0                                      | IF_BAND = 0                                      | 120-200 180-300                                | 120-200 180-300                                | 120-200 180-300                                | MHz                                            |
| RFL Frequency Range                             | IF_BAND = 1 RFL port                             | IF_BAND = 1 RFL port                             | 800-1000                                       | 800-1000                                       | 800-1000                                       | MHz                                            |
...
| Output Power, RFH1 Port                         | VGC = 2.6V, ACPR = -54dBc                        | VGC = 2.6V, ACPR = -54dBc                        | 7.5                                            | 7.5                                            | 7.5                                            | dBm                                            |
| Output Power, RFH0 Port                         | VGC = 2.6V, ACPR = -54dBc                        | VGC = 2.6V, ACPR = -54dBc                        | 6.6                                            | 6.6                                            | 6.6                                            | dBm                                            |
| Power Control Range                             | VGC = 0.5V to 2.5V                               | VGC = 0.5V to 2.5V                               | 30                                             | 30                                             | 30                                             | dB                                             |
| Gain Variation Over Temperature                 | Relative to +25°C, T A = -40°C to +85°C (Note 4) | Relative to +25°C, T A = -40°C to +85°C (Note 4) | ±1                                             | ±2                                             |                                                | dB                                             |
| LO Leakage                                      |                                                  |                                                  | -17                                            | -17                                            | -17                                            | dBm                                            |
| Image Signal                                    |                                                  |                                                  | -29                                            | -29                                            | -29                                            | dBc                                            |
...
| IF Reference Divide Ratio                   |                                                                        | 2       |         | 2048    |         |
| VCO Operating Range                         | VCO = 0                                                                | 240-470 | 240-470 | 240-470 | MHz     |
| VCO Operating Range                         | VCO = 1                                                                | 240-600 | 240-600 | 240-600 | MHz     |
| IF LO Output Power                          | BUF_EN = 1                                                             | -6      | -6      | -6      | dBm     |
| Charge-Pump Source/Sink Current             | ICP = 00 (Note 7)                                                      | 115     | 175     | 230     | µA      |
| Charge-Pump Source/Sink Current             | ICP = 01 (Note 7)                                                      | 145     | 235     | 315     | µA      |
| Charge-Pump Source/Sink Current             | ICP = 10 (Note 7)                                                      | 235     | 350     | 470     | µA      |
| Charge-Pump Source/Sink Current             | ICP = 11 (Note 7)                                                      | 300     | 465     | 625     | µA      |
| Turbolock Boost Current                     | (Note 5, 7)                                                            | 265     | 450     | 615     | µA      |
...
| Charge-Pump Source/Sink Current             | RCP = 00 (Note 7)                                                      | 100 100 | 165 165 | 225 225 | µA µA   |
| Charge-Pump Source/Sink Current             | RCP = 01 (Note 7)                                                      | 135     | 230     | 310     | µA µA   |
| Charge-Pump Source/Sink Current             | RCP = 10 (Note 7)                                                      | 210     | 340     | 460     | µA µA   |
| Charge-Pump Source/Sink Current             | RCP = 11 (Note 7)                                                      | 270     | 450     | 630     | µA µA   |
| Turbolock Boost Current                     | (Note 5, 6)                                                            | 245     | 435     | 630     | µA      |
| Charge-Pump Source/Sink Matching            | Locked, all values of RCP, over specified compliance range (Note 6, 7) |         | 5       |         | %       |
| Charge-Pump High-Z Leakage                  | Over specified compliance range (Note 6)                               |         |         | 10      | nA      |
...
|-----------------|-------------------------------------|---------------------------------|----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| MAX2360 MAX2366 | MAX2367                             | MAX2368                         | NAME           | FUNCTION                                                                                                                                                                                                                                                                                                                             |
...
| 2               | 2                                   | -                               | RFH0           | Transmitter RF Output for PCS Band (1700MHz to 2000MHz). This open- collector output requires a pullup inductor to the supply voltage. The pullup inductor may be part of the output matching network and may be connected directly to the battery.                                                                                  |
| 3               | 3                                   | 3                               | LOCK           | Open-Collector Output Indicating Lock Status of the IF and/or the RF PLLs. Requires a pullup resistor. Control using configuration register bit LD_MODE0, LD_MODE1.                                                                                                                                                                  |
| 4               | 4                                   | 4                               | V CC           | Power Supply                                                                                                                                                                                                                                                                                                                         |
| 5               | 5                                   | 5                               | IDLE           | Digital Input. A logic low on IDLE shuts down everything except the RF PLL and associated registers. A small R-C lowpass filter may be used to prevent digital noise.                                                                                                                                                                |
...
| 13, 14, 15      | 13, 14, 15                          | 13, 14, 15                      | CLK, DI, CS    | Input Pins from the 3-Wire Serial Bus (SPI/QSPI/MICROWIRE compatible). An R-C filter on each of these pins may be used to reduce noise.                                                                                                                                                                                              |
...
| 27      | 27      | 27      | SHDN             | Shutdown Input. A logic low on SHDN shuts down the entire IC. An R-C low- pass filter may be used to reduce digital noise.                                                                                                                                                                                                                                                                                                                                                                              |
...
| 29      | 29      | 29      | IFLO             | NBuffered LO Output. Control the output buffer using register bit BUF_EN and the divide ratio using the register bit BUF_DIV.                                                                                                                                                                                                                                                                                                                                                                           |
...
| 34, 35         | -              | -              | N.C.           | No Connection. Leave these pins floating.                                                                                                                                                                                                                                                |
...
| 38             | 38             | 38             | IFCP           | High-Impedance Output of the IF Charge Pump. Connect to the tune input of the IF VCOs through the IF PLL loop filter. Keep the line from IFCP to the tune input as short as possible to prevent spurious pickup, and connect the loop filter as close to the tune input as possible.     |
...
| 45, 46, 48     | 45, 46, 48     | 45, 46, 48     | GND            | Ground. Connect to PC board ground plane.                                                                                                                                                                                                                                                |
| 47             | 47             | -              | RFH1           | Transmitter RF Output for PCS Band (1700MHz to 2000MHz). This open-col- lector output requires a pullup inductor to the supply voltage. The pullup inductor may be part of the output matching network and may be connected directly to the battery.                                     |
...
The operational control register (OPCTRL) controls the state of the MAX2366/MAX2367/MAX2368. See Table 3 for the function of each bit.
...
The MAX2366 is designed for use in dual-band, triplemode systems. It is recommended for triple-mode handsets (Figure 2). The MAX2367 is designed for use in CDMA PCS handsets or WLL single-mode 2.4GHz ISM systems (Figure 3). The MAX2368 is designed for use in dual-mode cellular systems (Figure 4).
...
| RF_TURBO_ CHARGE |                1 | 2                        | 1 activates turbocharge feature, providing an additional 435µA of RF charge- pump current during frequency acquisition.                                                                                                         |
...
|------------------|--------------------------------------|-------------------|-------------------|-------------------|-------------------|-------------------|-------------------|-------------------|-------------------|-------------------|-------------------|----------------|----------------|----------------|
| MODE             | DESCRIPTION                          | LO SEL            | MODE              | IF BAND           | VCO               | MOD TYPE          | STBY              | TXSTBY            | SHDN_BIT          | IF PLL SHDN       | RF PLL SHDN       | IDLE           | TXGATE         | SHDN           |
...
The MAX2366/MAX2367/MAX2368 EV kit can be used as a starting point for layout. For best performance, take into consideration power-supply issues, as well as the RF, LO, and IF layout.

## Power-Supply Layout

To minimize coupling between different sections of the IC, the ideal power-supply layout is a star configuration, which has a large decoupling capacitor at a central VCC node. The VCC traces branch out from this node, each going to a separate VCC node in the MAX2366/ MAX2367/MAX2368 circuit. At the end of each trace is a bypass capacitor with impedance to ground less than 1 Ω at the frequency of interest. This arrangement provides local decoupling at each VCC pin. Use at least one via per bypass capacitor for a low-inductance ground connection.
...
|---------|------------------|---------------------|------------------|
| MAX2366 | 120 to 235       | 800 to 1150         | 800 to 1000      |
| MAX2366 | 120 to 300       | 1400 to 2300        | 1700 to 2000     |
| MAX2367 | 120 to 300       | 1400 to 2300        | 1700 to 2000     |
| MAX2368 | 120 to 235       | 800 to 1150         | 800 to 1000      |
